...
class SamplesApi:
    ...
    @validate_arguments
    def samples_controller_find_by_id_access(self, id : Annotated[StrictStr, Field(..., description="ID of the sample to check access for")], **kwargs) -> bool:  # noqa: E501
        """Check user access to a specific sample.  # noqa: E501

        Returns a boolean indicating whether the user has access to the sample with the specified ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def samples_controller_fullquery(self, limits : Annotated[Optional[StrictStr], Field(description="Define further query parameters like skip, limit, order <pre>  {    \"limit\": number,    \"skip\": number,    \"order\": [ascending, descending]  }  </pre>")] = None, fields : Annotated[Optional[StrictStr], Field(description="Full query filters to apply when retrieve samples <pre>  {    \"text\": string, <optional>    \"metadataKey\": string, <optional>    \"charactersitics\": [ <optional>      {        \"lhs\":<property>>,        \"relation\":[\"EQUAL_TO_STRING\",\"EQUAL_TO_NUMERIC\",\"GREATER_THAN\",\"LESS_THAN\"],        \"rhs\":<value>,        \"unit\":<unit>,      },      ...    ],  }    </pre>")] = None, **kwargs) -> List[SampleClass]:  # noqa: E501
    ...
    @validate_arguments
    def samples_controller_fullquery_with_http_info(self, limits : Annotated[Optional[StrictStr], Field(description="Define further query parameters like skip, limit, order <pre>  {    \"limit\": number,    \"skip\": number,    \"order\": [ascending, descending]  }  </pre>")] = None, fields : Annotated[Optional[StrictStr], Field(description="Full query filters to apply when retrieve samples <pre>  {    \"text\": string, <optional>    \"metadataKey\": string, <optional>    \"charactersitics\": [ <optional>      {        \"lhs\":<property>>,        \"relation\":[\"EQUAL_TO_STRING\",\"EQUAL_TO_NUMERIC\",\"GREATER_THAN\",\"LESS_THAN\"],        \"rhs\":<value>,        \"unit\":<unit>,      },      ...    ],  }    </pre>")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """It returns a list of samples matching the query provided.  # noqa: E501
