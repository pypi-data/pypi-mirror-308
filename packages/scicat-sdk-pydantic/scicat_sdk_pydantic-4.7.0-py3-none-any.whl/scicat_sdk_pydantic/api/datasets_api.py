...
class DatasetsApi:
    ...
    @validate_arguments
    def datasets_controller_count(self, filter : Annotated[Optional[StrictStr], Field(description="Database filters to apply when retrieving count for datasets")] = None, **kwargs) -> None:  # noqa: E501
    ...
    def datasets_controller_create(self, datasets_controller_create_request : Annotated[DatasetsControllerCreateRequest, Field(..., description="Input fields for the dataset to be created")], **kwargs) -> OutputDatasetObsoleteDto:  # noqa: E501
        """It creates a new dataset which can be a raw or derived one.  # noqa: E501
    ...
    def datasets_controller_find_by_id(self, pid : Annotated[StrictStr, Field(..., description="Id of the dataset to return")], **kwargs) -> OutputDatasetObsoleteDto:  # noqa: E501
        ...
        It returns the dataset requested through the pid specified.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def datasets_controller_find_by_id_and_delete(self, pid : Annotated[StrictStr, Field(..., description="Id of the dataset to be deleted")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_find_logbook_by_pid(self, pid : Annotated[StrictStr, Field(..., description="Persistent identifier of the dataset for which we would like to delete the datablock specified")], filters : StrictStr, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_fullfacet(self, facets : Annotated[Optional[StrictStr], Field(description="Defines list of field names, for which facet counts should be calculated")] = None, fields : Annotated[Optional[StrictStr], Field(description="Define the filter conditions by specifying the name of values of fields requested. There is also support for a `text` search to look for strings anywhere in the dataset.")] = None, **kwargs) -> List[object]:  # noqa: E501
        """It returns a list of dataset facets matching the filter provided.  # noqa: E501

        It returns a list of dataset facets matching the filter provided.<br>This endpoint still needs some work on the filter and facets specification.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def datasets_controller_fullquery(self, limits : Annotated[Optional[StrictStr], Field(description="Define further query parameters like skip, limit, order <pre>  {    \"limit\": number,    \"skip\": number,    \"order\": [ascending, descending]  }  </pre>")] = None, fields : Annotated[Optional[StrictStr], Field(description="Database filters to apply when retrieving datasets <pre>   {    \"mode\":{      \"key\": \"value\",    },    \"text\": string, <optional>    \"creationTime\": { <optional>      \"begin\": string,      \"end\": string,    },    \"type\": [\"type1\", ...], <optional>    \"creationLocation\": [\"creationLocation1\", ...], <optional>    \"ownerGroup\": [\"group1\", ...], <optional>    \"keywords\": [\"keyword1\", ...], <optional>    \"isPublished: boolean,  <optional>    \"scientific\": [ <optional>      {        \"lhs\":<metadata_key>>,        \"relation\":[\"EQUAL_TO_STRING\",\"EQUAL_TO_NUMERIC\",\"GREATER_THAN\",\"LESS_THAN\"],        \"rhs\":<metadata_value>,        \"unit\":<unit>,      },      ...    ],    \"metadataKey\": \"metadata\", <optional>    \"_id\": \"item id\", <optional>    \"userGroups\": [\"group1\", ...], <optional>    \"sharedWith\": [\"email\", ...], <optional>  }    </pre>")] = None, **kwargs) -> List[OutputDatasetObsoleteDto]:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_fullquery_with_http_info(self, limits : Annotated[Optional[StrictStr], Field(description="Define further query parameters like skip, limit, order <pre>  {    \"limit\": number,    \"skip\": number,    \"order\": [ascending, descending]  }  </pre>")] = None, fields : Annotated[Optional[StrictStr], Field(description="Database filters to apply when retrieving datasets <pre>   {    \"mode\":{      \"key\": \"value\",    },    \"text\": string, <optional>    \"creationTime\": { <optional>      \"begin\": string,      \"end\": string,    },    \"type\": [\"type1\", ...], <optional>    \"creationLocation\": [\"creationLocation1\", ...], <optional>    \"ownerGroup\": [\"group1\", ...], <optional>    \"keywords\": [\"keyword1\", ...], <optional>    \"isPublished: boolean,  <optional>    \"scientific\": [ <optional>      {        \"lhs\":<metadata_key>>,        \"relation\":[\"EQUAL_TO_STRING\",\"EQUAL_TO_NUMERIC\",\"GREATER_THAN\",\"LESS_THAN\"],        \"rhs\":<metadata_value>,        \"unit\":<unit>,      },      ...    ],    \"metadataKey\": \"metadata\", <optional>    \"_id\": \"item id\", <optional>    \"userGroups\": [\"group1\", ...], <optional>    \"sharedWith\": [\"email\", ...], <optional>  }    </pre>")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """It returns a list of datasets matching the query provided.  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_is_valid(self, datasets_controller_create_request : Annotated[DatasetsControllerCreateRequest, Field(..., description="Input fields for the dataset that needs to be validated")], **kwargs) -> bool:  # noqa: E501
