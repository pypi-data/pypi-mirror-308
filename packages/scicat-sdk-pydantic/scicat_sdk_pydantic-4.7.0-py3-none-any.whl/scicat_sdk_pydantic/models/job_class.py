...
class JobClass(BaseModel):
    ...
    __properties = ["_id", "emailJobInitiator", "type", "creationTime", "executionTime", "jobParams", "jobStatusMessage", "datasetList", "jobResultObject", "ownerGroup"]
    ...
    def from_dict(cls, obj: dict) -> JobClass:
        ...
        _obj = JobClass.parse_obj({
            ...
            "dataset_list": obj.get("datasetList"),
