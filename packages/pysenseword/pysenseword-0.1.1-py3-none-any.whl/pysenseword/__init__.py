...
def search(text,method='dfa',dictionary='default'):
    ...
    Args:
        ...
        method (str, optional): The algorithm to use for detecting sensitive words. Available options are:
            ...
            - 're': Regular expression
            - 'str': String find
        dictionary (list, optional): The path to the dictionary file. Defaults to 'default_dict.txt' in the same directory as the module.
    ...
    if dictionary == 'default':
        dictionary = load_keywords(os.path.dirname(__file__)+'\\default_dict.txt')
    if not dictionary:
