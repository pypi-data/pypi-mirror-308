var Pt = typeof global == "object" && global && global.Object === Object && global, ln = typeof self == "object" && self && self.Object === Object && self, $ = Pt || ln || Function("return this")(), w = $.Symbol, At = Object.prototype, fn = At.hasOwnProperty, cn = At.toString, q = w ? w.toStringTag : void 0;
function pn(e) {
...
var me = U($, "WeakMap"), Ze = Object.create, Ln = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!H(t))
...
function Q(e, t, n, r) {
  ...
  for (var i = -1, a = t.length; ++i < a; ) {
    var s = t[i], f = void 0;
    f === void 0 && (f = e[s]), o ? Se(n, s, f) : Et(n, s, f);
  }
  return n;
}
var We = Math.max;
...
var Gt = typeof exports == "object" && exports && !exports.nodeType && exports, nt = Gt && typeof module == "object" && module && !module.nodeType && module, zi = nt && nt.exports === Gt, rt = zi ? $.Buffer : void 0, it = rt ? rt.allocUnsafe : void 0;
function Hi(e, t) {
  if (t)
    return e.slice();
...
var Te = U($, "DataView"), Oe = U($, "Promise"), we = U($, "Set"), at = "[object Map]", Qi = "[object Object]", st = "[object Promise]", ut = "[object Set]", lt = "[object WeakMap]", ft = "[object DataView]", Vi = D(Te), ki = D(Z), eo = D(Oe), to = D(we), no = D(me), P = N;
...
var co = "[object Boolean]", po = "[object Date]", go = "[object Map]", _o = "[object Number]", ho = "[object RegExp]", bo = "[object Set]", yo = "[object String]", mo = "[object Symbol]", vo = "[object ArrayBuffer]", To = "[object DataView]", Oo = "[object Float32Array]", wo = "[object Float64Array]", Po = "[object Int8Array]", Ao = "[object Int16Array]", So = "[object Int32Array]", $o = "[object Uint8Array]", Co = "[object Uint8ClampedArray]", Io = "[object Uint16Array]", jo = "[object Uint32Array]";
function Eo(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case vo:
...
var va = 1, Ta = 2, Oa = "[object Boolean]", wa = "[object Date]", Pa = "[object Error]", Aa = "[object Map]", Sa = "[object Number]", $a = "[object RegExp]", Ca = "[object Set]", Ia = "[object String]", ja = "[object Symbol]", Ea = "[object ArrayBuffer]", xa = "[object DataView]", _t = w ? w.prototype : void 0, he = _t ? _t.valueOf : void 0;
...
function Ga(e, t, n, r, o, i) {
  ...
  if (b && !p)
    return i || (i = new S()), a || Lt(e) ? Jt(e, t, n, r, o, i) : Ma(e, t, f, n, r, o, i);
  if (!(n & Da)) {
  ...
  return b ? (i || (i = new S()), Na(e, t, n, r, o, i)) : !1;
}
...
var cs = 1, ps = 2, gs = 4, Qt = $i(function(e, t) {
  var n = {};
  if (e == null)
    return n;
  var r = !1;
...
function eu(e) {
  ...
  e[26]({
    ...
    p(i, a) {
      const s = a & /*$mergedProps, $slots, $treeData, $children, value, setSlotParams*/
...
function iu(e, t, n) {
  ...
  const b = _s(() => import("./tree-select-DjFuxw2P.js"));
  let {
    gradio: l
  } = t, {
    props: _ = {}
