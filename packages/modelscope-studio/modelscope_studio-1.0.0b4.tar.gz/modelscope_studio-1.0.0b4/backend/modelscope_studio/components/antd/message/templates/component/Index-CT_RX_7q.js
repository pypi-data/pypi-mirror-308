...
function Hs(e, t, n) {
  ...
  const p = ss(() => import("./message-CQn9ipSf.js"));
  let {
    gradio: d
  } = t, {
    props: b = {}
  ...
  return e.$$set = (h) => {
    t = ve(ve({}, t), Cs(h)), n(20, o = ht(t, r)), "gradio" in h && n(7, d = h.gradio), "props" in h && n(8, b = h.props), "_internal" in h && n(9, _ = h._internal), "content" in h && n(10, g = h.content), "as_item" in h && n(11, f = h.as_item), "visible" in h && n(0, v = h.visible), "elem_id" in h && n(12, O = h.elem_id), "elem_classes" in h && n(13, M = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(18, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && u.update((h) => ({
      ...h,
