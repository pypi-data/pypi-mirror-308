var At = typeof global == "object" && global && global.Object === Object && global, sn = typeof self == "object" && self && self.Object === Object && self, C = At || sn || Function("return this")(), A = C.Symbol, wt = Object.prototype, un = wt.hasOwnProperty, ln = wt.toString, X = A ? A.toStringTag : void 0;
function fn(e) {
...
var dn = "[object Null]", _n = "[object Undefined]", He = A ? A.toStringTag : void 0;
function U(e) {
...
function $e(e) {
  return typeof e == "symbol" || I(e) && U(e) == bn;
}
function Pt(e, t) {
...
var P = Array.isArray, hn = 1 / 0, qe = A ? A.prototype : void 0, Ye = qe ? qe.toString : void 0;
function $t(e) {
  if (typeof e == "string")
    return e;
  if (P(e))
...
var Pn = /[\\^$.*+?()[\]{}|]/g, $n = /^\[object .+?Constructor\]$/, Sn = Function.prototype, Cn = Object.prototype, jn = Sn.toString, En = Cn.hasOwnProperty, In = RegExp("^" + jn.call(En).replace(Pn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function xn(e) {
  if (!Y(e) || On(e))
    return !1;
  var t = Ct(e) ? In : $n;
...
var ve = K(C, "WeakMap"), Je = Object.create, Rn = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!Y(t))
...
var Mt = typeof exports == "object" && exports && !exports.nodeType && exports, Qe = Mt && typeof module == "object" && module && !module.nodeType && module, rr = Qe && Qe.exports === Mt, Ve = rr ? C.Buffer : void 0, ir = Ve ? Ve.isBuffer : void 0, ie = ir || nr, or = "[object Arguments]", ar = "[object Array]", sr = "[object Boolean]", ur = "[object Date]", lr = "[object Error]", fr = "[object Function]", cr = "[object Map]", pr = "[object Number]", gr = "[object Object]", dr = "[object RegExp]", _r = "[object Set]", br = "[object String]", hr = "[object WeakMap]", yr = "[object ArrayBuffer]", mr = "[object DataView]", vr = "[object Float32Array]", Tr = "[object Float64Array]", Or = "[object Int8Array]", Ar = "[object Int16Array]", wr = "[object Int32Array]", Pr = "[object Uint8Array]", $r = "[object Uint8ClampedArray]", Sr = "[object Uint16Array]", Cr = "[object Uint32Array]", m = {};
m[vr] = m[Tr] = m[Or] = m[Ar] = m[wr] = m[Pr] = m[$r] = m[Sr] = m[Cr] = !0;
m[or] = m[ar] = m[yr] = m[sr] = m[mr] = m[ur] = m[lr] = m[fr] = m[cr] = m[pr] = m[gr] = m[dr] = m[_r] = m[br] = m[hr] = !1;
function jr(e) {
  return I(e) && je(e.length) && !!m[U(e)];
}
function xe(e) {
  return function(t) {
    return e(t);
...
var Rt = typeof exports == "object" && exports && !exports.nodeType && exports, J = Rt && typeof module == "object" && module && !module.nodeType && module, Er = J && J.exports === Rt, _e = Er && At.process, H = function() {
  try {
    var e = J && J.require && J.require("util").types;
    return e || _e && _e.binding && _e.binding("util");
  } catch {
  }
}(), ke = H && H.isTypedArray, Lt = ke ? xe(ke) : jr, Ir = Object.prototype, xr = Ir.hasOwnProperty;
function Ft(e, t) {
  var n = P(e), r = !n && Ie(e), o = !n && !r && ie(e), i = !n && !r && !o && Lt(e), a = n || r || o || i, s = a ? Vn(e.length, String) : [], u = s.length;
  for (var l in e)
...
var Mr = Nt(Object.keys, Object), Rr = Object.prototype, Lr = Rr.hasOwnProperty;
function Fr(e) {
  if (!Ee(e))
    return Mr(e);
  var t = [];
...
function Re(e, t) {
  if (P(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || $e(e) ? !0 : Br.test(e) || !Kr.test(e) || t != null && e in Object(t);
}
...
var Ut = typeof exports == "object" && exports && !exports.nodeType && exports, tt = Ut && typeof module == "object" && module && !module.nodeType && module, Ki = tt && tt.exports === Ut, nt = Ki ? C.Buffer : void 0, rt = nt ? nt.allocUnsafe : void 0;
function Bi(e, t) {
  if (t)
    return e.slice();
...
var Hi = Object.prototype, qi = Hi.propertyIsEnumerable, it = Object.getOwnPropertySymbols, Ue = it ? function(e) {
...
var Oe = K(C, "DataView"), Ae = K(C, "Promise"), we = K(C, "Set"), ot = "[object Map]", Zi = "[object Object]", at = "[object Promise]", st = "[object Set]", ut = "[object WeakMap]", lt = "[object DataView]", Wi = G(Oe), Qi = G(W), Vi = G(Ae), ki = G(we), eo = G(ve), w = U;
(Oe && w(new Oe(new ArrayBuffer(1))) != lt || W && w(new W()) != ot || Ae && w(Ae.resolve()) != at || we && w(new we()) != st || ve && w(new ve()) != ut) && (w = function(e) {
...
function te(e, t, n, r, o, i) {
  ...
  if (p) {
    ...
    var d = w(e), h = d == qt || d == Ho;
    if (ie(e))
      return Bi(e, s);
    if (d == Yt || d == Ht || h && !o) {
      if (a = u || h ? {} : Eo(e), !s)
        return u ? Ji(e, Gi(a, e)) : Yi(e, Ui(a, e));
    } else {
      if (!y[d])
        return o ? e : {};
      a = jo(e, d, s);
  ...
  var _ = l ? u ? zt : Te : u ? Me : V, g = p ? void 0 : _(e);
  return Hn(g || e, function(c, v) {
    g && (v = c, c = e[v]), Et(a, v, te(c, t, n, v, e, i));
  }), a;
}
...
ae.prototype.add = ae.prototype.push = fa;
ae.prototype.has = ca;
function pa(e, t) {
...
function Xt(e, t, n, r, o, i) {
  ...
  if (l && p)
    return l == t && p == e;
  var d = -1, h = !0, f = n & _a ? new ae() : void 0;
...
var ya = 1, ma = 2, va = "[object Boolean]", Ta = "[object Date]", Oa = "[object Error]", Aa = "[object Map]", wa = "[object Number]", Pa = "[object RegExp]", $a = "[object Set]", Sa = "[object String]", Ca = "[object Symbol]", ja = "[object ArrayBuffer]", Ea = "[object DataView]", dt = A ? A.prototype : void 0, be = dt ? dt.valueOf : void 0;
...
var xa = 1, Ma = Object.prototype, Ra = Ma.hasOwnProperty;
function La(e, t, n, r, o, i) {
  ...
  for (var c = a; ++d < u; ) {
    ...
    var v = e[h], O = t[h];
    if (r)
      var L = a ? r(O, v, h, t, e, i) : r(v, O, h, e, t, i);
...
function Da(e, t, n, r, o, i) {
  var a = P(e), s = P(t), u = a ? bt : w(e), l = s ? bt : w(t);
  ...
  if (h && !p)
    return i || (i = new S()), a || Lt(e) ? Xt(e, t, n, r, o, i) : Ia(e, t, u, n, r, o, i);
  if (!(n & Fa)) {
    var f = p && ht.call(e, "__wrapped__"), _ = d && ht.call(t, "__wrapped__");
    if (f || _) {
      var g = f ? e.value() : e, c = _ ? t.value() : t;
      return i || (i = new S()), o(g, c, n, r, i);
    }
  }
  return h ? (i || (i = new S()), La(e, t, n, r, o, i)) : !1;
}
function Ke(e, t, n, r, o) {
  return e === t ? !0 : e == null || t == null || !I(e) && !I(t) ? e !== e && t !== t : Da(e, t, n, r, Ke, o);
}
var Ua = 1, Ga = 2;
function Ka(e, t, n, r) {
  var o = n.length, i = o;
  ...
  for (; ++o < i; ) {
    ...
    if (a[2]) {
      ...
      var p = new S(), d;
      if (!(d === void 0 ? Ke(l, u, Ua | Ga, r, p) : d))
        return !1;
    }
  }
  return !0;
...
function qa(e, t, n) {
  ...
  return i || ++r != o ? i : (o = e == null ? 0 : e.length, !!o && je(o) && jt(a, o) && (P(e) || Ie(e)));
}
function Ya(e, t) {
...
var Xa = 1, Ja = 2;
function Za(e, t) {
  return Re(e) && Jt(t) ? Zt(k(e), t) : function(n) {
    var r = Ti(n, e);
...
function Va(e) {
  return Re(e) ? Wa(k(e)) : Qa(e);
}
function ka(e) {
  return typeof e == "function" ? e : e == null ? St : typeof e == "object" ? P(e) ? Za(e[0], e[1]) : za(e) : Va(e);
}
function es(e) {
...
var ls = 1, fs = 2, cs = 4, Wt = Pi(function(e, t) {
  var n = {};
  if (e == null)
    return n;
  var r = !1;
  ...
  }), Q(e, zt(e), n), r && (n = te(n, ls | fs | cs, us));
...
function Os(e, t, n) {
  ...
  typeof i == "number" && mt(void 0), typeof e._internal.subIndex == "number" && mt(e._internal.subIndex), r && r.subscribe((f) => {
    o.slotKey.set(f);
  }), As();
  const a = fe(vs), s = ((d = B(a)) == null ? void 0 : d.as_item) || e.as_item, u = he(a ? s ? ((h = B(a)) == null ? void 0 : h[s]) || {} : B(a) || {} : {}), l = (f, _) => f ? _s({
    ...f,
    ..._ || {}
  }, t) : void 0, p = F({
    ...e,
  ...
  return t = s(e), n = a[t] = i[t](e), {
    ...
    p(u, l) {
      ...
      t = s(u), t === p ? a[t].p(u, l) : (rn(), D(a[p], 1, 1, () => {
        a[p] = null;
      }), nn(), n = a[t], n ? n.p(u, l) : (n = a[t] = i[t](u), n.c()), R(n, 1), n.m(r.parentNode, r));
    },
    i(u) {
      o || (R(n), o = !0);
    },
...
function Vs(e) {
  ...
  return {
    ...
    p(o, [i]) {
      ...
      2 && R(r, 1)) : (r = Ot(o), r.c(), R(r, 1), r.m(t.parentNode, t)) : r && (rn(), D(r, 1, 1, () => {
        r = null;
      }), nn());
    },
    i(o) {
...
function ks(e, t, n) {
  ...
  const p = gs(() => import("./tag.checkable-tag-DoT0NHzz.js"));
  let {
    gradio: d
  } = t, {
    props: h = {}
  ...
  return e.$$set = (b) => {
    t = Pe(Pe({}, t), Rs(b)), n(21, o = Tt(t, r)), "gradio" in b && n(7, d = b.gradio), "props" in b && n(8, h = b.props), "_internal" in b && n(9, _ = b._internal), "as_item" in b && n(10, g = b.as_item), "value" in b && n(0, c = b.value), "label" in b && n(11, v = b.label), "visible" in b && n(12, O = b.visible), "elem_id" in b && n(13, L = b.elem_id), "elem_classes" in b && n(14, j = b.elem_classes), "elem_style" in b && n(15, E = b.elem_style), "$$scope" in b && n(19, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && f.update((b) => ({
      ...b,
  ...
  }, [c, a, s, p, f, Be, ze, d, h, _, g, v, O, L, j, E, i, u, an, l];
}
class tu extends Cs {
  constructor(t) {
    super(), Us(this, t, ks, Vs, Ks, {
      gradio: 7,
      props: 8,
      _internal: 9,
      as_item: 10,
