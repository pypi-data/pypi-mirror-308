var vt = typeof global == "object" && global && global.Object === Object && global, tn = typeof self == "object" && self && self.Object === Object && self, S = vt || tn || Function("return this")(), A = S.Symbol, Tt = Object.prototype, nn = Tt.hasOwnProperty, rn = Tt.toString, q = A ? A.toStringTag : void 0;
function on(e) {
...
var fn = "[object Null]", ln = "[object Undefined]", Ke = A ? A.toStringTag : void 0;
function F(e) {
...
var $ = Array.isArray, pn = 1 / 0, Be = A ? A.prototype : void 0, ze = Be ? Be.toString : void 0;
function At(e) {
  if (typeof e == "string")
    return e;
  if ($(e))
...
var vn = /[\\^$.*+?()[\]{}|]/g, Tn = /^\[object .+?Constructor\]$/, On = Function.prototype, An = Object.prototype, wn = On.toString, $n = An.hasOwnProperty, Pn = RegExp("^" + wn.call($n).replace(vn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function Sn(e) {
  if (!H(e) || hn(e))
    return !1;
  var t = $t(e) ? Pn : Tn;
...
var ye = D(S, "WeakMap"), qe = Object.create, xn = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!H(t))
...
var jt = typeof exports == "object" && exports && !exports.nodeType && exports, Je = jt && typeof module == "object" && module && !module.nodeType && module, Vn = Je && Je.exports === jt, Ze = Vn ? S.Buffer : void 0, kn = Ze ? Ze.isBuffer : void 0, re = kn || Qn, er = "[object Arguments]", tr = "[object Array]", nr = "[object Boolean]", rr = "[object Date]", ir = "[object Error]", or = "[object Function]", ar = "[object Map]", sr = "[object Number]", ur = "[object Object]", fr = "[object RegExp]", lr = "[object Set]", cr = "[object String]", pr = "[object WeakMap]", gr = "[object ArrayBuffer]", dr = "[object DataView]", _r = "[object Float32Array]", br = "[object Float64Array]", hr = "[object Int8Array]", yr = "[object Int16Array]", mr = "[object Int32Array]", vr = "[object Uint8Array]", Tr = "[object Uint8ClampedArray]", Or = "[object Uint16Array]", Ar = "[object Uint32Array]", m = {};
m[_r] = m[br] = m[hr] = m[yr] = m[mr] = m[vr] = m[Tr] = m[Or] = m[Ar] = !0;
...
}(), We = z && z.isTypedArray, It = We ? je(We) : wr, Pr = Object.prototype, Sr = Pr.hasOwnProperty;
function Mt(e, t) {
  var n = $(e), r = !n && xe(e), o = !n && !r && re(e), i = !n && !r && !o && It(e), a = n || r || o || i, s = a ? Xn(e.length, String) : [], c = s.length;
  for (var f in e)
...
var Fe = Rt(Object.getPrototypeOf, Object), Ti = "[object Object]", Oi = Function.prototype, Ai = Object.prototype, Lt = Oi.toString, wi = Ai.hasOwnProperty, $i = Lt.call(Object);
function Pi(e) {
  if (!C(e) || F(e) != Ti)
    return !1;
  var t = Fe(e);
...
var ve = D(S, "DataView"), Te = D(S, "Promise"), Oe = D(S, "Set"), nt = "[object Map]", Hi = "[object Object]", rt = "[object Promise]", it = "[object Set]", ot = "[object WeakMap]", at = "[object DataView]", qi = N(ve), Yi = N(J), Xi = N(Te), Ji = N(Oe), Zi = N(ye), w = F;
...
var io = "[object Boolean]", oo = "[object Date]", ao = "[object Map]", so = "[object Number]", uo = "[object RegExp]", fo = "[object Set]", lo = "[object String]", co = "[object Symbol]", po = "[object ArrayBuffer]", go = "[object DataView]", _o = "[object Float32Array]", bo = "[object Float64Array]", ho = "[object Int8Array]", yo = "[object Int16Array]", mo = "[object Int32Array]", vo = "[object Uint8Array]", To = "[object Uint8ClampedArray]", Oo = "[object Uint16Array]", Ao = "[object Uint32Array]";
function wo(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case po:
...
function ee(e, t, n, r, o, i) {
  ...
  }) : Co(e) && e.forEach(function(l, v) {
    a.set(v, ee(l, t, n, v, e, i));
  });
  var _ = f ? c ? Gt : me : c ? Ee : Q, g = p ? void 0 : _(e);
  return Un(g || e, function(l, v) {
    g && (v = l, l = e[v]), St(a, v, ee(l, t, n, v, e, i));
  }), a;
}
...
function Ht(e, t, n, r, o, i) {
  ...
  if (f && p)
    return f == t && p == e;
  var d = -1, b = !0, u = n & la ? new oe() : void 0;
  for (i.set(e, t), i.set(t, e); ++d < s; ) {
    var _ = e[d], g = t[d];
    if (r)
      var l = a ? r(g, _, d, t, e, i) : r(_, g, d, e, t, i);
    if (l !== void 0) {
      if (l)
        continue;
      b = !1;
...
var ga = 1, da = 2, _a = "[object Boolean]", ba = "[object Date]", ha = "[object Error]", ya = "[object Map]", ma = "[object Number]", va = "[object RegExp]", Ta = "[object Set]", Oa = "[object String]", Aa = "[object Symbol]", wa = "[object ArrayBuffer]", $a = "[object DataView]", ct = A ? A.prototype : void 0, de = ct ? ct.valueOf : void 0;
...
function ja(e, t, n, r, o, i) {
  var a = n & Sa, s = me(e), c = s.length, f = me(t), p = f.length;
  if (c != p && !a)
    return !1;
  for (var d = c; d--; ) {
    var b = s[d];
...
function Ma(e, t, n, r, o, i) {
  var a = $(e), s = $(t), c = a ? gt : w(e), f = s ? gt : w(t);
  ...
  if (!(n & Ea)) {
    ...
    if (u || _) {
      var g = u ? e.value() : e, l = _ ? t.value() : t;
      return i || (i = new P()), o(g, l, n, r, i);
    }
  }
  return b ? (i || (i = new P()), ja(e, t, n, r, o, i)) : !1;
}
...
function Fa(e, t, n, r) {
  ...
  for (; ++o < i; ) {
    ...
    if (a[2]) {
      ...
      var p = new P(), d;
      if (!(d === void 0 ? Ue(f, c, Ra | La, r, p) : d))
        return !1;
    }
  }
  return !0;
...
function ls(e, t = {}) {
  return ts(Xt(e, Jt), (n, r) => t[r] || fs(r));
}
function _t(e) {
  const {
    gradio: t,
  ...
  return Object.keys(n).reduce((a, s) => {
    ...
    if (c) {
      const f = c[1], p = f.split("_"), d = (...u) => {
        const _ = u.map((l) => u && typeof l == "object" && (l.nativeEvent || l instanceof Event) ? {
          type: l.type,
          detail: l.detail,
...
function hs(e, t, n) {
  ...
  const a = le(_s), s = ((d = G(a)) == null ? void 0 : d.as_item) || e.as_item, c = _e(a ? s ? ((b = G(a)) == null ? void 0 : b[s]) || {} : G(a) || {} : {}), f = (u, _) => u ? ls({
    ...u,
    ..._ || {}
  }, t) : void 0, p = R({
    ...e,
...
function qs(e, t, n) {
  ...
  const p = us(() => import("./affix-7E-NAmZq.js"));
  let {
    gradio: d
  } = t, {
    props: b = {}
  ...
  return be(e, Ge, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Ae(Ae({}, t), xs(h)), n(18, o = yt(t, r)), "gradio" in h && n(6, d = h.gradio), "props" in h && n(7, b = h.props), "_internal" in h && n(8, _ = h._internal), "as_item" in h && n(9, g = h.as_item), "visible" in h && n(10, l = h.visible), "elem_id" in h && n(11, v = h.elem_id), "elem_classes" in h && n(12, O = h.elem_classes), "elem_style" in h && n(13, I = h.elem_style), "$$scope" in h && n(16, f = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && u.update((h) => ({
      ...h,
  ...
  }, [a, s, p, u, M, Ge, d, b, _, g, l, v, O, I, i, c, f];
}
class Xs extends As {
  constructor(t) {
