...
function Gs(e, t, n) {
  ...
  return H(e, Ke, (p) => n(16, o = p)), e.$$set = (p) => {
    t = yt(yt({}, t), Es(p)), n(24, i = ht(t, r)), "gradio" in p && n(6, h = p.gradio), "props" in p && n(7, f = p.props), "_internal" in p && n(8, d = p._internal), "as_item" in p && n(9, c = p.as_item), "value" in p && n(10, v = p.value), "title" in p && n(11, T = p.title), "visible" in p && n(12, R = p.visible), "elem_id" in p && n(13, x = p.elem_id), "elem_classes" in p && n(14, C = p.elem_classes), "elem_style" in p && n(15, Q = p.elem_style), "$$scope" in p && n(20, y = p.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && _.update((p) => ({
      ...p,
    ...
    458753 && en(l, s._internal.index || 0, {
      props: {
        style: s.elem_style,
        className: Os(s.elem_classes, "ms-gr-antd-tree-select-node"),
        id: s.elem_id,
        title: s.title,
        value: s.value,
        ...s.restProps,
