var yt = typeof global == "object" && global && global.Object === Object && global, kt = typeof self == "object" && self && self.Object === Object && self, S = yt || kt || Function("return this")(), O = S.Symbol, mt = Object.prototype, en = mt.hasOwnProperty, tn = mt.toString, B = O ? O.toStringTag : void 0;
function nn(e) {
...
function we(e) {
  return typeof e == "symbol" || C(e) && L(e) == ln;
}
function vt(e, t) {
...
var A = Array.isArray, fn = 1 / 0, Ge = O ? O.prototype : void 0, Ke = Ge ? Ge.toString : void 0;
function Tt(e) {
  if (typeof e == "string")
    return e;
  if (A(e))
...
var yn = /[\\^$.*+?()[\]{}|]/g, mn = /^\[object .+?Constructor\]$/, vn = Function.prototype, Tn = Object.prototype, On = vn.toString, wn = Tn.hasOwnProperty, An = RegExp("^" + On.call(wn).replace(yn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function Pn(e) {
  if (!K(e) || _n(e))
    return !1;
  var t = wt(e) ? An : mn;
...
var he = N(S, "WeakMap"), ze = Object.create, Sn = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!K(t))
...
function Pt(e, t, n) {
  var r = e[t];
  (!(Kn.call(e, t) && Pe(r, n)) || n === void 0 && !(t in e)) && Ae(e, t, n);
}
function X(e, t, n, r) {
  var o = !n;
  n || (n = {});
...
var xt = typeof exports == "object" && exports && !exports.nodeType && exports, z = xt && typeof module == "object" && module && !module.nodeType && module, wr = z && z.exports === xt, pe = wr && yt.process, G = function() {
  try {
    var e = z && z.require && z.require("util").types;
    return e || pe && pe.binding && pe.binding("util");
  } catch {
  }
}(), Je = G && G.isTypedArray, jt = Je ? xe(Je) : Or, Ar = Object.prototype, Pr = Ar.hasOwnProperty;
function Et(e, t) {
...
var Le = It(Object.getPrototypeOf, Object), mi = "[object Object]", vi = Function.prototype, Ti = Object.prototype, Mt = vi.toString, Oi = Ti.hasOwnProperty, wi = Mt.call(Object);
function Ai(e) {
  if (!C(e) || L(e) != mi)
    return !1;
  var t = Le(e);
...
var Rt = typeof exports == "object" && exports && !exports.nodeType && exports, We = Rt && typeof module == "object" && module && !module.nodeType && module, Ri = We && We.exports === Rt, Qe = Ri ? S.Buffer : void 0, Ve = Qe ? Qe.allocUnsafe : void 0;
function Li(e, t) {
  if (t)
    return e.slice();
...
var me = N(S, "DataView"), ve = N(S, "Promise"), Te = N(S, "Set"), et = "[object Map]", Bi = "[object Object]", tt = "[object Promise]", nt = "[object Set]", rt = "[object WeakMap]", it = "[object DataView]", zi = F(me), Hi = F(Y), qi = F(ve), Yi = F(Te), Xi = F(he), w = L;
(me && w(new me(new ArrayBuffer(1))) != it || Y && w(new Y()) != et || ve && w(ve.resolve()) != tt || Te && w(new Te()) != nt || he && w(new he()) != rt) && (w = function(e) {
  var t = L(e), n = t == Bi ? e.constructor : void 0, r = n ? F(n) : "";
  if (r)
    switch (r) {
      case zi:
        return it;
...
var no = "[object Boolean]", ro = "[object Date]", io = "[object Map]", oo = "[object Number]", ao = "[object RegExp]", so = "[object Set]", uo = "[object String]", lo = "[object Symbol]", fo = "[object ArrayBuffer]", co = "[object DataView]", po = "[object Float32Array]", go = "[object Float64Array]", _o = "[object Int8Array]", bo = "[object Int16Array]", ho = "[object Int32Array]", yo = "[object Uint8Array]", mo = "[object Uint8ClampedArray]", vo = "[object Uint16Array]", To = "[object Uint32Array]";
function Oo(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case fo:
...
function V(e, t, n, r, o, i) {
  ...
  if (p) {
    ...
    var _ = w(e), b = _ == Gt || _ == No;
    if (te(e))
      return Li(e, s);
    if (_ == Kt || _ == Ut || b && !o) {
      if (a = c || b ? {} : wo(e), !s)
        return c ? Ki(e, Mi(a, e)) : Ui(e, Ii(a, e));
    } else {
      if (!y[_])
        return o ? e : {};
      a = Oo(e, _, s);
  ...
  i.set(e, a), xo(e) ? e.forEach(function(f) {
    a.add(V(f, t, n, f, e, i));
  }) : $o(e) && e.forEach(function(f, v) {
    a.set(v, V(f, t, n, v, e, i));
  });
  var d = l ? c ? Dt : ye : c ? je : J, g = p ? void 0 : d(e);
  return Nn(g || e, function(f, v) {
    g && (v = f, f = e[v]), Pt(a, v, V(f, t, n, v, e, i));
  }), a;
}
...
function Bt(e, t, n, r, o, i) {
  ...
  if (l && p)
    return l == t && p == e;
  var _ = -1, b = !0, u = n & ua ? new re() : void 0;
...
var ca = 1, pa = 2, ga = "[object Boolean]", da = "[object Date]", _a = "[object Error]", ba = "[object Map]", ha = "[object Number]", ya = "[object RegExp]", ma = "[object Set]", va = "[object String]", Ta = "[object Symbol]", Oa = "[object ArrayBuffer]", wa = "[object DataView]", lt = O ? O.prototype : void 0, ge = lt ? lt.valueOf : void 0;
...
function Ca(e, t, n, r, o, i) {
  var a = n & Pa, s = ye(e), c = s.length, l = ye(t), p = l.length;
  if (c != p && !a)
    return !1;
  for (var _ = c; _--; ) {
    var b = s[_];
    if (!(a ? b in t : Sa.call(t, b)))
      return !1;
  }
  ...
  for (var f = a; ++_ < c; ) {
    ...
    var v = e[b], P = t[b];
    if (r)
      var W = a ? r(P, v, b, t, e, i) : r(v, P, b, e, t, i);
    if (!(W === void 0 ? v === P || o(v, P, n, r, i) : W)) {
      g = !1;
      break;
    }
    f || (f = b == "constructor");
  ...
  if (g && !f) {
    var I = e.constructor, h = t.constructor;
    I != h && "constructor" in e && "constructor" in t && !(typeof I == "function" && I instanceof I && typeof h == "function" && h instanceof h) && (g = !1);
  }
  return i.delete(e), i.delete(t), g;
}
var xa = 1, ft = "[object Arguments]", ct = "[object Array]", Q = "[object Object]", ja = Object.prototype, pt = ja.hasOwnProperty;
function Ea(e, t, n, r, o, i) {
  var a = A(e), s = A(t), c = a ? ct : w(e), l = s ? ct : w(t);
  c = c == ft ? Q : c, l = l == ft ? Q : l;
  var p = c == Q, _ = l == Q, b = c == l;
  if (b && te(e)) {
    if (!te(t))
      return !1;
    a = !0, p = !1;
  ...
  if (!(n & xa)) {
    var u = p && pt.call(e, "__wrapped__"), d = _ && pt.call(t, "__wrapped__");
    if (u || d) {
      var g = u ? e.value() : e, f = d ? t.value() : t;
      return i || (i = new $()), o(g, f, n, r, i);
    }
  }
  return b ? (i || (i = new $()), Ca(e, t, n, r, o, i)) : !1;
}
...
function Ra(e, t, n, r) {
  ...
  for (; ++o < i; ) {
    ...
    if (a[2]) {
      ...
      var p = new $(), _;
      if (!(_ === void 0 ? De(l, c, Ia | Ma, r, p) : _))
        return !1;
    }
  }
  return !0;
...
function Ba(e, t) {
  return Ee(e) && zt(t) ? Ht(Z(e), t) : function(n) {
    var r = di(n, e);
    return r === void 0 && r === t ? Ua(n, e) : De(t, r, Ga | Ka);
  };
}
function za(e) {
  return function(t) {
...
function _s(e, t, n) {
  ...
  typeof i == "number" && dt(void 0), typeof e._internal.subIndex == "number" && dt(e._internal.subIndex), r && r.subscribe((u) => {
    o.slotKey.set(u);
  }), bs();
  const a = le(gs), s = ((_ = D(a)) == null ? void 0 : _.as_item) || e.as_item, c = de(a ? s ? ((b = D(a)) == null ? void 0 : b[s]) || {} : D(a) || {} : {}), l = (u, d) => u ? us({
    ...u,
    ...d || {}
  }, t) : void 0, p = M({
    ...e,
  ...
  return a ? (a.subscribe((u) => {
    ...
    d && (u = u == null ? void 0 : u[d]), u = de(u), p.update((g) => ({
      ...g,
      ...u || {},
    ...
    var g;
    const d = de(u.as_item ? ((g = D(a)) == null ? void 0 : g[u.as_item]) || {} : D(a) || {});
    return p.set({
      ...u,
      _internal: {
        ...u._internal,
...
function Ns(e) {
  ...
  return {
    ...
    p(o, [i]) {
      ...
      1 && H(r, 1)) : (r = ht(o), r.c(), H(r, 1), r.m(t.parentNode, t)) : r && (Cs(), oe(r, 1, 1, () => {
        r = null;
      }), Os());
    },
    i(o) {
...
function Ds(e, t, n) {
  ...
  let o = bt(t, r), i, a, s;
  const c = as(() => import("./float-button.back-top-B1m6YCgf.js"));
  let {
    gradio: l
  } = t, {
    props: p = {}
  ...
  _e(e, P, (h) => n(0, a = h));
  const I = ps();
  return _e(e, I, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), $s(h)), n(16, o = bt(t, r)), "gradio" in h && n(6, l = h.gradio), "props" in h && n(7, p = h.props), "_internal" in h && n(8, b = h._internal), "as_item" in h && n(9, u = h.as_item), "visible" in h && n(10, d = h.visible), "elem_id" in h && n(11, g = h.elem_id), "elem_classes" in h && n(12, f = h.elem_classes), "elem_style" in h && n(13, v = h.elem_style);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && _.update((h) => ({
      ...h,
  ...
  }, [a, s, c, _, P, I, l, p, b, u, d, g, f, v, i];
}
class Gs extends Ts {
  constructor(t) {
    super(), js(this, t, Ds, Ns, Is, {
      gradio: 6,
      props: 7,
      _internal: 8,
      as_item: 9,
