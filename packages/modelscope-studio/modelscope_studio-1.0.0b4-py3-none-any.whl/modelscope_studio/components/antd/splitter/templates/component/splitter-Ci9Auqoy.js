import { g as Z, w as y } from "./Index-BGpAQh5d.js";
const m = window.ms_globals.React, B = window.ms_globals.React.forwardRef, J = window.ms_globals.React.useRef, Y = window.ms_globals.React.useState, Q = window.ms_globals.React.useEffect, X = window.ms_globals.React.createElement, R = window.ms_globals.ReactDOM.createPortal, O = window.ms_globals.antd.Splitter;
var F = {
  exports: {}
}, C = {};
/**
...
function Ee(n) {
  ...
  return {
    c() {
      t = U("react-portal-target"), o = me(), e && e.c(), l = T(), this.h();
    },
    l(s) {
    ...
    p(s, [a]) {
      ...
      16 && v(e, 1)) : (e = N(s), e.c(), v(e, 1), e.m(l.parentNode, l)) : e && (fe(), x(e, 1, 1, () => {
        e = null;
      }), le());
    },
    i(s) {
  ...
  return Q(() => {
    ...
    if (t && window.MutationObserver) {
      let d = function() {
        ...
        i = p, a(u), i.style.display = "contents", g(), (b = e.current) == null || b.appendChild(i);
      };
