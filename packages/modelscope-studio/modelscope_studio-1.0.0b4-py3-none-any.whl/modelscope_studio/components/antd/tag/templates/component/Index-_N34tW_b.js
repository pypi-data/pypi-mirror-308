...
function Qs(e, t, n) {
  ...
  const p = cs(() => import("./tag-CUnjs65C.js"));
  let {
    gradio: d
  } = t, {
    props: b = {}
  ...
  return ye(e, Be, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Pe(Pe({}, t), Is(h)), n(19, o = vt(t, r)), "gradio" in h && n(6, d = h.gradio), "props" in h && n(7, b = h.props), "_internal" in h && n(8, _ = h._internal), "as_item" in h && n(9, g = h.as_item), "value" in h && n(10, c = h.value), "visible" in h && n(11, v = h.visible), "elem_id" in h && n(12, O = h.elem_id), "elem_classes" in h && n(13, R = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && f.update((h) => ({
      ...h,
