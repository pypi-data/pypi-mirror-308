import { g as fe, w as x } from "./Index-B2UUcVTo.js";
const y = window.ms_globals.React, J = window.ms_globals.React.useMemo, ae = window.ms_globals.React.forwardRef, de = window.ms_globals.React.useRef, ue = window.ms_globals.React.useState, pe = window.ms_globals.React.useEffect, D = window.ms_globals.ReactDOM.createPortal, we = window.ms_globals.antd.Upload;
var Y = {
  exports: {}
}, S = {};
/**
  ...
  return {
    ...
    l(l) {
      o = V(l, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(o).forEach(R), r = Ee(l), t && t.l(l), s = z(), this.h();
    },
    h() {
      ee(o, "class", "svelte-1rt0kpf");
    },
    ...
    p(l, [a]) {
      ...
      16 && L(t, 1)) : (t = H(l), t.c(), L(t, 1), t.m(s.parentNode, s)) : t && (Se(), T(t, 1, 1, () => {
        t = null;
      }), ge());
    },
    i(l) {
...
function Ae(e, o, r) {
  ...
  const f = x();
  q(e, f, (d) => r(1, n = d));
  const c = [], p = De("$$ms-gr-react-wrapper"), {
    slotKey: u,
    slotIndex: _,
    subSlotIndex: F
  } = fe() || {}, k = i({
...
function j(e) {
  ...
  if (e._reactElement)
    return o.push(D(y.cloneElement(e._reactElement, {
...
const Qe = We(({
  ...
  return /* @__PURE__ */ X.jsx(we.Dragger, {
    ...
    onRemove: (h) => {
      p == null || p(h);
      const P = A.findIndex((I) => I.uid === h.uid), g = u.slice();
      g.splice(P, 1), c == null || c(g), f == null || f(g.map((I) => I.path));
    },
    beforeUpload: async (h, P) => {
      if (N && !await N(h, P))
        return !1;
      const g = (await o([h])).filter((I) => I);
      return c == null || c([...u, ...g]), f == null || f([...u.map((I) => I.path), ...g.map((I) => I.path)]), !1;
    },
    customRequest: oe,
    progress: s && {
      ...s,
    ...
    showUploadList: k ? {
      ...
      downloadIcon: e["showUploadList.downloadIcon"] ? E({
        slots: e,
        setSlotParams: _,
        key: "showUploadList.downloadIcon"
      }) : m.downloadIcon,
      removeIcon: e["showUploadList.removeIcon"] ? E({
        slots: e,
        setSlotParams: _,
        key: "showUploadList.removeIcon"
      }) : m.removeIcon,
      previewIcon: e["showUploadList.previewIcon"] ? E({
        slots: e,
        setSlotParams: _,
        key: "showUploadList.previewIcon"
      }) : m.previewIcon,
      extra: e["showUploadList.extra"] ? E({
        slots: e,
        setSlotParams: _,
