...
function Ys(e, t, n) {
  ...
  const p = ls(() => import("./image.preview-group-uyL7whVj.js"));
  let {
    gradio: d
  } = t, {
    props: b = {}
  ...
  return be(e, Ge, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Es(h)), n(19, o = yt(t, r)), "gradio" in h && n(6, d = h.gradio), "props" in h && n(7, b = h.props), "_internal" in h && n(8, _ = h._internal), "items" in h && n(9, g = h.items), "as_item" in h && n(10, f = h.as_item), "visible" in h && n(11, v = h.visible), "elem_id" in h && n(12, w = h.elem_id), "elem_classes" in h && n(13, M = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && u.update((h) => ({
      ...h,
  ...
  }, [a, s, p, u, R, Ge, d, b, _, g, f, v, w, M, C, i, c, l];
}
class Js extends As {
  constructor(t) {
