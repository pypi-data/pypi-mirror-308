...
var Fe = Rt(Object.getPrototypeOf, Object), wi = "[object Object]", Oi = Function.prototype, Ai = Object.prototype, Lt = Oi.toString, Pi = Ai.hasOwnProperty, $i = Lt.call(Object);
function Si(e) {
  if (!E(e) || N(e) != wi)
    return !1;
  var t = Fe(e);
...
var ve = U(S, "DataView"), Te = U(S, "Promise"), we = U(S, "Set"), nt = "[object Map]", qi = "[object Object]", rt = "[object Promise]", it = "[object Set]", ot = "[object WeakMap]", at = "[object DataView]", Yi = D(ve), Xi = D(J), Ji = D(Te), Zi = D(we), Wi = D(ye), A = N;
...
var da = 1, _a = 2, ba = "[object Boolean]", ha = "[object Date]", ya = "[object Error]", ma = "[object Map]", va = "[object Number]", Ta = "[object RegExp]", wa = "[object Set]", Oa = "[object String]", Aa = "[object Symbol]", Pa = "[object ArrayBuffer]", $a = "[object DataView]", ct = O ? O.prototype : void 0, de = ct ? ct.valueOf : void 0;
...
function Ys(e, t, n) {
  ...
  const p = ls(() => import("./statistic.countdown-O76YG9T8.js"));
  let {
    gradio: d
  } = t, {
    _internal: b = {}
  ...
  return be(e, Ge, (h) => n(0, a = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Es(h)), n(19, o = yt(t, r)), "gradio" in h && n(6, d = h.gradio), "_internal" in h && n(7, b = h._internal), "as_item" in h && n(8, u = h.as_item), "props" in h && n(9, _ = h.props), "value" in h && n(10, g = h.value), "elem_id" in h && n(11, v = h.elem_id), "elem_classes" in h && n(12, w = h.elem_classes), "elem_style" in h && n(13, M = h.elem_style), "visible" in h && n(14, C = h.visible), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && f.update((h) => ({
      ...h,
  ...
  }, [a, s, p, f, R, Ge, d, b, u, _, g, v, w, M, C, i, c, l];
}
class Js extends As {
  constructor(t) {
