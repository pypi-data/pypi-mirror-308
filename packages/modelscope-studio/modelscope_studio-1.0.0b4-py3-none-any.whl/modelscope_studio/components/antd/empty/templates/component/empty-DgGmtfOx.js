import { g as X, w as b } from "./Index-D_M7kY4z.js";
const m = window.ms_globals.React, B = window.ms_globals.React.forwardRef, J = window.ms_globals.React.useRef, Y = window.ms_globals.React.useState, Q = window.ms_globals.React.useEffect, S = window.ms_globals.ReactDOM.createPortal, Z = window.ms_globals.antd.Empty;
var W = {
  exports: {}
}, v = {};
/**
  ...
  return {
    ...
    l(s) {
      t = G(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), F(t).forEach(h), r = ie(s), e && e.l(s), l = L(), this.h();
    },
    h() {
      H(t, "class", "svelte-1rt0kpf");
    },
...
const D = B(({
  ...
  image: n.image ? /* @__PURE__ */ C.jsx(D, {
    slot: n.image
  }) : r.image
}));
export {
