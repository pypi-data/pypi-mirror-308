var vt = typeof global == "object" && global && global.Object === Object && global, nn = typeof self == "object" && self && self.Object === Object && self, S = vt || nn || Function("return this")(), A = S.Symbol, Tt = Object.prototype, rn = Tt.hasOwnProperty, on = Tt.toString, Y = A ? A.toStringTag : void 0;
function an(e) {
...
var $ = Array.isArray, gn = 1 / 0, Be = A ? A.prototype : void 0, ze = Be ? Be.toString : void 0;
function At(e) {
  if (typeof e == "string")
    return e;
  if ($(e))
...
var Tn = /[\\^$.*+?()[\]{}|]/g, On = /^\[object .+?Constructor\]$/, An = Function.prototype, wn = Object.prototype, $n = An.toString, Pn = wn.hasOwnProperty, Sn = RegExp("^" + $n.call(Pn).replace(Tn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function Cn(e) {
  if (!q(e) || yn(e))
    return !1;
  var t = $t(e) ? Sn : On;
...
var Fe = Rt(Object.getPrototypeOf, Object), Oi = "[object Object]", Ai = Function.prototype, wi = Object.prototype, Lt = Ai.toString, $i = wi.hasOwnProperty, Pi = Lt.call(Object);
function Si(e) {
  if (!C(e) || F(e) != Oi)
    return !1;
  var t = Fe(e);
...
var ve = D(S, "DataView"), Te = D(S, "Promise"), Oe = D(S, "Set"), nt = "[object Map]", qi = "[object Object]", rt = "[object Promise]", it = "[object Set]", ot = "[object WeakMap]", at = "[object DataView]", Yi = N(ve), Xi = N(Z), Ji = N(Te), Zi = N(Oe), Wi = N(ye), w = F;
(ve && w(new ve(new ArrayBuffer(1))) != at || Z && w(new Z()) != nt || Te && w(Te.resolve()) != rt || Oe && w(new Oe()) != it || ye && w(new ye()) != ot) && (w = function(e) {
...
var da = 1, _a = 2, ba = "[object Boolean]", ha = "[object Date]", ya = "[object Error]", ma = "[object Map]", va = "[object Number]", Ta = "[object RegExp]", Oa = "[object Set]", Aa = "[object String]", wa = "[object Symbol]", $a = "[object ArrayBuffer]", Pa = "[object DataView]", ct = A ? A.prototype : void 0, de = ct ? ct.valueOf : void 0;
...
function Ra(e, t, n, r, o, i) {
  var a = $(e), s = $(t), c = a ? gt : w(e), l = s ? gt : w(t);
...
function Zs(e, t, n) {
  ...
  const p = ls(() => import("./avatar.group-CwO4hnQn.js"));
  let {
    gradio: _
  } = t, {
    props: b = {}
  ...
  return be(e, Ge, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Ae(Ae({}, t), Ms(h)), n(18, o = yt(t, r)), "gradio" in h && n(6, _ = h.gradio), "props" in h && n(7, b = h.props), "_internal" in h && n(8, g = h._internal), "as_item" in h && n(9, d = h.as_item), "visible" in h && n(10, f = h.visible), "elem_id" in h && n(11, v = h.elem_id), "elem_classes" in h && n(12, O = h.elem_classes), "elem_style" in h && n(13, M = h.elem_style), "$$scope" in h && n(16, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && u.update((h) => ({
      ...h,
  ...
  }, [a, s, p, u, R, Ge, _, b, g, d, f, v, O, M, i, c, l];
}
class Vs extends Ss {
  constructor(t) {
