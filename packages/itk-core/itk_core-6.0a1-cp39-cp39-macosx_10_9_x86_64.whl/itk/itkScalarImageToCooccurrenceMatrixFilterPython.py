...
def scalar_image_to_cooccurrence_matrix_filter(*args,  offsets=..., offset: Sequence[int]=..., number_of_bins_per_axis: int=..., pixel_value_min_max: float=..., normalize: bool=..., mask_image: itkt.Image=..., inside_pixel_value: float=...,**kwargs):
