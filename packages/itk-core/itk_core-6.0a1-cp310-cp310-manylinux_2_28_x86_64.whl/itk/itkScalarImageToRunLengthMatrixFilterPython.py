...
def scalar_image_to_run_length_matrix_filter(*args,  offsets=..., offset: Sequence[int]=..., number_of_bins_per_axis: int=..., pixel_value_min_max: int=..., distance_value_min_max: float=..., mask_image: itkt.Image=..., inside_pixel_value: int=...,**kwargs):
