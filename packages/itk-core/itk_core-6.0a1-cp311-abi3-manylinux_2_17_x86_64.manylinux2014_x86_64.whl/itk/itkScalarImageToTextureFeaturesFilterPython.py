...
def scalar_image_to_texture_features_filter(*args,  requested_features=..., offsets=..., number_of_bins_per_axis: int=..., pixel_value_min_max: float=..., mask_image: itkt.Image=..., inside_pixel_value: float=..., fast_calculations: bool=...,**kwargs):
