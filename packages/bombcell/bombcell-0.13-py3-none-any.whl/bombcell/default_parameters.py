...
def default_parameters_for_unitmatch(kilosort_path, raw_dir = None, kilosort_version = None, ephys_meta_dir = None, gain_to_uV = None):
    ...
    param = {
        ...
        ## Amplitude / raw waveform parameters
        'detrend_waveform' : False, # If True will linearly de-trend over time, done in UnitMatch
        'n_raw_spikes_to_extract' : 1000, # Number of raw spikes per unit, 500 per CV at least!
        'save_multiple_raw' : True, # TODO check if still needed for UM
        'decompress_data' : True, # whether to decompress .cbin data
        'probe_type' : 1, # If you are using spikeGLX and your meta files does not
                        # contain information on your probe type specify it here 
                        # '1' for 1.0 (3Bs) and '2' for 2.0 (single or 4-shanks)
        ...
        'max_drift' : 100, # in um
        'min_presence_ratio' : 0.7, # minimum fraction of time chunks unit must be present for
        'min_SNR' : 0.9, #min SNR for a good unit
    } 
