...
def save_quality_metrics_as_tsvs(quality_metrics, unit_type_string, unique_templates, save_path):
    """
    ...
    save_qmetric_tsv(quality_metrics['max_drift_estimate'], unique_templates, save_path, r'cluster_max_drift.tsv', ('cluster_id', 'max_drift'))
    save_qmetric_tsv(quality_metrics['n_peaks'], unique_templates, save_path, r'cluster_n_peaks.tsv', ('cluster_id', 'n_peaks'))
    save_qmetric_tsv(quality_metrics['n_troughs'], unique_templates, save_path, r'cluster_n_troughs.tsv', ('cluster_id', 'n_troughs'))
    save_qmetric_tsv(quality_metrics['percent_missing_gaussian'], unique_templates, save_path, r'cluster_percentageSpikesMissing_gaussian.tsv', ('cluster_id', 'percentageSpikesMissing_gaussian'))
    save_qmetric_tsv(quality_metrics['presence_ratio'], unique_templates, save_path, r'cluster_presence_ratio.tsv', ('cluster_id', 'presence_ratio'))
    save_qmetric_tsv(quality_metrics['signal_to_noise_ratio'], unique_templates, save_path, r'cluster_SNR.tsv', ('cluster_id', 'SNR'))
    save_qmetric_tsv(quality_metrics['exp_decay'], unique_templates, save_path, r'cluster_spatial_decay_slope.tsv', ('cluster_id', 'spatial_decay_slope'))
    save_qmetric_tsv(quality_metrics['waveform_duration_peak_trough'], unique_templates, save_path, r'cluster_waveform_dur.tsv', ('cluster_id', 'waveform_dur'))
    save_qmetric_tsv(quality_metrics['waveform_baseline'], unique_templates, save_path, r'cluster_wv_baseline_flatness.tsv', ('cluster_id', 'wv_baseline_flatness'))


def save_quality_metrics_as_parquet(quality_metrics, save_path, file_name = 'templates._bc_qMetrics.parquet'):
    """
...
def save_params_as_parquet(param, save_path, file_name = '_bc_parameters._bc_qMetrics.parquet'):
    """
...
def save_waveforms_as_npy(raw_waveforms_full, raw_waveforms_peak_channel, save_path):
    ...
    file_path_peak_channels = os.path.join(save_path, 'templates._bc_rawWaveformsPeakChannels.npy')
    np.save(file_path_peak_channels, raw_waveforms_peak_channel)

def save_results(quality_metrics, unit_type_string, unique_templates, param, raw_waveforms_full, raw_waveforms_peak_channel, save_path):
    """
