...
class PwpTester:
    ...
    @staticmethod
    def verify_local_album(paths, enable_rename, time_stamp):
        LOGGER.test_msg(f'Verify local albums {paths}')
        # Do not use build_cmdline to keep it silent
    ...
    def program_38(self):
        ...
        # ---------------------------------------------------------------------------
        self.verify_local_album(['2002'], enable_rename='false', time_stamp="")
        # ---------------------------------------------------------------------------
    ...
    def program_41(self):
        ...
        # -----------------------------------------------------------------------------------------
        self.verify_local_album([offset + '/2023/2023-01-Janvier-27-test',
                                 offset + '/2007/2007-04-Avril-03-test'],
    ...
    def runner_100(self, set_album: str, set_thumbnails: str, delete=True):
        ...
        cmdline = self.build_test_cmdline({"--backup-test-stamp": "runner-100-time-stamp"},
                                          set_thumbnails=set_thumbnails, set_album=set_album, offset=offset)
    ...
    def program_103(self):
        ...
        LOGGER.test_msg('it would be great to remove this dependency byt this is NOT done')
    ...
    def runner_201(self, set_thumbnails='local', set_album='local', enable_database=False):
        ...
        cmdline = self.build_test_cmdline({'--verify-album': f"{offset}/2023/2023-06-Juin-17-Armor-cup",
        ...
        self.process(cmdline)
        # -----------------------------------------------
        cmdline = self.build_test_cmdline({'--verify-album': f"{offset}/Corsica",
        ...
        self.assert_trace("File '" + album + "/2023/2023-06-Juin-11-Forêt-de-la-Corbière" +  # noqa
        ...
        self.assert_trace("File '" + album + "/2023/2023-06-Juin-17-Armor-cup" +  # noqa
                         "/2023-06-17-11h05-44-Armor-cup.jpg' has not changed")  # noqa
        self.assert_trace("File '" + album + "/2023/2023-06-Juin-17-Armor-cup" +  # noqa
                         "/2023-06-17-11h05-45-Armor-cup.jpg' has not changed")  # noqa
        self.assert_trace("File '" + album + "/Corsica/2020-05-17-12h00-00-Corsica.jpg' has not changed")  # noqa
        self.assert_trace("File '" + album + "/Corsica/2021-08-18-12h00-00-Corsica.jpg' has not changed")  # noqa
        self.assert_trace("File '" + album + "/Corsica/2021-08-19-12h04-00-Corsica.jpg' has not changed")  # noqa
        self.assert_trace("File '" + album + "/Corsica/2021-08-19-12h04-01-Corsica.jpg' has not changed")  # noqa
    ...
    def program_206(self):
        ...
        cmdline = self.build_test_cmdline({'--backup-test-stamp': "runner-206-start-time"},
                                          set_thumbnails='local', set_album='local', enable_database=False)
    ...
    def program_907(self):
        ...
        LOGGER.test_msg('       verify "tests/results/BASE/piwiPre.ini" has be read')
        ...
        pwp_main(arguments=[
            ...
            test_scenario={"gui": "false",
                           ...
                           "shortcuts": "true",
                           "save": "true",
                           "1: choose dir": "TRIAGE/subdir",  # aka BASE
                           "1: set piwigo-user": "my-piwigo-user-name",
                           "1: save": "true",
                           "1: exit": "true",
                           })
        ...
        # ------------------------------------------------------------
        LOGGER.test_msg('test 3 : --gui true --test-gui true --not-a-flag true')
        initial_cwd = os.getcwd()
        ...
        pwp_main(arguments=[
            ...
            "--home", os.getcwd() + "/tests/results/HOME",
            "--gui", "true",
            '--not-a-flag', 'true',                     # should generate an error, which is seen transiently
            "--test-gui", "true"])
    ...
    def program_1007(self):
        ...
        LOGGER.test_msg('')
        LOGGER.test_msg('MANUAL test of piwiPre GUI, without automated test ')
        LOGGER.test_msg('Scenario of piwiPre started by pwpInstaller on an empty directory')
        LOGGER.test_msg('')
        ACTOR.mkdirs("tests/results/HOME")
