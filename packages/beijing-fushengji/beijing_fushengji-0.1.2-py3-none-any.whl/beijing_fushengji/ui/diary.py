...
class Ui_Diary(object):
    def setupUi(self, Diary):
        ...
        self.widget_2.setStyleSheet("image: url(:/bg/res/diary.bmp);")
        ...
        self.horizontalSpacer = QSpacerItem(
            136, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.horizontalSpacer_2 = QSpacerItem(
            135, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
    ...
    def retranslateUi(self, Diary):
        Diary.setWindowTitle(
            QCoreApplication.translate("Diary", "My days in Beijing", None)
        )
        self.label.setText(QCoreApplication.translate("Diary", "TextLabel", None))
        self.pushButton.setText(
            QCoreApplication.translate("Diary", "Close Diary", None)
        )
