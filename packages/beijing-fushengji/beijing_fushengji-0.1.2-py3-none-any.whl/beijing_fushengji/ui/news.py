...
class Ui_News(object):
    def setupUi(self, News):
        ...
        self.widget.setStyleSheet("image: url(:/res/news.bmp);")
        ...
        self.horizontalSpacer = QSpacerItem(
            141, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.horizontalSpacer_2 = QSpacerItem(
            140, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
    ...
    def retranslateUi(self, News):
        News.setWindowTitle(QCoreApplication.translate("News", "Beijing News", None))
        self.label.setText(QCoreApplication.translate("News", "TextLabel", None))
        self.pushButton.setText(QCoreApplication.translate("News", "OK", None))
