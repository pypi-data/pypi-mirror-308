...
class Ui_Story(object):
    ...
    def retranslateUi(self, Story):
        ...
        self.label_4.setText(
            QCoreApplication.translate(
                "Story",
                "You will experience the excitement of selling pirated VCDs and smuggled cars in Beijing, as well as the funny events that are unique to our time.",
                None,
            )
        )
        self.statusText.setText(QCoreApplication.translate("Story", "<status>", None))
        self.startGame.setText(
            QCoreApplication.translate("Story", "Start Game >>", None)
        )
