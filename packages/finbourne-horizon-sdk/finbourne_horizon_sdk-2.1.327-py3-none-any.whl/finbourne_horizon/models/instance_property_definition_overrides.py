...
class InstancePropertyDefinitionOverrides(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstancePropertyDefinitionOverrides:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstancePropertyDefinitionOverrides:
        """Create an instance of InstancePropertyDefinitionOverrides from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstancePropertyDefinitionOverrides.parse_obj(obj)

        _obj = InstancePropertyDefinitionOverrides.parse_obj({
