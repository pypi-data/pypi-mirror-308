...
class TestEvaluations:
    ...
    def test_method_evaluate_batch(self, client: LlamaStackClient) -> None:
        evaluation = client.evaluations.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
        ...
        assert_matches_type(EvaluationEvaluateBatchResponse, evaluation, path=["response"])
    ...
    def test_raw_response_evaluate_batch(self, client: LlamaStackClient) -> None:
        response = client.evaluations.with_raw_response.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
    ...
    def test_streaming_response_evaluate_batch(self, client: LlamaStackClient) -> None:
        with client.evaluations.with_streaming_response.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
...
class TestAsyncEvaluations:
    ...
    async def test_method_evaluate_batch(self, async_client: AsyncLlamaStackClient) -> None:
        evaluation = await async_client.evaluations.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
    ...
    async def test_raw_response_evaluate_batch(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.evaluations.with_raw_response.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
    ...
    async def test_streaming_response_evaluate_batch(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.evaluations.with_streaming_response.evaluate_batch(
            candidate={
                "model": "model",
                "sampling_params": {"strategy": "greedy"},
                "type": "model",
