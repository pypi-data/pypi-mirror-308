...
from llama_stack_client.types.evaluations import (
    JobStatusResponse,
    JobRetrieveResponse,
)
...
class TestJobs:
    ...
    def test_method_retrieve(self, client: LlamaStackClient) -> None:
        job = client.evaluations.jobs.retrieve(
            job_id="job_id",
        )
    ...
    def test_raw_response_retrieve(self, client: LlamaStackClient) -> None:
        response = client.evaluations.jobs.with_raw_response.retrieve(
            job_id="job_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamaStackClient) -> None:
        with client.evaluations.jobs.with_streaming_response.retrieve(
            job_id="job_id",
        ) as response:
    ...
    def test_method_cancel(self, client: LlamaStackClient) -> None:
        job = client.evaluations.jobs.cancel(
            job_id="job_id",
        )
        assert job is None
    ...
    def test_raw_response_cancel(self, client: LlamaStackClient) -> None:
        response = client.evaluations.jobs.with_raw_response.cancel(
            job_id="job_id",
        )
    ...
    def test_streaming_response_cancel(self, client: LlamaStackClient) -> None:
        with client.evaluations.jobs.with_streaming_response.cancel(
            job_id="job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_status(self, client: LlamaStackClient) -> None:
        job = client.evaluations.jobs.status(
            job_id="job_id",
        )
    ...
    def test_raw_response_status(self, client: LlamaStackClient) -> None:
        response = client.evaluations.jobs.with_raw_response.status(
            job_id="job_id",
        )
    ...
    def test_streaming_response_status(self, client: LlamaStackClient) -> None:
        with client.evaluations.jobs.with_streaming_response.status(
            job_id="job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncJobs:
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamaStackClient) -> None:
        job = await async_client.evaluations.jobs.retrieve(
            job_id="job_id",
        )
        assert_matches_type(JobRetrieveResponse, job, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.evaluations.jobs.with_raw_response.retrieve(
            job_id="job_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.evaluations.jobs.with_streaming_response.retrieve(
            job_id="job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_cancel(self, async_client: AsyncLlamaStackClient) -> None:
        job = await async_client.evaluations.jobs.cancel(
            job_id="job_id",
        )
        assert job is None
    ...
    async def test_raw_response_cancel(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.evaluations.jobs.with_raw_response.cancel(
            job_id="job_id",
        )
    ...
    async def test_streaming_response_cancel(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.evaluations.jobs.with_streaming_response.cancel(
            job_id="job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_status(self, async_client: AsyncLlamaStackClient) -> None:
        job = await async_client.evaluations.jobs.status(
            job_id="job_id",
        )
        assert_matches_type(Optional[JobStatusResponse], job, path=["response"])
    ...
    async def test_raw_response_status(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.evaluations.jobs.with_raw_response.status(
            job_id="job_id",
        )
    ...
    async def test_streaming_response_status(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.evaluations.jobs.with_streaming_response.status(
            job_id="job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
