...
class ApplianceExportJobClient(object):
    ...
    def change_appliance_export_job_compartment(self, appliance_export_job_id, change_appliance_export_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/change_appliance_export_job_compartment.py.html>`__ to see an example of how to use change_appliance_export_job_compartment API.
        """
    ...
    def create_appliance_export_job(self, create_appliance_export_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/create_appliance_export_job.py.html>`__ to see an example of how to use create_appliance_export_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_appliance_export_job(self, appliance_export_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/delete_appliance_export_job.py.html>`__ to see an example of how to use delete_appliance_export_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applianceExportJobId']
    ...
    def get_appliance_export_job(self, appliance_export_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/get_appliance_export_job.py.html>`__ to see an example of how to use get_appliance_export_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applianceExportJobId']
        resource_path = "/applianceExportJobs/{applianceExportJobId}"
    ...
    def list_appliance_export_jobs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/list_appliance_export_jobs.py.html>`__ to see an example of how to use list_appliance_export_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_appliance_export_job(self, appliance_export_job_id, update_appliance_export_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.138.1/dts/update_appliance_export_job.py.html>`__ to see an example of how to use update_appliance_export_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applianceExportJobId']
        resource_path = "/applianceExportJobs/{applianceExportJobId}"
