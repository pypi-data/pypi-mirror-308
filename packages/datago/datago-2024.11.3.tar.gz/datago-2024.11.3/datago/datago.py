...
# gopy pkg -author=Photoroom -email=team@photoroom.com -name=datago -version=2024.11.3 .
...
class DatagoConfig(go.GoClass):
	...
	def SetDefaults(self, goRun=False):
		"""SetDefaults() """
		_datago.datago_DatagoConfig_SetDefaults(self.handle, goRun)
...
class ImageTransformConfig(go.GoClass):
	...
	def SetDefaults(self, goRun=False):
		"""SetDefaults() """
		_datago.datago_ImageTransformConfig_SetDefaults(self.handle, goRun)
...
# Python type for struct datago.GeneratorDBConfig
class GeneratorDBConfig(DataSourceConfig):
	...
	def __init__(self, *args, **kwargs):
		...
		if len(kwargs) == 1 and 'handle' in kwargs:
			...
			self.handle = _datago.datago_GeneratorDBConfig_CTor()
			_datago.IncRef(self.handle)
			if  1 < len(args):
				self.Sources = args[1]
	...
	@property
	def Sources(self):
		return _datago.datago_GeneratorDBConfig_Sources_Get(self.handle)
	@Sources.setter
	def Sources(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_Sources_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_Sources_Set(self.handle, value)
	@property
	def RequireImages(self):
		return _datago.datago_GeneratorDBConfig_RequireImages_Get(self.handle)
	@RequireImages.setter
	def RequireImages(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_RequireImages_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_RequireImages_Set(self.handle, value)
	@property
	def RequireEmbeddings(self):
		return _datago.datago_GeneratorDBConfig_RequireEmbeddings_Get(self.handle)
	@RequireEmbeddings.setter
	def RequireEmbeddings(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_RequireEmbeddings_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_RequireEmbeddings_Set(self.handle, value)
	@property
	def Tags(self):
		return _datago.datago_GeneratorDBConfig_Tags_Get(self.handle)
	@Tags.setter
	def Tags(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_Tags_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_Tags_Set(self.handle, value)
	@property
	def TagsNE(self):
		return _datago.datago_GeneratorDBConfig_TagsNE_Get(self.handle)
	@TagsNE.setter
	def TagsNE(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_TagsNE_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_TagsNE_Set(self.handle, value)
	@property
	def HasAttributes(self):
		return _datago.datago_GeneratorDBConfig_HasAttributes_Get(self.handle)
	@HasAttributes.setter
	def HasAttributes(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_HasAttributes_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_HasAttributes_Set(self.handle, value)
	@property
	def LacksAttributes(self):
		return _datago.datago_GeneratorDBConfig_LacksAttributes_Get(self.handle)
	@LacksAttributes.setter
	def LacksAttributes(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_LacksAttributes_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_LacksAttributes_Set(self.handle, value)
	@property
	def HasMasks(self):
		return _datago.datago_GeneratorDBConfig_HasMasks_Get(self.handle)
	@HasMasks.setter
	def HasMasks(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_HasMasks_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_HasMasks_Set(self.handle, value)
	@property
	def LacksMasks(self):
		return _datago.datago_GeneratorDBConfig_LacksMasks_Get(self.handle)
	@LacksMasks.setter
	def LacksMasks(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_LacksMasks_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_LacksMasks_Set(self.handle, value)
	@property
	def HasLatents(self):
		return _datago.datago_GeneratorDBConfig_HasLatents_Get(self.handle)
	@HasLatents.setter
	def HasLatents(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_HasLatents_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_HasLatents_Set(self.handle, value)
	@property
	def LacksLatents(self):
		return _datago.datago_GeneratorDBConfig_LacksLatents_Get(self.handle)
	@LacksLatents.setter
	def LacksLatents(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_LacksLatents_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_LacksLatents_Set(self.handle, value)
	@property
	def ReturnLatents(self):
		return _datago.datago_GeneratorDBConfig_ReturnLatents_Get(self.handle)
	@ReturnLatents.setter
	def ReturnLatents(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_ReturnLatents_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_ReturnLatents_Set(self.handle, value)
	@property
	def MinShortEdge(self):
		return _datago.datago_GeneratorDBConfig_MinShortEdge_Get(self.handle)
	@MinShortEdge.setter
	def MinShortEdge(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_MinShortEdge_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_MinShortEdge_Set(self.handle, value)
	@property
	def MaxShortEdge(self):
		return _datago.datago_GeneratorDBConfig_MaxShortEdge_Get(self.handle)
	@MaxShortEdge.setter
	def MaxShortEdge(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_MaxShortEdge_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_MaxShortEdge_Set(self.handle, value)
	@property
	def MinPixelCount(self):
		return _datago.datago_GeneratorDBConfig_MinPixelCount_Get(self.handle)
	@MinPixelCount.setter
	def MinPixelCount(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_MinPixelCount_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_MinPixelCount_Set(self.handle, value)
	@property
	def MaxPixelCount(self):
		return _datago.datago_GeneratorDBConfig_MaxPixelCount_Get(self.handle)
	@MaxPixelCount.setter
	def MaxPixelCount(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_MaxPixelCount_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_MaxPixelCount_Set(self.handle, value)
	@property
	def RandomSampling(self):
		return _datago.datago_GeneratorDBConfig_RandomSampling_Get(self.handle)
	@RandomSampling.setter
	def RandomSampling(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorDBConfig_RandomSampling_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorDBConfig_RandomSampling_Set(self.handle, value)
	def SetDefaults(self, goRun=False):
		"""SetDefaults() """
		_datago.datago_GeneratorDBConfig_SetDefaults(self.handle, goRun)

# Python type for struct datago.GeneratorFileSystemConfig
class GeneratorFileSystemConfig(DataSourceConfig):
	"""-- Define the front end goroutine ---------------------------------------------------------------------------------------------------------------------------------------------------------------\n"""
	def __init__(self, *args, **kwargs):
		"""
		handle=A Go-side object is always initialized with an explicit handle=arg
		...
		if len(kwargs) == 1 and 'handle' in kwargs:
			...
			self.handle = _datago.datago_GeneratorFileSystemConfig_CTor()
			_datago.IncRef(self.handle)
			if  1 < len(args):
	...
	def __str__(self):
		pr = [(p, getattr(self, p)) for p in dir(self) if not p.startswith('__')]
		sv = 'datago.GeneratorFileSystemConfig{'
		first = True
		for v in pr:
			if callable(v[1]):
				continue
	...
	@property
	def RootPath(self):
		return _datago.datago_GeneratorFileSystemConfig_RootPath_Get(self.handle)
	@RootPath.setter
	def RootPath(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_GeneratorFileSystemConfig_RootPath_Set(self.handle, value.handle)
		else:
			_datago.datago_GeneratorFileSystemConfig_RootPath_Set(self.handle, value)
	def SetDefaults(self, goRun=False):
		"""SetDefaults() """
		_datago.datago_GeneratorFileSystemConfig_SetDefaults(self.handle, goRun)
...
class DatagoClient(go.GoClass):
	...
	@property
	def ImageConfig(self):
		return ImageTransformConfig(handle=_datago.datago_DatagoClient_ImageConfig_Get(self.handle))
	@ImageConfig.setter
	def ImageConfig(self, value):
		if isinstance(value, go.GoClass):
			_datago.datago_DatagoClient_ImageConfig_Set(self.handle, value.handle)
		else:
			raise TypeError("supplied argument type {t} is not a go.GoClass".format(t=type(value)))
