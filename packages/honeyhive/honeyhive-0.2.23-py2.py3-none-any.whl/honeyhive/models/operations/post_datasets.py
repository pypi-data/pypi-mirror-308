...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostDatasetsResponseBody:
    ...
    result: Optional[PostDatasetsResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
    



@dataclasses.dataclass
class PostDatasetsResponse:
    ...
    object: Optional[PostDatasetsResponseBody] = dataclasses.field(default=None)
    r"""Successful creation"""
