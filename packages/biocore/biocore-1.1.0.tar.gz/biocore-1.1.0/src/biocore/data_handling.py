...
if is_polars_available():
    _FORMAT_TO_CONVERTER["pl"] = PolarsConverter()
    _FORMAT_TO_CONVERTER["polars"] = PolarsConverter()
if is_datasets_available():
    _FORMAT_TO_CONVERTER["dataset"] = DatasetConverter()
    _FORMAT_TO_CONVERTER["ds"] = DatasetConverter()
    _FORMAT_TO_CONVERTER["iterabledataset"] = IterableDatasetConverter()
...
class DataHandler:
    ...
    def get_column_names_by_feature_type(X, feature_type):
        requires_backends("get_column_names_by_feature_type", "datasets")
        from datasets import Dataset, IterableDataset
    ...
    def get_numeric_features(
        ...
        if isinstance(X, (Dataset, IterableDataset)):
            from biocore.features import NUMERIC_FEATURES
    ...
    def get_categorical_features(X):
        ...
        if is_datasets_available() and is_biosets_available():
            from datasets import Dataset, IterableDataset
