...
class StandardDevCls:
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.hdr.modulation.standardDev.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ReadStruct structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:HDR:MODulation:SDEViation?', self.__class__.ReadStruct())
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.hdr.modulation.standardDev.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:HDR:MODulation:SDEViation?', self.__class__.FetchStruct())
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.hdr.modulation.standardDev.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:MEASurement<Instance>:HDR:MODulation:SDEViation?', self.__class__.CalculateStruct())
