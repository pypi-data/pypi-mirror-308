...
class IqDifferenceCls:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.hdr.trace.iqDifference.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:HDR:TRACe:IQDiff?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:BLUetooth:MEASurement<Instance>:HDR:TRACe:IQDiff \n
		Snippet: value: ResultData = driver.hdr.trace.iqDifference.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:HDR:TRACe:IQDiff?', self.__class__.ResultData())
