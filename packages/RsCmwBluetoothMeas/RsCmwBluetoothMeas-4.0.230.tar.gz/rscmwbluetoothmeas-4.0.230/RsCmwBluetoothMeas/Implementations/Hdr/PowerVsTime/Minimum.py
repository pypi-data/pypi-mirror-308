...
class MinimumCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.hdr.powerVsTime.minimum.read() \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.hdr.powerVsTime.minimum.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.hdr.powerVsTime.minimum.calculate() \n
		No command help available \n
