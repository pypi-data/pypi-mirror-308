...
class TypePyCls:
	...
	def fetch(self) -> enums.CtePacketType:
		...
		Use RsCmwBluetoothMeas.reliability.last_value to read the updated reliability indicator. \n
			:return: packet_type: AOAus | AOD1us | AOD2us | AOA2us | AOA1us AOD1us, AOD2us: CTE type angle of departure, 1 us or 2 us slot AOAus, AOA2us: CTE type angle of arrival, 2 us slot AOA1us: CTE type angle of arrival, 1 us slot"""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
		response = self._core.io.query_str_suppressed(f'FETCh:BLUetooth:MEASurement<Instance>:ISIGnal:ADETected:CTE:LENergy:LE1M:TYPE?', suppressed)
