...
class AverageCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.hdrp.powerVsTime.average.read() \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.hdrp.powerVsTime.average.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.hdrp.powerVsTime.average.calculate() \n
		No command help available \n
