...
class AverageCls:
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.hdrp.modulation.average.read() \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.hdrp.modulation.average.fetch() \n
		No command help available \n
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.hdrp.modulation.average.calculate() \n
		No command help available \n
