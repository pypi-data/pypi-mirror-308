...
class PatternCls:
	...
	def set(self, pattern_type: enums.MevPatternType, segment=repcap.Segment.Default) -> None:
		...
		Specifies the payload pattern type expected in the segment. \n
			:param pattern_type: ALL1 | P11 | OTHer | ALTernating | P44 ALL1: 11111111 P11: 10101010 OTHer: any pattern except P11, P44, ALL1 ALTernating: the periodical change between the pattern P11 and P44 P44: 11110000
	...
	def get(self, segment=repcap.Segment.Default) -> enums.MevPatternType:
		...
		Specifies the payload pattern type expected in the segment. \n
			:param segment: optional repeated capability selector. Default value: S1 (settable in the interface 'Segment')
			:return: pattern_type: ALL1 | P11 | OTHer | ALTernating | P44 ALL1: 11111111 P11: 10101010 OTHer: any pattern except P11, P44, ALL1 ALTernating: the periodical change between the pattern P11 and P44 P44: 11110000"""
		segment_cmd_val = self._cmd_group.get_repcap_cmd_value(segment, repcap.Segment)
