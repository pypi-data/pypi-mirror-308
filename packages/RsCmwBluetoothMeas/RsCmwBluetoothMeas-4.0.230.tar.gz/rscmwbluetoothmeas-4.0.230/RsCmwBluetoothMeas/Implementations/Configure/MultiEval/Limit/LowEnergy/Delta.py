...
class DeltaCls:
	...
	def set(self, delta_f_2_p_99_p_9: float, delta_f_2_p_99_enable: bool) -> None:
		...
		Sets/gets the limit for the frequency deviation deltaf2 for LE 1M PHY that must be exceeded by 99.9% of the measured
		samples. \n
			:param delta_f_2_p_99_p_9: numeric Range: 150 kHz to 250 kHz, Unit: Hz
	...
	class DeltaStruct(StructBase):
		"""Response structure. Fields: \n
			- Delta_F_2_P_99_P_9: float: numeric Range: 150 kHz to 250 kHz, Unit: Hz
