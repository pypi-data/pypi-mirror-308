...
class DminimumCls:
	...
	def set(self, freq_dev_f_1_lower: float, freq_dev_f_1_upper: float, freq_dev_f_1_enable: List[bool]) -> None:
		...
		Snippet: driver.configure.multiEval.limit.lowEnergy.lrange.dminimum.set(freq_dev_f_1_lower = 1.0, freq_dev_f_1_upper = 1.0, freq_dev_f_1_enable = [True, False, True]) \n
	...
	def get(self) -> DminimumStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LRANge:DMINimum \n
		Snippet: value: DminimumStruct = driver.configure.multiEval.limit.lowEnergy.lrange.dminimum.get() \n
		Defines the lower and upper deltaf1 frequency deviation limits for LE coded PHY. The mnemonics DAVerage, DMINimum,
		DMAXimum distinguish average, minimum and maximum frequency deviations. \n
