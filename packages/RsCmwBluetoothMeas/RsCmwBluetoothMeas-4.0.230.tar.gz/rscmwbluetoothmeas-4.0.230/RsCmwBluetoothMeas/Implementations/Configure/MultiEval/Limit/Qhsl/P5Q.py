...
class P5QCls:
	...
	def get_devm(self) -> DevmStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:QHSL:P5Q:DEVM \n
		Snippet: value: DevmStruct = driver.configure.multiEval.limit.qhsl.p5Q.get_devm() \n
		No command help available \n
			:return: structure: for return value, see the help for DevmStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:QHSL:P5Q:DEVM?', self.__class__.DevmStruct())

	def set_devm(self, value: DevmStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:QHSL:P5Q:DEVM \n
		Snippet with structure: \n
		structure = driver.configure.multiEval.limit.qhsl.p5Q.DevmStruct() \n
		...
		driver.configure.multiEval.limit.qhsl.p5Q.set_devm(value = structure) \n
		No command help available \n
			:param value: see the help for DevmStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:QHSL:P5Q:DEVM', value)
