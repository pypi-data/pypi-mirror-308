...
class P4HpCls:
	...
	def get_sacp(self) -> SacpStruct:
		...
		Snippet: value: SacpStruct = driver.configure.hdrp.limit.p4Hp.get_sacp() \n
	...
	def set_sacp(self, value: SacpStruct) -> None:
		...
		structure = driver.configure.hdrp.limit.p4Hp.SacpStruct() \n
		...
		driver.configure.hdrp.limit.p4Hp.set_sacp(value = structure) \n
		No command help available \n
