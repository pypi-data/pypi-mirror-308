...
class EvMagnitudeCls:
	...
	def get_offset(self) -> OffsetStruct:
		...
		Snippet: value: OffsetStruct = driver.configure.hdrp.limit.p8Hp.evMagnitude.get_offset() \n
	...
	def set_offset(self, value: OffsetStruct) -> None:
		...
		structure = driver.configure.hdrp.limit.p8Hp.evMagnitude.OffsetStruct() \n
		...
		driver.configure.hdrp.limit.p8Hp.evMagnitude.set_offset(value = structure) \n
		No command help available \n
