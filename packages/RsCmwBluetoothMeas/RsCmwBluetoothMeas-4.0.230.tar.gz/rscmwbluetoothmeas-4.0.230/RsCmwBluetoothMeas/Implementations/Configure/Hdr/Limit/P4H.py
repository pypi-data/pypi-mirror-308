...
class P4HCls:
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.hdr.limit.p4H.get_devm() \n
		No command help available \n
			:return: structure: for return value, see the help for DevmStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:HDR:LIMit:P4H:DEVM?', self.__class__.DevmStruct())
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:HDR:LIMit:P4H:DEVM', value)
	...
	def get_sgacp(self) -> SgacpStruct:
		...
		Snippet: value: SgacpStruct = driver.configure.hdr.limit.p4H.get_sgacp() \n
		No command help available \n
			:return: structure: for return value, see the help for SgacpStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:HDR:LIMit:P4H:SGACp?', self.__class__.SgacpStruct())
	...
	def set_sgacp(self, value: SgacpStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:HDR:LIMit:P4H:SGACp', value)
