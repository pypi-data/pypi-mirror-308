...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> enums.LePacketType:
		...
		Specifies the packet type of the measured LE signal. A data channel packet cannot be selected. It is only automatically
		selected in combined signal path with LE connection tests. \n
	...
	def get_lrange(self) -> enums.LePacketType:
		...
		Specifies the packet type of the measured signal for LE coded PHY. A data channel packet cannot be selected. It is only
