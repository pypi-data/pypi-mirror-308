...
class ExtendedCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Delta_F_299_P: float: float Frequency deviation value deltaf2 above which 99.9% of all measured deltaf2 values occur (BR, LE) . Range: -0.99999 MHz to 0.99999 MHz, Unit: Hz
