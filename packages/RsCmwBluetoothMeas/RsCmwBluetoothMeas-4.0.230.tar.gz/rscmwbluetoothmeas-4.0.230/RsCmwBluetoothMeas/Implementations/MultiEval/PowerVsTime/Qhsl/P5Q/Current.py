...
class CurrentCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.powerVsTime.qhsl.p5Q.current.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.multiEval.powerVsTime.qhsl.p5Q.current.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.powerVsTime.qhsl.p5Q.current.fetch() \n
		No command help available \n
