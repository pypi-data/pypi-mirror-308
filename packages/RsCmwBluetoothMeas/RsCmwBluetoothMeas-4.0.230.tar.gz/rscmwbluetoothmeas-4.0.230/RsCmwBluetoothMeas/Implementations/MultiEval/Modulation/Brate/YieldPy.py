...
class YieldPyCls:
	...
	def fetch(self) -> List[float]:
		...
		Returns the percentage of auto-detected BR packets with a particular pattern type. A result is available after the R&S
		CMW has auto-detected a packet (method RsCmwBluetoothMeas.Configure.InputSignal.dmode AUTO) . \n
