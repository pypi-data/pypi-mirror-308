...
class CurrentCls:
	...
	def fetch(self) -> ResultData:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:BRATe:CURRent \n
		Snippet: value: ResultData = driver.multiEval.modulation.brate.current.fetch() \n
		Returns the current, average, absolute min (xmin) , absolute max (xmax) , and max modulation results for BR packets. The
		values described below are returned by FETCh and READ commands. CALCulate commands return limit check results instead,
		one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:BRATe:CURRent?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:BRATe:CURRent \n
		Snippet: value: ResultData = driver.multiEval.modulation.brate.current.read() \n
		Returns the current, average, absolute min (xmin) , absolute max (xmax) , and max modulation results for BR packets. The
		values described below are returned by FETCh and READ commands. CALCulate commands return limit check results instead,
		one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:BRATe:CURRent?', self.__class__.ResultData())
