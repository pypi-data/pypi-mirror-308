...
class AverageCls:
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage \n
		Snippet: value: CalculateStruct = driver.multiEval.modulation.qhsl.p2Q.average.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage \n
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.average.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage \n
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.average.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P2Q:AVERage?', self.__class__.ResultData())
