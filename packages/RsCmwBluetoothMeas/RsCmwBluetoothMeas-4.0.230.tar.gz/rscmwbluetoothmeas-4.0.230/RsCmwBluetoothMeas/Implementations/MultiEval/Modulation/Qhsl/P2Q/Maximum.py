...
class MaximumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.modulation.qhsl.p2Q.maximum.calculate() \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.maximum.fetch() \n
		No command help available \n
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.maximum.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
