...
class PtxCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Out_Of_Tol: float or bool: float Out of tolerance result, i.e. the percentage of measurement intervals of the statistic count ([CMDLINKRESOLVED Configure.MultiEval.Scount#Sacp CMDLINKRESOLVED]) exceeding the specified limits. Range: 0 % to 100 %, Unit: %
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			- Reliability: int: decimal 'Reliability indicator'
			- Out_Of_Tol: float: float Out of tolerance result, i.e. the percentage of measurement intervals of the statistic count ([CMDLINKRESOLVED Configure.MultiEval.Scount#Sacp CMDLINKRESOLVED]) exceeding the specified limits. Range: 0 % to 100 %, Unit: %
