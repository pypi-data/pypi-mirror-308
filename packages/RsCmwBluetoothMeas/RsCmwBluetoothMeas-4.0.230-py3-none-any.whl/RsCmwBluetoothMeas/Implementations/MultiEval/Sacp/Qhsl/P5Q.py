...
class P5QCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.sacp.qhsl.p5Q.calculate() \n
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.sacp.qhsl.p5Q.read() \n
		No command help available \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.sacp.qhsl.p5Q.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
