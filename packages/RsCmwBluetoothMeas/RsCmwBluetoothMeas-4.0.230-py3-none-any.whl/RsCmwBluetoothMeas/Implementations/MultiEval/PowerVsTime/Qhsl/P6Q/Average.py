...
class AverageCls:
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P6Q:AVERage \n
		Snippet: value: CalculateStruct = driver.multiEval.powerVsTime.qhsl.p6Q.average.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P6Q:AVERage?', self.__class__.CalculateStruct())
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.multiEval.powerVsTime.qhsl.p6Q.average.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ReadStruct structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P6Q:AVERage?', self.__class__.ReadStruct())
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P6Q:AVERage \n
		Snippet: value: FetchStruct = driver.multiEval.powerVsTime.qhsl.p6Q.average.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P6Q:AVERage?', self.__class__.FetchStruct())
