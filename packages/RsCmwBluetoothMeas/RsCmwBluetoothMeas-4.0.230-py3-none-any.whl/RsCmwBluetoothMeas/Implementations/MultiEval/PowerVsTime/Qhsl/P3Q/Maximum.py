...
class MaximumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.powerVsTime.qhsl.p3Q.maximum.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.multiEval.powerVsTime.qhsl.p3Q.maximum.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.powerVsTime.qhsl.p3Q.maximum.fetch() \n
		No command help available \n
