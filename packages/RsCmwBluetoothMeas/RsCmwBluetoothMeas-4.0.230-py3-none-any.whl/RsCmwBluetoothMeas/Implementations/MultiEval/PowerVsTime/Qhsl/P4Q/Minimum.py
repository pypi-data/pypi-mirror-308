...
class MinimumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.powerVsTime.qhsl.p4Q.minimum.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.multiEval.powerVsTime.qhsl.p4Q.minimum.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.powerVsTime.qhsl.p4Q.minimum.fetch() \n
		No command help available \n
