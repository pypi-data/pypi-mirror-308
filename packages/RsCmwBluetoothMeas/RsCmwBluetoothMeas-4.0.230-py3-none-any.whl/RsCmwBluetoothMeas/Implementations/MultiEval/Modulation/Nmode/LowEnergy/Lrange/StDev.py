...
class StDevCls:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.nmode.lowEnergy.lrange.stDev.fetch() \n
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.nmode.lowEnergy.lrange.stDev.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
