...
class CurrentCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.modulation.qhsl.p2Q.current.calculate() \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.current.fetch() \n
		No command help available \n
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p2Q.current.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
