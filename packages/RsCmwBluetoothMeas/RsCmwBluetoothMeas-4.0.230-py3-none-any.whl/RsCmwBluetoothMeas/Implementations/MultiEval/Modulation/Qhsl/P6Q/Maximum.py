...
class MaximumCls:
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum \n
		Snippet: value: CalculateStruct = driver.multiEval.modulation.qhsl.p6Q.maximum.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum \n
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p6Q.maximum.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum \n
		Snippet: value: ResultData = driver.multiEval.modulation.qhsl.p6Q.maximum.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:MEValuation:MODulation:QHSL:P6Q:MAXimum?', self.__class__.ResultData())
