...
class ExtendedCls:
	...
	def fetch(self, segment=repcap.Segment.Default) -> FetchStruct:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:LIST:SEGMent<nr>:MODulation:XMINimum:EXTended \n
		Snippet: value: FetchStruct = driver.multiEval.listPy.segment.modulation.xminimum.extended.fetch(segment = repcap.Segment.Default) \n
		...
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:LIST:SEGMent{segment_cmd_val}:MODulation:XMINimum:EXTended?', self.__class__.FetchStruct())
