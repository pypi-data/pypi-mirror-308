...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> enums.PatternTypeIsignalLe:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:PATTern:LENergy[:LE1M] \n
		Snippet: value: enums.PatternTypeIsignalLe = driver.configure.inputSignal.pattern.lowEnergy.get_le_1_m() \n
		...
		return Conversions.str_to_scalar_enum(response, enums.PatternTypeIsignalLe)

	def set_le_1_m(self, pattern_type: enums.PatternTypeIsignalLe) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:PATTern:LENergy[:LE1M] \n
		Snippet: driver.configure.inputSignal.pattern.lowEnergy.set_le_1_m(pattern_type = enums.PatternTypeIsignalLe.OTHer) \n
		It specifies the data pattern type that the EUT transmits as user payload data in its LE packets. Commands for LE 1M PHY
		(...:LE1M...) and LE 2M PHY (...:LE2M...) are available.
			INTRO_CMD_HELP: For the combined signal path scenario, use: \n
			- CONFigure:BLUetooth:SIGN<i>:CONNection:PACKets:PATTern:LENergy[:LE1M]
		...
		"""
		param = Conversions.enum_scalar_to_str(pattern_type, enums.PatternTypeIsignalLe)
	...
	# noinspection PyTypeChecker
	def get_le_2_m(self) -> enums.PatternTypeIsignalLe:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:PATTern:LENergy:LE2M \n
		Snippet: value: enums.PatternTypeIsignalLe = driver.configure.inputSignal.pattern.lowEnergy.get_le_2_m() \n
		It specifies the data pattern type that the EUT transmits as user payload data in its LE packets. Commands for LE 1M PHY
		(...:LE1M...) and LE 2M PHY (...:LE2M...) are available.
			INTRO_CMD_HELP: For the combined signal path scenario, use: \n
			- CONFigure:BLUetooth:SIGN<i>:CONNection:PACKets:PATTern:LENergy[:LE1M]
	...
	def set_le_2_m(self, pattern_type: enums.PatternTypeIsignalLe) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:PATTern:LENergy:LE2M \n
		Snippet: driver.configure.inputSignal.pattern.lowEnergy.set_le_2_m(pattern_type = enums.PatternTypeIsignalLe.OTHer) \n
		It specifies the data pattern type that the EUT transmits as user payload data in its LE packets. Commands for LE 1M PHY
		(...:LE1M...) and LE 2M PHY (...:LE2M...) are available.
			INTRO_CMD_HELP: For the combined signal path scenario, use: \n
			- CONFigure:BLUetooth:SIGN<i>:CONNection:PACKets:PATTern:LENergy[:LE1M]
