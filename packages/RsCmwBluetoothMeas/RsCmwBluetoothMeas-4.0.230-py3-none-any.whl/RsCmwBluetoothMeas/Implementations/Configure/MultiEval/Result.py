...
class ResultCls:
	...
	def get_pencoding(self) -> bool:
		...
		I/Q constellation absolute (EDR) , I/Q constellation differential (EDR) , I/Q constellation error (EDR) , frequency
		...
		Use READ...? queries to retrieve results for disabled measurements. \n
			:return: enable: OFF | ON ON: Evaluate the results. OFF: Do not evaluate results.
		"""
	...
	def set_pencoding(self, enable: bool) -> None:
		...
		gated ACP (EDR) . Use method RsCmwBluetoothMeas.Configure.MultiEval.Result.all to enable/disable all result types. Tip:
		Use READ...? queries to retrieve results for disabled measurements. \n
			:param enable: OFF | ON ON: Evaluate the results. OFF: Do not evaluate results.
		"""
		param = Conversions.bool_to_str(enable)
	...
	class AllStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			- Devm: bool: OFF | ON Differential error vector magnitude (only for EDR) ON: Evaluate the results. OFF: Do not evaluate results.
			- Phase_Diff: bool: OFF | ON Phase difference (only for EDR)
			- Mod_Scalars: bool: OFF | ON Statistical modulation results
			- Iq_Absolute: bool: OFF | ON I/Q constellation absolute (only for EDR)
			- Iq_Differential: bool: OFF | ON I/Q constellation differential (only for EDR)
			- Iq_Error: bool: OFF | ON I/Q constellation error (only for EDR)
