...
class DminimumCls:
	...
	def set(self, freq_dev_f_1_lower: float, freq_dev_f_1_upper: float, freq_dev_f_1_enable: List[bool]) -> None:
		...
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.dminimum.set(freq_dev_f_1_lower = 1.0, freq_dev_f_1_upper = 1.0, freq_dev_f_1_enable = [True, False, True]) \n
	...
	def get(self) -> DminimumStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:DMINimum \n
		Snippet: value: DminimumStruct = driver.configure.multiEval.limit.lowEnergy.le2M.dminimum.get() \n
		Defines the lower and upper deltaf1 frequency deviation limits for LE 2M PHY. The mnemonics DAVerage, DMINimum, DMAXimum
		distinguish average, minimum and maximum frequency deviations. \n
