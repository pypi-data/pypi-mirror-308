...
class P3QCls:
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.multiEval.limit.qhsl.p3Q.get_devm() \n
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		structure = driver.configure.multiEval.limit.qhsl.p3Q.DevmStruct() \n
		...
		driver.configure.multiEval.limit.qhsl.p3Q.set_devm(value = structure) \n
		No command help available \n
