...
class CurrentCls:
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.hdrp.modulation.current.read() \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.hdrp.modulation.current.fetch() \n
		No command help available \n
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- P_99_Evm: enums.ResultStatus2: No parameter help available
			- Symbol_Rate_Error: int: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			...
			ArgStruct.scalar_enum('P_99_Evm', enums.ResultStatus2),
			ArgStruct.scalar_int('Symbol_Rate_Error')]
		...
		def __init__(self):
			...
			self.P_99_Evm: enums.ResultStatus2 = None
			self.Symbol_Rate_Error: int = None

	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:BLUetooth:MEASurement<Instance>:HDRP:MODulation:CURRent \n
		Snippet: value: CalculateStruct = driver.hdrp.modulation.current.calculate() \n
		No command help available \n
