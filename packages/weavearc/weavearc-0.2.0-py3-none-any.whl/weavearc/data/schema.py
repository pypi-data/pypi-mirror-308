...
class BaseModel(msgspec.Struct):
    ...
    @classmethod
    def from_dict(
        cls, dictionary: dict[str, Any], encoder: Optional[msgspec.json.Encoder] = None
    ) -> BaseModel:
        """
        ...
        try:
            model: BaseModel = msgspec.json.decode(
                json_encoder.encode(dictionary), type=cls
            )
            return model
    ...
    def as_dict(
        ...
        decoder: Optional[msgspec.json.Decoder] = None,
    ) -> dict:
        """
    ...
    @classmethod
    def from_defaults(cls) -> BaseModel:
        """
