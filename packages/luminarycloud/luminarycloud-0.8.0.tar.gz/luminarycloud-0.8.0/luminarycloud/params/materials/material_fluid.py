...
import luminarycloud.params.materials.laminar_viscosity as lv
from luminarycloud._helpers.defaults import _reset_defaults
from luminarycloud._proto.client import simulation_pb2 as clientpb
from luminarycloud.params.materials.laminar_viscosity import (
    LaminarViscosityModel,
)
...
class MaterialFluid(Material):
    ...
    laminar_viscosity_model: LaminarViscosityModel = field(default_factory=lv.Sutherland)
    ...
    def _to_proto(self) -> clientpb.MaterialEntity:
        ...
        if isinstance(self.laminar_viscosity_model, lv.Sutherland):
            ...
            _proto.material_fluid.sutherland_viscosity_ref.value = (
                self.laminar_viscosity_model.sutherland_viscosity_ref
            )
            _proto.material_fluid.sutherland_viscosity_temp_ref.value = (
                self.laminar_viscosity_model.sutherland_viscosity_temp_ref
            )
            _proto.material_fluid.sutherland_constant.value = (
                self.laminar_viscosity_model.sutherland_constant
            )
        elif isinstance(self.laminar_viscosity_model, lv.LaminarConstantViscosity):
            _proto.material_fluid.laminar_viscosity_model_newtonian = (
            ...
            _proto.material_fluid.laminar_constant_viscosity_constant.value = (
                self.laminar_viscosity_model.laminar_constant_viscosity_constant
            )
    ...
    def _from_proto(self, proto: clientpb.MaterialEntity):
        ...
        if (
            ...
            self.laminar_viscosity_model = lv.Sutherland(
                sutherland_viscosity_ref=proto.material_fluid.sutherland_viscosity_ref.value,
                sutherland_viscosity_temp_ref=proto.material_fluid.sutherland_viscosity_temp_ref.value,
            ...
            self.laminar_viscosity_model = lv.LaminarConstantViscosity(
                laminar_constant_viscosity_constant=proto.material_fluid.laminar_constant_viscosity_constant.value
            )
        elif (
            proto.material_fluid.laminar_viscosity_model_newtonian
            == enum.LaminarViscosityModelNewtonian.TEMPERATURE_DEPENDENT_LAMINAR_VISCOSITY
