...
class MaterialFluid(ParamGroupWrapper[clientpb.MaterialFluid]):
    ...
    laminar_viscosity_model_newtonian: enum.LaminarViscosityModelNewtonian = (
    ...
    "Sutherland Constant."
    dynamic_viscosity_table_data: Optional[RectilinearTable] = None
    ...
    material_fluid_preset: enum.MaterialFluidPreset = enum.MaterialFluidPreset.CUSTOM_MATERIAL_FLUID
    ...
    def _to_proto(self) -> clientpb.MaterialFluid:
        ...
        _proto.laminar_viscosity_model_newtonian = self.laminar_viscosity_model_newtonian
        _proto.laminar_constant_viscosity_constant.value = self.laminar_constant_viscosity_constant
        _proto.sutherland_viscosity_ref.value = self.sutherland_viscosity_ref
        _proto.sutherland_viscosity_temp_ref.value = self.sutherland_viscosity_temp_ref
        _proto.sutherland_constant.value = self.sutherland_constant
        if self.dynamic_viscosity_table_data is not None:
            _proto.dynamic_viscosity_table_data = self.dynamic_viscosity_table_data
        ...
        _proto.material_fluid_preset = self.material_fluid_preset
        return _proto
    ...
    def _from_proto(self, proto: clientpb.MaterialFluid):
        ...
        self.laminar_viscosity_model_newtonian = enum.LaminarViscosityModelNewtonian(
            proto.laminar_viscosity_model_newtonian
        )
        self.laminar_constant_viscosity_constant = proto.laminar_constant_viscosity_constant.value
        self.sutherland_viscosity_ref = proto.sutherland_viscosity_ref.value
        self.sutherland_viscosity_temp_ref = proto.sutherland_viscosity_temp_ref.value
        self.sutherland_constant = proto.sutherland_constant.value
        self.dynamic_viscosity_table_data = proto.dynamic_viscosity_table_data
        ...
        self.material_fluid_preset = enum.MaterialFluidPreset(proto.material_fluid_preset)
...
class MaterialSolid(ParamGroupWrapper[clientpb.MaterialSolid]):
    ...
    thermal_conductivity_table_data: Optional[RectilinearTable] = None
    "Correlation between thermal conductivity and temperature."
    material_solid_preset: enum.MaterialSolidPreset = enum.MaterialSolidPreset.CUSTOM_MATERIAL_SOLID
    "Select a predefined set of material properties or allow a custom set of properties."
    ...
    def _to_proto(self) -> clientpb.MaterialSolid:
        ...
        if self.thermal_conductivity_table_data is not None:
            _proto.thermal_conductivity_table_data = self.thermal_conductivity_table_data
        _proto.material_solid_preset = self.material_solid_preset
        return _proto
    ...
    def _from_proto(self, proto: clientpb.MaterialSolid):
        ...
        self.thermal_conductivity_table_data = proto.thermal_conductivity_table_data
        self.material_solid_preset = enum.MaterialSolidPreset(proto.material_solid_preset)
...
class General(ParamGroupWrapper[clientpb.General]):
    ...
    def _to_proto(self) -> clientpb.General:
        ...
        _proto.acceleration.x.value = self.acceleration.x
        _proto.acceleration.y.value = self.acceleration.y
        _proto.acceleration.z.value = self.acceleration.z
    ...
    def _from_proto(self, proto: clientpb.General):
        ...
        self.acceleration = Vector3(
            x=proto.acceleration.x.value,
            y=proto.acceleration.y.value,
            z=proto.acceleration.z.value,
        )
...
class Adjoint(ParamGroupWrapper[clientpb.Adjoint]):
    ...
    ""
    primal_simulation_id: Optional[str] = None
    ""
...
class FrameTransforms(ParamGroupWrapper[clientpb.FrameTransforms]):
    ...
    def _to_proto(self) -> clientpb.FrameTransforms:
        ...
        _proto.transform_translation.x.value = self.transform_translation.x
        _proto.transform_translation.y.value = self.transform_translation.y
        _proto.transform_translation.z.value = self.transform_translation.z
        _proto.transform_rotation_angles.x.value = self.transform_rotation_angles.x
        _proto.transform_rotation_angles.y.value = self.transform_rotation_angles.y
        _proto.transform_rotation_angles.z.value = self.transform_rotation_angles.z
        return _proto
    ...
    def _from_proto(self, proto: clientpb.FrameTransforms):
        ...
        self.transform_translation = Vector3(
            x=proto.transform_translation.x.value,
            y=proto.transform_translation.y.value,
            z=proto.transform_translation.z.value,
        )
        self.transform_rotation_angles = Vector3(
            x=proto.transform_rotation_angles.x.value,
            y=proto.transform_rotation_angles.y.value,
            z=proto.transform_rotation_angles.z.value,
        )
...
class MotionData(ParamGroupWrapper[clientpb.MotionData]):
    ...
    frame_parent: Optional[str] = None
    ...
    def _to_proto(self) -> clientpb.MotionData:
        ...
        _proto.motion_translation_velocity.x.value = self.motion_translation_velocity.x
        _proto.motion_translation_velocity.y.value = self.motion_translation_velocity.y
        _proto.motion_translation_velocity.z.value = self.motion_translation_velocity.z
        _proto.motion_angular_velocity.x.value = self.motion_angular_velocity.x
        _proto.motion_angular_velocity.y.value = self.motion_angular_velocity.y
        _proto.motion_angular_velocity.z.value = self.motion_angular_velocity.z
        _proto.motion_translation.x.value = self.motion_translation.x
        _proto.motion_translation.y.value = self.motion_translation.y
        _proto.motion_translation.z.value = self.motion_translation.z
        _proto.motion_rotation_angles.x.value = self.motion_rotation_angles.x
        _proto.motion_rotation_angles.y.value = self.motion_rotation_angles.y
        _proto.motion_rotation_angles.z.value = self.motion_rotation_angles.z
    ...
    def _from_proto(self, proto: clientpb.MotionData):
        ...
        self.motion_translation_velocity = Vector3(
            x=proto.motion_translation_velocity.x.value,
            y=proto.motion_translation_velocity.y.value,
            z=proto.motion_translation_velocity.z.value,
        )
        self.motion_angular_velocity = Vector3(
            x=proto.motion_angular_velocity.x.value,
            y=proto.motion_angular_velocity.y.value,
            z=proto.motion_angular_velocity.z.value,
        )
        self.motion_translation = Vector3(
            x=proto.motion_translation.x.value,
            y=proto.motion_translation.y.value,
            z=proto.motion_translation.z.value,
        )
        self.motion_rotation_angles = Vector3(
            x=proto.motion_rotation_angles.x.value,
            y=proto.motion_rotation_angles.y.value,
            z=proto.motion_rotation_angles.z.value,
        )
...
class ParticleGroup(ParamGroupWrapper[clientpb.ParticleGroup]):
    ...
    particle_group_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    ""
    particle_group_name: Optional[str] = None
    ""
    particle_group_behavior_model_ref: Optional[str] = None
    ""
    ...
    def _to_proto(self) -> clientpb.ParticleGroup:
        ...
        _proto.actuator_disk_center.x.value = self.actuator_disk_center.x
        _proto.actuator_disk_center.y.value = self.actuator_disk_center.y
        _proto.actuator_disk_center.z.value = self.actuator_disk_center.z
        _proto.actuator_disk_orientation_selection = self.actuator_disk_orientation_selection
        _proto.actuator_disk_rotation_angle.x.value = self.actuator_disk_rotation_angle.x
        _proto.actuator_disk_rotation_angle.y.value = self.actuator_disk_rotation_angle.y
        _proto.actuator_disk_rotation_angle.z.value = self.actuator_disk_rotation_angle.z
        _proto.actuator_disk_normal_vector.x.value = self.actuator_disk_normal_vector.x
        _proto.actuator_disk_normal_vector.y.value = self.actuator_disk_normal_vector.y
        _proto.actuator_disk_normal_vector.z.value = self.actuator_disk_normal_vector.z
    ...
    def _from_proto(self, proto: clientpb.ParticleGroup):
        ...
        self.actuator_disk_center = Vector3(
            x=proto.actuator_disk_center.x.value,
            y=proto.actuator_disk_center.y.value,
            z=proto.actuator_disk_center.z.value,
        )
        self.actuator_disk_orientation_selection = enum.ActuatorDiskOrientationSelection(
            proto.actuator_disk_orientation_selection
        )
        self.actuator_disk_rotation_angle = Vector3(
            x=proto.actuator_disk_rotation_angle.x.value,
            y=proto.actuator_disk_rotation_angle.y.value,
            z=proto.actuator_disk_rotation_angle.z.value,
        )
        self.actuator_disk_normal_vector = Vector3(
            x=proto.actuator_disk_normal_vector.x.value,
            y=proto.actuator_disk_normal_vector.y.value,
            z=proto.actuator_disk_normal_vector.z.value,
        )
...
class MonitorPlane(ParamGroupWrapper[clientpb.MonitorPlane]):
    ...
    monitor_plane_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    ""
    monitor_plane_name: Optional[str] = None
    ""
    ...
    monitor_plane_box_clip: Optional[bool] = None
    ...
    monitor_plane_volume_clip: Optional[bool] = None
    ...
    def _to_proto(self) -> clientpb.MonitorPlane:
        ...
        _proto.monitor_plane_point.x.value = self.monitor_plane_point.x
        _proto.monitor_plane_point.y.value = self.monitor_plane_point.y
        _proto.monitor_plane_point.z.value = self.monitor_plane_point.z
        _proto.monitor_plane_normal.x.value = self.monitor_plane_normal.x
        _proto.monitor_plane_normal.y.value = self.monitor_plane_normal.y
        _proto.monitor_plane_normal.z.value = self.monitor_plane_normal.z
        if self.monitor_plane_box_clip is not None:
            _proto.monitor_plane_box_clip = self.monitor_plane_box_clip
        _proto.monitor_plane_clip_center.x.value = self.monitor_plane_clip_center.x
        _proto.monitor_plane_clip_center.y.value = self.monitor_plane_clip_center.y
        _proto.monitor_plane_clip_center.z.value = self.monitor_plane_clip_center.z
        _proto.monitor_plane_clip_size.x.value = self.monitor_plane_clip_size.x
        _proto.monitor_plane_clip_size.y.value = self.monitor_plane_clip_size.y
        _proto.monitor_plane_clip_size.z.value = self.monitor_plane_clip_size.z
        _proto.monitor_plane_clip_rotation.x.value = self.monitor_plane_clip_rotation.x
        _proto.monitor_plane_clip_rotation.y.value = self.monitor_plane_clip_rotation.y
        _proto.monitor_plane_clip_rotation.z.value = self.monitor_plane_clip_rotation.z
    ...
    def _from_proto(self, proto: clientpb.MonitorPlane):
        ...
        self.monitor_plane_point = Vector3(
            x=proto.monitor_plane_point.x.value,
            y=proto.monitor_plane_point.y.value,
            z=proto.monitor_plane_point.z.value,
        )
        self.monitor_plane_normal = Vector3(
            x=proto.monitor_plane_normal.x.value,
            y=proto.monitor_plane_normal.y.value,
            z=proto.monitor_plane_normal.z.value,
        )
        self.monitor_plane_box_clip = proto.monitor_plane_box_clip
        self.monitor_plane_clip_center = Vector3(
            x=proto.monitor_plane_clip_center.x.value,
            y=proto.monitor_plane_clip_center.y.value,
            z=proto.monitor_plane_clip_center.z.value,
        )
        self.monitor_plane_clip_size = Vector3(
            x=proto.monitor_plane_clip_size.x.value,
            y=proto.monitor_plane_clip_size.y.value,
            z=proto.monitor_plane_clip_size.z.value,
        )
        self.monitor_plane_clip_rotation = Vector3(
            x=proto.monitor_plane_clip_rotation.x.value,
            y=proto.monitor_plane_clip_rotation.y.value,
            z=proto.monitor_plane_clip_rotation.z.value,
        )
...
class ReferenceValues(ParamGroupWrapper[clientpb.ReferenceValues]):
    ...
    use_aero_moment_ref_lengths: Optional[bool] = None
...
class BoundaryConditionsHeat(ParamGroupWrapper[clientpb.BoundaryConditionsHeat]):
    ...
    boundary_condition_name: Optional[str] = None
    ""
    boundary_condition_display_name: Optional[str] = None
    ""
    boundary_condition_interface_id: Optional[str] = None
...
class InitializationHeat(ParamGroupWrapper[clientpb.InitializationHeat]):
    ...
    def _to_proto(self) -> clientpb.InitializationHeat:
        ...
        if self.existing_solution_url is not None:
            _proto.existing_solution_url = self.existing_solution_url
    ...
    def _from_proto(self, proto: clientpb.InitializationHeat):
        ...
        self.existing_solution_url = proto.existing_solution_url
...
class HeatSource(ParamGroupWrapper[clientpb.HeatSource]):
    ...
    profile_source: Optional[bool] = None
    ...
    heat_source_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    ""
    heat_source_name: Optional[str] = None
    ...
    heat_source_power: Optional[float] = None
    "Power of the heat source."
    heat_source_power_per_unit_volume: Optional[float] = None
...
class SlidingInterfaces(ParamGroupWrapper[clientpb.SlidingInterfaces]):
    ...
    sliding_interface_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    "ID of the sliding interface"
    sliding_interface_name: Optional[str] = None
    ...
    def _to_proto(self) -> clientpb.SlidingInterfaces:
        ...
        _proto.sliding_matching_translation_transform.x.value = (
            self.sliding_matching_translation_transform.x
        )
        _proto.sliding_matching_translation_transform.y.value = (
            self.sliding_matching_translation_transform.y
        )
        _proto.sliding_matching_translation_transform.z.value = (
            self.sliding_matching_translation_transform.z
        )
        _proto.sliding_matching_periodic_rotation_angles.x.value = (
            self.sliding_matching_periodic_rotation_angles.x
        )
        _proto.sliding_matching_periodic_rotation_angles.y.value = (
            self.sliding_matching_periodic_rotation_angles.y
        )
        _proto.sliding_matching_periodic_rotation_angles.z.value = (
            self.sliding_matching_periodic_rotation_angles.z
        )
        _proto.sliding_matching_periodic_center_of_rotation.x.value = (
            self.sliding_matching_periodic_center_of_rotation.x
        )
        _proto.sliding_matching_periodic_center_of_rotation.y.value = (
            self.sliding_matching_periodic_center_of_rotation.y
        )
        _proto.sliding_matching_periodic_center_of_rotation.z.value = (
            self.sliding_matching_periodic_center_of_rotation.z
        )
    ...
    def _from_proto(self, proto: clientpb.SlidingInterfaces):
        ...
        self.sliding_matching_translation_transform = Vector3(
            x=proto.sliding_matching_translation_transform.x.value,
            y=proto.sliding_matching_translation_transform.y.value,
            z=proto.sliding_matching_translation_transform.z.value,
        )
        self.sliding_matching_periodic_rotation_angles = Vector3(
            x=proto.sliding_matching_periodic_rotation_angles.x.value,
            y=proto.sliding_matching_periodic_rotation_angles.y.value,
            z=proto.sliding_matching_periodic_rotation_angles.z.value,
        )
        self.sliding_matching_periodic_center_of_rotation = Vector3(
            x=proto.sliding_matching_periodic_center_of_rotation.x.value,
            y=proto.sliding_matching_periodic_center_of_rotation.y.value,
            z=proto.sliding_matching_periodic_center_of_rotation.z.value,
        )
...
class PeriodicPair(ParamGroupWrapper[clientpb.PeriodicPair]):
    ...
    periodic_pair_name: Optional[str] = None
    ""
    ...
    def _to_proto(self) -> clientpb.PeriodicPair:
        ...
        _proto.periodic_translation.x.value = self.periodic_translation.x
        _proto.periodic_translation.y.value = self.periodic_translation.y
        _proto.periodic_translation.z.value = self.periodic_translation.z
        _proto.periodic_center_of_rotation.x.value = self.periodic_center_of_rotation.x
        _proto.periodic_center_of_rotation.y.value = self.periodic_center_of_rotation.y
        _proto.periodic_center_of_rotation.z.value = self.periodic_center_of_rotation.z
        _proto.periodic_rotation_angles.x.value = self.periodic_rotation_angles.x
        _proto.periodic_rotation_angles.y.value = self.periodic_rotation_angles.y
        _proto.periodic_rotation_angles.z.value = self.periodic_rotation_angles.z
        return _proto
    ...
    def _from_proto(self, proto: clientpb.PeriodicPair):
        ...
        self.periodic_translation = Vector3(
            x=proto.periodic_translation.x.value,
            y=proto.periodic_translation.y.value,
            z=proto.periodic_translation.z.value,
        )
        self.periodic_center_of_rotation = Vector3(
            x=proto.periodic_center_of_rotation.x.value,
            y=proto.periodic_center_of_rotation.y.value,
            z=proto.periodic_center_of_rotation.z.value,
        )
        self.periodic_rotation_angles = Vector3(
            x=proto.periodic_rotation_angles.x.value,
            y=proto.periodic_rotation_angles.y.value,
            z=proto.periodic_rotation_angles.z.value,
        )
...
class Turbulence(ParamGroupWrapper[clientpb.Turbulence]):
    ...
    def _to_proto(self) -> clientpb.Turbulence:
        ...
        _proto.zdes_rmin.x.value = self.zdes_rmin.x
        _proto.zdes_rmin.y.value = self.zdes_rmin.y
        _proto.zdes_rmin.z.value = self.zdes_rmin.z
        _proto.zdes_rmax.x.value = self.zdes_rmax.x
        _proto.zdes_rmax.y.value = self.zdes_rmax.y
        _proto.zdes_rmax.z.value = self.zdes_rmax.z
    ...
    def _from_proto(self, proto: clientpb.Turbulence):
        ...
        self.zdes_rmin = Vector3(
            x=proto.zdes_rmin.x.value,
            y=proto.zdes_rmin.y.value,
            z=proto.zdes_rmin.z.value,
        )
        self.zdes_rmax = Vector3(
            x=proto.zdes_rmax.x.value,
            y=proto.zdes_rmax.y.value,
            z=proto.zdes_rmax.z.value,
        )
...
class AdjointControlsFluid(ParamGroupWrapper[clientpb.AdjointControlsFluid]):
    ...
    adjoint_frozen_turbulence: Optional[bool] = None
    ...
    adjoint_frozen_transition: Optional[bool] = None
...
class InitializationFluid(ParamGroupWrapper[clientpb.InitializationFluid]):
    ...
    turbulent_variable_initialization_type_komega: enum.TurbulentVariableInitializationTypeKomega = (
    ...
    def _to_proto(self) -> clientpb.InitializationFluid:
        ...
        _proto.uniform_v.x.value = self.uniform_v.x
        _proto.uniform_v.y.value = self.uniform_v.y
        _proto.uniform_v.z.value = self.uniform_v.z
        _proto.uniform_t.value = self.uniform_t
    ...
    def _from_proto(self, proto: clientpb.InitializationFluid):
        ...
        self.uniform_v = Vector3(
            x=proto.uniform_v.x.value,
            y=proto.uniform_v.y.value,
            z=proto.uniform_v.z.value,
        )
        self.uniform_t = proto.uniform_t.value
...
class BladeElementAirfoilData(ParamGroupWrapper[clientpb.BladeElementAirfoilData]):
    ...
    airfoil_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    "Assign a unique ID to this airfoil"
    airfoil_name: Optional[str] = None
    "Apply a descriptive name to this airfoil"
    airfoil_radial_station: Optional[float] = None
...
class PhysicalBehavior(ParamGroupWrapper[clientpb.PhysicalBehavior]):
    ...
    physical_behavior_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    ""
    physical_behavior_name: Optional[str] = None
    ""
    ...
    def _to_proto(self) -> clientpb.PhysicalBehavior:
        ...
        _proto.blade_element_pitch_schedule.x.value = self.blade_element_pitch_schedule.x
        _proto.blade_element_pitch_schedule.y.value = self.blade_element_pitch_schedule.y
        _proto.blade_element_pitch_schedule.z.value = self.blade_element_pitch_schedule.z
        _proto.blade_element_flap_schedule.x.value = self.blade_element_flap_schedule.x
        _proto.blade_element_flap_schedule.y.value = self.blade_element_flap_schedule.y
        _proto.blade_element_flap_schedule.z.value = self.blade_element_flap_schedule.z
        _proto.blade_element_lag_schedule.x.value = self.blade_element_lag_schedule.x
        _proto.blade_element_lag_schedule.y.value = self.blade_element_lag_schedule.y
        _proto.blade_element_lag_schedule.z.value = self.blade_element_lag_schedule.z
        ...
        _proto.source_particle_acceleration_vector.x.value = (
            self.source_particle_acceleration_vector.x
        )
        _proto.source_particle_acceleration_vector.y.value = (
            self.source_particle_acceleration_vector.y
        )
        _proto.source_particle_acceleration_vector.z.value = (
            self.source_particle_acceleration_vector.z
        )
    ...
    def _from_proto(self, proto: clientpb.PhysicalBehavior):
        ...
        self.blade_element_pitch_schedule = Vector3(
            x=proto.blade_element_pitch_schedule.x.value,
            y=proto.blade_element_pitch_schedule.y.value,
            z=proto.blade_element_pitch_schedule.z.value,
        )
        self.blade_element_flap_schedule = Vector3(
            x=proto.blade_element_flap_schedule.x.value,
            y=proto.blade_element_flap_schedule.y.value,
            z=proto.blade_element_flap_schedule.z.value,
        )
        self.blade_element_lag_schedule = Vector3(
            x=proto.blade_element_lag_schedule.x.value,
            y=proto.blade_element_lag_schedule.y.value,
            z=proto.blade_element_lag_schedule.z.value,
        )
        ...
        self.source_particle_acceleration_vector = Vector3(
            x=proto.source_particle_acceleration_vector.x.value,
            y=proto.source_particle_acceleration_vector.y.value,
            z=proto.source_particle_acceleration_vector.z.value,
        )
...
class PorousBehavior(ParamGroupWrapper[clientpb.PorousBehavior]):
    ...
    porous_behavior_id: Optional[str] = field(default_factory=create_unique_id, init=False)
    ""
    porous_behavior_name: Optional[str] = None
    ""
    ...
    porous_heat_source_power: Optional[float] = None
    "Power of the heat source."
    porous_heat_source_power_per_unit_volume: Optional[float] = None
    "Power per unit volume of the heat source."
    ...
    def _to_proto(self) -> clientpb.PorousBehavior:
        ...
        _proto.darcy_coeff.x.value = self.darcy_coeff.x
        _proto.darcy_coeff.y.value = self.darcy_coeff.y
        _proto.darcy_coeff.z.value = self.darcy_coeff.z
        _proto.forchheimer_coeff.x.value = self.forchheimer_coeff.x
        _proto.forchheimer_coeff.y.value = self.forchheimer_coeff.y
        _proto.forchheimer_coeff.z.value = self.forchheimer_coeff.z
    ...
    def _from_proto(self, proto: clientpb.PorousBehavior):
        ...
        self.darcy_coeff = Vector3(
            x=proto.darcy_coeff.x.value,
            y=proto.darcy_coeff.y.value,
            z=proto.darcy_coeff.z.value,
        )
        self.forchheimer_coeff = Vector3(
            x=proto.forchheimer_coeff.x.value,
            y=proto.forchheimer_coeff.y.value,
            z=proto.forchheimer_coeff.z.value,
        )
