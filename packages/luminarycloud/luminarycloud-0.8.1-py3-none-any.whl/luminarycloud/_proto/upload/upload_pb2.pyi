...
class MeshParams(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["disconnect", b"disconnect", "do_not_read_zones_openfoam", b"do_not_read_zones_openfoam", "mesh_type", b"mesh_type", "scaling", b"scaling"]) -> None: ...
...
class ResourceParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["geometry_params", b"geometry_params", "mesh_params", b"mesh_params", "params", b"params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["geometry_params", b"geometry_params", "mesh_params", b"mesh_params", "params", b"params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["params", b"params"]) -> typing_extensions.Literal["mesh_params", "geometry_params"] | None: ...
...
class FinishUploadReply(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["conversion", b"conversion", "url", b"url"]) -> None: ...
