...
class Geometry(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deleted", b"deleted", "id", b"id", "last_version_id", b"last_version_id", "name", b"name"]) -> None: ...
...
class SubscribeGeometryRequest(google.protobuf.message.Message):
    ...
    project_id: builtins.str
    geometry_id: builtins.str
    include_tags: builtins.bool
    """Include tags in the tessellation data. Experimental feature."""
    def __init__(
        self,
        *,
        project_id: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["geometry_id", b"geometry_id", "include_tags", b"include_tags", "project_id", b"project_id"]) -> None: ...
...
class CreateGeometryRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "project_id", b"project_id", "scaling", b"scaling", "url", b"url", "wait", b"wait"]) -> None: ...
