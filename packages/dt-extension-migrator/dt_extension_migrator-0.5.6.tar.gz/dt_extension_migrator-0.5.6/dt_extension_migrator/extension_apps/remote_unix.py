                    ...
                    for query in tile['queries']:
                        if query['metric']:
                            ...
                            if query['metric'] in NETWORK_METRICS:
                                ...
                                continue
                            query['metric'] = commands_key_mappings.get(query['metric'], "missing")
                            ...
                            if not is_network_metric:
                                for old_key in commands_key_mappings:
                                    if old_key in selector:
                                        selector = selector.replace(old_key, commands_key_mappings[old_key])
