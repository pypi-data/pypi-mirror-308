...
class RunsApi:
    ...
    def get_run_results(
        self,
        run_id: Annotated[StrictStr, Field(description="The run ID.")],
        include_review_results: Annotated[Optional[StrictBool], Field(description="Whether to include human review details in the results. When set to `true`, details such as review status and edits at the run or document level and at the extracted field level are included.  The following values are returned at the run or document level:  - `review_completed` - `files/documents/review_completed` - `files/documents/class_edit_history` - `files/documents/class_edit_history/timestamp` - `files/documents/class_edit_history/user_id` - `files/documents/class_edit_history/modifications` - `files/documents/class_edit_history/modifications/message`  The following values are returned at the extracted field level:  - `edit_history` - `files/edit_history/timestamp` - `files/edit_history/user_id` - `files/edit_history/modifications` - `files/edit_history/modifications/message`  See the response schema for details and descriptions.  <Note>The review process can include manually correcting values. This endpoint doesn't support returning the original and corrected values.</Note> ")] = None,
        include_confidence_scores: Annotated[Optional[StrictBool], Field(description="Whether to include confidence scores in the results. When set to `true`, classification confidence scores at the run or document level and extraction confidence scores at the extracted field level are included.  The following values are returned at the run or document level:  - `files/documents/classification_confidence/ocr`  The following values are returned at the extracted field level:  - `confidence/model`  See the response schema for details and descriptions. ")] = None,
        include_validation_results: Annotated[Optional[StrictBool], Field(description="Whether to include validation status in the results. When set to `true`, validation results at the run or document level and extracted field level are included.  The following values are returned at the run or document level:  - `files/validations/final_result_pass`  The following values are returned at the extracted field level:  - `validations/valid` - `validations/alerts`  See the response schema for details and descriptions. ")] = None,
        include_source_info: Annotated[Optional[StrictBool], Field(description="Whether to include source information in the results. When set to `true`, source details such as the image path of the generated image are included in the results.  The following values are returned at the run or document level:  - `files/documents/post_processed_paths`  The following values are returned at the extracted field level:  - `source_coordinates/top_x` - `source_coordinates/top_y` - `source_coordinates/bottom_x` - `source_coordinates/bottom_y` - `source_coordinates/page_number`  See the response schema for details and descriptions. ")] = None,
        ...
        :param run_id: The run ID. (required)
        :type run_id: str
        :param include_review_results: Whether to include human review details in the results. When set to `true`, details such as review status and edits at the run or document level and at the extracted field level are included.  The following values are returned at the run or document level:  - `review_completed` - `files/documents/review_completed` - `files/documents/class_edit_history` - `files/documents/class_edit_history/timestamp` - `files/documents/class_edit_history/user_id` - `files/documents/class_edit_history/modifications` - `files/documents/class_edit_history/modifications/message`  The following values are returned at the extracted field level:  - `edit_history` - `files/edit_history/timestamp` - `files/edit_history/user_id` - `files/edit_history/modifications` - `files/edit_history/modifications/message`  See the response schema for details and descriptions.  <Note>The review process can include manually correcting values. This endpoint doesn't support returning the original and corrected values.</Note> 
        :type include_review_results: bool
        :param include_confidence_scores: Whether to include confidence scores in the results. When set to `true`, classification confidence scores at the run or document level and extraction confidence scores at the extracted field level are included.  The following values are returned at the run or document level:  - `files/documents/classification_confidence/ocr`  The following values are returned at the extracted field level:  - `confidence/model`  See the response schema for details and descriptions. 
        :type include_confidence_scores: bool
        :param include_validation_results: Whether to include validation status in the results. When set to `true`, validation results at the run or document level and extracted field level are included.  The following values are returned at the run or document level:  - `files/validations/final_result_pass`  The following values are returned at the extracted field level:  - `validations/valid` - `validations/alerts`  See the response schema for details and descriptions. 
        :type include_validation_results: bool
        :param include_source_info: Whether to include source information in the results. When set to `true`, source details such as the image path of the generated image are included in the results.  The following values are returned at the run or document level:  - `files/documents/post_processed_paths`  The following values are returned at the extracted field level:  - `source_coordinates/top_x` - `source_coordinates/top_y` - `source_coordinates/bottom_x` - `source_coordinates/bottom_y` - `source_coordinates/page_number`  See the response schema for details and descriptions. 
    ...
    def list_runs(
        ...
        deployment_id: Annotated[Optional[StrictStr], Field(description="Filter runs by app deployment ID.")] = None,
        ...
        output_repo: Annotated[Optional[List[StrictStr]], Field(description="Filter runs by the output repo.")] = None,
        from_timestamp: Annotated[Optional[StrictInt], Field(description="Filter runs starting from this timestamp. Defaults to one week before the current time.")] = None,
        to_timestamp: Annotated[Optional[StrictInt], Field(description="Filter runs up to this timestamp. Defaults to the current time.")] = None,
        ...
        :type app_name: str
        :param deployment_id: Filter runs by app deployment ID.
        ...
        :param output_repo: Filter runs by the output repo.
        :type output_repo: List[str]
        :param from_timestamp: Filter runs starting from this timestamp. Defaults to one week before the current time.
        :type from_timestamp: int
        :param to_timestamp: Filter runs up to this timestamp. Defaults to the current time.
    ...
    def _list_runs_serialize(
        ...
        if output_repo is not None:
            ...
            _query_params.append(('output_repo', output_repo))
    ...
    def run_app(
        ...
        Run an app by its name or app ID. The input for the run can be a batch ID or an input file path.  To run deployments by API, use the [Run deployment endpoint.](/api-sdk/api-reference/runs/run-deployment/)  <Note>Any specified input or output is validated against the context set by the `IB-Context` header. For example, if the context is set to your community account, but the batch ID used as input for the run is stored in your organization, the call fails.</Note> 
    ...
    def run_deployment(
        self,
        deployment_id: Annotated[StrictStr, Field(description="The deployment ID.  <Tip>You can find the deployment ID by opening the deployment in AI Hub and looking at the site URL, such as https<span>://</span>aihub.instabase.com/deployments/**01902d6f-bb35-74cb-bd27-c09b38bbf20a**/runs.</Tip> ")],
        ...
        Run an AI Hub deployment by its deployment ID. The input for the run is specified using a batch ID or file path.  <Note>Any specified input or output is validated against the context set by the `IB-Context` header. For example, if the context is set to your community account, but the batch ID used as input for the run is stored in your organization, the call fails.</Note> 

        :param deployment_id: The deployment ID.  <Tip>You can find the deployment ID by opening the deployment in AI Hub and looking at the site URL, such as https<span>://</span>aihub.instabase.com/deployments/**01902d6f-bb35-74cb-bd27-c09b38bbf20a**/runs.</Tip>  (required)
        :type deployment_id: str
