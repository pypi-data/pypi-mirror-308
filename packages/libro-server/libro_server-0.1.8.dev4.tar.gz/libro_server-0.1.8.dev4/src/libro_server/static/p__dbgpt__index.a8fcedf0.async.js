          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              window.addEventListener('message', function (event) {
                // 确保消息来自可信源
                if (event.origin === "".concat(window.location.protocol, "//").concat(window.location.hostname, ":3000")) {
...
// EXTERNAL MODULE: ./node_modules/@difizen/libro-ai-native/es/index.js + 289 modules
var libro_ai_native_es = __webpack_require__(54840);
