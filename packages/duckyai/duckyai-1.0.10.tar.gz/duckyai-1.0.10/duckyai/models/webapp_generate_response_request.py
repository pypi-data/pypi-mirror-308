...
class WebappGenerateResponseRequest(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The project ID associated with the request.")
    __properties: ClassVar[List[str]] = ["max_completion_tokens", "index_name", "retrieval_query", "prompt", "prompt_template_id", "variables", "evaluation_id", "variant_name", "retrieval_strategy", "self_correction_strategy", "query_translation_strategy", "project_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebappGenerateResponseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebappGenerateResponseRequest from a dict"""
        if obj is None:
            return None
