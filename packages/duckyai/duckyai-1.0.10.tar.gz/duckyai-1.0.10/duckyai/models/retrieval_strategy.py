...
class RetrievalStrategy(BaseModel):
    ...
    """ # noqa: E501
    k: StrictInt = Field(description="Number of documents to retrieve")
    alpha: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Between 0 and 1, configures balance between keyword and semantic retrieval")
    rerank: Optional[StrictBool] = Field(default=None, description="Whether to rerank the results after retrieval")
    __properties: ClassVar[List[str]] = ["k", "alpha", "rerank"]
