...
class SlurmBlock(PluginBlock):
    ...
    def __init__(self, name: str, description: str, initialAction: typing.Callable, finalAction: typing.Callable, variables: typing.List[PluginVariable] = [], inputs: typing.List[PluginVariable] = [], inputGroups: typing.List[VariableGroup] = [], outputs: typing.List[PluginVariable] = [], id: typing.Optional[str] = None, failOnSlurmError: bool = True, externalURL: typing.Optional[str] = None) -> None:
        """
        :param name: The name of the block.
        :param description: The description of the block.
