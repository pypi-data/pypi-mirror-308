# CDKTF prebuilt bindings for hashicorp/hcp provider version 0.99.0

This repo builds and publishes the [Terraform hcp provider](https://registry.terraform.io/providers/hashicorp/hcp/0.99.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform hcp provider](https://registry.terraform.io/providers/hashicorp/hcp/0.99.0)
