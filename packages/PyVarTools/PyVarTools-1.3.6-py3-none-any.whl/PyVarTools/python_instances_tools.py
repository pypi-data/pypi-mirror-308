...
def get_function_parameters(
    function_: typing.Callable, excluding_parameters: list[str] | None = None
) -> dict[str, typing.Any]:
    """
    ...
    Args:
        ...
        excluding_parameters (list[str], optional): A list of parameter names to exclude from the result. Defaults to None.

    Returns:
        dict[str, typing.typing.Any]: A dictionary containing the function's parameters, excluding those specified in `excluding_parameters`.
...
def get_class_fields(class_: type, excluding_fields: list[str] | None = None) -> dict[str, typing.Any]:
    """
