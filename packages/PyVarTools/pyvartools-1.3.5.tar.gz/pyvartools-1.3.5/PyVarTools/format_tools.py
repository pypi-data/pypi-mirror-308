...
def format_data_frame(
    ...
    float_format: str | Callable[[float], str] = "%.2f",
    integer_format: str | Callable[[int], str] = "%d",
    ...
    Args:
        ...
        float_format (str | Callable[[float], str]): The format string or a callable function for float values. Defaults to "%.2f".
        integer_format (str | Callable[[int], str]): The format string or a callable function for integer values. Defaults to "%d".
