...
def get_function_parameters(function_: Callable, excluding_parameters: list[str] = None):
    ...
    Returns:
        dict[str, Any]: A dictionary containing the function's parameters, excluding those specified in `excluding_parameters`.
...
def get_class_fields(class_, excluding_fields: list[str] = None):
    ...
    Returns:
        dict[str, Any]: A dictionary containing the class's fields, excluding those specified in `excluding_fields`,
