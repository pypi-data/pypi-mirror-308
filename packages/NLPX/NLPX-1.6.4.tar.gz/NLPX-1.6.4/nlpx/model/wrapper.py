...
from nlpx.training.utils import convert_to_tensor, convert_data, convert_data_acc
...
class ModelWrapper:
	...
	def train(self, train_set: Dataset, val_set: Dataset = None, collate_fn=None, epochs=100,
		...
		if val_set:
			trainer = EvalTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			...
			trainer = Trainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                  batch_size,
			                  num_workers,
			                  pin_memory, pin_memory_device,
			                  persistent_workers,
...
class SimpleModelWrapper(ModelWrapper):
	...
	def train(self, X: Union[torch.Tensor, np.ndarray, List], y: Union[torch.Tensor, np.ndarray, List],
	          ...
	          show_progress=False, eps=1e-5):
		if val_data:
			trainer = SimpleEvalTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                            batch_size, eval_batch_size,
			                            num_workers, num_eval_workers,
			                            pin_memory, pin_memory_device,
			                            persistent_workers,
			...
			trainer = SimpleTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                        batch_size,
			                        num_workers,
			                        pin_memory, pin_memory_device,
			                        persistent_workers,
...
class ClassModelWrapper(ModelWrapper):
	...
	def train(self, train_set: Dataset, val_set: Dataset = None, collate_fn=None, epochs=100,
	          ...
	          show_progress=False, eps=1e-5):
		if val_set:
			trainer = EvalClassTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                           batch_size, eval_batch_size,
			                           num_workers, num_eval_workers,
			                           pin_memory, pin_memory_device,
			                           persistent_workers,
			...
			trainer = ClassTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
...
class SimpleClassModelWrapper(ClassModelWrapper):
	...
	def train(self, X: Union[torch.Tensor, np.ndarray, List], y: Union[torch.LongTensor, np.ndarray, List],
	          ...
	          show_progress=False, eps=1e-5):
		if val_data:
			trainer = SimpleEvalClassTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                                 batch_size, eval_batch_size,
			                                 num_workers, num_eval_workers,
			                                 pin_memory, pin_memory_device,
			                                 persistent_workers,
			...
			trainer = SimpleClassTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                             batch_size, num_workers,
			                             pin_memory, pin_memory_device,
			                             persistent_workers,
			                             early_stopping_rounds,
...
class PaddingTextModelWrapper(ClassModelWrapper):
	...
	def train(self, texts: Union[Collection[str], np.ndarray, pd.Series],
		...
		return super().train(train_set, val_set, collate_fn=PaddingTokenCollator(self.tokenizer.pad, max_length),
		              epochs=epochs, optimizer=optimizer, scheduler=scheduler, learning_rate=learning_rate,
...
class SplitPaddingTextModelWrapper(PaddingTextModelWrapper):
	...
	def train(self, texts: Union[Collection[str], np.ndarray, pd.Series],
		...
		val_data = (X_test, y_test)
		return super().train(X_train, y_train, val_data, max_length, epochs, optimizer, scheduler, learning_rate,
...
class RegressModelWrapper(ModelWrapper):
	...
	def train(self, train_set: Dataset, val_set: Dataset = None, collate_fn=None, epochs=100,
	          ...
	          show_progress=False, eps=1e-5):
		if val_set:
			trainer = EvalRegressTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                             batch_size, eval_batch_size,
			                             num_workers, num_eval_workers,
			                             pin_memory, pin_memory_device,
			                             persistent_workers,
			...
			trainer = RegressTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                         batch_size, num_workers,
			                         pin_memory, pin_memory_device,
			                         persistent_workers,
			                         early_stopping_rounds,  # 早停，等10轮决策，评价指标不在变化，停止
...
class SimpleRegressModelWrapper(RegressModelWrapper):
	...
	def train(self, X: Union[torch.Tensor, np.ndarray, List], y: Union[torch.Tensor, np.ndarray, List],
	          ...
	          show_progress=False, eps=1e-5):
		if val_data:
			trainer = SimpleEvalRegressTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                                   batch_size, eval_batch_size,
			                                   num_workers, num_eval_workers,
			                                   pin_memory, pin_memory_device,
			                                   persistent_workers,
			...
			trainer = SimpleRegressTrainer(epochs, optimizer, scheduler, learning_rate, T_max,
			                               batch_size,
			                               num_workers,
			                               pin_memory, pin_memory_device,
			                               persistent_workers,
