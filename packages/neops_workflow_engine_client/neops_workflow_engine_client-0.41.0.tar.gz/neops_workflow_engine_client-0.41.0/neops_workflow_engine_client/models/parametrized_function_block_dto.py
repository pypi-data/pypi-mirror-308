...
class ParametrizedFunctionBlockDto(BaseModel):
    """
    ParametrizedFunctionBlockDto
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "functionBlockId", "runOn", "parameters", "repeatConfig", "delay"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParametrizedFunctionBlockDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParametrizedFunctionBlockDto from a dict"""
        if obj is None:
            return None
