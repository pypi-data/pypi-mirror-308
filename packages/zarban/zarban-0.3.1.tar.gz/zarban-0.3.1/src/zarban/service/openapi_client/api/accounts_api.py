...
class AccountsApi(object):
    ...
    def accounts_address_get(self, address, **kwargs):  # noqa: E501
        """Get account by address  # noqa: E501

        Get account by address  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accounts_address_get(address, async_req=True)
        >>> result = thread.get()
        ...
        return self.accounts_address_get_with_http_info(address, **kwargs)  # noqa: E501

    def accounts_address_get_with_http_info(self, address, **kwargs):  # noqa: E501
        """Get account by address  # noqa: E501

        Get account by address  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accounts_address_get_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method accounts_address_get" % key
                )
        ...
        if self.api_client.client_side_validation and ('address' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `address` when calling `accounts_address_get`")  # noqa: E501
