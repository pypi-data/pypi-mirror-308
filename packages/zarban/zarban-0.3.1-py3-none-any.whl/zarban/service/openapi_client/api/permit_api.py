...
class PermitApi(object):
    ...
    def permit_single_get(self, token, user, **kwargs):  # noqa: E501
        """Get permit for single token  # noqa: E501

        Get permit for single token  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permit_single_get(token, user, async_req=True)
        >>> result = thread.get()
        ...
        return self.permit_single_get_with_http_info(token, user, **kwargs)  # noqa: E501

    def permit_single_get_with_http_info(self, token, user, **kwargs):  # noqa: E501
        """Get permit for single token  # noqa: E501

        Get permit for single token  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permit_single_get_with_http_info(token, user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method permit_single_get" % key
                )
        ...
        if self.api_client.client_side_validation and ('token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `token` when calling `permit_single_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('user' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `user` when calling `permit_single_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'token' in local_var_params and not re.search(r'0x[a-fA-F0-9]{40}', local_var_params['token']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `token` when calling `permit_single_get`, must conform to the pattern `/0x[a-fA-F0-9]{40}/`")  # noqa: E501
        if self.api_client.client_side_validation and 'user' in local_var_params and not re.search(r'0x[a-fA-F0-9]{40}', local_var_params['user']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `user` when calling `permit_single_get`, must conform to the pattern `/0x[a-fA-F0-9]{40}/`")  # noqa: E501
        collection_formats = {}
