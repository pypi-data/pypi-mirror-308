...
class SwapApi(object):
    ...
    def swap_quote_post(self, quote_request, **kwargs):  # noqa: E501
        """Get a quote for a swap  # noqa: E501

        Get a quote for a swap  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.swap_quote_post(quote_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.swap_quote_post_with_http_info(quote_request, **kwargs)  # noqa: E501

    def swap_quote_post_with_http_info(self, quote_request, **kwargs):  # noqa: E501
        """Get a quote for a swap  # noqa: E501

        Get a quote for a swap  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.swap_quote_post_with_http_info(quote_request, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(QuoteResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('quote_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `quote_request` when calling `swap_quote_post`")  # noqa: E501
