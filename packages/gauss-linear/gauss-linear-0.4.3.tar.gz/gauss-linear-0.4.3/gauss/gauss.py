...
from reliable import matrix_to_rref_with_steps
keywords = ['r', 'mult', 'rrsteps', 'eigenvalues', 'diagonalize', 'joe','cross', 'eigenvectors', 'characteristic', 'determinant', 'leastsquares', 'gramschmidt','qr', 'normalize', 'aat','normaleq', 'project', 'length', 'rationalize','qr', 'transpose', 'null', 'result','rr', 'q','av', 'atb', 'nullspace', 'inv', 'ata', 'colspace', 'rowspace', 'rank', 'orthoproject', 'show']
