...
T = TypeVar("T", bound="UpdateTargetBodyVariablesItem")
...
class UpdateTargetBodyVariablesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_target_body_variables_item = cls(
            key=key,
            value=value,
            sensitive=sensitive,
        )

        update_target_body_variables_item.additional_properties = d
        return update_target_body_variables_item
