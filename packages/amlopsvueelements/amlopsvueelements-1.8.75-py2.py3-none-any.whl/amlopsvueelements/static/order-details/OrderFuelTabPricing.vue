      ...
      >
        ...
        <div
          ...
          :style="{
            ...
            background: supplier.color ? `repeating-linear-gradient(45deg,${changeColorAlpha(supplier.color, 0.2)},${changeColorAlpha(supplier.color, 0.2)} 10px,rgb(255, 255, 255) 0,rgb(255, 255, 255) 20px)` : 'rgba(246, 248, 252, 0.5)'
          }"
        >
          <div class="pricing-step-content-col w-1/12">
