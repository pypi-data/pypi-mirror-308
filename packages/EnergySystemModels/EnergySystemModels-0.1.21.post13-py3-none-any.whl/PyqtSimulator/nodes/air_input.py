...
class CalcNode_AirInput(CalcNode):
    ...
    def evalImplementation(self):
        ...
        s_F_kgs = float(self.content.V_flow_edit.text()) * air_humide.func_rho_hum(s_T, s_RH, s_P*10**5)/3600 #kg/s
      #  print("masse vol=",air_humide.func_rho_hum(s_T, s_RH, s_P*10**5))
