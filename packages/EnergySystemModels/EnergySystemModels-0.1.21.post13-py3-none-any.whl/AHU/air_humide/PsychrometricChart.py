...
class Object:
    def __init__(self, figsize=(10, 6)):
        ...
        self.w_max = air_humide.func_w(T_db=self.T_db_max, RH=100)
    ...
    def add_points(self, points):
        ...
        self.enthalpy_values_max=round(int(air_humide.func_h(T_db=self.T_db_min,w=self.w_max))/ 10) * 10
        self.enthalpy_values_min=round(int(air_humide.func_h(T_db=self.T_db_min,w=0)) / 10) * 10
