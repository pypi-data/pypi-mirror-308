...
class Job:
    ...
    @property
    def basic_and_io_accounting_info(self):
        return win32job.QueryInformationJobObject(self._handle, win32job.JobObjectBasicAndIoAccountingInformation)
    @basic_and_io_accounting_info.setter
    def basic_and_io_accounting_info(self, val):
    ...
    def peak_process_memory_used(self):
        return self.extended_limit_info["PeakProcessMemoryUsed"]
        
    @property
    def peak_job_memory_used(self):
        return self.extended_limit_info["PeakJobMemoryUsed"]
    
    @property
    def per_process_user_time_limit(self):
        info = self.basic_limit_info
    ...
    # Basic Accounting Information & IO Accounting Information
    @property
    def total_user_time(self):
        return self.basic_accounting_info["TotalUserTime"]
    @property
    def total_kernel_time(self):
        return self.basic_accounting_info["TotalKernelTime"]
        
    @property
    def this_period_total_user_time(self):
        return self.basic_accounting_info["ThisPeriodTotalUserTime"]
    @property
    def this_period_total_kernel_time(self):
        return self.basic_accounting_info["ThisPeriodTotalKernelTime"]
        
    @property
    def total_page_fault_count(self):
        return self.basic_accounting_info["TotalPageFaultCount"]
        
    @property
    def total_processes(self):
        return self.basic_accounting_info["TotalProcesses"]
    @property
    def active_processes(self):
        return self.basic_accounting_info["ActiveProcesses"]
    @property
    def total_terminated_processes(self):
        return self.basic_accounting_info["TotalTerminatedProcesses"]
    
    @property
    def read_count(self):
        return self.basic_and_io_accounting["IoInfo"]["ReadOperationCount"]
    @property
    def write_count(self):
        return self.basic_and_io_accounting["IoInfo"]["WriteOperationCount"]
    @property
    def other_count(self):
        return self.basic_and_io_accounting["IoInfo"]["OtherOperationCount"]
    
    @property
    def read_transfer_count(self):
        return self.basic_and_io_accounting["IoInfo"]["ReadTransferCount"]
    @property
    def write_transfer_count(self):
        return self.basic_and_io_accounting["IoInfo"]["WriteTransferCount"]
    @property
    def other_transfer_count(self):
        return self.basic_and_io_accounting["IoInfo"]["OtherTransferCount"]