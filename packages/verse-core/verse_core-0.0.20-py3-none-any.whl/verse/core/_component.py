...
class Component:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._unpack_result = kwargs.pop("_unpack_result", False)
        self._handle = None
        self.provider = None
    ...
    def attach(
        ...
        self.attach_component_parameters()
    ...
    def attach_component_parameters(self):
        pass
    ...
    def _run_internal(
        ...
        if "kwargs" in args:
            ...
            unpack = args["kwargs"].pop("_unpack_result", False)
        res = self.run(
