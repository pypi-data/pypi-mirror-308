...
@keyframes fader_msg {{from {{color: {style.bgcolor};}} to {{color: {style.fgcolor}; }} }}
...
@keyframes fader_admin_failed {{from {{color: #ff0000;}} to {{color: {style.fgcolor}; }} }}
@keyframes fader_admin_success {{from {{color: #22ff00;}} to {{color: {style.fgcolor}; }} }}
@keyframes fader_admin_normal {{from {{color: #EEEEEE;}} to {{color: {style.fgcolor}; }} }}
