...
def test_data(
    ...
    if 'numerical_features' in mapping:
        column_mapping.numerical_features = mapping.get('numerical_features')
    if 'categorical_features' in mapping:
        column_mapping.categorical_features = mapping.get('categorical_features')
    if 'datetime' in mapping:
        column_mapping.datetime = mapping.get('datetime')
    if 'id' in mapping:
        column_mapping.id = mapping.get('id')
...
def check_data_drift(
    ...
    if 'prediction' in mapping:
        column_mapping.prediction = mapping.get('prediction')
