...
SGL_GIT_VERSION: str = 'commit: 642a7de / branch: main (local changes)'

SGL_VERSION: str = '0.2.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 2
...
class TypeConformance:
    ...
    @overload
    def __init__(self, type_name: str, interface_name: str, id: int = -1) -> None: ...
