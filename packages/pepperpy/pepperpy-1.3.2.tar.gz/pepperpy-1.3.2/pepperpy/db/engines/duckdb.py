...
class DuckDBEngine(BaseEngine):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to initialize DuckDB: {str(e)}", cause=e)
    ...
    async def execute(self, query: str, params: Optional[Dict[str, Any]] = None) -> QueryResult:
        ...
        try:
            ...
            raise DatabaseError(f"DuckDB query failed: {str(e)}", cause=e)
    ...
    async def execute_many(
        ...
        try:
            ...
            raise DatabaseError(f"DuckDB batch query failed: {str(e)}", cause=e)
