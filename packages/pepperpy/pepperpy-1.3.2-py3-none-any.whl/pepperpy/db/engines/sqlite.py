...
class SQLiteEngine(BaseEngine):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to initialize SQLite: {str(e)}", cause=e)
    ...
    async def execute(self, query: str, params: Optional[Dict[str, Any]] = None) -> QueryResult:
        ...
        try:
            ...
            raise DatabaseError(f"SQLite query failed: {str(e)}", cause=e)
    ...
    async def execute_many(
        ...
        async with self._pool.cursor() as cursor:
            try:
                ...
                await self._pool.rollback()
                raise DatabaseError(f"SQLite batch query failed: {str(e)}", cause=e)
