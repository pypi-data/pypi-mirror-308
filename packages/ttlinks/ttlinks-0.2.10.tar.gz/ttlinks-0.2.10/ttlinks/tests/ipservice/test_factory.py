...
from ttlinks.ipservice.ip_factory import IPv4Factory, IPv4TypeAddrBlocks, IPv6Factory, IPv6TypeAddrBlocks
...
def test_ipv4_host_creation(ipv4_factory):
    ...
    assert str(ipv4_host.ip_addr) == "192.168.1.10"
...
def test_ipv4_subnet_creation(ipv4_factory):
    ...
    assert str(ipv4_subnet.ip_addr) == "192.168.1.0"
...
def test_ipv4_wildcard_creation(ipv4_factory):
    ...
    assert str(ipv4_wildcard.ip_addr) == "192.168.1.0"
...
def test_ipv4_random_host(ipv4_factory):
    ...
    assert ipv4_random_host.ip_addr is not None
...
def test_ipv4_random_subnet(ipv4_factory):
    ...
    assert ipv4_random_subnet.ip_addr is not None
...
def test_ipv6_host_creation(ipv6_factory):
    ...
    assert str(ipv6_host.ip_addr) == "2001:db8::1"
    assert str(ipv6_host.mask) == "ffff:ffff:ffff:ffff::"
...
def test_ipv6_subnet_creation(ipv6_factory):
    ...
    assert str(ipv6_subnet.ip_addr) == "2001:db8::"
    assert str(ipv6_subnet.mask) == "ffff:ffff:ffff:ffff::"
...
def test_ipv6_wildcard_creation(ipv6_factory):
    ...
    assert str(ipv6_wildcard.ip_addr) == "2001:db8::"
    assert str(ipv6_wildcard.mask) == "::ff"
...
def test_ipv6_random_host(ipv6_factory):
    ...
    assert ipv6_random_host.ip_addr is not None
...
def test_ipv6_random_subnet(ipv6_factory):
    ...
    assert ipv6_random_subnet.ip_addr is not None
