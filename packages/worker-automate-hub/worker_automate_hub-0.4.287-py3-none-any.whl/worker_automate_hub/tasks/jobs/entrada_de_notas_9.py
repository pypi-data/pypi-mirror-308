...
async def entrada_de_notas_9(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        partes = re.split(r'[\s-]+', observacoes_nota)
        list_distribuicao_obs = [parte for parte in partes if parte.startswith(filialEmpresaOrigem) and len(parte) > len(filialEmpresaOrigem)]
