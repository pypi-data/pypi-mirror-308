...
async def entrada_de_notas_16(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        # Verifica se a nota NÃO contém apenas isqueiros
        if not emsys.apenas_isqueiros:
            console.print(
            ...
            console.print(
                "Nota contém apenas isqueiros. Checkbox de agrupamento por unidade de medida não será marcado.",
                style="bold blue"
            )
        ...
        try:
            ...
            try:
                ...
                if alterar_nop_result and not alterar_nop_result.sucesso:
