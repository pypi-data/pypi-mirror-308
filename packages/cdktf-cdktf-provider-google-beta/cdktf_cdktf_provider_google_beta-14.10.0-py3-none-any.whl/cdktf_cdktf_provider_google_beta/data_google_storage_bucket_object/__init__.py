...
Refer to the Terraform Registry for docs: [`data_google_storage_bucket_object`](https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object).
'''
...
class DataGoogleStorageBucketObject(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object google_storage_bucket_object}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object google_storage_bucket_object} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param bucket: The name of the containing bucket. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object#bucket DataGoogleStorageBucketObject#bucket}
        ...
        :param name: The name of the object. If you're interpolating the name of this object, see output_name instead. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object#name DataGoogleStorageBucketObject#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataGoogleStorageBucketObjectConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def bucket(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object#bucket DataGoogleStorageBucketObject#bucket}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object#id DataGoogleStorageBucketObject#id}.
    ...
    def name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.0/docs/data-sources/google_storage_bucket_object#name DataGoogleStorageBucketObject#name}
        '''
