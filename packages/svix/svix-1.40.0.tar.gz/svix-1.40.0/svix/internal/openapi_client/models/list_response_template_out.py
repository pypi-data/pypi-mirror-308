...
T = TypeVar("T", bound="ListResponseTemplateOut")
...
class ListResponseTemplateOut:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TemplateOut.from_dict(data_item_data)
        ...
        list_response_template_out = cls(
            data=data,
            done=done,
            iterator=iterator,
        ...
        list_response_template_out.additional_properties = d
        return list_response_template_out
