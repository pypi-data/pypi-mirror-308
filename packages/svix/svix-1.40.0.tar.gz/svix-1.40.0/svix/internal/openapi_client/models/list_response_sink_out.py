...
class ListResponseSinkOut:
    """
    Attributes:
        data (List[Union['SinkOutType0', 'SinkOutType1', 'SinkOutType2', 'SinkOutType3']]):
        done (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(data: object) -> Union["SinkOutType0", "SinkOutType1", "SinkOutType2", "SinkOutType3"]:
                try:
