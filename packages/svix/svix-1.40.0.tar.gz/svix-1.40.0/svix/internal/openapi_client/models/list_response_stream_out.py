...
T = TypeVar("T", bound="ListResponseStreamOut")
...
class ListResponseStreamOut:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = StreamOut.from_dict(data_item_data)
        ...
        list_response_stream_out.additional_properties = d
        return list_response_stream_out
