...
from tests.conftest import STAC_VERSION, createSequence, uploadPicture, waitForSequence, create_test_app
    ...
    with (
        ...
        def process():
            with app.app_context():
                w = runner_pictures.PictureProcessor(app=app, stop=False)
                w.process_jobs()
