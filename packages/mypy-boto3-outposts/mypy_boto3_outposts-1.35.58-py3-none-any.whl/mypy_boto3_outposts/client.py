...
class OutpostsClient(BaseClient):
    ...
    def list_asset_instances(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/outposts.html#Outposts.Client.list_asset_instances)
    ...
    def list_blocking_instances_for_capacity_task(
        ...
        account that initiated the capacity
        task.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/outposts.html#Outposts.Client.list_blocking_instances_for_capacity_task)
