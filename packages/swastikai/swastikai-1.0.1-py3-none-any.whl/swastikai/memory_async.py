...
from .models.memory_models import createPersonalMemory
from .models.memory_models import retrievePersonalMemory

class personal_memory:
    def __init__(self, api_key: str):
        self.base_url = "https://api.swastikai.com/api/memory/v1/"
