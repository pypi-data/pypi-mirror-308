...
def main(argv: None | list[str] | Namespace = None, /):
    ...
    ServedbFuseOperations(
        args.dbfile, 
        Path(args.cookies_path) if args.cookies_path else None, 
        predicate=predicate, 
...
parser.add_argument("-cp", "--cookies-path", default="", help="cookies 文件保存路径，如果不指定此文件，则下载文件使用 -o/--strm-origin 所指定的服务")
