...
__all__ = ['DatasetNotFoundError', 'Dataset_GetError', 'Dataset_CRUDError', 'QueryRequestError', 'query_dataset_public',
           'query_dataset_private', 'get_dataset_by_id', 'get_schema', 'alter_schema', 'set_dataset_tags',
           'UploadDataError', 'upload_dataset_stage_1', 'upload_dataset_stage_2_file', 'upload_dataset_stage_2_df',
           'upload_dataset_stage_3', 'index_dataset', 'index_status', 'generate_list_partitions_body',
           'list_partitions', 'generate_create_dataset_body', 'create', 'delete_partition_stage_1',
           'delete_partition_stage_2', 'delete', 'ShareDataset_AccessLevelEnum', 'generate_share_dataset_payload',
           'ShareDataset_Error', 'share_dataset', 'get_permissions']
...
class QueryRequestError(de.DomoError):
    def __init__(
        ...
        super().__init__(message, res=res, entity_id=dataset_id)
