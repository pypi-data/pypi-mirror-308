...
# %% ../../nbs/classes/50_DomoAccount_Default.ipynb 33
@patch_to(DomoAccount_Default)
...
# %% ../../nbs/classes/50_DomoAccount_Default.ipynb 36
@patch_to(DomoAccount_Default)
async def _share_v2(
    self: DomoAccount_Default,
    auth: dmda.DomoAuth = None,
...
# %% ../../nbs/classes/50_DomoAccount_Default.ipynb 39
@patch_to(DomoAccount_Default)
async def _share_v1(
    self: DomoAccount_Default,
    auth: dmda.DomoAuth = None,
...
# %% ../../nbs/classes/50_DomoAccount_Default.ipynb 42
@patch_to(DomoAccount_Default)
async def share(
    self: DomoAccount_Default,
    user_id=None,
