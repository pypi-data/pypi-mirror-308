...
__all__ = ['DomoJupyterWorkspace_Content', 'DomoJupyterDataSource', 'DJW_PermissionToAccountDenied',
           ...
           'DomoJupyterWorkspace', 'get_jupyter_workspaces', 'search_workspace_by_name', 'DomoJupyter_InvalidWorkspace']
...
async def add_account(
    ...
    dja = dja_account or DomoJupyterAccount(
