...
from ...types.options_flows import total_volume_retrieve_params
from ...types.options_flows.total_volume_retrieve_response import TotalVolumeRetrieveResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    total_volume_retrieve_params.TotalVolumeRetrieveParams,
                ),
            ),
            cast_to=TotalVolumeRetrieveResponse,
        )
