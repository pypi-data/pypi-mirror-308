...
class TestCorrelations:
    ...
    def test_method_list(self, client: Unusualwhales) -> None:
        correlation = client.correlations.list(
            symbols="symbols",
        )
        assert_matches_type(CorrelationListResponse, correlation, path=["response"])
    ...
    def test_raw_response_list(self, client: Unusualwhales) -> None:
        response = client.correlations.with_raw_response.list(
            symbols="symbols",
        )
    ...
    def test_streaming_response_list(self, client: Unusualwhales) -> None:
        with client.correlations.with_streaming_response.list(
            symbols="symbols",
        ) as response:
...
class TestAsyncCorrelations:
    ...
    async def test_method_list(self, async_client: AsyncUnusualwhales) -> None:
        correlation = await async_client.correlations.list(
            symbols="symbols",
        )
        assert_matches_type(CorrelationListResponse, correlation, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncUnusualwhales) -> None:
        response = await async_client.correlations.with_raw_response.list(
            symbols="symbols",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnusualwhales) -> None:
        async with async_client.correlations.with_streaming_response.list(
            symbols="symbols",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
