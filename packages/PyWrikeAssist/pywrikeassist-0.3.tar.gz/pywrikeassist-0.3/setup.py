...
setup(
    ...
    url='https://github.com/Ambareen-Jawaheer/PyWrikeAssist',
    download_url='https://github.com/Ambareen-Jawaheer/PyWrikeAssist/archive/refs/tags/v%s.tar.gz' % CURRENT_VERSION,
