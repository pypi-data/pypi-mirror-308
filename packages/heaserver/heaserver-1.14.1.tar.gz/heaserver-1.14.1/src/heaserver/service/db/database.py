...
DatabaseClientTypeVar = TypeVar('DatabaseClientTypeVar', bound=DatabaseClient)

class DatabaseContextManager(Generic[DatabaseClientTypeVar, CredentialTypeVar], AbstractAsyncContextManager[DatabaseClientTypeVar], ABC):
    """
    ...
    async def __aenter__(self) -> DatabaseClientTypeVar:
    ...
    @abstractmethod
    async def connection(self) -> DatabaseClientTypeVar:
