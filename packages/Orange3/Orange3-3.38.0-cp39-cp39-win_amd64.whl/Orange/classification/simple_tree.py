...
class SimpleTreeModel(Model):
    def __init__(self, learner, data):
        ...
        if len(data.domain.class_vars) != 1:
            ...
            raise ValueError(_tr.m[63, "Number of classes should be 1: {}"].format(n_cls))
        ...
        if data.domain.has_discrete_class:
            ...
            raise ValueError((_tr.m[64, "Only Continuous and Discrete "] + _tr.m[65, "variables are supported"]))
        ...
        for attr in data.domain.attributes:
            if attr.is_discrete:
                ...
                raise ValueError((_tr.m[66, "Only Continuous and Discrete "] + _tr.m[67, "variables are supported"]))
