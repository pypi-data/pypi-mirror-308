...
class SummaryService:
    ...
    async def get_pipeline_summary(self, pipeline_id: UUID) -> dict:
    ...
    async def get_pipeline_name_ids(
        self, limit: int = 10, offset: int = 0
    ) -> dict[str, list[UUID]]:
        pipelines = await self.pipeline_repo.get_all(limit=limit, offset=offset)
...
if __name__ == "__main__":
    ...
    async def example():
        ...
        pipeline_name_ids = await service.get_pipeline_name_ids()
