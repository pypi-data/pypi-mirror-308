...
TELEGRAM_BOT_TOKEN = dotenv_settings['DEFAULT_BOT_TOKEN'] if 'DEFAUL_BOT_TOKEN' in dotenv_settings else None
...
bot_user_admin = dotenv_settings['ADMIN_ID_LIST'] if 'ADMIN_ID_LIST' in dotenv_settings else None
if bot_user_admin:
