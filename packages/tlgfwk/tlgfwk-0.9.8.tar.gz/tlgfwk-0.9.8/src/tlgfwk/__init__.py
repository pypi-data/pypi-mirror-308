...
# Add src folder to current python sys path
# src_folder = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), '..')
# sys.path.append(src_folder)
# import translations   
# import tlgfwk.translations as translations
# AttributeError: module 'tlgfwk' has no attribute '__path__'
try:
