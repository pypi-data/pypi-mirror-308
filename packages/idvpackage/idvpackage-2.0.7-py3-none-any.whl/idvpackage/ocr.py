...
class IdentityVerification:
    ...
    def extract_document_info(self, image, side, document_type, country, nationality):
        ...
        if document_type == 'passport' and (side == 'first' or side == 'page_1' or side == ''):
        ...
        if document_type == 'passport' and (side == 'last' or side == 'page_2'):
    ...
    def extract_back_id_info(self, back_id, country, nationality):
        ...
        if country == 'LBN':
                ...
                try:
                    ...
                    st = time.time()
                    back_extraction_result = lebanon_back_id_extraction(text, country)
