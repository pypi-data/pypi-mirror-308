        ...
        if country in ['IRQ', 'LBN', 'QAT', 'SDN', 'SYR', 'JOR', 'PSE']:
            if country == 'IRQ':
                ...
                if data.get('doc_type') == 'passport':
                    ...
                    keys = ['name_en', 'name', 'first_name', 'fathers_name', 'last_name', 'first_name_en', 'fathers_name_en', 'last_name_en', 'issuing_authority', 'nationality', 'gender', 'issuing_country', 'gender_ar', 'mrz', 'place_of_birth', 'issuing_authority_en', 'place_of_birth_en', "issue_date", "id_number", "card_number"]
            ...
            if country == 'SDN':
                ...
                if data.get('doc_type') == 'passport':
                    keys = ['full_name_generic', 'first_name', 'middle_name', 'last_name', 'name_ar', 'gender', 'place_of_birth', 'place_of_issue', 'passport_number_mrz', 'national_number', 'issue_date', 'mrz', 'nationality']
                else:
                    # keys = ['father_name', 'last_name', 'name_en', 'first_name_en', 'fathers_name_en', 'last_name_en', 'gender_ar', 'place_of_birth', 'issue_date', 'issue_date_ar', 'card_number_ar', 'id_number_ar']
