# CDKTF prebuilt bindings for newrelic/newrelic provider version 3.52.1

This repo builds and publishes the [Terraform newrelic provider](https://registry.terraform.io/providers/newrelic/newrelic/3.52.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform newrelic provider](https://registry.terraform.io/providers/newrelic/newrelic/3.52.1)
