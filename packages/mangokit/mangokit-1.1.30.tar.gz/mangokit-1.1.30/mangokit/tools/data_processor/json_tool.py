...
from mangokit.exceptions.error_msg import ERROR_MSG_0003, ERROR_MSG_0004
from mangokit.exceptions.exceptions import JsonPathError
...
class JsonTool:
    ...
    def loads(cls, json_list_str: str) -> list | dict:
        ...
        try:
            ...
            try:
                ...
                raise JsonPathError(*ERROR_MSG_0004)
    ...
    def get_json_path_value(cls, obj: dict, expr, index=0):
        ...
        try:
            ...
            raise JsonPathError(*ERROR_MSG_0003, value=(expr,))
