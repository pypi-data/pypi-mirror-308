...
class SystemSettings(BaseSettings):  # type: ignore
    ...
    def set_model_registry(self, model_registry: RunwayModelRegistry) -> None:
        if isinstance(model_registry.data, MLFlowModelRegistryData):
            ...
            os.environ["MLFLOW_S3_IGNORE_TLS"] = "false" if model_registry.data.storage_cert_check else "true"
            ...
            os.environ["MLFLOW_TRACKING_INSECURE_TLS"] = "false" if model_registry.data.cert_check else "true"
