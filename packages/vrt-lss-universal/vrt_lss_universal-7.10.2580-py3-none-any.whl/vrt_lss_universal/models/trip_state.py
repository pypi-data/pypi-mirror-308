...
class TripState(BaseModel):
    ...
    distance: Optional[Annotated[int, Field(le=4000000000, strict=True, ge=0)]] = Field(default=0, description="Total distance in meters.")
