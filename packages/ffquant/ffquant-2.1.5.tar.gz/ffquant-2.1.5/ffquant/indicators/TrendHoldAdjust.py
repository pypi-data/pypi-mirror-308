...
class TrendHoldAdjust(bt.Indicator):
    ...
    def signal_calcuate(self):
        ...
        if self.p.debug:
            stdout_log(f'{self.__class__.__name__}, cur_bar_time_str: {cur_bar_time_str}, support_tp: {support_tp}, support_active_buy_sell: {support_active_buy_sell}, support_trend: {support_trend}')
        ...
        # when target value is not changed
        if now_trendhold == self.trendhold_last:
            ...
            # when target value is changed
            # support_tp and support_active_buy_sell both suggest BULLISH
            if support_tp > 0 and support_active_buy_sell > 0 and now_trendhold == TrendHoldAdjust.BEARISH:
                signal_dict['trendhold'] = TrendHoldAdjust.BULLISH
            # support_tp and support_active_buy_sell both suggest BEARISH
            elif support_tp < 0 and support_active_buy_sell < 0 and now_trendhold == TrendHoldAdjust.BULLISH:
                signal_dict['trendhold'] = TrendHoldAdjust.BEARISH
            # TurningPoint and ActiveBuySell Conflict Case 1
            elif support_tp > 0 and support_active_buy_sell < 0 and now_trendhold == TrendHoldAdjust.BULLISH:
                if support_trend > 0:
                    signal_dict['trendhold'] = TrendHoldAdjust.BULLISH
                else:
                    signal_dict['trendhold'] = TrendHoldAdjust.BEARISH
            # TurningPoint and ActiveBuySell Conflict Case 2
            elif support_tp > 0 and support_active_buy_sell < 0 and now_trendhold == TrendHoldAdjust.BEARISH:
                if support_trend > 0:
                    signal_dict['trendhold'] = TrendHoldAdjust.BULLISH
                else:
                    signal_dict['trendhold'] = TrendHoldAdjust.BEARISH
            # TurningPoint and ActiveBuySell Conflict Case 3
            elif support_tp < 0 and support_active_buy_sell > 0 and now_trendhold == TrendHoldAdjust.BULLISH:
                if support_trend > 0:
                    signal_dict['trendhold'] = TrendHoldAdjust.BULLISH
                else:
                    signal_dict['trendhold'] = TrendHoldAdjust.BEARISH
            # TurningPoint and ActiveBuySell Conflict Case 4
            elif support_tp < 0 and support_active_buy_sell > 0 and now_trendhold == TrendHoldAdjust.BEARISH:
                if support_trend > 0:
                    signal_dict['trendhold'] = TrendHoldAdjust.BULLISH
                else:
        ...
        if self.trendhold_last == TrendHoldAdjust.BEARISH and signal_dict['trendhold'] == TrendHoldAdjust.BULLISH:
            ...
            if self.tha_inherited and signal_dict['trendhold'] == TrendHoldAdjust.BULLISH and self.crossover[0] == -1:
                if self.p.debug:
                ...
                self.tha_inherited = False
            elif self.tha_inherited and signal_dict['trendhold'] == TrendHoldAdjust.BEARISH and self.crossover[0] == 1:
                if self.p.debug:
        ...
        if signal_dict['trendhold'] != TrendHoldAdjust.NA and signal_dict['trendhold'] == -1 * self.trend_warrant[0]:
            stdout_log(f"{self.__class__.__name__}, cur_bar_time_str: {cur_bar_time_str}, forbid TrendHoldAdjust to be the very opposite of TrendWarrant, set to TrendHold. New trendhold adjust: {signal_dict['trendhold']}, trend_warrant: {self.trend_warrant[0]}, trendhold: {self.trendhold[0]}")
            signal_dict['trendhold'] = self.trendhold[0]
