...
# The following three functions are weighting function to be chosen manually within the compute_light_field_psf function.
...
def compute_light_field_psf(intensity, x, y, z,
    ...
    for sz in z_subsamples:
        ...
        # TODO: clean up conditional statement below, adjusted to remove cache
        if z+kz*sz not in {}:
...
def compute_psf_imap(in_tuple):
    ...
    psf = compute_light_field_psf(intensity, x, y, z, z_spacing, num_lenslets_in_aperture,
                                  supersample_factor, lenslet_array, scrub)
