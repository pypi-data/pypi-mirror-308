...
SELECT * FROM `project_id.dataset_id.your_table_name` ORDER BY your_date_column DESC LIMIT 100;
    ...
    def dbiu(self, db_preset_name, db_name, table_name, unique_columns, insert_columns=None, print_query=False):
        ...
        with mysql.connector.connect(host=host, user=username, password=password, database=db_name) as conn:
            ...
            try:
                ...
                # Debug: Print columns and head of DataFrames
                # print("Columns in self.df:", self.df.columns)
                # print("Columns in existing_df:", existing_df.columns)
                # print("Head of self.df:\n", self.df.head())
                # print("Head of existing_df:\n", existing_df.head())
                ...
                # Debug: Print unique new data to insert
                # print("Unique new data to insert:\n", unique_new_data_df)
    ...
    def dbiusp(self, db_abs_path, table_name, unique_columns, insert_columns=None, print_query=False):
        """Database insert or update to sqlite3 db path."""
        ...
        # Ensure unique columns are included in insert columns for merge operation
        for col in unique_columns:
            if col not in insert_columns:
                insert_columns.append(col)
        
        print("Insert columns after adding unique columns:", insert_columns)
        ...
        print("DataFrame after processing columns:", self.df.head())
        ...
        try:
            ...
            # Convert to DataFrame
            existing_df = pd.DataFrame(existing_data, columns=unique_columns)
            print("Existing DataFrame:", existing_df.head())
            ...
            print("Unique new data to insert:", unique_new_data_df.head())
