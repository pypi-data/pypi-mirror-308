...
class MemfaultChunk:
    ...
    def user_agent(self):
        ...
        return "MemfaultCLI/" + version + f" ({platform.platform(terse=True)};)"
    ...
    def post(self, chunk: bytes):
        ...
        request_args["headers"]["User-Agent"] = self.user_agent
    ...
    def do_batch_post(self, files: List):
        ...
        # Pick up default headers and merge with Memfault Auth headers + CLI User-Agent
