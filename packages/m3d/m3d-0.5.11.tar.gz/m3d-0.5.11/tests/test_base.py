...
def test_quaternion():
    ...
    assert o.similar(o2, CONVERTION_ERROR)
    o = m3d.Orientation()
    o2 = m3d.Orientation.from_quaternion(0.0, 0.0, 0.0, 0.0)
    assert o.similar(o2, CONVERTION_ERROR)
...
def test_quaternion_class():
    ...
    np.testing.assert_array_equal(np.array(q), q_m3d.data)
...
def test_valid_and_invalid_rotation_matrices():
    ...
    for i in range(1000):
        ...
        valid_orient = m3d.Orientation.from_rotation_vector(np.random.rand(3))
...
def test_transform_from_corresponding_points():
    p1 = np.array([
        [1., 0., 0.],
        [0., 1., 0.],
        [0., 0., 1.],
    ...
    t = m3d.Transform.from_pose_vector(0., 1., 2., 0.1, 0.2, 0.3)
    p2 = t * p1
