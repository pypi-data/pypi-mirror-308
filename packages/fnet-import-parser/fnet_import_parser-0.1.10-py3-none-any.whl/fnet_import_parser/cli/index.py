from fnet_import_parser.src.index import default  # Import the default function from the src.index module
...
def main():
    ...
    parser = argparse.ArgumentParser(description="fnet_import_parser")
