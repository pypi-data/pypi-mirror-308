...
def format_csv(
    input_path: str,
    output_path: str,
    key_version_1: str = "first_report_cue_id",
    key_version_2: str = "other_report_cue_id"
):
    ...
    with open(input_path) as f:
        ...
        for row in reader:
            ...
            curr_id = input_val("yle_numerical_id")
            try:
                curr_other_report_id = input_val("other_report_id")
            except KeyError:
                curr_other_report_id = input_val("production_last_edited_at")

            row_top_border = False
            if main_color.eval_change(curr_id):
            ...
            if other_color.eval_change(curr_other_report_id):
            ...
            change_status = get_change_status(input_val(key_version_1), input_val(key_version_2))
...
if __name__ == "__main__":
    ...
    if len(args) != 4:
        print("""
            Usage:
                python3 format_report.py <input_path> <output_path> <key_version_1> <key_version_2>
