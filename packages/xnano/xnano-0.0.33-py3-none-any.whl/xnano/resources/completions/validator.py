    ...
    if loader:
        with console.progress(
            ...
            for input_text in inputs:
                ...
                try:
                    accuracy_result = await acompletion(
                        messages=[
                            {"role": "system", "content": system_message},
                            {"role": "user", "content": f"Input: {input_text}"},
                        ],
                ...
                if context:
                    ...
                    try:
                        accuracy_score_result = await acompletion(
                            messages=[
                                {"role": "system", "content": system_message},
                                {
                                    "role": "user",
                ...
                try:
                    explanation_result = await acompletion(
                        messages=[
                            {"role": "system", "content": system_message},
                            {"role": "user", "content": f"Input: {input_text}"},
                        ],
        ...
        for input_text in inputs:
            ...
            if guardrails:
                ...
                try:
                    guardrails_result = await acompletion(
                        messages=[
                            {"role": "system", "content": system_message},
                            {
                                "role": "user",
...
if __name__ == "__main__":
    ...
    print(validate("the capital of france is paris", loader=True))

    print(validate("the capital of france is london", loader=False))
