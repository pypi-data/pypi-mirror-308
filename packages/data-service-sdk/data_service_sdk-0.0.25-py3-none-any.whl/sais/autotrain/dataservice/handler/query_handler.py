...
from sais.autotrain.dataservice.model.data_model import Task, StatusEnum, QueryNWPRequest, QueryNWPBizRequest, QueryStationRequest, \
    QueryObservationRequest, BaseRsp, BizResponse
...
class QueryNWPHandler(object):
    ...
    def execute_query_mongo(self, query_params: Union[QueryNWPRequest,QueryNWPBizRequest]):
        if isinstance(query_params, QueryNWPRequest):
            ...
            return query_nwp_mongo_biz(query_params.src, query_params.start_time, query_params.ndays, query_params.hours,
                                   query_params.coords,
                                   query_params.vars,
                                   query_params.workers)
        else:
