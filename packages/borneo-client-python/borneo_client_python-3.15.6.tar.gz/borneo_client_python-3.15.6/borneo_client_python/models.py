...
class ConnectionStatusGroup(StrEnum):
...
@dataclass(kw_only=True)
class ListConnectionFilter:

    group: str | None = None


@dataclass(kw_only=True)
class ListConnectionStatusInput:

    filter: ListConnectionFilter | None = None


class ConnectionStatusValue(StrEnum):
    SUCCESS = "success"
    FAILURE = "failure"


@dataclass(kw_only=True)
class ConnectionAvailabilityEntry:
...
class ConnectionStatusResult:
    """
    :param group: Name of the group. eg. integration, connector, public_cloud,
    service, data_plane
    :param subgroup: Name of the sub group. eg. notification, catalog
    :param connection_type: Type of connection. eg. mysql/S3, aws/gcp/azure
    :param connection_id: Unique identifier of the connection eg. jira/slack/acryl ,
    vcpu
    :param connection_name: Name of the connection. eg. name of connector or name of
    the cloud account.
    :param last_status: Last know connection status.
    :param availability: List of availabilities for each time interval.
    """
    ...
    last_status: ConnectionLastStatus | None = None
    availability: list[ConnectionAvailabilityEntry] | None = None


@dataclass(kw_only=True)
class ListConnectionStatusOutput:

    results: list[ConnectionStatusResult] | None = None
...
class DescribeInspectionResultOutput:
    ...
    (status
    `processed`) or not (status `failed`).
...
@dataclass(kw_only=True)
class InspectionAggregateResultFilter:
...
@dataclass(kw_only=True)
class ListInspectionAggregateResultsInput:
    """
    ...
    filter: InspectionAggregateResultFilter | None = None
    next_token: str | None = None
    page_size: int | None = None
    sort: SortRecords | None = None
...
@dataclass(kw_only=True)
class InspectionAggregateResult:
    """
    :param scan_id: Unique identifier for the scan
    :param latest_updated_at: Timestamp when the inspection result was last updated
    :param resource_id: Identifier for the resource
    :param resource: The resource object
    :param snapshots: A list of snapshots associated with the inspection result
    :param statuses: A list of statuses related to the inspection result
    """
    ...
    snapshots: list[dict[str, InfotypeSnapshot]] | None = None
    statuses: list[str] | None = None
    all_sample_tokens: list[dict[str, list[SampleTokens]]] | None = None
    confidence_snapshots: list[dict[str, ConfidenceSnapshot]] | None = None
    scan_iteration_ids: list[str] | None = None


@dataclass(kw_only=True)
class ListInspectionAggregateResultsOutput:
    """
    ...
    inspection_results: list[InspectionAggregateResult] | None = None
    total: int | None = None
    next_token: str | None = None
    sort: SortRecords | None = None
...
class SeverityLevel(StrEnum):
    """Issue & data classification severity"""
...
class DescribeIssueOutput:
    ...
    :param severity: Issue & data classification severity
...
class CreateProcessingActivityInput:
    ...
    :param company_role: Role of the company for a processing activity
...
class ProcessingActivityRecipientMember:
    ...
    sub_processor_id: str | None = None
...
@dataclass
class TagResourceUnionFilter:

    value: TagResourcesFilter


@dataclass
class TagResourceUnionResourceIds:

    value: list[str]


@dataclass
class TagResourceUnionUnknown:
    """Represents an unknown variant.
...
TagResourceUnion = Union[
    TagResourceUnionFilter, TagResourceUnionResourceIds, TagResourceUnionUnknown
]
...
class UntagResourcesInput:
    ...
    tag_value: str | None = None
    tag_resources: TagResourceUnion | None = None
