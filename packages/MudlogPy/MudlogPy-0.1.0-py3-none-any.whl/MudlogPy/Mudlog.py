...
def header_mudlog(df_well_headers,utiliy_path):
    try:
    ...
    textinfo = [well,LOC,STATE,CTRY,API,"",SPD,BMC,BMC,GE,LFROM + "   To   " + LITO ,FORM,DRILLFLUIDS]
    j=0.8
    ...
    fig8.savefig("ch.pdf",format="pdf",bbox_inches='tight',pad_inches=0)
    return fig8
