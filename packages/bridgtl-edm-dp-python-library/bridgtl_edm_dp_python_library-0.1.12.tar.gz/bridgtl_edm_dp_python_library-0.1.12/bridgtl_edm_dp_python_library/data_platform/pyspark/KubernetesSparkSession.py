...
from bridgtl_edm_dp_python_library.data_platform.pyspark.utility import copy_file_to_spark
...
class KubernetesSparkSession:
    def __init__(
        ...
        self.driver_google_service_account_path = google_service_account_path
        self.executor_google_service_account_path = "./gcloud/application_default_credentials.json"
    ...
    def _initialize_default_config(self):
        ...
        if self.driver_google_service_account_path:
            self.config["spark.hadoop.google.cloud.auth.service.account.enable"] = "true"
            self.config["spark.hadoop.google.cloud.auth.service.account.json.keyfile"] = self.executor_google_service_account_path
            ...
            # Extra Java options for GCP authentication
            self.config["spark.driver.extraJavaOptions"] = f"-DGOOGLE_APPLICATION_CREDENTIALS={self.driver_google_service_account_path}"
            self.config["spark.executor.extraJavaOptions"] = f"-DGOOGLE_APPLICATION_CREDENTIALS={self.executor_google_service_account_path}"
    ...
    def create(self):
        ...
        copy_file_to_spark(session, self.driver_google_service_account_path)
