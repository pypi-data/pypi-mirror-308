...
# Modèle plus complexe avec N couches de neurones
...
neur.deep_neural_network(X_train_reshape, y_train, hidden_layers = (128, 64, 16), learning_rate = 0.05, n_iter = 1000)
