...
# Modèle plus complexe avec 2 couches de neurones

# Importation de fichier hdf5
import h5py
# Biblio neurones /
import lib_neurones_2couches as neur
...
parametres = neur.reseau_2couches(X_train_reshape, y_train, n1 = 64, learning_rate = 0.05, n_iter = 1000, pas_iter = 10)
