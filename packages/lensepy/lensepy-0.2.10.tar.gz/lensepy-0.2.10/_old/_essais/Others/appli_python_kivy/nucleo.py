...
class NucleoBoard():
    ...
    def connectToBoard(self):
        self.nucleo_connected = True;
        print("Se connecter à Nucleo USB")

    def isConnected(self):
        return self.nucleo_connected
        
    def __init__(self):
        self.nucleo_connected = False
            ...
            if (serialSelected.inWaiting() > 0):
                ...
                if(dataReceived == bytes('[','utf-8')):
                    ...
                    for i_verif in range(i_rec):
                        ...
                        pdix = pdix * 10
                    i_rec = 0
                    data_acq.append(int(num_rec))
                else:
                    tab_data[i_rec] = int(dataReceived)
                    i_rec += 1
        serialSelected.close()
        self.serial_connected = 0
        print('Erreur 1 = ' + str(nb_error1))
        print('Erreur 2 = ' + str(nb_error2))
        print(data_acq)
        return data_acq
