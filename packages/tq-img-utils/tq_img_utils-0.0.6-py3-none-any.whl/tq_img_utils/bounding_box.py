...
class BoundingBox:
    ...
    def __init__(self, x: int, y: int, width: int, height: int, constraint: Tuple[int, int] = None,
                 constrain_warning: bool = False):
        """
    ...
    def get_extend_bounds(self, margin: int, constraint: Tuple[int, int] = None) -> 'BoundingBox':
        """
        extend bounding(add margin), return new bounding box
