...
def create_databus(name, replicas, observability):
    data = {"name": name, "replicas": replicas, "observability": observability}
...
def get_client_config(name, client_name):
    response = requests.get(
...
def main():
    ...
    if args.action == "list":
        ...
        create_databus(args.name, args.replicas, args.observability)
        ...
        if args.create:
            ...
            get_client_config(args.name, args.client_name)
        elif args.delete:
