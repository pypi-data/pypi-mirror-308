...
def get_originator():
    ...
    # Combine them
    originator = f"{filename} - {function_name}"
    
    return originator

def send_email(email_type="info", email_message="Message", originator="Rikpy", attachment=None, email_recipient=None):
...
def send_email_with_credentials(smtp_server, smtp_port,smtp_user, smtp_pass, email_recipient, email_subject = "Subject", email_message="Message", email_html_message="", originator="Rikpy"):
