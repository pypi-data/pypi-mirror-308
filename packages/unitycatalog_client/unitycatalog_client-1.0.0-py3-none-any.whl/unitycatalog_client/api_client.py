...
import unitycatalog_client.models
from unitycatalog_client import rest
from unitycatalog_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unitycatalog_client.models, klass)
