...
class PragyanClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyPandey.functions.FastTelethon import upload_file
        from pyPandey.functions.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyPandey.functions.FastTelethon import download_file
        from pyPandey.functions.helper import progress
