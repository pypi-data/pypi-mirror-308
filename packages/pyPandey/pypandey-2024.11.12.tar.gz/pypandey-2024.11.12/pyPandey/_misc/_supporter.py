...
#
#   Pragyan Don't Need This Stuffs
#
...
from pyPandey._misc._decorators import compile_pattern, Pragyan_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Pragyan")
