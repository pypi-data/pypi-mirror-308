...
def create_packages(
    dependencies: list[LockFileDependency], reader_location: Location
) -> list[Package]:
...
def create_java_archive(
    dependency: LockFileDependency, name: str, version: str
) -> JavaArchive:
    return JavaArchive(
...
def create_package(
    name: str, version: str, location: Location, archive: JavaArchive
) -> Package:
    return Package(
        name=name,
        version=version,
