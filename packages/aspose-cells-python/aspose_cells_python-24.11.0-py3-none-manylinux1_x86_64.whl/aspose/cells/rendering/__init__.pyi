...
class SheetRender:
    ...
    @overload
    def to_image(self, page_index : int, stream : io.RawIOBase) -> None:
    ...
    @overload
    def to_tiff(self, stream : io.RawIOBase) -> None:
...
class WorkbookRender:
    ...
    @overload
    def to_image(self, stream : io.RawIOBase) -> None:
