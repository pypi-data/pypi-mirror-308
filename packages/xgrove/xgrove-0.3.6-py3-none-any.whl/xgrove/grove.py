...
class grove():
    ...
    def calculateGrove(self):
        ...
        # predictions_gen wird einmal für alle Bäume berechnet
        ...
        for nt in self.ntrees:
            ...
            # Resete predictions für jeden neuen Wert von nt
            ...
            df_small = self.consolidate_rules(df_small)
            print(f"df_small dropped: {df_small}")
