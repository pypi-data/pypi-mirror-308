...
##############################################################################
#HemoPI2.0 is developed for predicting hemolytic activity of peptides      #
# from their primary sequence. It is developed by Prof G. P. S.       #
#Raghava's group. Please cite : HemoPI2.0                                  #
# ############################################################################
import argparse
import warnings
import os
...
def ML_run(file1, out, threshold):
    ...
    clf = pickle.load(open(nf_path + '/../Model/hemopi2_ml_clf.sav', 'rb'))  # Load the pre-trained model
...
def main():
    ...
    if Job == 1:
        ...
        if Model == 1:
            ...
            os.system(f'python3 {nf_path}/../Model/composition_calculate.py {output_len_file} {wd} {wd}/out2')
            ...
            motifs_p_1 = nf_path + '/../motif/pos_motif_1.txt'
            motifs_n_1 = nf_path + '/../motif/neg_motif_1.txt'
            motifs_p_2 = nf_path + '/../motif/pos_motif_2.txt'
            motifs_n_2 = nf_path + '/../motif/neg_motif_2.txt'
    ...
    if Job == 3:
        ...
        if Model == 1:  
            ...
            os.system(f'python3 {nf_path}/../Model/composition_calculate.py {output_len_file} {wd} {wd}/out2')
            os.system(f'python3 {nf_path}/../Model/composition_calculate.py {wd}/out_len_mut {wd} {wd}/out3')
    ...
    if Job == 4:
        ...
        if Model == 1:  
            ...
            os.system(f'python3 {nf_path}/../Model/composition_calculate.py {wd}/mut_seq {wd} {wd}/out2')
            mlres = ML_run(f'{wd}/out2', f'{wd}/out22', threshold)
    ...
    if Job == 5:
        ...
        df1, output_len_file = lenchk(dfseq, wd)
        merci = nf_path + '/../merci/MERCI_motif_locator.pl'
        motifs_p = nf_path + '/../motif/all_pos.txt'
        motifs_n = nf_path + '/../motif/all_neg.txt'
