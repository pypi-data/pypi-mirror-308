...
from src.template_manager import DirectoryNavigator
...
@patch('src.artefact_lister.FileClassifier')
@patch('src.artefact_lister.DirectoryNavigator')
...
@patch('src.artefact_lister.FileClassifier')
@patch('src.artefact_lister.ArtefactReader')
