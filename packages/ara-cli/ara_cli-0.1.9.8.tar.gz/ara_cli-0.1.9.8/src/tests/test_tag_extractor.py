...
def test_extract_tags_no_navigation(mock_file_system, mock_navigator, mock_file_classifier):
    ...
    with patch('src.template_manager.DirectoryNavigator', return_value=mock_navigator), \
         patch('src.file_classifier.FileClassifier', return_value=mock_file_classifier):
