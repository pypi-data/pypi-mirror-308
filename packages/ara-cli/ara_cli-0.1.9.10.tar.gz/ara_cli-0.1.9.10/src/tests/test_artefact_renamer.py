...
@patch("src.artefact_renamer.os.path.exists")
...
@patch("src.artefact_renamer.os.rename")
@patch("src.artefact_renamer.os.path.exists", side_effect=[True, True, False, False, True])
...
@patch("src.artefact_renamer.os.path.exists", side_effect=[True, True, True, False])
...
@patch("src.artefact_renamer.os.path.exists", side_effect=[True, False, False])
...
@patch("src.artefact_renamer.os.path.exists", side_effect=[True, True, True])
...
@patch("src.artefact_renamer.os.path.exists", side_effect=[True, True, False, True])
...
@patch("builtins.open", new_callable=mock_open)
@patch("src.artefact_renamer.Classifier.get_artefact_title", return_value="Vision")
