...
from src.update_config_prompt import (
...
@patch('src.update_config_prompt.read_file')
@patch('src.update_config_prompt.write_file')
@patch('src.update_config_prompt.update_items_in_file')
@patch('os.replace')
...
@patch('src.update_config_prompt.generate_config_prompt_template_file')
@patch('src.update_config_prompt.generate_config_prompt_givens_file')
@patch('src.update_config_prompt.update_config_prompt_files')
...
@patch("src.update_config_prompt.Classifier.get_sub_directory", return_value="sub_dir")
@patch("src.update_config_prompt.os.path.join", side_effect=lambda *args: "/".join(args))
@patch("src.update_config_prompt.ensure_directory_exists")
@patch("src.update_config_prompt.handle_existing_file")
@patch('src.update_config_prompt.generate_config_prompt_givens_file')
@patch('src.update_config_prompt.generate_config_prompt_template_file')
