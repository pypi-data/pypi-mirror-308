...
# 初始化数据库
if not os.path.exists(os.getcwd()+"/app/common/file/sqlite/index_index") and os.path.exists(os.getcwd()+"/app/intapp/controller/index/file/sqlite/intappindex"):#兼容性之前的
    shutil.copy(os.getcwd()+"/app/intapp/controller/index/file/sqlite/intappindex",os.getcwd()+"/app/common/file/sqlite/index_index")
