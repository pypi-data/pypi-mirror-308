...
if os.path.exists(os.getcwd()+"/app/common/"):
    ...
    try:
        ...
        sqlite("admin",model_app_path).insert({"username":"kcw","password":md5("kcw"+str(password)),"phone":"","nickname":"kcw-linux控制板","name":"","role":1,'blacklistrole':0,"logintime":times(),"addtime":times()})
    ...
    try:
        ...
        role=[{"name":'首页',"value":'/intapp/index/index/home'},
            {"name":'导航列表',"value":'/intapp/index/index/menu'},
            {"name":'系统信息',"value":'/intapp/index/index/homes'},
            {"name":'磁盘分区',"value":'/intapp/index/index/disk'},
            {"name":'cpu和内存以及网络',"value":'/intapp/index/index/cpume'},
            {"name":'进程列表',"value":'/intapp/index/index/process'},
            {"name":'shell执行能力',"value":'/intapp/index/index/shell'},
            {"name":'管理员',"value":'/intapp/index/admin'},
            {"name":'计划任务',"value":'/intapp/index/plan'},
            {"name":'任务队列',"value":'/intapp/index/task'},
            {"name":'系统配置',"value":'/intapp/index/setup'},
            {"name":'模块管理',"value":'/intapp/index/modular'},
            {"name":'插件管理',"value":'/intapp/index/plug'},
            {"name":'导航管理',"value":'/intapp/index/menu'}]
