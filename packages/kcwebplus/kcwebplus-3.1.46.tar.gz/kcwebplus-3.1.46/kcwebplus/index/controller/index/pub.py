...
class pub:
    ...
    def script(assembly='core',t=''):
        ...
        return response.tpl(path='/intapp/controller/index/tpl/static/script.js',response_cache=True,ETag=ETag,header={"Content-type":"application/javascript; charset=utf-8","Access-Control-Allow-Origin":"*","Access-Control-Allow-Credentials":"true"})
    def clistartplan():
        #这里是初始化计划任务 （cli方式运行）
        try:
            ...
            pass
    def webclosemsg(format='json',msg='您访问的站点正在维护中，暂时无法访问，请稍后在试',a1='',a2='',a3='',a4='',a5='',a6='',a7='',a8='',a9='',a10=''):
        if format=='html':
            return msg
        elif format=='json':
            return errorjson(code=-1,msg=msg)
