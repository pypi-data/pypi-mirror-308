...
from earnix2_sdk.clients.imx.models.s3_prefix_properties import S3PrefixProperties
...
class ConnectionServiceApi:
    ...
    def list_files(
        self,
        connection_id: Annotated[StrictInt, Field(description="The connection id.")],
        s3_prefix_properties: Annotated[
            S3PrefixProperties, Field(description="S3 Files Request")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        List all files in a given prefix

        :param connection_id: The connection id. (required)
        :type connection_id: int
        :param s3_prefix_properties: S3 Files Request (required)
        :type s3_prefix_properties: S3PrefixProperties
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_files_serialize(
            connection_id=connection_id,
            s3_prefix_properties=s3_prefix_properties,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _list_files_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if s3_prefix_properties is not None:
            _body_params = s3_prefix_properties
    ...
    def list_folders(
        ...
        connection_id: Annotated[StrictInt, Field(description="The connection id.")],
        s3_prefix_properties: Annotated[
            S3PrefixProperties, Field(description="S3 Folders Request")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param connection_id: The connection id. (required)
        :type connection_id: int
        :param s3_prefix_properties: S3 Folders Request (required)
        :type s3_prefix_properties: S3PrefixProperties
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
