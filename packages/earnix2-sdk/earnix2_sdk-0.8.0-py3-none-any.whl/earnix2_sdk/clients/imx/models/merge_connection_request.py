...
class MergeConnectionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "name", "description", "tags"]
    ...
    def from_json(
        cls, json_str: str
    ) -> Optional[Union[MergeS3ConnectionRequest, MergeSnowflakeConnectionRequest]]:
    ...
    def from_dict(
        ...
        if object_type == "MergeS3ConnectionRequest":
            return import_module(
                "earnix2_sdk.clients.imx.models.merge_s3_connection_request"
            ).MergeS3ConnectionRequest.from_dict(obj)
        if object_type == "MergeSnowflakeConnectionRequest":
            return import_module(
                "earnix2_sdk.clients.imx.models.merge_snowflake_connection_request"
