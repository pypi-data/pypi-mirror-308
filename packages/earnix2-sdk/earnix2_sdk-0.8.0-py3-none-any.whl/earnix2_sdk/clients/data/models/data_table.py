...
class DataTable(BaseModel):
    ...
    revisions_count: Optional[StrictInt] = Field(
        default=0, description="Number of revisions", alias="revisionsCount"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "revisionsCount": obj.get("revisionsCount")
                if obj.get("revisionsCount") is not None
                else 0,
                "tags": obj.get("tags"),
            }
        )
