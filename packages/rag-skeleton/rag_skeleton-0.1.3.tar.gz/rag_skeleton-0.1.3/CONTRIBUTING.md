...
Welcome to `rag_skeleton` contributor's guide.
...
If you experience bugs or general issues with `rag_skeleton`, please have a look
...
You can help improve `rag_skeleton` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`rag_skeleton` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `rag_skeleton`'s files. While this mechanism can
...
```
conda create -n rag_skeleton python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/rag_skeleton.git
   cd rag_skeleton
   ```
...
5. Install [pre-commit]:
   ...
   `rag_skeleton` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/rag_skeleton
[issue tracker]: https://github.com/<USERNAME>/rag_skeleton/issues
