...
class CompletionsStreamBodyCompletionsBodyWithTokensTypedDict(TypedDict):
    tokens: List[int]
...
class CompletionsStreamBodyCompletionsBodyWithTokens(BaseModel):
    tokens: List[int]
    r"""The tokenized prompt (i.e., input tokens). Either `prompt` or `tokens` field is required."""
...
class CompletionsStreamBodyCompletionsBodyWithPromptTypedDict(TypedDict):
    prompt: str
...
class CompletionsStreamBodyCompletionsBodyWithPrompt(BaseModel):
    prompt: str
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
