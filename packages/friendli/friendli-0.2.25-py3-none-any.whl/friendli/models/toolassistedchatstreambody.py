...
ToolAssistedChatStreamBodyToolChoiceType = Literal["function"]
r"""The type of the tool. Currently, only `function` is supported."""


class ToolAssistedChatStreamBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class ToolAssistedChatStreamBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class ToolAssistedChatStreamBodyToolChoiceObjectTypedDict(TypedDict):
    type: ToolAssistedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: ToolAssistedChatStreamBodyToolChoiceFunctionTypedDict


class ToolAssistedChatStreamBodyToolChoiceObject(BaseModel):
    type: ToolAssistedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""

    function: ToolAssistedChatStreamBodyToolChoiceFunction


ToolAssistedChatStreamBodyToolChoiceTypedDict = Union[
    ToolAssistedChatStreamBodyToolChoiceObjectTypedDict, str
]
...
ToolAssistedChatStreamBodyToolChoice = Union[
    ToolAssistedChatStreamBodyToolChoiceObject, str
]
r"""Determines the tool calling behavior of the model.
When set to `none`, the model will bypass tool execution and generate a response directly.
In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
...
class ToolAssistedChatStreamBodyTypedDict(TypedDict):
    model: str
    ...
    ***Tip***
    ...
    tool_choice: NotRequired[ToolAssistedChatStreamBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class ToolAssistedChatStreamBody(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""
    ...
    ***Tip***
    ...
    tool_choice: Optional[ToolAssistedChatStreamBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
