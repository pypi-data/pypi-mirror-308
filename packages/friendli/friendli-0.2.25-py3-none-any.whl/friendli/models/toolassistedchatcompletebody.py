...
ToolAssistedChatCompleteBodyToolChoiceType = Literal["function"]
r"""The type of the tool. Currently, only `function` is supported."""


class ToolAssistedChatCompleteBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class ToolAssistedChatCompleteBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class ToolAssistedChatCompleteBodyToolChoiceObjectTypedDict(TypedDict):
    type: ToolAssistedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: ToolAssistedChatCompleteBodyToolChoiceFunctionTypedDict


class ToolAssistedChatCompleteBodyToolChoiceObject(BaseModel):
    type: ToolAssistedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""

    function: ToolAssistedChatCompleteBodyToolChoiceFunction


ToolAssistedChatCompleteBodyToolChoiceTypedDict = Union[
    ToolAssistedChatCompleteBodyToolChoiceObjectTypedDict, str
]
...
ToolAssistedChatCompleteBodyToolChoice = Union[
    ToolAssistedChatCompleteBodyToolChoiceObject, str
]
r"""Determines the tool calling behavior of the model.
When set to `none`, the model will bypass tool execution and generate a response directly.
In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
...
class ToolAssistedChatCompleteBodyTypedDict(TypedDict):
    model: str
    ...
    ***Tip***
    ...
    tool_choice: NotRequired[ToolAssistedChatCompleteBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class ToolAssistedChatCompleteBody(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""
    ...
    ***Tip***
    ...
    tool_choice: Optional[ToolAssistedChatCompleteBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
