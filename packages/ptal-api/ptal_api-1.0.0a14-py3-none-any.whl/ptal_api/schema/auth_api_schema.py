...
class CreateUserParams(sgqlc.types.Input):
    __schema__ = auth_api_schema
    __field_names__ = ('access_level_id', 'email', 'enabled', 'fathers_name', 'first_name', 'is_admin', 'last_name', 'login', 'receive_notifications', 'receive_telegram_notifications', 'telegram_chat_id')
...
class UpdateUserParams(sgqlc.types.Input):
    __schema__ = auth_api_schema
    __field_names__ = ('access_level_id', 'email', 'enabled', 'fathers_name', 'first_name', 'is_admin', 'last_name', 'receive_notifications', 'receive_telegram_notifications', 'telegram_chat_id')
    access_level_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='accessLevelID')
    email = sgqlc.types.Field(String, graphql_name='email')
    enabled = sgqlc.types.Field(Boolean, graphql_name='enabled')
    fathers_name = sgqlc.types.Field(String, graphql_name='fathersName')
