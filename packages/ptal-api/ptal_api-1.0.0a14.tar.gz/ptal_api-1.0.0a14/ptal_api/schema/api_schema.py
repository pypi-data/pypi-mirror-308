...
class ConceptViewMetricType(sgqlc.types.Enum):
    __schema__ = api_schema
    __choices__ = ('countConcepts', 'countConceptsAndDocuments', 'countDocumentFacts', 'countDocumentMentions', 'countEvents', 'countObjects', 'countPotentialDocuments', 'countProperties', 'countResearchMaps')
...
class DocumentViewMetricType(sgqlc.types.Enum):
    __schema__ = api_schema
    __choices__ = ('countChildDocs', 'countConcepts', 'countDisambiguatedEntities', 'countEntities', 'countEvents', 'countLinks', 'countNamedEntities', 'countObjects', 'countPropertyCandidates', 'countResearchMaps', 'countStoryDocs')
...
class PropertyFilterSettings(sgqlc.types.Input):
    __schema__ = api_schema
    __field_names__ = ('component_id', 'date_time_filter', 'double_filter', 'geo_filter', 'int_filter', 'property_type', 'property_type_id', 'status', 'string_filter')
...
class ConceptStatistics(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('count_concepts', 'count_concepts_and_documents', 'count_document_facts', 'count_document_mentions', 'count_events', 'count_objects', 'count_potential_documents', 'count_properties', 'count_research_maps')
...
class Metrics(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('count_child_docs', 'count_concepts', 'count_disambiguated_entities', 'count_entities', 'count_events', 'count_links', 'count_named_entities', 'count_objects', 'count_property_candidates', 'count_research_maps', 'count_story_docs')
...
class ParagraphMetadata(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('bullet', 'colspan', 'content_type', 'header', 'height', 'hidden', 'language', 'line_id', 'md5', 'name', 'original_text', 'page_id', 'paragraph_type', 'rowspan', 'size', 'width')
...
class Account(sgqlc.types.Type, RecordInterface):
    __schema__ = api_schema
    __field_names__ = ('country', 'id', 'image', 'image_new', 'key', 'markers', 'metric', 'name', 'params', 'period', 'platform', 'url')
    country = sgqlc.types.Field(String, graphql_name='country')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    image = sgqlc.types.Field(Image, graphql_name='image')
    image_new = sgqlc.types.Field(Image, graphql_name='imageNew')
...
class ConceptTypePresentation(sgqlc.types.Type, EntityTypePresentation, RecordInterface):
    __schema__ = api_schema
    __field_names__ = ('has_header_information', 'has_supporting_documents', 'hide_empty_rows', 'id', 'internal_url', 'internal_url_new', 'is_default', 'layout', 'list_widget_type', 'name', 'pagination_widget_type', 'root_concept_type')
...
class Platform(sgqlc.types.Type, RecordInterface):
    __schema__ = api_schema
    __field_names__ = ('accounts', 'country', 'id', 'image', 'image_new', 'key', 'language', 'markers', 'metric', 'name', 'params', 'period', 'platform_type', 'url')
...
class MentionUnion(sgqlc.types.Union):
    __schema__ = api_schema
    __types__ = (ImageNodeMention, NodeMention, TextNodeMention)
