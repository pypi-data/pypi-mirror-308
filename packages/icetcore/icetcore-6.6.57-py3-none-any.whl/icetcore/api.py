    ...
    def getATM(self, symbol: str, atmindex: int):
        ...
        if atmkey in self._tcoreapi.quoteobj.eventobj.atm.keys():
            ...
            if not atmdata:
                return
            result=""
            atmsymbol="TC.O."+_symbl[2]+"."+ _symbl[3]+"."+ _symbl[4]+"."+(_symbl[5] if len(_symbl)>5 else "C")+"."+atmdata["ATM"]
...
class TradeAPI:
    ...
    def getposition(self, accmask: str):
        ...
        self.tradeobj.queryaccountdata(7,accsplit[0],accmask.replace(accsplit[0]+"-",""))
 ...
 # 订阅动态greekline数据
    ...
    def getATM(self, symbol: str, atmindex: int):
        ...
        if "TC.O" not in symbol:
            ...
            return
        _symbl=symbol.split(".")
        reqatmsymbol= "TC.O." + _symbl[2] + "." + _symbl[3] + "." + _symbl[4] + ".GET.ATM"
