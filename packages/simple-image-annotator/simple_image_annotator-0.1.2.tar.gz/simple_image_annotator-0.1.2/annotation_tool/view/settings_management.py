...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.font_size_spinbox.setRange(10, 15)
        ...
        # Indexing Timeout (milliseconds)
        self.indexing_timeout_spinbox = CustomSpinBox()
        self.indexing_timeout_spinbox.setRange(1, 30)
        self.indexing_timeout_spinbox.setSingleStep(1)
        self.indexing_timeout_spinbox.setValue(self.config.indexing_timeout_sec)
        form_layout.addRow("Indexing Timeout (ms):", self.indexing_timeout_spinbox)
