...
class MainApplication(qtw.QApplication):
    ...
    def update_project(self):
        ...
        if dlg.exec() == qtw.QDialog.DialogCode.Accepted:
            ...
            if updated_settings == current_project.settings and is_identity:
            ...
            if (
                updated_settings.schema == current_project.settings.schema
                and is_identity
            ):
            ...
            updated_project.apply_renaming_mapping(translate_groups, translate_classes)
