...
class AudienceBuilderDefinition:
    """
...
class ABMediaDcr:
    ...
    def participants(self) -> Dict[str, Any]:
        ...
        """
        dcr = self.high_level[AUDIENCE_BUILDER_SUPPORTED_VERSION]
