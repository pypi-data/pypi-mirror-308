...
class SwarmRouter:
    ...
    Attributes:
        ...
        shared_memory_system (Any): The shared memory system to be used by the agents.
        rules (str): The rules to be injected to every agent.
        documents (List[str]): A list of document file paths to be used in the swarm.
        output_type (str): The type of output to be generated by the swarm.
    ...
    def __init__(
        ...
        output_type: str = "str",  # Md, PDF, Txt, csv
        *args,
        **kwargs,
    ):
        self.name = name
