...
def isLLMReady():
    if config.llm_backend == "openai" and config.openaiApi_key:
        return True
    elif config.llm_backend == "mistral" and config.mistralApi_key:
        return True
    elif config.llm_backend == "groq" and config.groqApi_key:
        return True
    return False
