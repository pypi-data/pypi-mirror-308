...
The WHERE condition is described as: {query}"""
    ...
    # IOTV
    def textAnswerIV(self, command, source, systemMessage, goBack=""):
        try:
        ...
        _, textOutput, _ = self.textAnswer(textInput, source, systemMessage, goBack=goBack)
...
{textOutput}"""
    ...
    def textAnswer(self, command, source, systemMessage, goBack=""):
        if command.strip():
            command = command.strip()
