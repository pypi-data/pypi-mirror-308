...
setup(
    name='lib4gd',
    version='0.2.9',  # Incremented version
    description='A comprehensive library for image handling, MongoDB, and Google Drive file management.',
    ...
    install_requires=[
        ...
        'motor>=2.0.0',  # MongoDB async driver
        'psutil>=5.9.0',  # For memory and CPU monitoring
    ],
    python_requires='>=3.7',
    classifiers=[
