...
from ..models.field_date_system_type import FieldDateSystemType
from ..models.field_date_validation_status import FieldDateValidationStatus
...
class FieldDate:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldDateValidationStatus):
        type (Literal['date']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldDateSystemType]):
    ...
    system_type: Union[Unset, FieldDateSystemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldDateValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldDateSystemType(_system_type)
        ...
        field_date.additional_properties = d
        return field_date
