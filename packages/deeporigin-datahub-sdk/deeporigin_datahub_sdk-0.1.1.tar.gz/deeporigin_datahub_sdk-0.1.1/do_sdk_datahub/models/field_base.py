...
from ..models.field_base_system_type import FieldBaseSystemType
from ..models.field_base_type import FieldBaseType
from ..models.field_base_validation_status import FieldBaseValidationStatus
...
class FieldBase:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldBaseValidationStatus):
        type (FieldBaseType):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldBaseSystemType]):
    """
    ...
    system_type: Union[Unset, FieldBaseSystemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldBaseValidationStatus(d.pop("validationStatus"))

        type = FieldBaseType(d.pop("type"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldBaseSystemType(_system_type)
