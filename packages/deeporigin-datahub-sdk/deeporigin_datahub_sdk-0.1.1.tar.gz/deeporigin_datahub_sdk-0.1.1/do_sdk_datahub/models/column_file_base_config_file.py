...
T = TypeVar("T", bound="ColumnFileBaseConfigFile")


@_attrs_define
class ColumnFileBaseConfigFile:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_file_base_config_file = cls(
            allowed_extensions=allowed_extensions,
        )

        column_file_base_config_file.additional_properties = d
        return column_file_base_config_file
