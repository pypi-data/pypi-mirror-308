...
if TYPE_CHECKING:
    from ..models.list_mentions_response_200_data import ListMentionsResponse200Data
...
class ListMentionsResponse200:
    """
    Attributes:
        data (ListMentionsResponse200Data):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        data = ListMentionsResponse200Data.from_dict(d.pop("data"))
