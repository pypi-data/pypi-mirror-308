...
from ..models.field_user_system_type import FieldUserSystemType
from ..models.field_user_validation_status import FieldUserValidationStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.field_user_value_type_0 import FieldUserValueType0
    from ..models.invalid_data import InvalidData


T = TypeVar("T", bound="FieldUser")
...
class FieldUser:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldUserValidationStatus):
        type (Literal['user']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldUserSystemType]):
        value (Union['FieldUserValueType0', None, Unset]):
    """
    ...
    system_type: Union[Unset, FieldUserSystemType] = UNSET
    value: Union["FieldUserValueType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, FieldUserValueType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldUserValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldUserSystemType(_system_type)

        def _parse_value(data: object) -> Union["FieldUserValueType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = FieldUserValueType0.from_dict(data)

                return value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["FieldUserValueType0", None, Unset], data)
        ...
        field_user.additional_properties = d
        return field_user
