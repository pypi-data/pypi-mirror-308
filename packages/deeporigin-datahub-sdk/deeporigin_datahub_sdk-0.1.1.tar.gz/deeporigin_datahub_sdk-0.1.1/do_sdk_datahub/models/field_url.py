...
from ..models.field_url_system_type import FieldUrlSystemType
from ..models.field_url_validation_status import FieldUrlValidationStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.field_url_value_type_0 import FieldUrlValueType0
...
class FieldUrl:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldUrlValidationStatus):
        type (Literal['url']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldUrlSystemType]):
        value (Union['FieldUrlValueType0', None, Unset]):
    """
    ...
    system_type: Union[Unset, FieldUrlSystemType] = UNSET
    value: Union["FieldUrlValueType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, FieldUrlValueType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldUrlValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldUrlSystemType(_system_type)

        def _parse_value(data: object) -> Union["FieldUrlValueType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = FieldUrlValueType0.from_dict(data)

                return value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["FieldUrlValueType0", None, Unset], data)
