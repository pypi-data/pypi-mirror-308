...
from ..models.add_column_url_cardinality import AddColumnUrlCardinality
from ..models.add_column_url_enabled_viewers_item import AddColumnUrlEnabledViewersItem
from ..models.add_column_url_inline_viewer import AddColumnUrlInlineViewer
from ..models.add_column_url_system_type import AddColumnUrlSystemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddColumnUrl")
...
class AddColumnUrl:
    ...
    Attributes:
        type (Literal['url']):
        name (str):
        cardinality (AddColumnUrlCardinality):
        system_type (Union[Unset, AddColumnUrlSystemType]):
        is_required (Union[Unset, bool]):
        enabled_viewers (Union[Unset, List[AddColumnUrlEnabledViewersItem]]):
        cell_json_schema (Union[Unset, Any]):
        inline_viewer (Union[Unset, AddColumnUrlInlineViewer]):
    """

    type: Literal["url"]
    name: str
    cardinality: AddColumnUrlCardinality
    system_type: Union[Unset, AddColumnUrlSystemType] = UNSET
    is_required: Union[Unset, bool] = UNSET
    enabled_viewers: Union[Unset, List[AddColumnUrlEnabledViewersItem]] = UNSET
    cell_json_schema: Union[Unset, Any] = UNSET
    inline_viewer: Union[Unset, AddColumnUrlInlineViewer] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cardinality = AddColumnUrlCardinality(d.pop("cardinality"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = AddColumnUrlSystemType(_system_type)
        ...
        for enabled_viewers_item_data in _enabled_viewers or []:
            enabled_viewers_item = AddColumnUrlEnabledViewersItem(enabled_viewers_item_data)
        ...
        if isinstance(_inline_viewer, Unset):
            ...
            inline_viewer = AddColumnUrlInlineViewer(_inline_viewer)
        ...
        add_column_url.additional_properties = d
        return add_column_url
