...
from ..models.field_float_system_type import FieldFloatSystemType
from ..models.field_float_validation_status import FieldFloatValidationStatus
...
class FieldFloat:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldFloatValidationStatus):
        type (Literal['float']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldFloatSystemType]):
    ...
    system_type: Union[Unset, FieldFloatSystemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldFloatValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldFloatSystemType(_system_type)
        ...
        field_float.additional_properties = d
        return field_float
