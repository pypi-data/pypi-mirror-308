...
from ..models.field_integer_system_type import FieldIntegerSystemType
from ..models.field_integer_validation_status import FieldIntegerValidationStatus
...
T = TypeVar("T", bound="FieldInteger")
...
class FieldInteger:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldIntegerValidationStatus):
        type (Literal['integer']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldIntegerSystemType]):
    ...
    system_type: Union[Unset, FieldIntegerSystemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldIntegerValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldIntegerSystemType(_system_type)
        ...
        field_integer.additional_properties = d
