...
from ..models.field_text_system_type import FieldTextSystemType
from ..models.field_text_validation_status import FieldTextValidationStatus
...
class FieldText:
    ...
    Attributes:
        column_id (str):
        validation_status (FieldTextValidationStatus):
        type (Literal['text']):
        version (Union[Unset, float]):
        invalid_data (Union[Unset, InvalidData]):
        system_type (Union[Unset, FieldTextSystemType]):
    ...
    system_type: Union[Unset, FieldTextSystemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_status = FieldTextValidationStatus(d.pop("validationStatus"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = FieldTextSystemType(_system_type)
        ...
        field_text.additional_properties = d
        return field_text
