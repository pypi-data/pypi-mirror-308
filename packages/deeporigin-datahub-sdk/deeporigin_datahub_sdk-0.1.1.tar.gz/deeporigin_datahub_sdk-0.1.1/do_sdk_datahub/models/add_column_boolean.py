...
from ..models.add_column_boolean_cardinality import AddColumnBooleanCardinality
from ..models.add_column_boolean_enabled_viewers_item import AddColumnBooleanEnabledViewersItem
from ..models.add_column_boolean_inline_viewer import AddColumnBooleanInlineViewer
from ..models.add_column_boolean_system_type import AddColumnBooleanSystemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddColumnBoolean")


@_attrs_define
class AddColumnBoolean:
    """
    Attributes:
        type (Literal['boolean']):
        name (str):
        cardinality (AddColumnBooleanCardinality):
        system_type (Union[Unset, AddColumnBooleanSystemType]):
        is_required (Union[Unset, bool]):
        enabled_viewers (Union[Unset, List[AddColumnBooleanEnabledViewersItem]]):
        cell_json_schema (Union[Unset, Any]):
        inline_viewer (Union[Unset, AddColumnBooleanInlineViewer]):
    """

    type: Literal["boolean"]
    name: str
    cardinality: AddColumnBooleanCardinality
    system_type: Union[Unset, AddColumnBooleanSystemType] = UNSET
    is_required: Union[Unset, bool] = UNSET
    enabled_viewers: Union[Unset, List[AddColumnBooleanEnabledViewersItem]] = UNSET
    cell_json_schema: Union[Unset, Any] = UNSET
    inline_viewer: Union[Unset, AddColumnBooleanInlineViewer] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cardinality = AddColumnBooleanCardinality(d.pop("cardinality"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = AddColumnBooleanSystemType(_system_type)
        ...
        for enabled_viewers_item_data in _enabled_viewers or []:
            enabled_viewers_item = AddColumnBooleanEnabledViewersItem(enabled_viewers_item_data)
        ...
        if isinstance(_inline_viewer, Unset):
            ...
            inline_viewer = AddColumnBooleanInlineViewer(_inline_viewer)

        add_column_boolean = cls(
            type=type,
            name=name,
            cardinality=cardinality,
        ...
        add_column_boolean.additional_properties = d
        return add_column_boolean
