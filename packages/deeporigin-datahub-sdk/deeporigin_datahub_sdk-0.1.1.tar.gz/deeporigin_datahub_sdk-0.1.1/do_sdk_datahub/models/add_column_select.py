...
from ..models.add_column_select_cardinality import AddColumnSelectCardinality
from ..models.add_column_select_enabled_viewers_item import AddColumnSelectEnabledViewersItem
from ..models.add_column_select_inline_viewer import AddColumnSelectInlineViewer
from ..models.add_column_select_system_type import AddColumnSelectSystemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.add_column_select_config_select import AddColumnSelectConfigSelect


T = TypeVar("T", bound="AddColumnSelect")


@_attrs_define
class AddColumnSelect:
    """
    Attributes:
        type (Literal['select']):
        config_select (AddColumnSelectConfigSelect):
        name (str):
        cardinality (AddColumnSelectCardinality):
        system_type (Union[Unset, AddColumnSelectSystemType]):
        is_required (Union[Unset, bool]):
        enabled_viewers (Union[Unset, List[AddColumnSelectEnabledViewersItem]]):
        cell_json_schema (Union[Unset, Any]):
        inline_viewer (Union[Unset, AddColumnSelectInlineViewer]):
    """
    ...
    name: str
    cardinality: AddColumnSelectCardinality
    system_type: Union[Unset, AddColumnSelectSystemType] = UNSET
    is_required: Union[Unset, bool] = UNSET
    enabled_viewers: Union[Unset, List[AddColumnSelectEnabledViewersItem]] = UNSET
    cell_json_schema: Union[Unset, Any] = UNSET
    inline_viewer: Union[Unset, AddColumnSelectInlineViewer] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        config_select = AddColumnSelectConfigSelect.from_dict(d.pop("configSelect"))

        name = d.pop("name")

        cardinality = AddColumnSelectCardinality(d.pop("cardinality"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = AddColumnSelectSystemType(_system_type)
        ...
        for enabled_viewers_item_data in _enabled_viewers or []:
            enabled_viewers_item = AddColumnSelectEnabledViewersItem(enabled_viewers_item_data)
        ...
        if isinstance(_inline_viewer, Unset):
            ...
            inline_viewer = AddColumnSelectInlineViewer(_inline_viewer)

        add_column_select = cls(
            type=type,
        ...
        add_column_select.additional_properties = d
        return add_column_select
