...
from ..models.add_column_editor_cardinality import AddColumnEditorCardinality
from ..models.add_column_editor_enabled_viewers_item import AddColumnEditorEnabledViewersItem
from ..models.add_column_editor_inline_viewer import AddColumnEditorInlineViewer
from ..models.add_column_editor_system_type import AddColumnEditorSystemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddColumnEditor")


@_attrs_define
class AddColumnEditor:
    """
    Attributes:
        type (Literal['editor']):
        name (str):
        cardinality (AddColumnEditorCardinality):
        system_type (Union[Unset, AddColumnEditorSystemType]):
        is_required (Union[Unset, bool]):
        enabled_viewers (Union[Unset, List[AddColumnEditorEnabledViewersItem]]):
        cell_json_schema (Union[Unset, Any]):
        inline_viewer (Union[Unset, AddColumnEditorInlineViewer]):
    """

    type: Literal["editor"]
    name: str
    cardinality: AddColumnEditorCardinality
    system_type: Union[Unset, AddColumnEditorSystemType] = UNSET
    is_required: Union[Unset, bool] = UNSET
    enabled_viewers: Union[Unset, List[AddColumnEditorEnabledViewersItem]] = UNSET
    cell_json_schema: Union[Unset, Any] = UNSET
    inline_viewer: Union[Unset, AddColumnEditorInlineViewer] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cardinality = AddColumnEditorCardinality(d.pop("cardinality"))
        ...
        if isinstance(_system_type, Unset):
            ...
            system_type = AddColumnEditorSystemType(_system_type)
        ...
        for enabled_viewers_item_data in _enabled_viewers or []:
            enabled_viewers_item = AddColumnEditorEnabledViewersItem(enabled_viewers_item_data)
        ...
        if isinstance(_inline_viewer, Unset):
            ...
            inline_viewer = AddColumnEditorInlineViewer(_inline_viewer)

        add_column_editor = cls(
            type=type,
            name=name,
            cardinality=cardinality,
        ...
        add_column_editor.additional_properties = d
        return add_column_editor
