...
class AsyncMRSClient:
    ...
    def __init__(self, hostname, kadme_token:str, username:str, password:str|None=None, ticket:str|None=None):
        """
    ...
    async def upload_file(self, domain: dict, destinationPath: str, data: bytes) -> dict | None:
        """
        ...
        response = await self.request(method="POST",endpoint=url, data=files, headers=headers)
        return response
