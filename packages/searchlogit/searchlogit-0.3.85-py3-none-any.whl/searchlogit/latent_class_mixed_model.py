...
# {
    ...
    def setup(self, X, y, varnames=None, alts=None, isvars=None, num_classes=2,
              ...
              batch_size=None, halton_opts=None, ftol=1e-5, ftol_lccmm=1e-3,
              gtol=1e-5, gtol_membership_func=1e-5, return_hess=True, return_grad=True, method="bfgs",
              validation=False, mnl_init=True, mxl_init=True):
    # {
        ...
        # {
            ...
            # {
                ...
                mxl = MixedLogit()
                mxl = misc.setup_logit(i, mxl, X, y, varnames, self.class_params_spec, avail, alts, transvars, gtol,
