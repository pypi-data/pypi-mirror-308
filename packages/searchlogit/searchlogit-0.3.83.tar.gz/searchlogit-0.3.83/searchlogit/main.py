...
def MaaS_search(number_of_classes = 3, number_of_iterations = 1000, initial_iterations = 200):
...
def main(args):
    ...
    if args.model_run_item == 1:
        ...
        MaaS_search(args.num_classes, args.iterations, args.iterations_i)
...
# {
    ...
    parser.add_argument('--iterations_i', type= int, default= 200, help = 'first phase number of iterations')
