...
This is a [PEP-518](https://peps.python.org/pep-0518/) custom Python 'build backend' for setuptools to transpile [swpwr](https://github.com/QueriumCorp/swpwr) React build assets and re-organizing the build files into an Open edX XBlock-compliant organizational scheme, before building the package itself.
This package is published to PyPi as [swpwrxblock-build-backend](https://pypi.org/project/swpwrxblock-build-backend/), and is specified in the pyproject.toml configuration of https://github.com/QueriumCorp/swpwrxblock.
