...
def read_and_analyse_FTIR_features( ip, file_data ):
    ...
    df.to_csv( ip.output_directory + "FTIR/Features/Mean_Features_Unnormalised.csv" )
    ...
    df.to_csv( ip.output_directory + "FTIR/Features/Std_of_Features_Unnormalised.csv" )
