...
def pca( directory, output_directory, shiny, features_df, std_of_features_df ):
    ...
    if pca_of_pca_of_individual_datasets:
        ...
        return pca_ft_df[pca_ft_df.columns[0]].tolist(), pca_ft_df[pca_ft_df.columns[1]].tolist(), np.array( pca_std[0] ).tolist(), np.array( pca_std[1] ).tolist(), components[:, 0].tolist(), components[:, 1].tolist(), pca_feature_names
