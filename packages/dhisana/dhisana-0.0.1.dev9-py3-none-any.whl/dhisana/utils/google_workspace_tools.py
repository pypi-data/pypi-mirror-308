...
@assistant_tool
async def list_emails_in_time_range_async(start_time: str, end_time: str, unread_only: bool = True, labels: List[str] = [], mailbox_email: str = "") -> List[Dict[str, Any]]:
    """
...
@assistant_tool
async def reply_to_email_async(message_id: str, reply_body: str, mailbox_email: str = "", mark_as_read: str = "True", add_labels: List[str] = []) -> Dict[str, Any]:
    """
