...
@click.option('--display-name', '-d', 'display_name', type=str, required=True, help='Friendly name of the group.')
@click.option('--name', '-n', 'name', type=str, required=True, help='The name of this group.')
...
@click.option('--display-name', '-d', 'display_name', type=str, required=False, help='Friendly name of the group.')
@click.option('--name', '-n', 'name', type=str, required=False, help='The name of this group.')
@click.option('--group-id', '-n', 'group_id', type=str, required=True, help='The id of the group.')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
...
@click.option('--blocked', '-b', 'blocked', type=bool, required=False, help='Block status.')
@click.option('--group-id', '-n', 'group_id', type=str, required=True, help='The id of the group.')
@click.pass_context
