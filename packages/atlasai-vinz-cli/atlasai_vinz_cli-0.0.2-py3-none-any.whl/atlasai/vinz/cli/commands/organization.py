...
@click.option('--display-name', '-d', 'display_name', type=str, required=True, help='Friendly name of the organization.')
@click.option('--name', '-n', 'name', type=str, required=True, help='The name of this organization.')
@click.option('--metadata', '-m', 'org_metadata', type=str, required=False, help='Metadata associated with the organization, in the form of an object with string values (max 255 chars).')
@click.pass_context
...
@click.option('--display-name', '-d', 'display_name', type=str, required=False, help='Friendly name of the organization.')
@click.option('--name', '-n', 'name', type=str, required=False, help='The name of this organization.')
@click.option('--metadata', '-m', 'org_metadata', type=str, required=False, help='Metadata associated with the organization, in the form of an object with string values (max 255 chars).')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to fetch. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
...
@click.pass_context
def list_organizations(ctx, query, limit, offset):
    params = {
        'limit': limit,
        'offset': offset,
        'search': query
...
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to fetch. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
def get_organization(ctx, org_id):
    params = {'org_id': org_id}
    _, result = _get(
...
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.option('--query', '-q', 'query', type=str, required=False, help='Filter Organizations')
@click.option('--limit', '-l', 'limit', type=str, required=False, help='Limit the number of objects to return.')
@click.option('--offset', '-o', 'offset', type=str, required=False, help='Offset the objects.')
@click.pass_context
def list_users(ctx, org_id, limit, offset, query):
    params = {
        'org_id': org_id,
        'limit': limit,
        'offset': offset,
...
@click.option('--user', '-u', 'user_ids', multiple=True, type=str, required=True, help='Users to add. Pass this parameter multiple times for more than one user. ')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
...
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.option('--user-metadata', '-u', 'user_metadata', type=JSON, required=False, help='User metadata json.')
@click.option('--app-metadata', '-a', 'app_metadata', type=JSON, required=False, help='App metadata json.')
@click.option('--blocked', '-b', 'blocked', type=boolean, required=False, help='Block status.')
@click.pass_context
...
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.option('--role', '-r', 'roles', multiple=True, type=str, required=True, help='Role ids. Add this parameter multiple times for multiple roles.')
@click.pass_context
...
@click.option('--description', '-d', 'description', type=str, required=True, help='Description of the role.')
@click.option('--name', '-n', 'name', type=str, required=True, help='The name of this role.')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
...
@click.option('--description', '-d', 'description', type=str, required=False, help='Description of the role.')
@click.option('--name', '-n', 'name', type=str, required=False, help='The name of this role.')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.option('--role-id', '-r', 'role_id', type=str, required=True, help='Role id to update. This field is the role_id field from get/list')
@click.pass_context
...
@click.option('--role-id', '-n', 'role_id', type=str, required=True, help='The id of the role. This field is the role_id field from get/list')
@click.option('--org-id', '-i', 'org_id', type=str, required=False, help='Organization id to use. If not specified, it will return your own organization. This is the field org_id returned in the list method.')
@click.pass_context
