...
@click.option('--email', '-e', 'email', type=str, required=True, help='Email of the user')
@click.option('--given-name', '-g', 'given_name', type=str, required=True, help='Given name.')
@click.option('--family-name', '-f', 'family_name', type=str, required=True, help='Family name.')
@click.option('--user-metadata', '-u', 'user_metadata', type=JSON, required=False, help='User metadata.')
@click.option('--app-metadata', '-a', 'app_metadata', type=JSON, required=False, help='App metadata.')
@click.option('--nickname', '-n', 'nickname', type=str, required=False, help='Nickname.')
@click.option('--blocked', '-b', 'blocked', type=bool, required=False, help='Boolean.')
...
@click.option('--email', '-e', 'email', type=str, required=False, help='Email of the user')
@click.option('--given-name', '-g', 'given_name', type=str, required=False, help='Given name.')
@click.option('--family-name', '-f', 'family_name', type=str, required=False, help='Family name.')
@click.option('--user-metadata', '-u', 'user_metadata', type=JSON, required=False, help='User metadata.')
@click.option('--app-metadata', '-a', 'app_metadata', type=JSON, required=False, help='App metadata.')
@click.option('--nickname', '-n', 'nickname', type=str, required=False, help='Nickname.')
@click.option('--blocked', '-b', 'blocked', type=bool, required=False, help='Boolean.')
@click.option('--user-id', '-i', 'user_id', type=str, required=False, help='User id to update. This is the field user_id returned in the list method.')
@click.pass_context
...
@click.option('--user-id', '-u', 'user_id', type=str, required=True, help='The id of the user. This field is the user_id field from get/list')
@click.pass_context
