...
class NotificationQueueAzureEventGridInbound(NotificationHook):
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> NotificationQueueAzureEventGridInbound:
    ...
    def from_dict(cls, obj: dict) -> NotificationQueueAzureEventGridInbound:
        ...
        _obj = NotificationQueueAzureEventGridInbound.parse_obj({
            ...
            obj.get("azure_storage_queue_primary_uri"),
            "azure_tenant_id":
...
class NotificationQueueAzureEventGridInboundModel(NotificationHook):
    ...
    def _to_model(self):
        return NotificationQueueAzureEventGridInbound(
            azure_storage_queue_primary_uri=self.
            azure_storage_queue_primary_uri,
    ...
    def _from_model(cls, model) -> NotificationQueueAzureEventGridInboundModel:
        return NotificationQueueAzureEventGridInboundModel(
            azure_storage_queue_primary_uri=model.
            azure_storage_queue_primary_uri,
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a NotificationQueueAzureEventGridInbound.
    ...
    @classmethod
    def from_dict(cls,
                  obj: dict) -> NotificationQueueAzureEventGridInboundModel:
        """Creates an instance of NotificationQueueAzureEventGridInbound from a dict.
        ...
        return cls._from_model(
            NotificationQueueAzureEventGridInbound.from_dict(obj))
