...
class DatabaseRoleCloneModel():
    ...
    def _to_model(self):
        return DatabaseRoleClone(name=self.name, )

    @classmethod
    def _from_model(cls, model) -> DatabaseRoleCloneModel:
        return DatabaseRoleCloneModel(name=model.name, )

    def to_dict(self):
        """Creates a dictionary of the properties from a DatabaseRoleClone.
    ...
    def from_dict(cls, obj: dict) -> DatabaseRoleCloneModel:
        """Creates an instance of DatabaseRoleClone from a dict.
