...
from snowflake.core.stream._generated.models import *
...
class StreamSource(BaseModel):
    ...
    def from_json(
        cls, json_str: str
    ) -> Union[StreamSourceExternalTable, StreamSourceStage, StreamSourceTable,
               StreamSourceView]:
    ...
    def from_dict(
        ...
        if object_type:
            klass = getattr(snowflake.core.stream._generated.models,
                            object_type)
...
class StreamSourceModel():
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a StreamSource.
    ...
    def from_dict(
        cls, obj: dict
    ) -> Union[StreamSourceExternalTableModel, StreamSourceStageModel,
               StreamSourceTableModel, StreamSourceViewModel]:
        """Creates an instance of StreamSource from a dict.
