...
class SQLFunctionModel(FunctionLanguage):
    ...
    def _to_model(self):
        return SQLFunction(called_on_null_input=self.called_on_null_input, )
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a SQLFunction.
    ...
    def from_dict(cls, obj: dict) -> SQLFunctionModel:
        """Creates an instance of SQLFunction from a dict.
