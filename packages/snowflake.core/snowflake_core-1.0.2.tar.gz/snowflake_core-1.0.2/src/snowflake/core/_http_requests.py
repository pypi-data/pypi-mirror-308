...
PrimitiveTypes = typing.TypeVar('PrimitiveTypes', float, bool, bytes, str, int)
...
def resolve_url(
    ...
    collection_formats: typing.Dict[typing.Any, typing.Any],
    safe_quoting: str,
) -> str:
    if path_params:
...
def sanitize_for_serialization(obj: PrimitiveTypes) -> PrimitiveTypes:
    ...
@typing.overload
def sanitize_for_serialization(obj: typing.List[typing.Any]) -> typing.List[typing.Any]:
    ...
@typing.overload
def sanitize_for_serialization(obj: typing.Tuple[typing.Any, ...]) -> typing.Tuple[typing.Any, ...]:
    ...
@typing.overload
def sanitize_for_serialization(
    ...
    ...
@typing.overload
def sanitize_for_serialization(obj: typing.Dict[typing.Any, typing.Any]) -> typing.Dict[typing.Any, typing.Any]:
    ...
@typing.overload
def sanitize_for_serialization(obj: ToDictProto) -> typing.Dict[typing.Any, typing.Any]:
    ...
def sanitize_for_serialization(
    obj: typing.Union[
        None,
...
def parameters_to_tuples(
    ...
    collection_formats: typing.Optional[typing.Dict[typing.Any, typing.Any]],
) -> typing.List[typing.Tuple[typing.Any, typing.Any]]:
    ...
    """
    new_params: typing.List[typing.Tuple[typing.Any, typing.Any]] = []
