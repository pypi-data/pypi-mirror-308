...
class FileTransferMaterialModel():
    ...
    def _to_model(self):
        return FileTransferMaterial(presigned_url=self.presigned_url, )

    @classmethod
    def _from_model(cls, model) -> FileTransferMaterialModel:
        return FileTransferMaterialModel(presigned_url=model.presigned_url, )

    def to_dict(self):
        """Creates a dictionary of the properties from a FileTransferMaterial.
    ...
    def from_dict(cls, obj: dict) -> FileTransferMaterialModel:
        """Creates an instance of FileTransferMaterial from a dict.
