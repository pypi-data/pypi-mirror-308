...
class PointOfTimeStatement(PointOfTime):
    ...
    statement : str, optional
        Statement of the point of time.
    """
...
class PointOfTimeStatementModel(PointOfTime):
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a PointOfTimeStatement.
    ...
    def from_dict(cls, obj: dict) -> PointOfTimeStatementModel:
        """Creates an instance of PointOfTimeStatement from a dict.
