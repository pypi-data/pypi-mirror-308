...
class PointOfTime(BaseModel):
    ...
    def from_json(
        cls, json_str: str
    ) -> Union[PointOfTimeOffset, PointOfTimeStatement, PointOfTimeStream,
...
class PointOfTimeModel():
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a PointOfTime.
    ...
    def from_dict(
        cls, obj: dict
               ...
               PointOfTimeStreamModel, PointOfTimeTimestampModel]:
        """Creates an instance of PointOfTime from a dict.
