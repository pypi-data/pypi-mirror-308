...
class PointOfTimeTimestamp(PointOfTime):
    ...
    timestamp : str
        Timestamp of the point of time.
    """
...
class PointOfTimeTimestampModel(PointOfTime):
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a PointOfTimeTimestamp.
    ...
    def from_dict(cls, obj: dict) -> PointOfTimeTimestampModel:
        """Creates an instance of PointOfTimeTimestamp from a dict.
