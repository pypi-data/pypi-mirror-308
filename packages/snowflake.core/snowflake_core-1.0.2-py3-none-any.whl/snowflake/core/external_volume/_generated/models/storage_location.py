...
class StorageLocation(BaseModel):
    ...
    def from_json(
        cls, json_str: str
    ) -> Union[StorageLocationAzure, StorageLocationGcs, StorageLocationS3,
...
class StorageLocationModel():
    ...
    def _to_model(self):
        return StorageLocation(name=self.name, )
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a StorageLocation.
    ...
    def from_dict(
        cls, obj: dict
    ) -> Union[StorageLocationAzureModel, StorageLocationGcsModel,
               StorageLocationS3Model, StorageLocationS3GovModel]:
        """Creates an instance of StorageLocation from a dict.
