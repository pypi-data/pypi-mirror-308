...
def try_single_quote_value(value: typing.Any) -> str:
...
def get_file(
    ...
    *,
    ...
    options: typing.Dict[str, typing.Union[int, str]] = {"parallel": parallel}
    ...
    if is_running_inside_stored_procedure():  # pragma: no cover
        try:
            ...
            cur._download(stage_location, target_directory, options)  # type: ignore [attr-defined]
...
def put_file(
    ...
    *,
    ...
    if is_running_inside_stored_procedure():  # pragma: no cover
        try:
            cur = root.connection.cursor()
            cur._upload(  # type: ignore [attr-defined]
                local_file_name,
                stage_location,
                {
                    "parallel": parallel,
