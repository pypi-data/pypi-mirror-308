...
class NamedDefaultModel():
    ...
    def _to_model(self):
        return NamedDefault(name=self.name, )

    @classmethod
    def _from_model(cls, model) -> NamedDefaultModel:
        return NamedDefaultModel(name=model.name, )

    def to_dict(self):
        """Creates a dictionary of the properties from a NamedDefault.
    ...
    def from_dict(cls, obj: dict) -> NamedDefaultModel:
        """Creates an instance of NamedDefault from a dict.
