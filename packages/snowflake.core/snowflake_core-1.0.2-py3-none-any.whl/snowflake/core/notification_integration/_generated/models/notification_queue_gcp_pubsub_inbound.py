...
class NotificationQueueGcpPubsubInbound(NotificationHook):
    ...
    def from_dict(cls, obj: dict) -> NotificationQueueGcpPubsubInbound:
        ...
        _obj = NotificationQueueGcpPubsubInbound.parse_obj({
            ...
            obj.get("gcp_pubsub_subscription_name"),
            "gcp_pubsub_service_account":
...
class NotificationQueueGcpPubsubInboundModel(NotificationHook):
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a NotificationQueueGcpPubsubInbound.
    ...
    def from_dict(cls, obj: dict) -> NotificationQueueGcpPubsubInboundModel:
        """Creates an instance of NotificationQueueGcpPubsubInbound from a dict.
        ...
        return cls._from_model(
            NotificationQueueGcpPubsubInbound.from_dict(obj))
