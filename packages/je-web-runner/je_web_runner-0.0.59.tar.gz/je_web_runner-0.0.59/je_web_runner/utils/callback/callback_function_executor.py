...
class CallbackFunctionExecutor(object):
    ...
    def __init__(self):
        self.event_dict: dict = {
            ...
            # webdriver wrapper
            "WR_set_driver": webdriver_wrapper.set_driver,
            "WR_set_webdriver_options_capability": webdriver_wrapper.set_driver,
            "WR_find_element": webdriver_wrapper.find_element_with_test_object_record,
            "WR_find_elements": webdriver_wrapper.find_elements_with_test_object_record,
            "WR_implicitly_wait": webdriver_wrapper.implicitly_wait,
            "WR_explict_wait": webdriver_wrapper.explict_wait,
            "WR_to_url": webdriver_wrapper.to_url,
            "WR_forward": webdriver_wrapper.forward,
            "WR_back": webdriver_wrapper.back,
            "WR_refresh": webdriver_wrapper.refresh,
            "WR_switch": webdriver_wrapper.switch,
            "WR_set_script_timeout": webdriver_wrapper.set_script_timeout,
            "WR_set_page_load_timeout": webdriver_wrapper.set_page_load_timeout,
            "WR_get_cookies": webdriver_wrapper.get_cookies,
            "WR_get_cookie": webdriver_wrapper.get_cookie,
            "WR_add_cookie": webdriver_wrapper.add_cookie,
            "WR_delete_cookie": webdriver_wrapper.delete_cookie,
            "WR_delete_all_cookies": webdriver_wrapper.delete_all_cookies,
            "WR_execute": webdriver_wrapper.execute,
            "WR_execute_script": webdriver_wrapper.execute_script,
            "WR_execute_async_script": webdriver_wrapper.execute_async_script,
            "WR_move_to_element": webdriver_wrapper.move_to_element_with_test_object,
            "WR_move_to_element_with_offset": webdriver_wrapper.move_to_element_with_offset_and_test_object,
            "WR_drag_and_drop": webdriver_wrapper.drag_and_drop_with_test_object,
            "WR_drag_and_drop_offset": webdriver_wrapper.drag_and_drop_offset_with_test_object,
            "WR_perform": webdriver_wrapper.perform,
            "WR_reset_actions": webdriver_wrapper.reset_actions,
            "WR_left_click": webdriver_wrapper.left_click_with_test_object,
            "WR_left_click_and_hold": webdriver_wrapper.left_click_and_hold_with_test_object,
            "WR_right_click": webdriver_wrapper.right_click_with_test_object,
            "WR_left_double_click": webdriver_wrapper.left_double_click_with_test_object,
            "WR_release": webdriver_wrapper.release_with_test_object,
            "WR_press_key": webdriver_wrapper.press_key_with_test_object,
            "WR_release_key": webdriver_wrapper.release_key_with_test_object,
            "WR_move_by_offset": webdriver_wrapper.move_by_offset,
            "WR_pause": webdriver_wrapper.pause,
            "WR_send_keys": webdriver_wrapper.send_keys,
            "WR_send_keys_to_element": webdriver_wrapper.send_keys_to_element_with_test_object,
            "WR_scroll": webdriver_wrapper.scroll,
            "WR_check_current_webdriver": webdriver_wrapper.check_current_webdriver,
            "WR_maximize_window": webdriver_wrapper.maximize_window,
            "WR_fullscreen_window": webdriver_wrapper.fullscreen_window,
            "WR_minimize_window": webdriver_wrapper.minimize_window,
            "WR_set_window_size": webdriver_wrapper.set_window_size,
            "WR_set_window_position": webdriver_wrapper.set_window_position,
            "WR_get_window_position": webdriver_wrapper.get_window_position,
            "WR_get_window_rect": webdriver_wrapper.get_window_rect,
            "WR_set_window_rect": webdriver_wrapper.set_window_rect,
            "WR_get_screenshot_as_png": webdriver_wrapper.get_screenshot_as_png,
            "WR_get_screenshot_as_base64": webdriver_wrapper.get_screenshot_as_base64,
            "WR_get_log": webdriver_wrapper.get_log,
            "WR_single_quit": webdriver_wrapper.quit,
            # web element
