...
def show_status_icon(iconPath: str, title: str, funcArgs: tuple, customExitFunction: Callable|None = None, exit: bool = False, addMenuItems: list[MenuItem] = [], useDefault: bool = True) -> None:
    """
