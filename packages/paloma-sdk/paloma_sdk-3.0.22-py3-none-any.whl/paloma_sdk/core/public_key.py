...
class SimplePublicKey(PublicKey):
    ...
    def address(self) -> str:
        return get_bech("paloma", self.raw_address().hex())
...
class ValConsPubKey(PublicKey):
    ...
    def address(self) -> str:
        return get_bech("palomavalcons", self.raw_address().hex())
...
class LegacyAminoMultisigPublicKey(PublicKey):
    ...
    def address(self) -> str:
        address = get_bech("paloma", self.raw_address())
        return address

    def pubkey_address(self) -> str:
        return get_bech("palomapub", str(self.encode_amino_pubkey()))
