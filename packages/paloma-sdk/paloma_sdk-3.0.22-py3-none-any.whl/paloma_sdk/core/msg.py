...
class Msg(BasePalomaData):
    ...
    def from_data(data: dict) -> Msg:
        from paloma_sdk.util.parse_msg import parse_msg

        return parse_msg(data)

    @staticmethod
    def from_proto(proto: any) -> Msg:
        from paloma_sdk.util.parse_msg import parse_proto

        return parse_proto(proto)

    @staticmethod
    def unpack_any(any_pb: Any_pb) -> Msg:
        from paloma_sdk.util.parse_msg import parse_unpack_any
