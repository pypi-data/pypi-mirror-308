...
from paloma_sdk.core import Coins, Dec
from paloma_sdk.core.deposit import Deposit
from paloma_sdk.core.gov import Proposal, ProposalStatus, WeightedVoteOption
from paloma_sdk.core.gov.data import Vote
    ...
    async def proposals(
        ...
        Args:
            options (dict, optional): dictionary containing options. Defaults to {}. you can use one or more below:
                {
                    "proposal_status": paloma_sdk.core.gov.ProposalStatus (int)
