...
echo
echo '[VERSION AT src/smyoon_sense_api/__init__.py]'
grep __version__ src/smyoon_sense_api/__init__.py
...
python3.8 -m twine upload dist/* --verbose --repository smyoon-sense-api
#rm -rf ~/.pypirc
