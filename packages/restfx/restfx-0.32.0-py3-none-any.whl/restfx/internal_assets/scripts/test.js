(function () {
    ...
    function initHeaders() {
        ...
        function addHeaderItem(checked, key, value) {
            var removeButton = el('a', {
                href: 'javascript:',
            ...
            var newRow = el('tr', {'class': 'test-row--header'}, [
                el('td', null, el('input', {
                    type: 'checkbox', 'class': 'test-header--checkbox', checked: checked ? 'checked' : undefined
                })),
                el('td', null, el('input', {
                    type: 'text', 'class': 'test-header--name arg-value', maxlength: 1024, value: key
                })),
                el('td', null, el('input', {
                    type: 'text', 'class': 'test-header--value arg-value', maxlength: 1024, value: value
                })),
                el('td', null, removeButton)
            ])
        ...
        // 添加默认的请求头
        addHeaderItem(true, 'accept', 'application/json;text')
        addHeaderItem(true, 'Cache-Control', 'no-cache')
        addHeaderItem(true, 'X-Requested-With', 'XMLHttpRequest')
    }
