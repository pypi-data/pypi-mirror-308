...
class HTTPBasic(Module):
    ...
    Configuration:
        - HTTPBASIC_ALLOW_SELF_SIGNUP: Whether to allow self-registration of users. Defaults to False.
        - HTTPBASIC_SQL_URL: The SQL connection URL. Defaults to "sqlite:///.db".
    """
    ...
    def __init__(
        ...
        """
        super().__init__("HTTPBasic", "HTTP Basic Authenticator", os.getenv("HTTPBASIC_SQL_URL", "sqlite:///.db"))
        self._allow_self_signup = os.getenv("HTTPBASIC_ALLOW_SELF_SIGNUP", False)
