        ...
        if self.custom_field_model:
            ...
            for key, value in self.initial_data.items():
                if key.startswith("custom_field_"):
                    ...
                    _req_custom_fields_data[custom_field_id] = {"field_type": "", "value": value}

            _req_custom_fields_id = list(_req_custom_fields_data.keys())

            custom_fields_configured = self.custom_field_model.objects.filter(
                tenant=tenant, status=CUSTOM_FIELD_STATUS[1][0]
            )
            ...
            for custom_field in custom_fields_configured:
                ...
                if _custom_field_id not in _req_custom_fields_id:
                    ...
                    custom_field_value = _req_custom_fields_data[_custom_field_id].get("value", "")

                    _req_custom_fields_data[_custom_field_id]["field_type"] = custom_field_type
