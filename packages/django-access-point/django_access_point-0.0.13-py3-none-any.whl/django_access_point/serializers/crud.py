...
class CrudSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        self.custom_field_queryset = self.context.get("custom_field_queryset", None)
        ...
        if self.custom_field_model:
            ...
            _req_custom_fields_id = list(custom_fields_data.keys())

            print(self.custom_field_queryset)
