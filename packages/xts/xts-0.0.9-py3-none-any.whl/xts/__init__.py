...
class XTSystemsSDK:
    def __init__(self, base_url: str = "http://localhost:20437", verbose: bool = True):
    ...
    def user_exists(self, email):
        response = requests.get(f"{self.base_url}/v1/user/exists?email={email}")
        if self.verbose:
            parse_response(response)
    ...
    def get_user(self):
        response = requests.get(f"{self.base_url}/v1/user", headers=self.headers)
        if self.verbose:
            parse_response(response)
        return response.json()
    ...
    def create_invitation(self, email: str, company_id: str, role_id: int):
        response = requests.post(
            f"{self.base_url}/v1/invitations",
            headers=self.headers,
    ...
    def accept_invitation(self, invitation_id: str):
        response = requests.post(
            f"{self.base_url}/v1/invitations/{invitation_id}/accept",
            headers=self.headers,
        )
        if self.verbose:
            parse_response(response)
    ...
    def verify_stripe_session(self, session_id):
        response = requests.post(
            f"{self.base_url}/v1/verify-stripe-session",
            headers=self.headers,
    ...
    def create_checkout_session(self):
        response = requests.post(
            f"{self.base_url}/v1/create-checkout-session", headers=self.headers
        )
        if self.verbose:
            parse_response(response)
        return response.json()
    ...
    def create_portal_session(self):
        response = requests.post(
            f"{self.base_url}/v1/create-portal-session", headers=self.headers
        )
        if self.verbose:
            parse_response(response)
        return response.json()
    ...
    def delete_user(self):
        response = requests.delete(f"{self.base_url}/v1/user", headers=self.headers)
        if self.verbose:
            parse_response(response)
        return response.json()
    ...
    def register_machine(self, company_id: str, hostname: str, device_data: dict = {}):
        response = requests.post(
    ...
    def learn_file(
        ...
        try:
            if not company_id:
                response = requests.post(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/learn/file",
                    json={
                        "file_name": file_name,
    ...
    def learn_url(
        ...
        try:
            if not company_id:
                response = requests.post(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/learn/url",
                    json={
                        "url": url,
                        "collection_number": collection_number,
                    },
    ...
    def positive_feedback(
        ...
        try:
            response = requests.post(
                headers=self.headers,
                url=f"{self.base_url}/api/agent/{agent_name}/feedback",
                json={
    ...
    def fork_conversation(
        ...
        try:
            response = requests.post(
                headers=self.headers,
                url=f"{self.base_url}/api/conversation/fork",
    ...
    def delete_conversation_message(
        ...
        try:
            response = requests.delete(
                headers=self.headers,
                url=f"{self.base_url}/api/conversation/message",
                json={
                    "message": message,
                    "agent_name": agent_name,
                    "conversation_name": conversation_name,
    ...
    def get_memories_external_sources(
        ...
        try:
            if not company_id:
                response = requests.get(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/memory/external_sources/{collection_number}",
                )
            else:
                response = requests.get(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/memory/external_sources/{collection_number}/{company_id}",
                )
            if self.verbose:
                parse_response(response)
    ...
    def get_persona(self, agent_name: str, company_id: str = None) -> str:
        try:
            if company_id:
                response = requests.get(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/persona/{company_id}",
                )
            else:
                response = requests.get(
                    headers=self.headers,
                    url=f"{self.base_url}/api/agent/{agent_name}/persona",
                )
            if self.verbose:
                parse_response(response)
            return response.json()["message"]
