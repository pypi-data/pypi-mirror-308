...
class WeatherPeriodTotalsV1Legends(DataGardenModelLegends):
	...
	DAYS_WITH_WEATHER_DATA = (
		"number of days for which weather data is available during the period"
	)
	DAYS_WITH_METRIC_DATA = (
		"number of days for which metric data is available during the period"
	)
