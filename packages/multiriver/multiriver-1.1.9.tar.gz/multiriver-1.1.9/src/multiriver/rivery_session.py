...
class RiverySession:
    ...
    def create_logic_river(self, river_ids, group_id, cron_schedule=None, **kwargs):
        ...
        for river_id in river_ids:
            logs_steps.append(
                json.loads(utils.liberal_format(LOGIC_STEP_BODY, logic_step_name=f"Logic Step {river_id}", river_id=river_id))
            )
