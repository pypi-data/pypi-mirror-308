...
class LocalEnvoy(ABC):
    ...
    async def start(self) -> None:
        # Begin with an empty set of consensuses. Set this explicitly, so that
        # the xDS server at least opens the listener port.
        await self.set_consensuses({})
