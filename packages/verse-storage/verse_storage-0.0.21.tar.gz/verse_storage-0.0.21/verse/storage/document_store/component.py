...
class DocumentStore(StoreComponent):
    ...
    def _attach_component_parameters(self):
        setattr(self.provider, "collection", self.collection)
        setattr(self.provider, "id_map_field", self.id_map_field)
        setattr(self.provider, "pk_map_field", self.pk_map_field)
