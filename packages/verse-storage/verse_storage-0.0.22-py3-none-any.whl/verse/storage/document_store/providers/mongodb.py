...
class ResourceHelper:
    ...
    def drop_collection(self, collection: str, nargs: Any):
        NCall(self.database_client[collection].drop, None, nargs).invoke()
...
class AsyncResourceHelper:
    ...
    async def drop_collection(self, collection: str, nargs: Any):
        await NCall(
            self.database_client[collection].drop, None, nargs
        ).ainvoke()
