...
def option_ipa(args):
    ...
    if check_modifiers('-ipa',args,["-fileOutput","-limit","-nf","-from","-to","-around","-minutes","-contains","-orderNumber"],help) == False: return
...
def option_ipe(args):
    ...
    if check_modifiers('-ipe',args,["-fileOutput","-limit","-last","-where","-contains"],help) == False: return
    ...
    return VlocityErrorLog.print_error_list(where=where,limit=limit,contains=contains)
