...
class TestClient:
    ...
    def test_method_create(self, client: DeeporiginData) -> None:
        ...
        assert_matches_type(CreateResponse, client_, path=["response"])
    ...
    def test_method_add_database_column_with_all_params(self, client: DeeporiginData) -> None:
        client_ = client.add_database_column(
            column={
                ...
                "type": "boolean",
                "cell_json_schema": {},
                "enabled_viewers": ["code", "html", "image"],
    ...
    def test_streaming_response_download_file(self, client: DeeporiginData) -> None:
        with client.with_streaming_response.download_file() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list_database_column_unique_values_overload_1(self, client: DeeporiginData) -> None:
        client_ = client.list_database_column_unique_values(
            column_id="columnId",
        )
        assert_matches_type(ListDatabaseColumnUniqueValuesResponse, client_, path=["response"])
    ...
    @parametrize
    def test_method_list_messages(self, client: DeeporiginData) -> None:
        client_ = client.list_messages(
            thread_id="threadId",
        )
        assert_matches_type(ListMessagesResponse, client_, path=["response"])

    @parametrize
    def test_raw_response_list_messages(self, client: DeeporiginData) -> None:
        response = client.with_raw_response.list_messages(
            thread_id="threadId",
        )
    ...
    @parametrize
    def test_streaming_response_list_messages(self, client: DeeporiginData) -> None:
        with client.with_streaming_response.list_messages(
            thread_id="threadId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_method_send_message(self, client: DeeporiginData) -> None:
        client_ = client.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
    ...
    @parametrize
    def test_method_send_message_with_all_params(self, client: DeeporiginData) -> None:
        client_ = client.send_message(
            messages=[
                {
                    "content": "x",
    ...
    @parametrize
    def test_raw_response_send_message(self, client: DeeporiginData) -> None:
        response = client.with_raw_response.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
    ...
    @parametrize
    def test_streaming_response_send_message(self, client: DeeporiginData) -> None:
        with client.with_streaming_response.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
...
class TestAsyncClient:
    ...
    async def test_method_create(self, async_client: AsyncDeeporiginData) -> None:
        client = await async_client.create(
            body={},
        )
        assert_matches_type(CreateResponse, client, path=["response"])

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncDeeporiginData) -> None:
        response = await async_client.with_raw_response.create(
            body={},
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncDeeporiginData) -> None:
        async with async_client.with_streaming_response.create(
            body={},
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_download_file(self, async_client: AsyncDeeporiginData) -> None:
        async with async_client.with_streaming_response.download_file() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list_database_column_unique_values_overload_1(
        ...
        client = await async_client.list_database_column_unique_values(
            column_id="columnId",
        )
        assert_matches_type(ListDatabaseColumnUniqueValuesResponse, client, path=["response"])
    ...
    @parametrize
    async def test_method_list_messages(self, async_client: AsyncDeeporiginData) -> None:
        client = await async_client.list_messages(
            thread_id="threadId",
        )
        assert_matches_type(ListMessagesResponse, client, path=["response"])

    @parametrize
    async def test_raw_response_list_messages(self, async_client: AsyncDeeporiginData) -> None:
        response = await async_client.with_raw_response.list_messages(
            thread_id="threadId",
        )
    ...
    @parametrize
    async def test_streaming_response_list_messages(self, async_client: AsyncDeeporiginData) -> None:
        async with async_client.with_streaming_response.list_messages(
            thread_id="threadId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_method_send_message(self, async_client: AsyncDeeporiginData) -> None:
        client = await async_client.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
    ...
    @parametrize
    async def test_method_send_message_with_all_params(self, async_client: AsyncDeeporiginData) -> None:
        client = await async_client.send_message(
            messages=[
                {
                    "content": "x",
    ...
    @parametrize
    async def test_raw_response_send_message(self, async_client: AsyncDeeporiginData) -> None:
        response = await async_client.with_raw_response.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
    ...
    @parametrize
    async def test_streaming_response_send_message(self, async_client: AsyncDeeporiginData) -> None:
        async with async_client.with_streaming_response.send_message(
            messages=[
                {
                    "content": "x",
                    "role": "user",
