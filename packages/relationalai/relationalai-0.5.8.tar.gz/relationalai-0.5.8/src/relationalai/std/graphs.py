...
class Compute:
    ...
    def eigenvector_centrality(self, node):
        if not self._graph.undirected:
            raise DirectedGraphNotSupported("eigenvector_centrality")
    ...
    def louvain(
        ...
        # [FUTURE TODO]: The following check should be un-commented when
        #   to make Louvain start throwing an exception when passed a directed graph.
        #
        # if not self._graph.undirected:
        #     raise DirectedGraphNotApplicable("louvain")
