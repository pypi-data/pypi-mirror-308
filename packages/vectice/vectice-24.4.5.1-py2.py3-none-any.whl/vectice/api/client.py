...
if TYPE_CHECKING:
    ...
    from vectice.api.json import ProjectOutput, WorkspaceOutput
...
class Client:
    ...
    def create_project(self, workspace_id: str, project: ProjectInput) -> ProjectOutput:
        project_full_copy_enabled = self.is_feature_flag_enabled("project-full-copy")

        return ProjectApi(self._gql_client, self.auth).create_project(workspace_id, project, project_full_copy_enabled)
