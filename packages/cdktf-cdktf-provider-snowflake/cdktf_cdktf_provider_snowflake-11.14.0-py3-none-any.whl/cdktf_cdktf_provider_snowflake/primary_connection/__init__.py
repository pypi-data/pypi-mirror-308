...
class PrimaryConnection(
    ...
    def __init__(
        ...
        *,
        ...
        :param comment: Specifies a comment for the connection. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/primary_connection#comment PrimaryConnection#comment}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing PrimaryConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/primary_connection#import import section} in the documentation of this resource for the id to use
