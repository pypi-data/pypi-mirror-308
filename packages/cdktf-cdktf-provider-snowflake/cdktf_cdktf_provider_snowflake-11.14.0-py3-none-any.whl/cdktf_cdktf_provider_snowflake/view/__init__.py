...
class View(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing View that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#import import section} in the documentation of this resource for the id to use
    ...
    def put_aggregation_policy(
        ...
        *,
        ...
        '''
        :param policy_name: Aggregation policy name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#policy_name View#policy_name}
        :param entity_key: Defines which columns uniquely identify an entity within the view. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#entity_key View#entity_key}
        '''
    ...
    def put_row_access_policy(
        ...
        *,
        ...
        '''
        :param on: Defines which columns are affected by the policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#on View#on}
        :param policy_name: Row access policy name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#policy_name View#policy_name}
        '''
...
class ViewColumn:
    def __init__(
        ...
        *,
        ...
        '''
        :param column_name: Specifies affected column name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#column_name View#column_name}
        :param comment: Specifies a comment for the column. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#comment View#comment}
        :param masking_policy: masking_policy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#masking_policy View#masking_policy}
        :param projection_policy: projection_policy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#projection_policy View#projection_policy}
        '''
...
class ViewColumnOutputReference(
    ...
    def put_projection_policy(self, *, policy_name: builtins.str) -> None:
        '''
        :param policy_name: Specifies the projection policy to set on a column. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/view#policy_name View#policy_name}
        '''
