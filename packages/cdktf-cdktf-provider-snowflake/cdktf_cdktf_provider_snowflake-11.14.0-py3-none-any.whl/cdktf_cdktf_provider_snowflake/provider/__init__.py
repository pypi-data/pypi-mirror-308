...
class SnowflakeProvider(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs#import import section} in the documentation of this resource for the id to use
