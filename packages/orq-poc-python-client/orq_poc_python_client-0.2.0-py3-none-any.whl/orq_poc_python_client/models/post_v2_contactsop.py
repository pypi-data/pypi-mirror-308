...
class PostV2ContactsRequestBodyTypedDict(TypedDict):
...
class PostV2ContactsRequestBody(BaseModel):
    r"""Update user information payload"""
...
class PostV2ContactsResponseBodyTypedDict(TypedDict):
...
class PostV2ContactsResponseBody(BaseModel):
    r"""Successful operation"""
    ...
    updated: Optional[datetime] = dateutil.parser.isoparse("2024-11-12T13:40:39.730Z")
    r"""The date and time the resource was last updated"""
