...
RouterChatCompletionsMessagesRouterChatCompletionsRequestRole = Literal["tool"]
r"""The role of the messages author, in this case **tool**."""

RouterChatCompletions2RouterChatCompletionsRequestRequestBodyMessages4Type = Literal[
    "image_url"
]

RouterChatCompletions2Detail = Literal["low", "high", "auto"]
...
RouterChatCompletions2RouterChatCompletionsRequestRequestBodyMessagesType = Literal[
    "text"
]
...
RouterChatCompletionsMessagesRouterChatCompletionsRole = Literal["assistant"]
...
RouterChatCompletionsMessagesRole = Literal["user"]
r"""The role of the messages author, in this case **user**."""

RouterChatCompletions2RouterChatCompletionsRequestRequestBodyType = Literal["image_url"]
...
RouterChatCompletions2RouterChatCompletionsRequestType = Literal["text"]
...
RouterChatCompletions2RouterChatCompletionsType = Literal["image_url"]
...
RouterChatCompletions2Type = Literal["text"]
...
RouterChatCompletionsType = Literal["function"]
r"""The type of the tool. Currently, only function is supported."""

RouterChatCompletionsRouterChatCompletionsType = Literal["object"]
...
ResponseBodyFinishReason = Literal["stop", "length", "content_filter", "tool_calls"]
...
RouterChatCompletionsResponseBodyType = Literal["function"]
...
RouterChatCompletionsResponseBodyRole = Literal[
    "system",
    "assistant",
    "user",
    "exception",
...
RouterChatCompletionsResponseBodyFinishReason = Literal[
