...
class Logger:
    ...
    def __init__(self, endpoint_server: str, endpoint_port: int, endpoint_command: str, api_token: str, application: str, resolveRemoteSource: bool = False):
        ...
        self.__api_url = f"http://{endpoint_server}:{endpoint_port}/{endpoint_command}"
    ...
    def fullSend(self, title: str, category: str, category2: str, syslogLevel: int, contents: str):
        """
        ...
        Args:
            ...
            syslogLevel (int): The system log level (SYSLOG level code) of the entry.
