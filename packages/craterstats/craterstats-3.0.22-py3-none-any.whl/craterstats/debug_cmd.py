...
def main():
    ...
    cmd = r'-i "D:\mydocs\publications\2024-10 sequence probability\figs\ce6 site seq\ce-6 mare.cs"'
    cmd = r'-cs yue22 -ep moon -p source=%sample%/Pickering.scc -p type=poisson,range=[.2,7] -p range=[2,5]'
