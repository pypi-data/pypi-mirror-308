...
class ControlTowerClient(BaseClient):
    ...
    def reset_enabled_control(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/controltower.html#ControlTower.Client.reset_enabled_control)
