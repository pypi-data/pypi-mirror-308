    ...
    def copy(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"proj_name": proj_name}, template_copy_params.TemplateCopyParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncTemplatesResource(AsyncAPIResource):
    ...
    async def copy(
        ...
        *,
        ...
        return await self._post(
            f"/v1/templates/{template_id}/copy",
            body=await async_maybe_transform({"proj_name": proj_name}, template_copy_params.TemplateCopyParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TemplateCopyResponse,
