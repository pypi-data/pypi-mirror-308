...
class AssetsExtractResource(SyncAPIResource):
    ...
    def extract(
        ...
        *,
        ...
        auth_key: str | NotGiven = NOT_GIVEN,
        log_level: Literal["verbose", "concise"] | NotGiven = NOT_GIVEN,
        parse_strategy: Literal["optimized", "ocr", "markdown", "xml"] | NotGiven = NOT_GIVEN,
        ...
        Args:
          log_level: An enumeration.

          parse_strategy: An enumeration.
