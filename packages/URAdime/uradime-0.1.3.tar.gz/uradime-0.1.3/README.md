...
uradime \
    ...
    --window-size 20 \                # Allowed padding on the 5' ends of the reads, sometime needs to be very big due to universal tails etc.
    --ignore-amplicon-size \          # Usefull if short read sequecing like Illumina
