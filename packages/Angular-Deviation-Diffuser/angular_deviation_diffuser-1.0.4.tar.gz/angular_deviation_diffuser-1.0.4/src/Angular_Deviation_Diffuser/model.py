...
from Angular_Deviation_Diffuser.loss as loss
...
class FoldingDiff(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # scheduler = LinearAnnealingLR(optimizer, num_annealing_steps=1000, num_total_steps=4000,global_step_func=self.get_global_step)
