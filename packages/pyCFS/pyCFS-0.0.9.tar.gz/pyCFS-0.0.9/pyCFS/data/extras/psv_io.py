...
def read_unv(
    ...
    data_type : str, optional
        type of data:
         ...
         'Coherence' = Coherence
         _custom_string_ = data labeled with _custom_string_
    ...
    if measurement_3d:
        ...
        psv_data["data3D"] = np.array(data_3d)
    else:
        psv_data["data"] = []
        ...
        for i in progressbar(uff_setn_data, "Reading dataset: "):
            ...
            if entry["id2"] == id2_str:
                psv_data["data"].append(entry["data"])
...
def convert_frf_data(psv_data: Dict, operator, data_name_conversion_dict: Dict) -> Dict:
...
def combine_frf_3D(psv_data1: Dict, psv_data2: Dict, psv_data3: Dict, eps=1e-9) -> Dict:
    """Compute 3D FRF from 3 single frf_data including psv_coord information."""
    data1 = psv_data1["data"]
    data2 = psv_data2["data"]
    data3 = psv_data3["data"]
