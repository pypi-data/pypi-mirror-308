...
.. |commits-since| image:: https://img.shields.io/github/commits-since/ionelmc/python-csu/v1.2.0.svg
    :alt: Commits since latest release
    :target: https://github.com/ionelmc/python-csu/compare/v1.2.0...main
