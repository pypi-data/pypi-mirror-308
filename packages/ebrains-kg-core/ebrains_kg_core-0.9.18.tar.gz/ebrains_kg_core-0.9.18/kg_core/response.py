...
class Scope(BaseModel):
    uuid: Optional[UUID] = Field(alias="id")
...
class SpaceInformation(BaseModel):
    identifier: Optional[str] = Field(alias="http://schema.org/identifier")
    name: Optional[str] = Field(alias="http://schema.org/name")
    permissions: Optional[List[str]] = Field(alias="https://core.kg.ebrains.eu/vocab/meta/permissions")


class TypeInformation(BaseModel):
    identifier: Optional[str] = Field(alias="http://schema.org/identifier")
    description: Optional[str] = Field(alias="http://schema.org/description")
    name: Optional[str] = Field(alias="http://schema.org/name")
    # TODO incoming_links
    occurrences: Optional[int] = Field(alias="https://core.kg.ebrains.eu/vocab/meta/occurrences")
...
class ReducedUserInformation(BaseModel):
    alternate_name: Optional[str] = Field(alias="http://schema.org/alternateName")
    name: Optional[str] = Field(alias="http://schema.org/name")
    uuid: Optional[UUID] = Field(alias="@id")
...
class User(BaseModel):
    alternate_name: Optional[str] = Field(alias="http://schema.org/alternateName")
    name: Optional[str] = Field(alias="http://schema.org/name")
    email: Optional[str] = Field(alias="http://schema.org/email")
    given_name: Optional[str] = Field(alias="http://schema.org/givenName")
    family_name: Optional[str] = Field(alias="http://schema.org/familyName")
    identifiers: Optional[List[str]] = Field(alias="http://schema.org/identifier")


class UserWithRoles(BaseModel):
    user: User
    client_roles: Optional[List[str]] = Field(alias="clientRoles")
    user_roles: Optional[List[str]] = Field(alias="userRoles")
