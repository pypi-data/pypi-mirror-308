...
class Agent: 
    ...
    def _apply_filters(self, percepts: Dict[str, Dict[str, Set[Percept]]], env_name: str):
        ...
        self.print(f"Percept Filter: Focus: {self.percept_filter['focus']}({len(self.percept_filter['focus'])}), Ignore: {self.percept_filter['ignore']}({len(self.percept_filter['ignore'])})  {focusing}")
