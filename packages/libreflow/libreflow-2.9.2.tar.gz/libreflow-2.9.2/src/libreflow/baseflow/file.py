...
bpy.ops.lfs.playblast(do_render=%s, filepath='%s', studio='%s', project='%s', sequence='%s', scene='%s', do_simplify=%s, version='%s', template_path='%s', do_autoplay=%s, frame_count=%s)""" % (
            str(do_render),
            self.output_path,
