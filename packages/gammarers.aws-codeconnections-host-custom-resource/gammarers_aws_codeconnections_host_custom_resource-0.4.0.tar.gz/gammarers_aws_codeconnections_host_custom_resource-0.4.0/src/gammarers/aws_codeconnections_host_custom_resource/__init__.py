    ...
    def __init__(
        ...
        *,
        ...
        props = CodeConnectionsHostCustomResourceProps(
            ...
            resouce_naming_option=resouce_naming_option,
        )
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "resouce_naming_option": "resouceNamingOption",
    },
)
class CodeConnectionsHostCustomResourceProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument resouce_naming_option", value=resouce_naming_option, expected_type=type_hints["resouce_naming_option"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "name": name,
            "provider_endpoint": provider_endpoint,
            "provider_type": provider_type,
        }
        if resouce_naming_option is not None:
            self._values["resouce_naming_option"] = resouce_naming_option
    ...
    def resouce_naming_option(
        ...
        result = self._values.get("resouce_naming_option")
