...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, base_path=None, hidden=False, name=None, prn=None, pulp_href=None, no_content_change_since=None, pulp_last_updated=None, base_url=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
