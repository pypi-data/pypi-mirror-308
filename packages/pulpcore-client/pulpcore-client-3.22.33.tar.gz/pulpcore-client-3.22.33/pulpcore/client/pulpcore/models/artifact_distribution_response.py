...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_url=None, content_guard=None, base_path=None, name=None, pulp_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
