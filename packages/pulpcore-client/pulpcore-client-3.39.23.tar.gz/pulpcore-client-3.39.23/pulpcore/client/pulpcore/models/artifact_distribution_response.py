...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, name=None, base_path=None, pulp_created=None, content_guard=None, pulp_href=None, base_url=None, local_vars_configuration=None):  # noqa: E501
