...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_last_updated=None, pulp_href=None, base_path=None, pulp_labels=None, name=None, content_guard=None, base_url=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
