...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_created=None, base_path=None, content_guard=None, pulp_labels=None, name=None, pulp_href=None, base_url=None, local_vars_configuration=None):  # noqa: E501
