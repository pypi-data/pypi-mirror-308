...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, no_content_change_since=None, content_guard=None, base_url=None, pulp_created=None, name=None, pulp_href=None, pulp_labels=None, base_path=None, pulp_last_updated=None, hidden=False, prn=None, local_vars_configuration=None):  # noqa: E501
