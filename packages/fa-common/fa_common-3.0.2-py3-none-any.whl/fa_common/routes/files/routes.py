...
from fa_common.routes.files.utils import extension_to_mimetype, is_image
...
async def get_raw_table(
    ...
    response = await service.get_table_from_file(file, offset, limit, seperator, sheet, return_format=response_format)
