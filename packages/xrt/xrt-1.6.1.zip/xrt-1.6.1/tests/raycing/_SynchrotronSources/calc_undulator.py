...
def flux_through_aperture(energy, theta, psi, I0):
    ...
    plt.savefig("01 - Flux_ap_{}.png".format("new" if newCode else "old"))
...
def intensity_in_transverse_plane(energy, theta, psi, I0):
    ...
    plt.savefig("02 - Intensity_tr_plane_{}.png".format("new" if newCode else "old"))
...
#    hsvC = np.stack((hue, sat, val), axis=2) # numpy1.10
    ...
    plt.savefig("03 - Intensity_tr_plane_color_{}.png".format("new" if newCode else "old"))
