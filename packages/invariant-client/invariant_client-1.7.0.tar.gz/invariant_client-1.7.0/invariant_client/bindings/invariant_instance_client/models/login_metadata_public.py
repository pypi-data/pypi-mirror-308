...
T = TypeVar("T", bound="LoginMetadataPublic")


@_attrs_define
class LoginMetadataPublic:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        login_metadata_public.additional_properties = d
        return login_metadata_public
