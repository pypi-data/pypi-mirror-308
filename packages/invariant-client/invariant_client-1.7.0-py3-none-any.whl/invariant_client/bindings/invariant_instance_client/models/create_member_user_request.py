...
T = TypeVar("T", bound="CreateMemberUserRequest")


@_attrs_define
class CreateMemberUserRequest:
    """
    Attributes:
        type (Literal['member']):
        email (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_member_user_request = cls(
            type=type,
            email=email,
        ...
        create_member_user_request.additional_properties = d
        return create_member_user_request
