...
from meutils.schemas.oneapi_types import REDIRECT_MODEL, NOTICE, FOOTER
from meutils.schemas.oneapi_types import MODEL_PRICE, MODEL_RATIO, COMPLETION_RATIO, GROUP_RATIO, USER_USABLE_GROUPS
