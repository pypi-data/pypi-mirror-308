...
def save_file_temporarily(file):
    """
    Guarda un archivo temporalmente en el sistema y lo elimina después.

    Args:
        file (bytes): Contenido del archivo que se desea almacenar temporalmente.

    Returns:
        str: Ruta del archivo temporal creado antes de ser eliminado.

    Raises:
        Exception: En caso de error al guardar o eliminar el archivo.
    """
    import tempfile
    import os
