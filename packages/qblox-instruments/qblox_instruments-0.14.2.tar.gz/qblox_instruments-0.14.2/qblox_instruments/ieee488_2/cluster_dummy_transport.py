...
class ClusterDummyTransport(DummyTransport):
    ...
    # ------------------------------------------------------------------------
    def __init__(self, dummy_cfg: Dict[Union[str, int], ClusterType]):
        """
        ...
        for slot_idx in dummy_cfg:
            if str(slot_idx) in self._modules:
                self._modules[str(slot_idx)] = QcmQrmDummyTransport(dummy_cfg[slot_idx])
    ...
    def delete_dummy_binned_acquisition_data(
        ...
        ----------
        """
        self._modules[str(slot_idx)].delete_dummy_binned_acquisition_data(
    ...
    # ------------------------------------------------------------------------
    def delete_dummy_scope_acquisition_data(self, slot_idx: int):
        """
