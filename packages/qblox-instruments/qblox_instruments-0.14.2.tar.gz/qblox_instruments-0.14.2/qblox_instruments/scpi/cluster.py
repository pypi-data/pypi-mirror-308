...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.9.0 fwBuild=30/07/2024-12:43:40 fwHash=0x80063CC5 fwDirty=0 kmodVersion=0.9.2 kmodBuild=08/11/2024-08:05:02 kmodHash=0x4700EAF9 kmodDirty=0 swVersion=0.9.2 swBuild=08/11/2024-08:05:02 swHash=0x4700EAF9 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=08/11/2024-08:05:02 cfgManHash=0x4700EAF9 cfgManDirty=0"
            if build != build_ref:
