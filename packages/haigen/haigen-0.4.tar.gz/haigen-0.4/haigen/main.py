...
class Haigen(BaseChatModel):
    ...
    llm_url: str = None
    heigen_api_key: str = None

    def __init__(self, llm_url, heigen_api_key, *args,**kwargs):
        super().__init__(*args, **kwargs)
        self.llm_url = llm_url
        self.heigen_api_key = heigen_api_key
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        headers = {
            ...
            "Authorization": f"Bearer {self.heigen_api_key}"
        }
