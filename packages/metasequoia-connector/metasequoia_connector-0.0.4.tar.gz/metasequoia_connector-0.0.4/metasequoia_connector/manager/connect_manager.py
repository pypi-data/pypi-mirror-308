...
class ConnectManager:
    ...
    def __init__(self, config_path: str, mode: str = "dev"):
        # 从配置文件中读取配置信息
    ...
    @classmethod
    def from_environment(cls, environ_name: Optional[str] = None, mode: str = "dev"):
        ...
        return ConnectManager(config_path, mode=mode)  # 实现配置信息的单例
