...
class File(PydanticSubtypeSerializable):
    ...
    def save(self, output_path: str, default_file_name: str = None, custom_formatter=None, exclude_defaults=False) -> str:
        ...
        with open(output_path, 'w') as fout:
            data = self.json(exclude_unset=True, exclude_none=True,
                             exclude_defaults=exclude_defaults, indent=True)
            lines = yaml.safe_dump(json.loads(data),
