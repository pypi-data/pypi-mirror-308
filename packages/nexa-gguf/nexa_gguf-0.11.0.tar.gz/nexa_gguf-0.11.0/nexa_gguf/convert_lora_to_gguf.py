...
import nexa_gguf
from nexa_gguf.convert_hf_to_gguf import LazyTorchTensor, Model
...
def nexa_convert_lora_to_gguf(
    ...
    ftype = ftype_map[outtype]

    dir_base_model: Path | None = base
    dir_lora: Path = lora_path
    ...
    with torch.inference_mode():
        ...
        class LoraModel(model_class):
            ...
            def set_type(self):
                self.gguf_writer.add_type(nexa_gguf.GGUFType.ADAPTER)
                self.gguf_writer.add_string(nexa_gguf.Keys.Adapter.TYPE, "lora")

            def set_gguf_parameters(self):
                self.gguf_writer.add_float32(nexa_gguf.Keys.Adapter.LORA_ALPHA, self.lora_alpha)
