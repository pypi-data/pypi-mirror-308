...
def tidal_potential(
    ...
    mode_coeffs = (
        # n
        (-e - (9. /  8.) * e3) * cos4_p_sin4 + (5. * e + (13. / 3.) * e3) * cos2_sin2,
        # 2n
        (-3. / 2.) * e2 * cos4_p_sin4 + (-2. + 11.) * cos2_sin2,
        # 3n
        (-53. / 24.) * e3 * cos4_p_sin4 + (-7. * e + (581. / 24.) * e3) * cos2_sin2,
        # 4n
        -17. * e2 * cos2_sin2,
        # 5n
        (-845. / 24.) * e3 * cos2_sin2,
        # 2o + n
        ((-1. / 12.) * e + (1. / 96.) * e3) * sin_o_4 + (1. / 288.) * e3 + \
            ((1. / 2.) * e + (9. / 16.) * e3) * cos2_sin2,
        # 2o + 2n
        ((1. / 6.) - (5. / 12.) * e2) * sin_o_4 + (3. / 4.) * e2 * cos2_sin2,
        # 2o + 3n
        ((7. / 12.) * e - (41. / 32.) * e3) * sin_o_4 + (53. / 48.) * e3 * cos2_sin2,
        # 2o + 4n
        (17. / 12.) * e2 * sin_o_4,
        # 2o + 5n
        (845. / 288.) * e3 * sin_o_4,
        # 2o - n
        ((-1. / 12.) * e + (1. / 96.) * e3) * cos_o_4 + (1. / 288.) * e3 * sin_o_4 + \
            ((1. / 2.) * e + (9. / 16.) * e3) * cos2_sin2,
        # 2o - 2n
        ((1. / 6.) - (5. / 12.) * e2) * cos_o_4 + (3. / 4.) * e2 * cos2_sin2,
        # 2o - 3n
        ((7. / 12.) * e - (41. / 32.) * e3) * cos_o_4 + (53. / 48.) * e3 * cos2_sin2,
        # 2o - 4n
        (17. / 12.) * e2 * cos_o_4,
        # 2o - 5n
        (845. / 288.) * e3 * cos_o_4,
        # o
        ((2. / 3.) + e2) * cos3_sin + ((-2. / 3.) - e2) * sin3_cos,
        # 2o
        ((1. / 3.) + (1. / 2.) * e2) * cos2_sin2,
        # o + n
        ((-4. / 3.) * e - (13. / 12.) * e3) * sin3_cos + (e + (10. / 9.) * e3) * cos3_sin,
        # o + 2n
        ((2. / 3.) - (19. / 6.) * e2) * sin3_cos + (3. / 2.) * e2 * cos3_sin,
        # o + 3n
        ((7. / 3.) * e - (22. / 3.) * e3) * sin3_cos + (53. / 24.) * e3 * cos3_sin,
        # o + 4n
        (17. / 3.) * e2 * sin3_cos,
        # o + 5n
        (845. / 72.) * e3 * sin3_cos,
        # o - n
        (-e - (10. / 9.) * e3) * sin3_cos + ((4. / 3.) * e + (13. / 12.) * e3) * cos3_sin,
        # o - 2n
        ((-2. / 3.) + (19. / 6.) * e2) * cos3_sin + (-3. / 2.) * e2 * sin3_cos,
        # o - 3n
        (-53. / 24.) * e3 * sin3_cos + ((-7. / 3.) * e + (22. / 3.) * e3) * cos3_sin,
        # o - 4n
        (-17. / 3.) * e2 * cos3_sin,
        # o - 5n
        (-845. / 72.) * e3 * cos3_sin
    ...
    static_coeff = ((-1. / 3.) - (1. / 2.) * e2) * cos4_p_sin4 + ((4. / 3.) + 2. * e2) * cos2_sin2
