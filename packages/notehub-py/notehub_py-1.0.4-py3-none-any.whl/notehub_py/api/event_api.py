...
class EventApi:
    ...
    def get_fleet_events(
        ...
        date_type: Annotated[Optional[StrictStr], Field(description="Which date to filter on, either 'captured' or 'uploaded'.  This will apply to the startDate and endDate parameters")] = None,
