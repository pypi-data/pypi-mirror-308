...
class WithdrawBankTransferRequest(BaseModel):
    ...
    """ # noqa: E501
    currency: Optional[Currency] = Field(description="Required. ISO 4217 currency code of the bank transfer. Barion does not perform currency conversion; ensure compatibility with recipient bank. ", alias="Currency")
