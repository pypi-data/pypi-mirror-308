...
class UserInformation(BaseModel):
    ...
    UserInformation
    """ # noqa: E501
    name: Optional[NameInformation] = Field(default=None, description="Structure representing the name of the user.", alias="Name")
    email: Optional[StrictStr] = Field(default=None, description="The e-mail address of the user.", alias="Email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Name": NameInformation.from_dict(obj["Name"]) if obj.get("Name") is not None else None,
            "Email": obj.get("Email")
        })
        return _obj
