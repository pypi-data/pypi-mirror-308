...
class DetailedPaymentTransaction(BaseModel):
    ...
    currency: Optional[Currency] = Field(default=None, description="The 3 character ISO 4217 currency code of the transaction.", alias="Currency")
    ...
    status: Optional[TransactionStatus] = Field(default=None, description="The current status of the transaction.", alias="Status")
