...
class BillingAddress(BaseModel):
    ...
    BillingAddress
    """ # noqa: E501
    country: Optional[Annotated[str, Field(strict=True, max_length=2)]] = Field(default=None, description="The payer's country code in ISO-3166-1 format (e.g., HU or DE). Use `ZZ` if shipping address is not available.", alias="Country")
    ...
    region: Optional[Annotated[str, Field(strict=True, max_length=2)]] = Field(default=None, description="Send `null` if not applicable. The country subdivision code (state or county) in [ISO-3166-2](https://en.wikipedia.org/wiki/ISO_3166-2:HU) format.", alias="Region")
    ...
    __properties: ClassVar[List[str]] = ["Country", "City", "Region", "Zip", "Street", "Street2", "Street3"]
