...
class PaymentCompleteResponseWithErrorMessages(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["PaymentId", "PaymentRequestId", "PaymentStatus", "IsSuccessful", "TraceId", "Errors"]
