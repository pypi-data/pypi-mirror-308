...
class UserHistory(BaseModel):
    ...
    type: Optional[HistoryItemType] = Field(default=None, description="The type of the history item.", alias="Type")
    ...
    balance_change_type: Optional[BalanceChangeType] = Field(default=None, description="Indicates the direction of change regarding the account's available balance.", alias="BalanceChangeType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if balance_change_type (nullable) is None
        # and model_fields_set contains the field
        if self.balance_change_type is None and "balance_change_type" in self.model_fields_set:
            _dict['BalanceChangeType'] = None
