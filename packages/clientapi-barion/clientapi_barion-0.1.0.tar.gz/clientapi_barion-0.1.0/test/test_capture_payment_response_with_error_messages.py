...
class TestCapturePaymentResponseWithErrorMessages(unittest.TestCase):
    """CapturePaymentResponseWithErrorMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapturePaymentResponseWithErrorMessages:
        """Test CapturePaymentResponseWithErrorMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapturePaymentResponseWithErrorMessages`
        """
        model = CapturePaymentResponseWithErrorMessages()
        if include_optional:
            return CapturePaymentResponseWithErrorMessages(
                is_successful = True,
    ...
    def testCapturePaymentResponseWithErrorMessages(self):
        """Test CapturePaymentResponseWithErrorMessages"""
