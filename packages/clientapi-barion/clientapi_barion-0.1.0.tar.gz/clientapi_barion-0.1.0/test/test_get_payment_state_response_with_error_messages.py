...
class TestGetPaymentStateResponseWithErrorMessages(unittest.TestCase):
    """GetPaymentStateResponseWithErrorMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentStateResponseWithErrorMessages:
        """Test GetPaymentStateResponseWithErrorMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentStateResponseWithErrorMessages`
        """
        model = GetPaymentStateResponseWithErrorMessages()
        if include_optional:
            return GetPaymentStateResponseWithErrorMessages(
    ...
    def testGetPaymentStateResponseWithErrorMessages(self):
        """Test GetPaymentStateResponseWithErrorMessages"""
