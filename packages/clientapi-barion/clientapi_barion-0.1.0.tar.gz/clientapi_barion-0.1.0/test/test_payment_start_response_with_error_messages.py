...
class TestPaymentStartResponseWithErrorMessages(unittest.TestCase):
    """PaymentStartResponseWithErrorMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentStartResponseWithErrorMessages:
        """Test PaymentStartResponseWithErrorMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentStartResponseWithErrorMessages`
        """
        model = PaymentStartResponseWithErrorMessages()
        if include_optional:
            return PaymentStartResponseWithErrorMessages(
                payment_id = '',
                payment_request_id = '',
                status = 'Prepared',
                qr_url = '',
    ...
    def testPaymentStartResponseWithErrorMessages(self):
        """Test PaymentStartResponseWithErrorMessages"""
