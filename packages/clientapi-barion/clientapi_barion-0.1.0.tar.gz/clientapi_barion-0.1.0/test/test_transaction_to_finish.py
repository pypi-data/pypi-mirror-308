...
class TestTransactionToFinish(unittest.TestCase):
    """TransactionToFinish unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionToFinish:
        """Test TransactionToFinish
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionToFinish`
        """
        model = TransactionToFinish()
        if include_optional:
            return TransactionToFinish(
    ...
    def testTransactionToFinish(self):
        """Test TransactionToFinish"""
