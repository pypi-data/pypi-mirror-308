...
class TestPaymentStateResponse(unittest.TestCase):
    """PaymentStateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentStateResponse:
        """Test PaymentStateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentStateResponse`
        """
        model = PaymentStateResponse()
        if include_optional:
    ...
    def testPaymentStateResponse(self):
        """Test PaymentStateResponse"""
