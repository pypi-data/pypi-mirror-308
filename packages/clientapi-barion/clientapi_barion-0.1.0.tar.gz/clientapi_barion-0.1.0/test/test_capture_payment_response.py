...
class TestCapturePaymentResponse(unittest.TestCase):
    """CapturePaymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapturePaymentResponse:
        """Test CapturePaymentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapturePaymentResponse`
        """
        model = CapturePaymentResponse()
        if include_optional:
    ...
    def testCapturePaymentResponse(self):
        """Test CapturePaymentResponse"""
