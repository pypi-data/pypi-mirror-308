...
class TestCancelAuthorizationResponseWithErrorMessages(unittest.TestCase):
    """CancelAuthorizationResponseWithErrorMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelAuthorizationResponseWithErrorMessages:
        """Test CancelAuthorizationResponseWithErrorMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelAuthorizationResponseWithErrorMessages`
        """
        model = CancelAuthorizationResponseWithErrorMessages()
        if include_optional:
            return CancelAuthorizationResponseWithErrorMessages(
                is_successful = True,
    ...
    def testCancelAuthorizationResponseWithErrorMessages(self):
        """Test CancelAuthorizationResponseWithErrorMessages"""
