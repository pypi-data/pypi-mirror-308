...
class PaymentStartResponseWithErrorMessages(BaseModel):
    """
    ...
    status: Optional[PaymentStatus] = Field(default=None, description="The status of the payment in the Barion system.", alias="Status")
    qr_url: Optional[StrictStr] = Field(default=None, description="URL for a QR code representing the payment.", alias="QRUrl")
    recurrence_result: Optional[RecurrenceResult] = Field(default=None, description="Indicates the result of an authorized payment scenario. The result depends on the values of the InitiateRecurrence and RecurrenceId properties supplied in the request.", alias="RecurrenceResult")
    ...
    __properties: ClassVar[List[str]] = ["PaymentId", "PaymentRequestId", "Status", "QRUrl", "RecurrenceResult", "Transactions", "GatewayUrl", "CallbackUrl", "RedirectUrl", "ThreeDSAuthClientData", "TraceId", "IsSuccessful", "Errors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if recurrence_result (nullable) is None
        # and model_fields_set contains the field
        if self.recurrence_result is None and "recurrence_result" in self.model_fields_set:
            _dict['RecurrenceResult'] = None
