...
class WithdrawBankTransferResponseWithErrorMessages(BaseModel):
    """
    ...
    currency: Optional[Currency] = Field(default=None, description="The currency of the bank transfer.", alias="Currency")
    ...
    __properties: ClassVar[List[str]] = ["TransactionId", "Currency", "Amount", "Comment", "BankAccount", "Bank", "Recipient", "Errors"]
