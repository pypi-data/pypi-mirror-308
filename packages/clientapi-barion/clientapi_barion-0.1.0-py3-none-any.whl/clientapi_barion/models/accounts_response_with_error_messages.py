...
class AccountsResponseWithErrorMessages(BaseModel):
    """
    AccountsResponseWithErrorMessages
    """ # noqa: E501
    accounts: Optional[List[Account]] = Field(default=None, description="List of accounts in the user's Barion wallet.", alias="Accounts")
    errors: Optional[List[Error]] = Field(default=None, alias="Errors")
    __properties: ClassVar[List[str]] = ["Accounts", "Errors"]
