...
class PaymentStateResponseWithErrorMessages(BaseModel):
    """
    ...
    recurrence_type: Optional[RecurrenceType] = Field(default=None, description="The RecurrenceType that was defined in the payment/start request for the recurring scenario.", alias="RecurrenceType")
    ...
    currency: Optional[Currency] = Field(default=None, description="The payment's 3-character ISO 4217 currency code.", alias="Currency")
    ...
    payment_method: Optional[PaymentMethod] = Field(default=None, description="The last method used when attempting to complete the payment. If there was no payment attempt made yet, this property is `Unknown`.", alias="PaymentMethod")
    errors: Optional[List[Error]] = Field(default=None, alias="Errors")
    __properties: ClassVar[List[str]] = ["PaymentId", "PaymentRequestId", "POSId", "POSName", "POSOwnerEmail", "POSOwnerCountry", "Status", "PaymentType", "AllowedFundingSources", "FundingSource", "FundingInformation", "RecurrenceType", "TraceId", "GuestCheckout", "CreatedAt", "CompletedAt", "ValidUntil", "ReservedUntil", "DelayedCaptureUntil", "Transactions", "Total", "Currency", "SuggestedLocale", "FraudRiskScore", "CallbackUrl", "RedirectUrl", "PaymentMethod", "Errors"]
