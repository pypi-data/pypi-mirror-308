...
from clientapi_barion.models.funding_sources import FundingSources
...
class PaymentStartRequest(BaseModel):
    ...
    funding_sources: List[Optional[FundingSources]] = Field(description="An array of strings containing the allowed funding sources that can be used to complete the payment.", alias="FundingSources")
    ...
    recurrence_type: Optional[StrictStr] = Field(default=None, description="Required for `3DS`, when executing token payments. Describes the nature of the token payment.", alias="RecurrenceType")
    ...
    locale: Optional[Locale] = Field(alias="Locale")
    currency: Optional[Currency] = Field(alias="Currency")
    ...
    challenge_preference: Optional[ChallengePreference] = Field(default=None, description="Required for `3DS`. The merchant's preference of the 3DS challenge. Here you can specify what 3DS authentication should be utilized.", alias="ChallengePreference")
    __properties: ClassVar[List[str]] = ["PaymentType", "ReservationPeriod", "DelayedCapturePeriod", "PaymentWindow", "GuestCheckOut", "InitiateRecurrence", "RecurrenceId", "FundingSources", "PaymentRequestId", "PayerHint", "CardHolderNameHint", "RecurrenceType", "TraceId", "RedirectUrl", "CallbackUrl", "Transactions", "OrderNumber", "ShippingAddress", "Locale", "Currency", "PayerPhoneNumber", "PayerWorkPhoneNumber", "PayerHomeNumber", "BillingAddress", "PayerAccountInformation", "PurchaseInformation", "ChallengePreference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if challenge_preference (nullable) is None
        # and model_fields_set contains the field
        if self.challenge_preference is None and "challenge_preference" in self.model_fields_set:
            _dict['ChallengePreference'] = None
