...
class GetUserHistoryResponseWithErrorMessages(BaseModel):
    """
    GetUserHistoryResponseWithErrorMessages
    """ # noqa: E501
    user_history: Optional[List[UserHistory]] = Field(default=None, alias="UserHistory")
    errors: Optional[List[Error]] = Field(default=None, alias="Errors")
    __properties: ClassVar[List[str]] = ["UserHistory", "Errors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in user_history (list)
        _items = []
        if self.user_history:
            for _item_user_history in self.user_history:
                if _item_user_history:
                    _items.append(_item_user_history.to_dict())
            _dict['UserHistory'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UserHistory": [UserHistory.from_dict(_item) for _item in obj["UserHistory"]] if obj.get("UserHistory") is not None else None,
