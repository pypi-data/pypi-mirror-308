...
from clientapi_barion.models.availability_indicator import AvailabilityIndicator
...
from clientapi_barion.models.re_order_indicator import ReOrderIndicator
...
class PurchaseInformation(BaseModel):
    ...
    PurchaseInformation
    """ # noqa: E501
    delivery_timeframe: Optional[DeliveryTimeframeType] = Field(default=None, description="The speed of the delivery method.", alias="DeliveryTimeframe")
    ...
    availability_indicator: Optional[AvailabilityIndicator] = Field(default=None, description="When the goods will be available.", alias="AvailabilityIndicator")
    re_order_indicator: Optional[ReOrderIndicator] = Field(default=None, description="Indicates if this purchase is a re-order.", alias="ReOrderIndicator")
    shipping_address_indicator: Optional[ShippingAddressIndicator] = Field(default=None, description="What kind of shipping is used.", alias="ShippingAddressIndicator")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if delivery_timeframe (nullable) is None
        # and model_fields_set contains the field
        if self.delivery_timeframe is None and "delivery_timeframe" in self.model_fields_set:
            _dict['DeliveryTimeframe'] = None

        # set to None if availability_indicator (nullable) is None
        # and model_fields_set contains the field
        if self.availability_indicator is None and "availability_indicator" in self.model_fields_set:
            _dict['AvailabilityIndicator'] = None

        # set to None if re_order_indicator (nullable) is None
        # and model_fields_set contains the field
        if self.re_order_indicator is None and "re_order_indicator" in self.model_fields_set:
            _dict['ReOrderIndicator'] = None

        # set to None if shipping_address_indicator (nullable) is None
        # and model_fields_set contains the field
        if self.shipping_address_indicator is None and "shipping_address_indicator" in self.model_fields_set:
            _dict['ShippingAddressIndicator'] = None
