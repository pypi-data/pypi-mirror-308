...
class StateCls:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.rxQuality.iqCoherency.state.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:IQCoherency:STATe?')
