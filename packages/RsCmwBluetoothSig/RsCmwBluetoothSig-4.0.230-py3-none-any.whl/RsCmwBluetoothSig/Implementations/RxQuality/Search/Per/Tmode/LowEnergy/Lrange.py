...
class LrangeCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Per: float or bool: float Packet error rate Range: 0 % to 100 %
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.rxQuality.search.per.tmode.lowEnergy.lrange.calculate() \n
		Return the results of PER search RX measurement in LE UTP test mode. Commands for uncoded LE 1M PHY (..
		:TMODe:LENergy:LE1M..) , LE 2M PHY (..:TMODe:LENergy:LE2M..) , and LE coded PHY (..:TMODe:LENergy:LRANge..) are available. \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:TMODe:LENergy:LRANge?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.rxQuality.search.per.tmode.lowEnergy.lrange.fetch() \n
		Return the results of PER search RX measurement in LE UTP test mode. Commands for uncoded LE 1M PHY (..
		:TMODe:LENergy:LE1M..) , LE 2M PHY (..:TMODe:LENergy:LE2M..) , and LE coded PHY (..:TMODe:LENergy:LRANge..) are available. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:TMODe:LENergy:LRANge?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:TMODe:LENergy:LRANge \n
		Snippet: value: ResultData = driver.rxQuality.search.per.tmode.lowEnergy.lrange.read() \n
		Return the results of PER search RX measurement in LE UTP test mode. Commands for uncoded LE 1M PHY (..
		:TMODe:LENergy:LE1M..) , LE 2M PHY (..:TMODe:LENergy:LE2M..) , and LE coded PHY (..:TMODe:LENergy:LRANge..) are available. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:TMODe:LENergy:LRANge?', self.__class__.ResultData())
