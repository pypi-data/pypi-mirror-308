...
class LrangeCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.rxQuality.search.per.lowEnergy.lrange.read() \n
		...
		return self._core.io.query_struct(f'READ:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:LENergy:LRANge?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:LENergy:LRANge \n
		Snippet: value: ResultData = driver.rxQuality.search.per.lowEnergy.lrange.fetch() \n
		Return the results of PER search RX measurement for LE direct test mode, LE connection tests, and LE audio.
			INTRO_CMD_HELP: Starts, stops or aborts the measurement: \n
			- LE direct test mode: Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
			- LE connection tests (normal mode) : Commands for uncoded LE 1M PHY (..:NMODe:LENergy:LE1M..) , LE 2M PHY (..:NMODe:LENergy:LE2M..) , and LE coded PHY (..:NMODe:LENergy:LRANge..) are available.
			...
			- LE audio: Commands (..:AUDio:LENergy..) are available. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:LENergy:LRANge?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.rxQuality.search.per.lowEnergy.lrange.calculate() \n
		Return the results of PER search RX measurement for LE direct test mode, LE connection tests, and LE audio.
			INTRO_CMD_HELP: Starts, stops or aborts the measurement: \n
			- LE direct test mode: Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
			- LE connection tests (normal mode) : Commands for uncoded LE 1M PHY (..:NMODe:LENergy:LE1M..) , LE 2M PHY (..:NMODe:LENergy:LE2M..) , and LE coded PHY (..:NMODe:LENergy:LRANge..) are available.
		...
		return self._core.io.query_struct(f'CALCulate:BLUetooth:SIGNaling<Instance>:RXQuality:SEARch:PER:LENergy:LRANge?', self.__class__.CalculateStruct())
