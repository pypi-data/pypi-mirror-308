...
class Le2MCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.rxQuality.per.lowEnergy.le2M.read() \n
		...
		return self._core.io.query_struct(f'READ:BLUetooth:SIGNaling<Instance>:RXQuality:PER:LENergy:LE2M?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:PER:LENergy:LE2M \n
		Snippet: value: ResultData = driver.rxQuality.per.lowEnergy.le2M.fetch() \n
		Return all results of the signaling LE Rx measurement for LE direct test, LE connection tests, and LE audio.
			INTRO_CMD_HELP: Starts, stops or aborts the measurement: \n
			- LE direct test mode: Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
			- LE connection tests (normal mode) : Commands for uncoded LE 1M PHY (..:NMODe:LENergy:LE1M..) , LE 2M PHY (..:NMODe:LENergy:LE2M..) , and LE coded PHY (..:NMODe:LENergy:LRANge..) are available.
			...
			- LE audio: Commands (..:AUDio:LENergy..) are available. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:PER:LENergy:LE2M?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.rxQuality.per.lowEnergy.le2M.calculate() \n
		Return all results of the signaling LE Rx measurement for LE direct test, LE connection tests, and LE audio.
			INTRO_CMD_HELP: Starts, stops or aborts the measurement: \n
			- LE direct test mode: Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
			- LE connection tests (normal mode) : Commands for uncoded LE 1M PHY (..:NMODe:LENergy:LE1M..) , LE 2M PHY (..:NMODe:LENergy:LE2M..) , and LE coded PHY (..:NMODe:LENergy:LRANge..) are available.
		...
		return self._core.io.query_struct(f'CALCulate:BLUetooth:SIGNaling<Instance>:RXQuality:PER:LENergy:LE2M?', self.__class__.CalculateStruct())
