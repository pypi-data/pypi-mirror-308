...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> List[float or bool]:
		...
		Snippet: value: List[float or bool] = driver.configure.rfSettings.dtx.stab.mindex.stable.lowEnergy.get_le_1_m() \n
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: mod_index: (float or boolean items) float | ON | OFF Range: 0.495 to 0.505
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:MINDex:STABle:LENergy:LE1M?')
	...
	def get_lrange(self) -> List[float or bool]:
		...
		Snippet: value: List[float or bool] = driver.configure.rfSettings.dtx.stab.mindex.stable.lowEnergy.get_lrange() \n
		Return the modulation index h under the periodic change (10 values) for stable range h = 0.495 to 0.505.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available. For
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: mod_index: (float or boolean items) float | ON | OFF Range: 0.495 to 0.505
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:MINDex:STABle:LENergy:LRANge?')
		return Conversions.str_to_float_or_bool_list(response)
	...
	def get_le_2_m(self) -> List[float or bool]:
		...
		Snippet: value: List[float or bool] = driver.configure.rfSettings.dtx.stab.mindex.stable.lowEnergy.get_le_2_m() \n
		Return the modulation index h under the periodic change (10 values) for stable range h = 0.495 to 0.505.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available. For
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: mod_index: (float or boolean items) float | ON | OFF Range: 0.495 to 0.505
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:MINDex:STABle:LENergy:LE2M?')
		return Conversions.str_to_float_or_bool_list(response)
