...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> List[float or bool]:
		...
		Snippet: value: List[float or bool] = driver.configure.rfSettings.dtx.stab.mindex.tmode.lowEnergy.get_le_1_m() \n
		No command help available \n
			:return: mod_index: (float or boolean items) No help available
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:MINDex:TMODe:LENergy:LE1M?')
