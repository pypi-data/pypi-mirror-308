...
class Le2MCls:
	"""Le2M commands group definition. 4 total commands, 4 Subgroups, 0 group commands"""
	...
	def a0Reference(self):
		"""a0Reference commands group. 0 Sub-classes, 1 commands."""
	...
	def a1Nreference(self):
		"""a1Nreference commands group. 0 Sub-classes, 1 commands."""
	...
	def a2Nreference(self):
		"""a2Nreference commands group. 0 Sub-classes, 1 commands."""
	...
	def a3Nreference(self):
		"""a3Nreference commands group. 0 Sub-classes, 1 commands."""
