...
class A0ReferenceCls:
	...
	def set(self, limit: float or bool, enable: bool) -> None:
		...
		Snippet: driver.configure.rxQuality.iqCoherency.limit.lowEnergy.le2M.a0Reference.set(limit = 1.0, enable = False) \n
		...
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQCoherency:LIMit:LENergy:LE2M:A0Reference {param}'.rstrip())
	...
	def get(self) -> A0ReferenceStruct:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQCoherency:LIMit:LENergy:LE2M:A0Reference \n
		Snippet: value: A0ReferenceStruct = driver.configure.rxQuality.iqCoherency.limit.lowEnergy.le2M.a0Reference.get() \n
		Defines the IQ samples coherency limit for mean reference phase deviation (RPD) results for the reference antenna.
		Commands for uncoded LE 1M PHY (..:LE1M..) and LE 2M PHY (..:LE2M..) are available. \n
			:return: structure: for return value, see the help for A0ReferenceStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQCoherency:LIMit:LENergy:LE2M:A0Reference?', self.__class__.A0ReferenceStruct())
