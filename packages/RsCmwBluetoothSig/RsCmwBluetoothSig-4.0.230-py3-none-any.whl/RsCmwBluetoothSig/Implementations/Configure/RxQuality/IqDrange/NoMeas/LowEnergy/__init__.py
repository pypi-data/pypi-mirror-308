...
class LowEnergyCls:
	"""LowEnergy commands group definition. 8 total commands, 2 Subgroups, 0 group commands"""
	...
	@property
	def le1M(self):
		"""le1M commands group. 0 Sub-classes, 4 commands."""
	...
	@property
	def le2M(self):
		"""le2M commands group. 0 Sub-classes, 4 commands."""
