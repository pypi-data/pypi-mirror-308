...
class Le1MCls:
	...
	def set(self, ant_3_minus_2_enable: bool, ant_2_minus_ref_enable: bool, ant_ref_minus_1_enable: bool) -> None:
		...
		Snippet: driver.configure.rxQuality.iqDrange.antMeanAmp.limit.lowEnergy.le1M.set(ant_3_minus_2_enable = False, ant_2_minus_ref_enable = False, ant_ref_minus_1_enable = False) \n
		...
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQDRange:ANTMeanamp:LIMit:LENergy:LE1M {param}'.rstrip())
	...
	def get(self) -> Le1MStruct:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQDRange:ANTMeanamp:LIMit:LENergy:LE1M \n
		Snippet: value: Le1MStruct = driver.configure.rxQuality.iqDrange.antMeanAmp.limit.lowEnergy.le1M.get() \n
		Disables/enables the limit check for the IQ dynamic range results to monitor the requirement: MeanANT3 < MeanANT2 <
		MeanANT0 < MeanANT1 \n
			:return: structure: for return value, see the help for Le1MStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:IQDRange:ANTMeanamp:LIMit:LENergy:LE1M?', self.__class__.Le1MStruct())
