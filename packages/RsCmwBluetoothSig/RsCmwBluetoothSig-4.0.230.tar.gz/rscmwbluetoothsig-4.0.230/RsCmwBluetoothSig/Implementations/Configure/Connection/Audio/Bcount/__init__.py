...
class BcountCls:
	"""Bcount commands group definition. 3 total commands, 1 Subgroups, 0 group commands"""
	...
	def leSignaling(self):
		"""leSignaling commands group. 0 Sub-classes, 3 commands."""
	...
	def clone(self) -> 'BcountCls':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = BcountCls(self._core, self._cmd_group.parent)
