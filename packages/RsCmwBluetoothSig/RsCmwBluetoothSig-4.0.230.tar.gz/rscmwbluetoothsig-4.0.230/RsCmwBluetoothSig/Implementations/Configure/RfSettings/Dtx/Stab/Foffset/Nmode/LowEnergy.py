...
class LowEnergyCls:
	...
	def get_le_2_m(self) -> List[int or bool]:
		...
		Snippet: value: List[int or bool] = driver.configure.rfSettings.dtx.stab.foffset.nmode.lowEnergy.get_le_2_m() \n
	...
	def get_lrange(self) -> List[int or bool]:
		...
		Snippet: value: List[int or bool] = driver.configure.rfSettings.dtx.stab.foffset.nmode.lowEnergy.get_lrange() \n
		Return the frequency offset under the periodic change according to the test specification for Bluetooth wireless
		technology (10 values for BR and LE, 3 values for EDR) .
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- RF tests:
	...
	def get_le_1_m(self) -> List[int or bool]:
		...
		Snippet: value: List[int or bool] = driver.configure.rfSettings.dtx.stab.foffset.nmode.lowEnergy.get_le_1_m() \n
		Return the frequency offset under the periodic change according to the test specification for Bluetooth wireless
		technology (10 values for BR and LE, 3 values for EDR) .
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- RF tests:
