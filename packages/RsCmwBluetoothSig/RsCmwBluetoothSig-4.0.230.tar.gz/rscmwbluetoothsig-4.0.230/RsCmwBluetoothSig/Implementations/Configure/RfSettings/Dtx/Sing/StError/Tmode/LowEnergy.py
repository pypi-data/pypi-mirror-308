...
class LowEnergyCls:
	...
	def get_lrange(self) -> enums.SymbolTimeErrorLe:
		...
		Snippet: value: enums.SymbolTimeErrorLe = driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.get_lrange() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LRANge?')
	...
	def set_lrange(self, symbol_time_err: enums.SymbolTimeErrorLe) -> None:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LRANge \n
		Snippet: driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.set_lrange(symbol_time_err = enums.SymbolTimeErrorLe.NEG50) \n
		Specifies the symbol timing error of the LE signal.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
		...
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LRANge {param}')
	...
	def get_le_2_m(self) -> enums.SymbolTimeErrorLe:
		...
		Snippet: value: enums.SymbolTimeErrorLe = driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.get_le_2_m() \n
		Specifies the symbol timing error of the LE signal.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: symbol_time_err: OFF | NEG50 | POS50 No symbol timing error, - 50 ppm or 50 ppm
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE2M?')
		return Conversions.str_to_scalar_enum(response, enums.SymbolTimeErrorLe)

	def set_le_2_m(self, symbol_time_err: enums.SymbolTimeErrorLe) -> None:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE2M \n
		Snippet: driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.set_le_2_m(symbol_time_err = enums.SymbolTimeErrorLe.NEG50) \n
		Specifies the symbol timing error of the LE signal.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
		...
		"""
		param = Conversions.enum_scalar_to_str(symbol_time_err, enums.SymbolTimeErrorLe)
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE2M {param}')
	...
	def get_le_1_m(self) -> enums.SymbolTimeErrorLe:
		...
		Snippet: value: enums.SymbolTimeErrorLe = driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.get_le_1_m() \n
		Specifies the symbol timing error of the LE signal.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: symbol_time_err: OFF | NEG50 | POS50 No symbol timing error, - 50 ppm or 50 ppm
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE1M?')
		return Conversions.str_to_scalar_enum(response, enums.SymbolTimeErrorLe)

	def set_le_1_m(self, symbol_time_err: enums.SymbolTimeErrorLe) -> None:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE1M \n
		Snippet: driver.configure.rfSettings.dtx.sing.stError.tmode.lowEnergy.set_le_1_m(symbol_time_err = enums.SymbolTimeErrorLe.NEG50) \n
		Specifies the symbol timing error of the LE signal.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode:
		Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
		...
		"""
		param = Conversions.enum_scalar_to_str(symbol_time_err, enums.SymbolTimeErrorLe)
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:SING:STERror:TMODe:LENergy:LE1M {param}')
