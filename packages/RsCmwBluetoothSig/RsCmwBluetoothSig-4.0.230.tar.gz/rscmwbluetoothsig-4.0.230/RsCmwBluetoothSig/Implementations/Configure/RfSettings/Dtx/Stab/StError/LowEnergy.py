...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> List[int]:
		...
		Snippet: value: List[int] = driver.configure.rfSettings.dtx.stab.stError.lowEnergy.get_le_1_m() \n
		...
		"""
		response = self._core.io.query_bin_or_ascii_int_list('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:STERror:LENergy:LE1M?')
		return response

	def get_lrange(self) -> List[int]:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:STERror:LENergy:LRANge \n
		Snippet: value: List[int] = driver.configure.rfSettings.dtx.stab.stError.lowEnergy.get_lrange() \n
		Return the symbol timing error under the periodic change according to the test specification for Bluetooth wireless
		technology (10 values for BR and LE, 3 values for EDR) .
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- RF tests:
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: symbol_time_err: decimal Range: - 50 ppm to 50 ppm, for BR/EDR: - 20 ppm to 20 ppm , Unit: ppm
		"""
		response = self._core.io.query_bin_or_ascii_int_list('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:STERror:LENergy:LRANge?')
		return response

	def get_le_2_m(self) -> List[int]:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:STERror:LENergy:LE2M \n
		Snippet: value: List[int] = driver.configure.rfSettings.dtx.stab.stError.lowEnergy.get_le_2_m() \n
		Return the symbol timing error under the periodic change according to the test specification for Bluetooth wireless
		technology (10 values for BR and LE, 3 values for EDR) .
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- RF tests:
		...
		:TMODe:LENergy:LRANge..) are available. \n
			:return: symbol_time_err: decimal Range: - 50 ppm to 50 ppm, for BR/EDR: - 20 ppm to 20 ppm , Unit: ppm
		"""
		response = self._core.io.query_bin_or_ascii_int_list('CONFigure:BLUetooth:SIGNaling<Instance>:RFSettings:DTX:STAB:STERror:LENergy:LE2M?')
		return response
