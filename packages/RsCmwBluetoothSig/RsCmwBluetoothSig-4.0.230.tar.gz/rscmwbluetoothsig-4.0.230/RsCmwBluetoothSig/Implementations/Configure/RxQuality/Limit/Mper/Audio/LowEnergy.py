...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> float or bool:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:LIMit:MPER:AUDio:LENergy[:LE1M] \n
		Snippet: value: float or bool = driver.configure.rxQuality.limit.mper.audio.lowEnergy.get_le_1_m() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:LIMit:MPER:AUDio:LENergy:LE1M?')
		return Conversions.str_to_float_or_bool(response)

	def set_le_1_m(self, limit: float or bool) -> None:
		"""SCPI: CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:LIMit:MPER:AUDio:LENergy[:LE1M] \n
		Snippet: driver.configure.rxQuality.limit.mper.audio.lowEnergy.set_le_1_m(limit = 1.0) \n
		Specifies the upper PER limit for LE RX measurements.
			INTRO_CMD_HELP: Refer also to the following commands: \n
			- LE direct test mode: Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available.
			- LE connection tests (normal mode) : Commands for uncoded LE 1M PHY (..:NMODe:LENergy:LE1M..) , LE 2M PHY (..:NMODe:LENergy:LE2M..) , and LE coded PHY (..:NMODe:LENergy:LRANge..) are available.
		...
		self._core.io.write(f'CONFigure:BLUetooth:SIGNaling<Instance>:RXQuality:LIMit:MPER:AUDio:LENergy:LE1M {param}')
