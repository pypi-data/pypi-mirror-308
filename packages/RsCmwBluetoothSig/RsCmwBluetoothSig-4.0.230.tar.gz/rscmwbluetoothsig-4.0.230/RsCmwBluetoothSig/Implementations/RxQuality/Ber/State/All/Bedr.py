...
class BedrCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.rxQuality.ber.state.all.bedr.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:BLUetooth:SIGNaling<Instance>:RXQuality:BER:STATe:ALL:BEDR?', self.__class__.FetchStruct())
