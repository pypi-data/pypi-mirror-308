...
class ChromeRemoteWebDriver(EmptyWebDriver):
    ...
    def create_driver(self, command_executor: str = None, session_id: str = None):
        ...
        Args:
            command_executor (str): The address of the remote webdriver server. Defaults to None.
            session_id (str): The ID of the existing webdriver session. Defaults to None.
