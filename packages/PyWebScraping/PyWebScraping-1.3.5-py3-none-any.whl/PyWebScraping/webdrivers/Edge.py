...
class EdgeStartArgs(BrowserStartArgs):
    ...
    def __init__(
        ...
        Args:
            webdriver_dir (str | None): Directory of the webdriver executable. Defaults to None.
            debugging_port (int | None): Port for remote debugging. Defaults to None.
...
class EdgeRemoteWebDriver(EmptyWebDriver):
    ...
    def create_driver(self, command_executor: str | None = None, session_id: str | None = None):
        ...
        Args:
            command_executor (str | None): URL of the remote webdriver server. If provided will overwrite server URL during initialization. Defaults to None.
            session_id (str | None): ID of an existing session to connect to. If provided, will overwrite session ID specified during initialization. Defaults to None.
