...
class WindowRect:
    ...
    def __init__(self, x: int | None = None, y: int | None = None, width: int | None = None, height: int | None = None):
        """
        Initializes WindowRect with optional x, y, width, and height values.

        Args:
            x (int | None): The x-coordinate. Defaults to None.
            y (int | None): The y-coordinate. Defaults to None.
            width (int | None): The width. Defaults to None.
            height (int | None): The height. Defaults to None.
    ...
    def set_rect(
        self, x: int | None = None, y: int | None = None, width: int | None = None, height: int | None = None
    ) -> "WindowRect":
        """
