...
from PyWebRequests.getters import get_random_user_agent
from PyWindowsCMD.netstat import (
    get_localhost_beasy_ports,
    get_localhost_minimum_free_port,
    get_localhost_processes_with_pids,
)
from PyWindowsCMD.taskkill import ProcessID, taskkill_windows
...
from PyWebScraping import errors
...
class EmptyWebDriver:
    ...
    def switch_to_window(self, window: str | int | None = None):
        """
        Switches focus to the specified window.

        Args:
            window (str | int | None): The name, index, or handle of the window to switch to. If None, switches to the current window. Defaults to None.
    ...
    def close_window(self, window: str | int | None = None):
        """
        Closes the specified window.

        Args:
            window (str | int | None): The name, index, or handle of the window to close. If None, closes the current window. Defaults to None.
        """
    ...
    def update_times(self, temp_implicitly_wait: int | None = None, temp_page_load_timeout: int | None = None):
        """
        Updates the implicit wait and page load timeout.

        Args:
            temp_implicitly_wait (int | None): Temporary implicit wait time. Defaults to None.
            temp_page_load_timeout (int | None): Temporary page load timeout. Defaults to None.
        """
    ...
    def find_inner_web_element(
        ...
        by: By,
        value: str,
        temp_implicitly_wait: int | None = None,
        temp_page_load_timeout: int | None = None,
    ) -> WebElement:
        """
    ...
    def find_web_elements(
        self, by: By, value: str, temp_implicitly_wait: int | None = None, temp_page_load_timeout: int | None = None
    ) -> list[WebElement]:
        """
    ...
    def get_rect(self) -> WindowRect:
        ...
        return WindowRect(window_rect["x"], window_rect["y"], window_rect["width"], window_rect["height"])
    ...
    def search_url(self, url: str, temp_implicitly_wait: int | None = None, temp_page_load_timeout: int | None = None):
        """
...
class BrowserOptionsManager:
    ...
    def __init__(
        ...
        Args:
            ...
            proxy_command (str): Command-line argument for setting the proxy.
            debugging_port (int | None): The debugging port number. Defaults to None.
            user_agent (list[str] | None): The user agent string as a list. Defaults to None.
            proxy (str | list[str] | None): The proxy server address or a list of addresses. Defaults to None.
        """
    ...
    def set_user_agent(self, user_agent: list[str] | None = None):
        """
        Sets the user agent for the browser.

        Args:
            user_agent (list[str] | None): The user agent string as a list. If None, a default user agent is used. Defaults to None.
        """
        if user_agent is not None:
            ...
            if random_user_agent is None:
                raise errors.BadUserAgent("No random user agent found")

            self.user_agent = [random_user_agent]

        self.options.add_argument(self.user_agent_command % " ".join(self.user_agent))

    def set_proxy(self, proxy: str | list[str] | None = None):
        """
        Sets the proxy server for the browser.

        Args:
            proxy (str | list[str] | None): The proxy server address, or a list of addresses. If a list is provided, a random proxy is chosen. Defaults to None.
        """
        self.proxy = proxy
    ...
    def set_debugger_address(self, debugging_port: int | None):
        """
        Sets the debugger address for the browser.

        Args:
            debugging_port (int | None): The debugging port number.
        """
...
class BrowserStartArgs:
    ...
    def set_webdriver_dir(self, webdriver_dir: str = None):
        ...
        Args:
            webdriver_dir (str): The webdriver directory path. Defaults to None.
        """
        self.webdriver_dir = webdriver_dir
...
class BrowserWebDriver(EmptyWebDriver):
    ...
    def __init__(
        ...
        webdriver_path: str,
        webdriver_start_args: BrowserStartArgs | None = None,
        webdriver_options_manager: BrowserOptionsManager | None = None,
        ...
        Args:
            ...
            bom_proxy_command (str): BrowserOptionsManager command for proxy.
            webdriver_path (str): Path to the webdriver executable.
            webdriver_start_args (BrowserStartArgs | None): Manages browser start-up arguments. Defaults to None.
            webdriver_options_manager (BrowserOptionsManager | None): Manages browser options. Defaults to None.
        ...
        if webdriver_options_manager is not None:
            ...
            self.webdriver_options_manager = BrowserOptionsManager(
                self.bom_debugging_port_command, self.bom_user_agent_command, self.bom_proxy_command
            )
    ...
    def start_webdriver(
        ...
        Args:
            debugging_port (int | None): The debugging port. Defaults to None.
            webdriver_dir (str | None): The webdriver directory. Defaults to None.
            headless_mode (bool | None): Whether to run in headless mode. Defaults to None.
            mute_audio (bool | None): Whether to mute audio. Defaults to None.
            proxy (str | list[str] | None): The proxy server(s). Defaults to None.
            user_agent (list[str] | None): The user agent. Defaults to None.
            window_rect (WindowRect | None): The browser window size and position. Defaults to None.
        """
    ...
    def close_webdriver(self):
        ...
        for pid, ports in get_localhost_processes_with_pids().items():
            if self.debugging_port in ports:
                taskkill_windows(taskkill_type=TaskKillTypes.forcefully_terminate, selectors=ProcessID(pid))
    ...
    def restart_webdriver(
        ...
        Args:
            debugging_port (int | None): The debugging port. Defaults to None.
            webdriver_dir (str | None): The webdriver directory. Defaults to None.
            headless_mode (bool | None): Run in headless mode. Defaults to None.
            mute_audio (bool | None): Whether to mute audio. Defaults to None.
            proxy (str | list[str] | None): The proxy server. Defaults to None.
            user_agent (list[str] | None): The user agent. Defaults to None.
            window_rect (WindowRect | None): The desired window size and position. Defaults to None.
        """
        self.close_webdriver()
        self.start_webdriver(debugging_port, webdriver_dir, headless_mode, mute_audio, proxy, user_agent, window_rect)
