...
class DataPoint(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["avg_sampling_rate", b"avg_sampling_rate", "data", b"data", "data_present", b"data_present", "is_reliable", b"is_reliable"]) -> None: ...
