...
class SFTPClearIO(IClearIO):
	...
	def __init__(self, hostName:str, port:int = 22,
			  ...
			  userName:str|None = None,
			  password:str|None = None,
			  keyFile:Path|str|None = None, keyType:SFTPKeyType = SFTPKeyType.RSAKey, passphrase:str|None = None) -> None:
		if (hostName is None):
	...
	def ListAllDirectories(self, fullDirectoryPath:Path|str) -> list[Path|str]:
	...
	def ListAllDirectoriesRecursively(self, fullDirectoryPath:Path|str) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListDirectories(self, fullDirectoryPath:Path|str, pattern:str|None = None) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
		...
		if (pattern == "*.*" or pattern == "*" or pattern == "" or pattern is None):
			...
			for item in allItems:
				if (re.search(pattern, str(item.stem))):
					returnValue.append(item)
		return sorted(returnValue)

	def ListDirectoriesRecursively(self, fullDirectoryPath:Path|str, pattern:str|None = None) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListAllFiles(self, fullDirectoryPath:Path|str) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListAllFilesRecursively(self, fullDirectoryPath:Path|str) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListFiles(self, fullDirectoryPath:Path|str, pattern:str|None = None) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListFilesRecursively(self, fullDirectoryPath:Path|str, pattern:str|None = None) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
	...
	def ListRecursively(self, fullDirectoryPath:Path|str) -> list[Path|str]:
		returnValue:list[TypedPath] = list[TypedPath]()
		if (not isinstance(fullDirectoryPath, str)):
			fullDirectoryPath = str(fullDirectoryPath)
		if (fullDirectoryPath == "." or fullDirectoryPath == ""):
