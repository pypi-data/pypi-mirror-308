...
class SqlBaseParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SqlBaseParser#setCollation.
    def enterSetCollation(self, ctx:SqlBaseParser.SetCollationContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#setCollation.
    def exitSetCollation(self, ctx:SqlBaseParser.SetCollationContext):
        pass
