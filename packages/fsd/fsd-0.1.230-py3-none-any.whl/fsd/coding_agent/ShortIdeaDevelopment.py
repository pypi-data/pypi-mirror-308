...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"IMPORTANT: Only if new files are being added or existing files are being moved, provide a minimal tree structure under '#### Directory Structure' showing ONLY the specific directories and files being added/moved. Example:\n"
            f"```plaintext\n"
            f"src/\n"
