...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"3. For each file that needs modifications, specify:\n"
            f"   - Exact functions/methods to modify\n"
            f"   - Data structures and algorithms to implement\n" 
            f"   - UI components and styling details\n"
            f"   - Database schema changes\n"
            f"   - API endpoints and request/response formats\n"
            f"4. For each new file to create, detail:\n"
            f"   - Complete technical specifications\n"
            f"   - Framework and libraries to use\n"
            f"   - Component architecture\n"
            f"   - Data flow and state management\n"
            f"   - Testing requirements\n"
            f"5. Consider file movements and restructuring with full technical context\n"
            f"6. Map out implementation dependencies with specific technical touchpoints\n\n"
            f"Then provide an extremely detailed technical analysis:\n"
            f"1. For each file involved, specify:\n"
            f"   - Exact purpose and functionality\n"
            f"   - Complete technical stack and frameworks\n"
            f"   - Data models and relationships\n"
            f"   - UI/UX specifications if applicable\n"
            f"   - Performance requirements\n"
            f"2. For each change needed:\n"
            f"   - Exact code sections to modify\n"
            f"   - Detailed algorithmic approach\n"
            f"   - Data transformation logic\n"
            f"   - Error handling requirements\n"
            f"   - Security considerations\n"
            f"3. Technical dependencies between changes:\n"
            f"   - API contracts and interfaces\n"
            f"   - Shared data structures\n"
            f"   - Service communication patterns\n"
            f"   - State management flow\n"
            f"4. Implementation sequence with technical milestones\n\n"
            ...
            f"command here\n"
            f"```\n"
            f"IMPORTANT: THIS IS A NO-CODE PLANNING PHASE. DO NOT INCLUDE ANY CODE SNIPPETS, IMPLEMENTATION DETAILS, OR BASH COMMANDS.\n"
