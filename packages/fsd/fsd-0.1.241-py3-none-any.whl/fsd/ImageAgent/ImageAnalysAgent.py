...
class ImageAnalysAgent:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language, file_attachments, focused_files, assets_link):
        prompt = (
            f"ONLY RETURN MARKDOWN TABLES FOR NEW PNG, JPG, JPEG IMAGES TO BE GENERATED. NO OTHER TEXT OR FORMATS.\n\n"
            ...
            f"- Support PNG, JPG, JPEG formats only\n"
