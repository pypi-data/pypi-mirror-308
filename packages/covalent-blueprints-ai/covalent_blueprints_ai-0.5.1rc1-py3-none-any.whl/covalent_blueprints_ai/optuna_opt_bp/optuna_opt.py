...
from covalent_blueprints_ai.optuna_opt_bp.utilities import StudyWrapper, optuna
...
def optuna_opt(
    ...
    study_obj = StudyWrapper(study=study, fixed_distributions=fixed_distributions)
