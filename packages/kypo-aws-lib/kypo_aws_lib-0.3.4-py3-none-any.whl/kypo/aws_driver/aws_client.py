...
from kypo.cloud_commons.topology_elements import Host
...
class KypoAwsClient(KypoCloudClientBase):
    ...
    def __init__(self, aws_access_key: str, aws_secret_key: str, region: str, base_vpc_name: str,
                 base_subnet_name: str, availability_zone: str, trc: TransformationConfiguration,
                 ca_bundle: str = ''):
        """
        ...
        self.organizations_client = boto3.client(
            'organizations', aws_access_key_id=aws_access_key,
            aws_secret_access_key=aws_secret_key,
            config=boto_client_config
        )
    ...
    def get_private_ip(link_tf_resource: Dict[str, dict]) -> str:
        ...
        """
        return link_tf_resource['attributes']['private_ip_list'][0]
    ...
    def get_terraform_provider(self) -> str:
        ...
        return template.render(region=self.region, access_key=self.access_key,
                               secret_key=self.secret_key)

    def create_terraform_template(self, topology_instance: TopologyInstance,
        ...
        return template.render(availability_zone=self.availability_zone,
    ...
    def _map_aws_image(image_raw: dict) -> Image:
        return Image(os_distro=image_raw['Name'], os_type=image_raw['PlatformDetails'], disk_format=None,
                     ...
                     default_user=None, name=image_raw['ImageId'], owner_specified={})
    ...
    def get_project_name(self):
        ...
        """
        return self.organizations_client.list_accounts()['Accounts'][0]['Name']
