...
class SourceFinder:
    ...
    def find_scrape_urls_on_wiki(self, top_n=5, bootstrap_url=None, language='en',
                                 user_agent='SAGED-bias (contact@holisticai.com)', scrap_backlinks=0):
        """
        ...
        if isinstance(main_page, str):
            ...
            if scrap_backlinks > 0:
                ...
                related_backlinks = get_related_backlinks(topic, main_page, wiki_wiki, max_depth=1, top_n=scrap_backlinks)
