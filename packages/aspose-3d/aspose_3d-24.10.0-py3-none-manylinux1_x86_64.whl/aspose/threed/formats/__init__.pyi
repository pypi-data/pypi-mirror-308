...
class PdfFormat(aspose.threed.FileFormat):
    ...
    @overload
    def extract(self, stream : io.RawIOBase, password : List[int]) -> List[List[int]]:
    ...
    @overload
    def extract_scene(self, stream : io.RawIOBase, password : List[int]) -> List[aspose.threed.Scene]:
        '''Extract raw 3D content from PDF stream.
