...
from eclypse.core.remote.communication import rest
from eclypse.core.remote.communication.rest import HTTPStatusCode
from eclypse.core.remote.service import RESTServiceEngine


class OrderService(RESTServiceEngine):
