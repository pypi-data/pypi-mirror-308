...
from eclypse.core.report.metric import _metric_wrapper
from eclypse.core.utils.types import ReporterType
...
def simulation(
    ...
    *,
    ...
    report: Optional[Union[ReporterType, List[ReporterType]]] = "csv",
    ...
    Args:
        ...
        triggers (Optional[Dict[str, Callable]], optional): The triggers for the metric.
            Defaults to None.
        report (Optional[Union[ReporterType, List[ReporterType]], optional):
