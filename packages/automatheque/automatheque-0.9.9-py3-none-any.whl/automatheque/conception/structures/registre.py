...
class MetaInstancePersistanteRegistre(type):
    ...
    TODO : utiliser un Generic[T] ? https://medium.com/@steveYeah/using-generics-in-python-99010e5056eb#8e63
            ça marche peut etre pas ? https://github.com/python/typing/issues/449
            => si https://mypy.readthedocs.io/en/stable/metaclasses.html
