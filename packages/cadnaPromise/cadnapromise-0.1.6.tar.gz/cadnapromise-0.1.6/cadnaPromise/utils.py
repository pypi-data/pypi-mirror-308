...
Date: Nov. 2024
	...
	© Thibault HILAIRE, 2024

	Xinye Chen add new funcationalities (promise --version, promise --chsd (for arbitrary precisions), 
				manage for pip installing) 
"""
...
def getFPM(args):
	...
	try:
		...
		log.warning("File for customized precision formats is lacking.")
