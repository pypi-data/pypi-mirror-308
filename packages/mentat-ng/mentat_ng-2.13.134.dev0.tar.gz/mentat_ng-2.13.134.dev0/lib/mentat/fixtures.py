...
class MentatFixtures():
    ...
    def get_example_event_classes():
        return [EventClassModel(
            ...
            source_based=False,
            label_en='You were a target of a network attack, which was blocked by our automated system FTAS.',
            label_cz='Byli jste cílem síťového útoku, který byl zablokován naším automatizovaným systémem FTAS.',
            ...
            rule="Category in ['Anomaly.Traffic'] AND Node.Name in ['cz.cesnet.ftas', 'cz.cesnet.gc15']",
            severity="low",
            subclassing="",
            enabled=True
        )]
