...
def stats_data(df_use):
    ...
    # finaldf_poi - input for other statis models (multivariate)  eg. Poisson, Negative Binomial, contains the covariates
...
def ARIMA_model(ARMAmodel,test,predict_length,confidence_interval):
    ...
    return arima_mse, arima_rmse,arima_mae,arima_mape, arima_list,arima, arimap, arimaf

##Yushu
#### Function for Machine Learning Model #lagged_amount = parameter_length, how much past data am I using, this function is to generate a dataframe containing these past points as columns. So, the train points starts accordingly
def gen_ml(wave,test_length,parameter_length,lag_reserve,resid):
    ...
    if resid == False :
        x = end_point - lag_reserve#this part is now true. as not doing resid
    else:
    ...
    test_index = data_index.loc[end_point - test_length:end_point,:]
    train_index = data_index.loc[:x - 1, :]
