...
def wave_prediction(delay_definition_flag, prediction_length, delay, WAVE, waveID, training_period, lag_reserve, lagged_amount, overlap, confidence_interval, tuned_model_dict):
  """
  ...
  train_x,test_x,train_y,test_y, fit_weeks_ml, pred_weeks_ml = gen_ml(wave,prediction_length, lagged_amount, prediction_length, resid = False)
  print('**fit_pred_y_ML')
  ...
  print("**xgb_resid: Shapes:", xgb_resid_predict.shape, arima.tail(prediction_length).shape)
