...
class IInternal_BC():
    ...
    def _allocate_arrays(self):
        self.Ar = np.zeros((self._nr, self.dim, self.dim))
        self.Br = np.zeros((self._nr, self.dim))
        ...
        self._buff_send = np.empty((self._buff_dim_by_neibor))
        self._buff_recv = np.empty((self._nb_neibors, self._buff_dim_by_neibor))
