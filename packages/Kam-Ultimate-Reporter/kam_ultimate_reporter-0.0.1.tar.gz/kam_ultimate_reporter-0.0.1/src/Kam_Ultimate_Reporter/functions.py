...
def fetch_username(uuid, headers):
    """
    ...
    """
    url = f'https://okapi-cls02.ils.medad.com/users/{uuid}'
    try:
...
def fetch_loan_type_name(uuid, header_dict):
    """
    ...
    """
    url = f'https://okapi-cls02.ils.medad.com/loan-types/{uuid}'
    try:
