...
#TODO
    ...
    def constraint_values(self,
        ...
        CONSTRAINT_MAPPER = {
            ...
            'i': (0, 90),              # Inclination must be positive and below 90 degrees
        ...
        assert missing_variable in CONSTRAINT_MAPPER.keys(), f"Variable not found in constraints \n '{missing_variable}': (0, float('inf')),"
    ...
    def _solve_equation(self,
        ...
        for missing_variable in MAPPER:
            ...
            for solution in solutions:
                ...
                column_values_results.append(func(*column_values))
            ...
            self.table.loc[indices, MAPPER[str(missing_variable)]] =  column_values_results
            self.table.loc[indices, f"{MAPPER[str(missing_variable)]}.Error.Lower"] = uncertainty_results
            self.table.loc[indices, f"{MAPPER[str(missing_variable)]}.Error.Upper"] = uncertainty_results
        return
    ...
    def __check_inclination(self) -> None:
        ...
        self.table.loc[indices, 'Planet.Inclination'] = 180 - self.table.loc[indices, 'Planet.Inclination']
        return
