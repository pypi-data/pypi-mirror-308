...
class GcsTrajectoryOptimization:
    ...
    @staticmethod
    def UnwrapToContinousTrajectory(gcs_trajectory: pydrake.trajectories.CompositeTrajectory, continuous_revolute_joints: list[int], starting_rounds: list[int] | None = ..., tol: float = ...) -> pydrake.trajectories.CompositeTrajectory: ...
