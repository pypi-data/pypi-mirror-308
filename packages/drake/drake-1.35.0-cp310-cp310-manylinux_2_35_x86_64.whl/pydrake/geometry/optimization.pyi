...
@overload
def CalcPairwiseIntersections(convex_sets_A: list[ConvexSet], convex_sets_B: list[ConvexSet], continuous_revolute_joints: list[int], preprocess_bbox: bool = ...) -> list[tuple[int, int, numpy.ndarray[numpy.float64[m, 1]]]]: ...
@overload
def CalcPairwiseIntersections(convex_sets_A: list[ConvexSet], convex_sets_B: list[ConvexSet], continuous_revolute_joints: list[int], bboxes_A: list[Hyperrectangle], bboxes_B: list[Hyperrectangle]) -> list[tuple[int, int, numpy.ndarray[numpy.float64[m, 1]]]]: ...
@overload
def CalcPairwiseIntersections(convex_sets: list[ConvexSet], continuous_revolute_joints: list[int], preprocess_bbox: bool = ...) -> list[tuple[int, int, numpy.ndarray[numpy.float64[m, 1]]]]: ...
@overload
def CalcPairwiseIntersections(convex_sets: list[ConvexSet], continuous_revolute_joints: list[int], bboxes: list[Hyperrectangle] = ...) -> list[tuple[int, int, numpy.ndarray[numpy.float64[m, 1]]]]: ...
