    ...
    if system == "Windows":
        ...
        if os.path.exists("/etc/debian_version"):
            ...
            if DebFile is None:
                ...
                subprocess.check_call([sys.executable, "-m", "pip", "install", "python-debian"])
            ...
            if Spec is None or Package is None:
                ...
                subprocess.check_call([sys.executable, "-m", "pip", "install", "rpm-py-installer"])
