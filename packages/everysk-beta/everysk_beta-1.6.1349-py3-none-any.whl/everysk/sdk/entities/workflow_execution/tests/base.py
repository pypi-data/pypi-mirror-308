...
class WorkflowExecutionTestCase(TestCase):
    ...
    def setUp(self):
        self.workflow_execution: WorkflowExecution = WorkflowExecution(
            ...
            worker_executions_ids=['wkex_df0fcbd647552fb6dcd6046be', 'wkex_1234567891234567891234567'],
            _managed_user=False,
    ...
    def test_query_load_with_id(self):
        expected_data = compress({'class_name': 'WorkflowExecution', 'method_name': 'retrieve', 'self_obj': None, 'params': {'entity_id': 'wfex_1234567891234567891234567'}}, protocol='gzip', serialize='json')
    ...
    def test_query_load(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'load', 'self_obj': workflow_execution.to_query().to_dict(add_class_path=True), 'params': {'offset': None}}, protocol='gzip', serialize='json')
