...
class InvalidBetError(DiceError):
...
class DiceGame:
    ...
    def specific_number(self):
        ...
        try:
            ...
            if bet < 1 or bet > 6:
                raise InvalidBetError("Invalid bet number. It must be between 1 and 6.")
    ...
    def high_or_low(self):
        ...
        try:
            ...
            if high_or_low not in ['high', 'low']:
                raise InvalidBetError("Invalid option. You must choose 'high' or 'low'.")
            rolled_number = self.roll_die()
    ...
    def even_or_odd(self):
        ...
        try:
            ...
            if even_or_odd not in ['even', 'odd']:
                raise InvalidBetError("Invalid option. You must choose 'even' or 'odd'.")
            rolled_number = self.roll_die()
    ...
    def target_sum(self):
        ...
        try:
            ...
            if target < 2 or target > 12:
                raise InvalidBetError("Invalid number. It must be between 2 and 12.")
            die1 = self.roll_die()
            die2 = self.roll_die()
            total = die1 + die2
    ...
    def greater_less_equal(self):
        ...
        try:
            ...
            if choice not in ['greater', 'less', 'equal']:
                raise InvalidBetError("Invalid option. You must choose 'greater', 'less', or 'equal'.")
            die2 = self.roll_die()
    ...
    def play(self):
        ...
        try:
            ...
            if option in options:
                ...
                raise InvalidBetError("Invalid option. You must select a number between 1 and 8.")
        except ValueError:
            print("Error: You must enter a number.")
        except InvalidBetError as e:
            print(e)
