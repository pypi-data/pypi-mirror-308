...
class Blackjack:
    ...
    def calculate_hand_value(self, hand):
        ...
        value = 0
        aces = 0
        for card, points in hand:
            if card == 'A':
                aces += 1
            value += points

        # Adjust Aces' values if necessary
    ...
    def play(self):
        ...
        print("Your initial hand:", self.player_hand)
        ...
        print("Dealer's initial hand:", self.dealer_hand)
        ...
        # Results
        print("\nFinal results:")
        print("Your hand:", self.player_hand, "with a value of:", player_value)
        print("Dealer's hand:", self.dealer_hand, "with a value of:", dealer_value)
...
class Poker:
    ...
    def play(self):
        ...
        # Final results
        print("\nResults:")
        print("Your hand:", self.players["Player 1"])
        print("Dealer's hand:", self.players["Dealer"])
