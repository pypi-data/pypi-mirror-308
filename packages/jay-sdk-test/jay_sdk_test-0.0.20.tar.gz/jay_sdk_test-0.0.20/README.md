...
import jay_sdk_test
from jay_sdk_test.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = jay_sdk_test.Configuration(
    host = "http://localhost"
)
...
with jay_sdk_test.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = jay_sdk_test.AdminApi(api_client)
...
*UserIdentitiesApi* | [**user_identities_controller_find_one**](docs/UserIdentitiesApi.md#user_identities_controller_find_one) | **GET** /api/v3/useridentities/findOne | It returns the user identity profile of the first user matching the query
