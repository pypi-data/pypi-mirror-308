    ...
    def make_instance(self, include_optional) -> SampleWithAttachmentsAndDatasets:
        ...
        if include_optional:
            return SampleWithAttachmentsAndDatasets(
                ...
                attachments = [
                    jay_sdk_test.models.attachment.Attachment(
                        created_by = '', 
                        updated_by = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                datasets = [
                    jay_sdk_test.models.dataset_class.DatasetClass(
                        created_by = '', 
                        updated_by = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        ...
                        version = '', 
                        history = [
                            jay_sdk_test.models.history_class.HistoryClass(
                                id = '918c98b1-c956-4f0f-94e8-5ab24154a0e2', 
                                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                updated_by = '', )
                            ], 
