<script lang="ts">
	...
	function centerCamera() {
		...
		const cameraZ = boundingSphere.center.z + boundingSphere.radius / Math.sin(fov / 2);

		camera.position.set(boundingSphere.center.x, boundingSphere.center.y, cameraZ * 1.5);
