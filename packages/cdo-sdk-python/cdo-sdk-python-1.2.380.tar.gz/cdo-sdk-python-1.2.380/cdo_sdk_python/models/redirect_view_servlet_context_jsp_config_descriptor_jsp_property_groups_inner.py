...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deferredSyntaxAllowedAsLiteral", "errorOnUndeclaredNamespace", "trimDirectiveWhitespaces", "scriptingInvalid", "elIgnored", "pageEncoding", "isXml", "includePreludes", "includeCodas", "buffer", "defaultContentType", "urlPatterns"]
