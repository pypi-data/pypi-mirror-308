...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buffer", "defaultContentType", "urlPatterns", "scriptingInvalid", "elIgnored", "pageEncoding", "isXml", "includePreludes", "includeCodas", "deferredSyntaxAllowedAsLiteral", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace"]
