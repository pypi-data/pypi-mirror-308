...
from ngcbpc.command.global_args import PARENT_PARSERS
...
class CLICommand:
    ...
    def _can_expose_with_current_config(self, tag=None, name=None):
        ...
        if tag == CONFIG_TYPE:
            ...
            return name in (config.command_map.get("commands") or []) if config.command_map else False
    ...
    def __add_open_tracing(self, parser, func_name):
        ...
        @trace_command(name=command_name)
