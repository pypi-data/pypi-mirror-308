...
def question_yes_no(question, default=None, default_yes=False):  # noqa: D103
    if default_yes:
        return True
    ...
    while True:
        ...
        get_nvPrettyPrint().print_error("Enter valid input choice of 'yes' or 'no' (or 'y' or 'n')\n")


def question_yes_no_cancel(question, default_yes=False):  # noqa: D103
    if default_yes:
        return True
    ...
    while True:
        ...
        get_nvPrettyPrint().print_error("Enter valid input choice of 'yes' or 'no' (or 'y' or 'n') or 'cancel'\n")
