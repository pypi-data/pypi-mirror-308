...
class Task:
    ...
    def __init__(self, transfer_coordinator, callbacks=None, kwargs=None):
...
class FilesToQueueTask(Task):  # noqa: D101
    @staticmethod
    def _can_transfer_file(entry, transfer_path, omit_links, exclude_patterns=None):
        try:
        ...
        try:
            ...
            TransferPrinter().print_error("{} - Skipping file.".format(ve))
            return None
