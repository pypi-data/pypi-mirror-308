...
class Adapter:  # noqa: D101
    ...
    def get_token(self):  # noqa: D102
        _org = self._org or Configuration().org_name
        _team = self._team or Configuration().team_name
        renew = Adapter.renew
        Adapter.renew = False
        return Authentication.get_token(org=_org, team=_team, renew=renew)
...
class GRPCUploadAdapter(Adapter):  # noqa: D101
    ...
    def submit_request(self, client, filemeta, transfer_coordinator=None, **_):
