...
class NVPrettyPrint(metaclass=Singleton):  # noqa: D101
    def __init__(self):
        self.LINE = ""
        self.HEADER = ""
        self.ATRIB = ""
    ...
    def print_warning(self, string):  # noqa: D102
        ...
        if self.config.format_type != "json" and self.config.format_type != "csv":
    ...
    def print_data(self, input_str, is_table=False, output_target=None, no_wrap_columns=None):  # noqa: D102
        formatter = get_formatter(self.config.format_type, output_target=output_target)
    ...
    def create_transfer_progress_bar(
        ...
        quiet = self.config.format_type == "json" or NGC_CLI_PROGRESS_BAR_STYLE == "NONE"
