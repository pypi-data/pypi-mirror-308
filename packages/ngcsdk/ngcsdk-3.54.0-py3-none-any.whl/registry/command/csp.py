...
class CSPSubCommand(RegistryCommand):  # noqa: D101
    ...
    def remove(self, args):  # noqa: D102
        self.config.validate_configuration()
        confirm_remove(target=args.name, default=args.default_yes)
    ...
    def remove_settings(self, args):
        ...
        self.config.validate_configuration()
        confirm_remove(target=f"settings for '{args.name}'", default=args.default_yes)
        try:
