...
class QuickStartProjectSubCommand(QuickStartCommand):  # noqa: D101
    ...
    def __init__(self, parser):
        ...
        self.api = client.basecommand.quickstart.project
        self.cluster_api = client.basecommand.quickstart.cluster
        self.image_api = client.registry.image
        self.label_set_api = client.registry.label_set
        self.printer = QuickStartProjectPrinter()
    ...
    @staticmethod
    def _get_owner():
        user_response = UsersAPI(get_connection()).user_who()
    ...
    def remove(self, args):
        ...
        confirm_remove(target=args.project_id, default=False)
    ...
    def cluster_remove(self, args):
        ...
        confirm_remove(target=args.cluster_id, default=False)
    ...
    def remove_template(self, args):
        ...
        org_name = args.org or self.config.org_name
        team_name = args.team or self.config.team_name
        confirm_remove(target=args.template_id, default=False)
