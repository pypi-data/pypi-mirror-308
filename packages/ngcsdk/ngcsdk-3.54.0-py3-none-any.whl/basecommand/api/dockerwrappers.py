...
class ContainerWrapper:
    ...
    def __init__(self, org_name, team_name, job_id, daemon_ip, proxy_ip, cluster_id, task_id=None):
    ...
    def _write_auth_config_file(self, renew=False):
        ...
        auth_header = Authentication.auth_header(auth_org=self._org_name, auth_team=self._team_name, renew=renew)
        if not auth_header:
