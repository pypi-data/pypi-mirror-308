...
class JobType(str, enum.Enum):  # noqa: D101
    COPY = "copy"
    SYNC = "sync"


class ObjectProtocol(str, enum.Enum):  # noqa: D101
    S3 = "s3"
    OCI_PREAUTH = "ocipreauth"
    AZUREBLOB = "azureblob"


class StorageLocationType(str, enum.Enum):  # noqa: D101
    CEPHFS = "cephfs"
    DDN = "ddn"
    S3 = "s3"
    LOCAL = "local"
...
class JobState(str, enum.Enum):  # noqa: D101
...
class BcpJobType(str, enum.Enum):  # noqa: D101
    IMPORT = "import"
    EXPORT = "export"


class BcpResourceType(str, enum.Enum):  # noqa: D101
    DATASET = "dataset"
    RESULTSET = "resultset"
    WORKSPACE = "workspace"


class BcpCopyType(str, enum.Enum):  # noqa: D101
    IMPORT = "import"
    EXPORT = "export"
    ACE2ACE = "ace_to_ace"


class BcpCopyActionType(str, enum.Enum):  # noqa: D101
