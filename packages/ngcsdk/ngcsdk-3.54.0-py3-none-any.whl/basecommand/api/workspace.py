...
class WorkspaceAPI:  # noqa: D101
    def __init__(self, connection, api_client=None, dataset_service_connection=None):
        ...
        self._org_api = OrgAPI(connection=connection)
    ...
    def upload(
        ...
        dataset_service_enabled = is_dataset_service_enabled(org_api=self.client.org, org_name=org_name)
    ...
    def download(
        ...
        controller = TransferController(download_id, config, dataset_service_enabled, workspace_id)
        if files or dirs:
