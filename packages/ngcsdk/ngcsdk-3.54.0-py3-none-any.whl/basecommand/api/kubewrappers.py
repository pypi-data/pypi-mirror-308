...
class KubeWrapper:
    ...
    def __init__(self, org_name, team_name, job_id, proxy_ip, container_id, replica_id):
    ...
    def _exec_attach(self):
        token = Authentication.get_token(org=self.org_name, team=self.team_name, renew=True)
