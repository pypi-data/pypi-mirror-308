...
def _get_overridden_values(*, org=None, team=None, ace=None) -> _ConfigValues:
    org = org or Configuration().org_name
    team = team or Configuration().team_name
    ace = ace or Configuration().ace_name
    if org == "no-org":
        org = None
    if team == "no-team":
        team = None
...
def create_cluster_params(
    ...
    *,
    ...
    qs_printer = QuickStartClusterPrinter()
...
class QuickStartClusterAPI:  # noqa: D101
    ...
    def list(
        ...
        *,
        ...
        org, team, _ = _get_overridden_values(org=org, team=team)
    ...
    def list_instance_types(
        ...
        *,
        ...
        org, team, ace = _get_overridden_values(org=org, team=team, ace=ace)
