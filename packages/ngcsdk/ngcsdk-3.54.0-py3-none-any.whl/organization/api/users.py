...
class UsersAPI:  # noqa: D101
    ...
    def info(self, user_id: str, org: Optional[str] = None, team: Optional[str] = None):
        ...
        org_name = org or self.connection.configuration.org_name
        team_name = team or self.connection.configuration.team_name
    ...
    def user_who_personal_key(self, sak_key):
        ...
        sak_caller_info_object = self.connection.configuration._get_sak_key_details(sak_key)
    ...
    def who(self, org: Optional[str] = None):
        ...
        """  # noqa: D205, D401
        self.connection.configuration._check_org(org, remote_validation=True)  # pylint: disable=protected-access
        self.connection.configuration.validate_configuration()
        org_name = org or self.connection.configuration.org_name
        if self.connection.configuration.app_key and self.connection.configuration.app_key.startswith(
            SCOPED_KEY_PREFIX
        ):
            sak_key = self.connection.configuration.app_key
    ...
    def get_user_storage_quota(self, user_id: int, org_name: str, ace_name: str):
        ...
        dataset_service_storage_info = self.api_client.basecommand.dataset.get_user_storage(org_name=org_name)
        return (
    ...
    def storage_quota(self, user_id: int, org: Optional[str] = None, ace: Optional[str] = None):
        ...
        self.connection.configuration.validate_configuration()
        org_name = org or self.connection.configuration.org_name
        ace_name = ace or self.connection.configuration.ace_name
