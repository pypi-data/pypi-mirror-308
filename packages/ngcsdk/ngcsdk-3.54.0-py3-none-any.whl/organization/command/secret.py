...
class SecretCommand(UserCommand):  # noqa: D101
    ...
    def __init__(self, parser):
        ...
        self.client = Client(api_key=self.config.app_key, base_url=self.config.base_url).secrets
        self.printer = SecretPrinter()
    ...
    def delete(self, args):  # noqa: D102
        ...
        confirm_remove(target=target, default=args.default_yes)
