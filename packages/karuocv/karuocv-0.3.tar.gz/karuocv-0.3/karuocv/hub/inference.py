...
class ImageAnnotator:
    def __init__(self, weights_file, verbose: bool = False) -> None:
        """
        Args:
        ...
        self._model = genYOLOModel(self._weights_file, verbose)

    def fullAnnotateImage(self, image: cv2.typing.MatLike, box_annotator: sv.BoxAnnotator = None, label_annotator: sv.LabelAnnotator = None) -> cv2.typing.MatLike:
        """
        对一幅图片进行完整注解
        Args:
            image MatLike 图片
