...
def vcd_inferenced_video(weight_file: str, source_video: str, output_video: str, recorder: str = "imageio", verbose: bool = False) -> Union[None | sv.VideoInfo]:
    """
    推理录像
    Args:
    ...
    try:
        ...
        if recorder == "imageio":
            ...
            _video_saver = imageio.get_writer(output_video, format="FFMPEG", fps=video_info.fps)
