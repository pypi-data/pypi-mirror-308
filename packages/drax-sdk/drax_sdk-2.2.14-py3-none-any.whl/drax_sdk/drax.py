...
class DraxCore:
    ...
    def list_nodes(
        self, project_id: str | None, keyword: str | None, page: int = 1, size: int = 10
    ) -> PagedResult[Node]:
        if project_id == None:
    ...
    def set_state(self, node_id: str, state_request: StateRequest) -> None:
        for key, value in state_request.configuration.items():
            state_request.configuration[key] = str(value)
