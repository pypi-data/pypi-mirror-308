...
class CameraPrebufferDelegate(Protocol):
    async def getPrebufferingState(self, source_name: str, container: Container) -> PrebufferState | None: ...
...
class CameraDeviceSource(CameraBaseSource, Protocol):
    ...
    async def get_prebuffering_state(self, container: Container) -> PrebufferState | None: ...
