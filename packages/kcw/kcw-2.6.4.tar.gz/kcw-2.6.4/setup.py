...
confkcw={}
confkcw['name']=config.kcw['name']                            #项目的名称 
confkcw['version']=config.kcw['version']							#项目版本
confkcw['description']=config.kcw['description']       #项目的简单描述
confkcw['long_description']=config.kcw['long_description']     #项目详细描述
confkcw['license']=config.kcw['license']                   #开源协议   mit开源
confkcw['url']=config.kcw['url']
confkcw['author']=config.kcw['author']  					 #名字
confkcw['author_email']=config.kcw['author_email'] 	     #邮件地址
confkcw['maintainer']=config.kcw['maintainer'] 						 #维护人员的名字
confkcw['maintainer_email']=config.kcw['maintainer_email']    #维护人员的邮件地址
