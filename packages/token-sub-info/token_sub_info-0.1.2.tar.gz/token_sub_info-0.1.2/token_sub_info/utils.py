...
from .exceptions import TokenExpiredException, IncorrectTokenFormatException, UserUnauthorizedException
...
def decode_token(token: str, public_key: str, jwt_algorithm: str) -> dict:
    """
