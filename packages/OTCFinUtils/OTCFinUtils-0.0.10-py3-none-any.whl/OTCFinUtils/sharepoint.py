...
from OTCFinUtils.data_structs import HTTPStatus
...
def load_document(dataverse_url: str, token: str, document_path: str, drive: str) -> BytesIO:
    ...
    if download_response.status_code != HTTPStatus.OK.value:
...
def create_excel_document(
    ...
    if response.status_code not in (HTTPStatus.CREATED.value, HTTPStatus.OK.value):
