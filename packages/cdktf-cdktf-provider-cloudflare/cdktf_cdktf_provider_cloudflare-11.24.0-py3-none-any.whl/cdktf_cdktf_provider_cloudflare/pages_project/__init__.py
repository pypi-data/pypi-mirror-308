...
Refer to the Terraform Registry for docs: [`cloudflare_pages_project`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project).
'''
...
class PagesProject(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project cloudflare_pages_project} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#account_id PagesProject#account_id}
        :param name: Name of the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#name PagesProject#name}
        :param production_branch: The name of the branch that is used for the production environment. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#production_branch PagesProject#production_branch}
        :param build_config: build_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#build_config PagesProject#build_config}
        :param deployment_configs: deployment_configs block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#deployment_configs PagesProject#deployment_configs}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#id PagesProject#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param source: source block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#source PagesProject#source}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing PagesProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#import import section} in the documentation of this resource for the id to use
    ...
    def put_build_config(
        ...
        *,
        ...
        '''
        :param build_caching: Enable build caching for the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#build_caching PagesProject#build_caching}
        :param build_command: Command used to build project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#build_command PagesProject#build_command}
        :param destination_dir: Output directory of the build. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#destination_dir PagesProject#destination_dir}
        :param root_dir: Your project's root directory, where Cloudflare runs the build command. If your site is not in a subdirectory, leave this path value empty. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#root_dir PagesProject#root_dir}
        :param web_analytics_tag: The classifying tag for analytics. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#web_analytics_tag PagesProject#web_analytics_tag}
        :param web_analytics_token: The auth token for analytics. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#web_analytics_token PagesProject#web_analytics_token}
        '''
    ...
    def put_deployment_configs(
        ...
        *,
        ...
        '''
        :param preview: preview block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#preview PagesProject#preview}
        :param production: production block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#production PagesProject#production}
        '''
    ...
    def put_source(
        ...
        *,
        ...
        '''
        :param config: config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#config PagesProject#config}
        :param type: Project host type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#type PagesProject#type}
        '''
...
class PagesProjectDeploymentConfigsOutputReference(
    ...
    def put_preview(
        ...
        *,
        ...
        '''
        :param always_use_latest_compatibility_date: Use latest compatibility date for Pages Functions. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#always_use_latest_compatibility_date PagesProject#always_use_latest_compatibility_date}
        :param compatibility_date: Compatibility date used for Pages Functions. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#compatibility_date PagesProject#compatibility_date}
        :param compatibility_flags: Compatibility flags used for Pages Functions. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#compatibility_flags PagesProject#compatibility_flags}
        :param d1_databases: D1 Databases used for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#d1_databases PagesProject#d1_databases}
        :param durable_object_namespaces: Durable Object namespaces used for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#durable_object_namespaces PagesProject#durable_object_namespaces}
        :param environment_variables: Environment variables for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#environment_variables PagesProject#environment_variables}
        :param fail_open: Fail open used for Pages Functions. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#fail_open PagesProject#fail_open}
        :param kv_namespaces: KV namespaces used for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#kv_namespaces PagesProject#kv_namespaces}
        :param placement: placement block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#placement PagesProject#placement}
        :param r2_buckets: R2 Buckets used for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#r2_buckets PagesProject#r2_buckets}
        :param secrets: Encrypted environment variables for Pages Functions. Defaults to ``map[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#secrets PagesProject#secrets}
        :param service_binding: service_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#service_binding PagesProject#service_binding}
        :param usage_model: Usage model used for Pages Functions. Available values: ``unbound``, ``bundled``, ``standard``. Defaults to ``bundled``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#usage_model PagesProject#usage_model}
        '''
...
class PagesProjectDeploymentConfigsPreviewOutputReference(
    ...
    def put_placement(self, *, mode: typing.Optional[builtins.str] = None) -> None:
        '''
        :param mode: Placement Mode for the Pages Function. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#mode PagesProject#mode}
        '''
...
class PagesProjectDeploymentConfigsPreviewServiceBinding:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#name PagesProject#name}
        :param service: The name of the Worker to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#service PagesProject#service}
        :param environment: The name of the Worker environment to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#environment PagesProject#environment}
        '''
        if __debug__:
...
class PagesProjectSourceConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param production_branch: Project production branch name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#production_branch PagesProject#production_branch}
        :param deployments_enabled: Toggle deployments on this repo. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#deployments_enabled PagesProject#deployments_enabled}
        :param owner: Project owner username. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#owner PagesProject#owner}
        :param pr_comments_enabled: Enable Pages to comment on Pull Requests. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#pr_comments_enabled PagesProject#pr_comments_enabled}
        :param preview_branch_excludes: Branches will be excluded from automatic deployment. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#preview_branch_excludes PagesProject#preview_branch_excludes}
        :param preview_branch_includes: Branches will be included for automatic deployment. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#preview_branch_includes PagesProject#preview_branch_includes}
        :param preview_deployment_setting: Preview Deployment Setting. Available values: ``custom``, ``all``, ``none``. Defaults to ``all``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#preview_deployment_setting PagesProject#preview_deployment_setting}
        :param production_deployment_enabled: Enable production deployments. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#production_deployment_enabled PagesProject#production_deployment_enabled}
        :param repo_name: Project repository name. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/pages_project#repo_name PagesProject#repo_name}
        '''
        if __debug__:
