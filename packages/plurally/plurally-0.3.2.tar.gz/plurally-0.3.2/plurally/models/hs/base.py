...
This block requires you to connect your HubSpot account to Plurally.
            ...
            def adapters(self):
                return super().adapters | (
                    {entity_name: {Association: assoc_adapter}} if assoc_adapter else {}
                )
                    ...
                    **{
                        prop: (
                            ...
                            Field(
                                ...
                                description=cls.FIELD_PROPS.get(prop, {}).get(
                                    "description"
                                ),
                            ),
                        )
