...
def extract_lr(adata, species, min_cell=1):
    """
    ...
    if species == 'mouse':
        geneInter = pd.read_csv(
            '/home/liujixin/project/SpaGRD/data/CellChatDB/mouse_CellChatDB_interaction.csv', header=0,
            index_col=0)
        comp = pd.read_csv('/home/liujixin/project/SpaGRD/data/CellChatDB/mouse_CellChatDB_complex.csv',
                           header=0,
                           index_col=0)
        ...
        geneInter = pd.read_csv(
            '/home/liujixin/project/SpaGRD/data/CellChatDB/human_CellChatDB_interaction.csv', header=0,
            index_col=0)
        comp = pd.read_csv('/home/liujixin//project/SpaGRD/data/CellChatDB/human_CellChatDB_complex.csv',
    ...
    # all_ligand_list = np.unique(single_ligand_list).tolist()
    # all_receptor_list = np.unique(single_receptor_list).tolist()
