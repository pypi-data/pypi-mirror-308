...
setup(
  name = 'invoicing_alexl70', #* Your package will have this name
  ...
  author = 'Alexander Levinson',            # Your name
  author_email = 'alexander.levinson.70@gmail.com',  # Your email
  url = 'https://github.com/AlexL70/python-package', # Homepage of your library (e.g. github or your website)
