...
if __name__ == "__main__":
    adj_list = {
        "P": {"k1": [12], "k2": [22], "k3": [37]},
        "k1": {"P": [12], "k2": [8], "k4": [10], "k5": [8]},
        "k2": {"P": [22], "k1": [8], "k3": [11], "k5": [17]},
        "k3": {"P": [37], "k2": [11], "k5": [21], "k6": [7]},
        "k4": {"k1": [10], "k5": [15], "k7": [20], "k9": [14]},
        "k5": {"k1": [8], "k2": [17], "k3": [21], "k4": [15], "k6": [20], "k7": [15]},
        "k6": {"k3": [7], "k5": [20], "k7": [18], "k8": [23]},
        "k7": {"k4": [20], "k5": [15], "k6": [18], "k8": [10], "k9": [15]},
        "k8": {"k6": [23], "k7": [10], "k9": [22]},
        "k9": {"k4": [14], "k7": [15], "k8": [22]},
    }
    G = Graph(adj_list)
    print(G.chinese_postman("P"))
