...
class AllegoCoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetHasGPIOExpander = channel.unary_unary(
                '/allego.AllegoCore/SetHasGPIOExpander',
                request_serializer=allegoserver__pb2.SetHasGPIOExpanderRequest.SerializeToString,
                response_deserializer=common__pb2.StandardReply.FromString,
                )
...
class AllegoCoreServicer(object):
    ...
    def SetHasGPIOExpander(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AllegoCoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetHasGPIOExpander': grpc.unary_unary_rpc_method_handler(
                    servicer.SetHasGPIOExpander,
                    request_deserializer=allegoserver__pb2.SetHasGPIOExpanderRequest.FromString,
                    response_serializer=common__pb2.StandardReply.SerializeToString,
            ),
...
class AllegoCore(object):
    ...
    @staticmethod
    def SetHasGPIOExpander(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.AllegoCore/SetHasGPIOExpander',
            allegoserver__pb2.SetHasGPIOExpanderRequest.SerializeToString,
            common__pb2.StandardReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
