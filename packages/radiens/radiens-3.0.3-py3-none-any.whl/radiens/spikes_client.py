...
class SpikesClient():
    ...
    def get_spike_waveforms(self, dataset_id: str, time_range: TimeRange | list, hub_name=DEFAULT_HUB_ID):
        """
    ...
    def get_spike_timestamps(self, dataset_id: str, time_range:  TimeRange, hub_name=DEFAULT_HUB_ID):
        """
