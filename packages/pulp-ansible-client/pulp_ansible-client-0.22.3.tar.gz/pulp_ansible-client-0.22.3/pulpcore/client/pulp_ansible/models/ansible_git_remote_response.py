...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, tls_validation=None, pulp_labels=None, ca_cert=None, pulp_last_updated=None, sock_read_timeout=None, hidden_fields=None, name=None, pulp_href=None, proxy_url=None, connect_timeout=None, url=None, rate_limit=None, sock_connect_timeout=None, total_timeout=None, pulp_created=None, max_retries=None, client_cert=None, prn=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
