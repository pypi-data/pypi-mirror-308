...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, prn=None, total_timeout=None, url=None, sock_connect_timeout=None, name=None, pulp_labels=None, pulp_href=None, rate_limit=None, pulp_created=None, headers=None, download_concurrency=None, hidden_fields=None, connect_timeout=None, proxy_url=None, ca_cert=None, tls_validation=None, max_retries=None, client_cert=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
