...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, client_key=None, total_timeout=None, username=None, url=None, proxy_username=None, sock_connect_timeout=None, name=None, pulp_labels=None, rate_limit=None, proxy_password=None, headers=None, password=None, download_concurrency=None, connect_timeout=None, proxy_url=None, ca_cert=None, tls_validation=None, max_retries=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
