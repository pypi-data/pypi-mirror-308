...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, prn=None, artifact=None, pulp_href=None, pulp_created=None, pulp_last_updated=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501
