...
class AnsibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, username=None, tls_validation=None, pulp_labels=None, ca_cert=None, sock_read_timeout=None, client_key=None, name=None, proxy_url=None, connect_timeout=None, url=None, rate_limit=None, sock_connect_timeout=None, proxy_password=None, total_timeout=None, max_retries=None, proxy_username=None, client_cert=None, password=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
