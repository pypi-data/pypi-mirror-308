        ...
        with open(self._dummy_part_memory , 'r') as openfile:
            ...
            for i in range(n):
                try:
                    ...
                    raise Exception(f'ERROR: memory location was not set but got called by _dryrun_read on slave {slave} and register {register + i} \n fix by using fillout_dummy_memory before attempting to read dummy memory')
            return data    
