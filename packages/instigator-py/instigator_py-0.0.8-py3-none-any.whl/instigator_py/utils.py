"""Helper functions used throughout instigator_py."""
...
from instigator_py.environment import StrictEnvironment
...
def create_tmp_repo_dir(repo_dir: Path | str) -> Path:
    ...
    base_dir = tempfile.mkdtemp(prefix='instigator_py')
...
def create_env_with_context(context: dict[str, Any]) -> StrictEnvironment:
    ...
    envvars = context.get('instigator_py', {}).get('_jinja2_env_vars', {})
