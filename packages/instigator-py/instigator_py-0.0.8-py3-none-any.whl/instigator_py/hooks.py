"""Functions for discovering and executing various instigator_py hooks."""
...
from instigator_py import utils
from instigator_py.exceptions import FailedHookException
...
def run_script_with_context(
    ...
    :param script_path: Absolute path to the script to run.
    :param cwd: The directory to run the script from.
    :param context: instigator_py project template context.
    """
