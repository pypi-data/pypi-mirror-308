...
from instigator_py.exceptions import InvalidZipRepository
from instigator_py.prompt import prompt_and_delete, read_repo_password
from instigator_py.utils import make_sure_path_exists
...
def unzip(
    ...
    This will download the zipfile to the instigator_py repository,
    and unpack into a temporary directory.

    :param zip_uri: The URI for the zipfile.
    :param is_url: Is the zip URI a URL or a file?
    :param clone_to_dir: The instigator_py repository directory
