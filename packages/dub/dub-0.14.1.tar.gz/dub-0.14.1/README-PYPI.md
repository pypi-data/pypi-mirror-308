...
* [list](https://github.com/dubinc/dub-python/blob/master/docs/sdks/customers/README.md#list) - Get a list of customers
* [create](https://github.com/dubinc/dub-python/blob/master/docs/sdks/customers/README.md#create) - Create a customer
* [get](https://github.com/dubinc/dub-python/blob/master/docs/sdks/customers/README.md#get) - Get a customer
