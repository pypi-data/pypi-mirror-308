...
male_names = [
    'Adam', 'Antonio', 'Albert', 'Alexandr', 'Anton', 'Appolon', 'Artur', 'Askold', 'Avgust',
    'Bogdan', 'Boris', 'Constantin', 'Daniil', 'David', 'Denis', 'Efim', 'Efrem', 'Elizar', 'Emil',
    'Emmanuil', 'Ernest', 'Ferapont', 'Filipp', 'Foma', 'Gavriil', 'Gedeon', 'German',
    'Gordey', 'Ignat', 'Ilarion', 'Iona', 'Iov', 'Ipolit', 'Izmail', 'Klim', 'Lazar', 'Lavr', 'Leonid',
    'Lev', 'Luka', 'Makar', 'Maksim', 'Mark', 'Markel', 'Marat', 'Max', 'Maximus', 'Miron', 'Modest',
    'Nazar', 'Nestor', 'Nik', 'Osip', 'Pankrat', 'Pavl', 'Platon', 'Potap', 'Prohor', 'Rafail', 'Renat',
    'Rodion', 'Roman', 'Ruslan', 'Serge', 'Sidor', 'Sokrat', 'Safron', 'Spiridon', 'Stepfan',
    'Taras', 'Tihon', 'Timur', 'Trofim', 'Vadim', 'Viktor', 'Vladlen', 'Zahar'
]
female_names = [
    'Ada', 'Agla', 'Aida', 'Akulina', 'Alexandra', 'Alina', 'Alisa', 'Alica',
    'Alla', 'Angelica', 'Angelina', 'Anna', 'Avgustina', 'Avgusta', 'Dana', 'Diana',
    'Elena', 'Emilia', 'Eva', 'Evelina', 'Faina', 'Kristina', 'Ekaterina', 'Kamila', 'Katerina',
    'Karolina', 'Kira', 'Lada', 'Lana', 'Larisa', 'Lina', 'Lianna', 'Lilia', 'Liza', 'Ludmila', 'Margarita',
    'Maria', 'Marina', 'Marta', 'Melania', 'Mila', 'Naina', 'Oksana', 'Paulina',
    'Regina', 'Renata', 'Roza', 'Sabina', 'Sofia', 'Svetlana', 'Valentina', 'Valeria',
    'Vasilisa', 'Vasilina', 'Vera', 'Veronika', 'Vilena', 'Viktoria', 'Ksenia', 'Zlata', 'Inessa',
    'Inna', 'Irina', 'Julia'
]
surnames = ['Abramovich', 'Adler', 'Barak', 'Bauman', 'Beider', 'Belski', 'Berg', 'Berkovich', 'Bernshtein',
            'Behold',
            'Bilarchik', 'Binin', 'Bolkovski', 'Botvin', 'Brainin', 'Brodski', 'Bunin', 'Damari', 'Davidovich',
            'Dolin', 'Dorenik', 'Dutnik', 'Gaisin', 'Galich', 'Gandelman', 'German', 'Gershin', 'Gilkin',
            'Ginzburg', 'Golanski', 'Goldberg', 'Gorbik', 'Gurari', 'Gutman', 'Hardin', 'Hazin', 'Ivkin',
            'Kabuli',
            'Katser', 'Kafka', 'Kaganin', 'Kamadei', 'Kantor', 'Kaplan', 'Kaplanak', 'Katsman', 'Katz',
            'Keller',
            'Kim', 'Kogan', 'Kolchak', 'Konoval', 'Kopelman', 'Kotin', 'Kovalik', 'Kramer', 'Krasnovich',
            'Kravets',
            'Kristol', 'Kulisher', 'Lamberg', 'Lazar', 'Lekin', 'Lenski', 'Levan', 'Leviev', 'Levin', 'Levora',
            'Levtak', 'Makler', 'Malik', 'Malkin', 'Mandel', 'Mandelman', 'Markovets', 'Marks', 'Marlin',
            'Marshak',
            'Mask', 'Mazenger', 'Meider', 'Mekin', 'Mendes', 'Miller', 'Merkin', 'Miro', 'Mits', 'Mitzer',
            'Mizrani', 'Molin', 'Morgen', 'Morovez', 'Novak', 'Novinski', 'Ohman', 'Pagon', 'Palevi',
            'Perelman',
            'Perez', 'Polak', 'Pushman', 'Rabin', 'Rivlin', 'Romanovich', 'Rosalinksi', 'Rosin', 'Rubinski',
            'Rudskoi', 'Ruvin', 'Serfin', 'Sheidlin', 'Shengin', 'Shtal', 'Shuller', 'Shuster', 'Sikora',
            'Sitner',
            'Sokol', 'Sverdlin', 'Talesnik', 'Talin', 'Teplinski', 'Tokach', 'Trofim', 'Turski', 'Tverdin',
            'Valter',
            'Vesman', 'Veller', 'Veniamin', 'Venski', 'Veron', 'Zakon', 'Zelin', 'Zelman', 'Zlatan']
        ...
        for message in messages:
            try:
                ...
                if message.text:
                    ...
                    # file_name = message.video.file_name or f"{datetime.datetime.utcnow().strftime('%d-%m-%Y_%H-%M-%S-%f.mp4')}"
                    # dst = os.path.join(MEDIA_D, str(BOT_TID_TEST), file_name)
                    # await app.download_media(file_id, dst)
...
async def get_pay_btn(bot, chat_id, lz, payload='donate', stars=1):
    try:
        ...
        await bot.send_invoice(chat_id=chat_id,
                               ...
                               payload=f"{chat_id}_{stars}_{payload}",
                               currency='XTR',
...
async def star_invoice_link(bot, PROJECT_USERNAME, chat_id, stars, payload='-', photo_url=None):
    result = None
    try:
...
async def list_star_invoice_link(bot, PROJECT_USERNAME):
    try:
        chat_id = 1
        stars = 1
        payload = '-'
...
async def refund_star_payment_fun(bot, state, chat_id, telegram_payment_id):
    res = None
    try:
        try:
    ...
    try:
        ...
        for mem_id, mem_item in memes_data.items():
            ...
            try:
                ...
                mem_item['id'] = mem_id
                file_id, mem_format = await create_mem(bot, chat_id, lz, tid, mem_item, username_orig, title, desc, file_photo, IMGFLIP_UN, IMGFLIP_PS, MEDIA_D, mem_type)
                if file_id:
                    rnd_emoji = random.choices(animated_emoji, k=random.randint(2, 5))
                    rnd_words = random.choices(trg_utms, k=random.randint(2, 5))
    ...
    try:
        ...
        if input_file.lower().endswith('.webp') and os.path.getsize(input_file) <= size_kb:
            ...
            if PACK_TYPE == 'emoji' and width == 100 and height == 100:
                ...
                upl = await bot.upload_sticker_file(user_id=chat_id,
                                                    sticker=types.FSInputFile(input_file),
...
async def item_to_dynamic_sticker(bot, chat_id, input_file, PACK_TYPE, PACK_KIND, is_upload=True, is_circle=False, is_rbg=False):
    result = result_upl = None
    file_jpg = input_file[:input_file.rfind('.')] + '_.jpg'
    ...
    try:
        ...
        ffmpeg_command = ['ffmpeg', '-i', i_input_data,
        ...
        if is_upload:
            upl = await bot.upload_sticker_file(user_id=chat_id,
                                                sticker=types.FSInputFile(file_webm),
                                                sticker_format=sticker_format)
            result_upl = upl.file_id
        else:
...
async def text_layout(text, MEDIA_D):
    ...
    try:
        ...
        file_name = os.path.join(MEDIA_D, datetime.datetime.utcnow().strftime('%d-%m-%Y_%H-%M-%S-%f.png'))
        surface.write_to_png(file_name)
        result = file_name
    except Exception as e:
        logger.info(log_ % str(e))
        ...
        if message.text == '⬅️ Prev':
            ...
            for obj in album:
                if obj.photo:
                    ...
                    media_type = 'video'
                    file_name_part_new = obj.video.file_name or f"{datetime.datetime.utcnow().strftime('%d-%m-%Y_%H-%M-%S-%f.mp4')}"
                elif obj.audio:
    ...
    try:
        ...
        if message.text == '⬅️ Prev':
            ...
            if message.text:
                ...
                file_id = message.video.file_id
                file_name_part = message.video.file_name or f"{datetime.datetime.utcnow().strftime('%d-%m-%Y_%H-%M-%S-%f.mp4')}"
                file_name = os.path.join(MEDIA_D, file_name_part)
                file = await bot.get_file(file_id)
                await bot.download_file(file.file_path, file_name)
...
async def check_webapp_hash(init_data, TOKEN_BOT, BOT_TOKEN_MAIN=None, extra=None):
    ...
    try:
        ...
        print('seconds {(datetime.datetime.now() - auth_date).seconds}', init_data)
