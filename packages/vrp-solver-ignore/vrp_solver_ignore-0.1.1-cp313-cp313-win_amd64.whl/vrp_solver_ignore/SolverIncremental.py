...
class Solver_Incremental(Parent_Solver):

    def solve(self) -> None:
        """
        Implements the incremental column generation method.
        """
        ...
        while True:
            ...
            new_routes = self.sp_solver.solve_incremental_shortest_path(duals)
