...
Content_types_numbers: dict = {}
""" Reverse mapping of Content_types """

def build_content_types_numbers() -> None:
	""" Build the reverse mapping of Content_types """
	global Content_types_numbers
	Content_types_numbers = { v: k for k, v in Content_types.items() }

# build the reverse mapping
build_content_types_numbers()
