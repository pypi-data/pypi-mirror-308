...
class AaveTarget1AddressEmptyCodeContractError(PypechainBaseError):
...
class AaveTarget1AddressInsufficientBalanceContractError(PypechainBaseError):
...
class AaveTarget1DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class AaveTarget1ExpInvalidExponentContractError(PypechainBaseError):
...
class AaveTarget1FailedInnerCallContractError(PypechainBaseError):
...
class AaveTarget1InsufficientBalanceContractError(PypechainBaseError):
...
class AaveTarget1InsufficientLiquidityContractError(PypechainBaseError):
...
class AaveTarget1InvalidTimestampContractError(PypechainBaseError):
...
class AaveTarget1LnInvalidInputContractError(PypechainBaseError):
...
class AaveTarget1MinimumTransactionAmountContractError(PypechainBaseError):
...
class AaveTarget1OutputLimitContractError(PypechainBaseError):
...
class AaveTarget1ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class AaveTarget1RestrictedZeroAddressContractError(PypechainBaseError):
...
class AaveTarget1SafeERC20FailedOperationContractError(PypechainBaseError):
...
class AaveTarget1UnsafeCastToInt128ContractError(PypechainBaseError):
...
class AaveTarget1UnsafeCastToInt256ContractError(PypechainBaseError):
...
class AaveTarget1UnsafeCastToUint112ContractError(PypechainBaseError):
...
class AaveTarget1UnsafeCastToUint128ContractError(PypechainBaseError):
...
class AaveTarget1ContractErrors(PypechainBaseContractErrors):
...
class AaveTarget1CloseLongContractFunction0(PypechainContractFunction):
    ...
    _error_class = AaveTarget1ContractErrors
...
class AaveTarget1CloseLongContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> AaveTarget1CloseLongContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> AaveTarget1CloseLongContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            AaveTarget1CloseLongContractFunction0._type_signature: AaveTarget1CloseLongContractFunction0.factory(
                "AaveTarget1CloseLongContractFunction0", **kwargs
            ),
        }
        return out


class AaveTarget1CloseShortContractFunction0(PypechainContractFunction):
...
class AaveTarget1CloseShortContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> AaveTarget1CloseShortContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> AaveTarget1CloseShortContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            AaveTarget1CloseShortContractFunction0._type_signature: AaveTarget1CloseShortContractFunction0.factory(
                "AaveTarget1CloseShortContractFunction0", **kwargs
            ),
        }
        return out
