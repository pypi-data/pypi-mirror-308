...
class LsETHTarget3AddressEmptyCodeContractError(PypechainBaseError):
...
class LsETHTarget3AddressInsufficientBalanceContractError(PypechainBaseError):
...
class LsETHTarget3BelowMinimumContributionContractError(PypechainBaseError):
...
class LsETHTarget3CircuitBreakerTriggeredContractError(PypechainBaseError):
...
class LsETHTarget3DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class LsETHTarget3ExpInvalidExponentContractError(PypechainBaseError):
...
class LsETHTarget3FailedInnerCallContractError(PypechainBaseError):
...
class LsETHTarget3InsufficientLiquidityContractError(PypechainBaseError):
...
class LsETHTarget3InvalidAprContractError(PypechainBaseError):
...
class LsETHTarget3InvalidTimestampContractError(PypechainBaseError):
...
class LsETHTarget3LnInvalidInputContractError(PypechainBaseError):
...
class LsETHTarget3MinimumTransactionAmountContractError(PypechainBaseError):
...
class LsETHTarget3NotPayableContractError(PypechainBaseError):
...
class LsETHTarget3OutputLimitContractError(PypechainBaseError):
...
class LsETHTarget3PoolAlreadyInitializedContractError(PypechainBaseError):
...
class LsETHTarget3PoolIsPausedContractError(PypechainBaseError):
...
class LsETHTarget3ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class LsETHTarget3RestrictedZeroAddressContractError(PypechainBaseError):
...
class LsETHTarget3SafeERC20FailedOperationContractError(PypechainBaseError):
...
class LsETHTarget3TransferFailedContractError(PypechainBaseError):
...
class LsETHTarget3UnsafeCastToInt128ContractError(PypechainBaseError):
...
class LsETHTarget3UnsafeCastToInt256ContractError(PypechainBaseError):
...
class LsETHTarget3UnsafeCastToUint112ContractError(PypechainBaseError):
...
class LsETHTarget3UnsafeCastToUint128ContractError(PypechainBaseError):
...
class LsETHTarget3UnsupportedTokenContractError(PypechainBaseError):
...
class LsETHTarget3UpdateLiquidityFailedContractError(PypechainBaseError):
...
class LsETHTarget3ContractErrors(PypechainBaseContractErrors):
...
class LsETHTarget3AddLiquidityContractFunction0(PypechainContractFunction):
    ...
    _error_class = LsETHTarget3ContractErrors
...
class LsETHTarget3AddLiquidityContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _minLpSharePrice: int, _minApr: int, _maxApr: int, _options: IHyperdrive.Options) -> LsETHTarget3AddLiquidityContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> LsETHTarget3AddLiquidityContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            LsETHTarget3AddLiquidityContractFunction0._type_signature: LsETHTarget3AddLiquidityContractFunction0.factory(
                "LsETHTarget3AddLiquidityContractFunction0", **kwargs
            ),
        }
        return out


class LsETHTarget3InitializeContractFunction0(PypechainContractFunction):
...
class LsETHTarget3InitializeContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _apr: int, _options: IHyperdrive.Options) -> LsETHTarget3InitializeContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> LsETHTarget3InitializeContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            LsETHTarget3InitializeContractFunction0._type_signature: LsETHTarget3InitializeContractFunction0.factory(
                "LsETHTarget3InitializeContractFunction0", **kwargs
            ),
        }
        return out
