...
class ERC4626Target4AddressEmptyCodeContractError(PypechainBaseError):
...
class ERC4626Target4AddressInsufficientBalanceContractError(PypechainBaseError):
...
class ERC4626Target4ExpInvalidExponentContractError(PypechainBaseError):
...
class ERC4626Target4FailedInnerCallContractError(PypechainBaseError):
...
class ERC4626Target4InsufficientBalanceContractError(PypechainBaseError):
...
class ERC4626Target4InsufficientLiquidityContractError(PypechainBaseError):
...
class ERC4626Target4InvalidCheckpointTimeContractError(PypechainBaseError):
...
class ERC4626Target4InvalidTimestampContractError(PypechainBaseError):
...
class ERC4626Target4LnInvalidInputContractError(PypechainBaseError):
...
class ERC4626Target4MinimumTransactionAmountContractError(PypechainBaseError):
...
class ERC4626Target4OutputLimitContractError(PypechainBaseError):
...
class ERC4626Target4RestrictedZeroAddressContractError(PypechainBaseError):
...
class ERC4626Target4SafeERC20FailedOperationContractError(PypechainBaseError):
...
class ERC4626Target4UnsafeCastToInt128ContractError(PypechainBaseError):
...
class ERC4626Target4UnsafeCastToInt256ContractError(PypechainBaseError):
...
class ERC4626Target4UnsafeCastToUint112ContractError(PypechainBaseError):
...
class ERC4626Target4UnsafeCastToUint128ContractError(PypechainBaseError):
...
class ERC4626Target4UnsupportedTokenContractError(PypechainBaseError):
...
class ERC4626Target4ContractErrors(PypechainBaseContractErrors):
    ...
    UnsupportedToken: ERC4626Target4UnsupportedTokenContractError
    ...
    def __init__(
        ...
        self.UnsupportedToken = ERC4626Target4UnsupportedTokenContractError()
...
class ERC4626Target4CheckpointContractFunction0(PypechainContractFunction):
    ...
    _error_class = ERC4626Target4ContractErrors
...
class ERC4626Target4CheckpointContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _checkpointTime: int, _maxIterations: int) -> ERC4626Target4CheckpointContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> ERC4626Target4CheckpointContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            ERC4626Target4CheckpointContractFunction0._type_signature: ERC4626Target4CheckpointContractFunction0.factory(
                "ERC4626Target4CheckpointContractFunction0", **kwargs
            ),
        }
        return out


class ERC4626Target4RedeemWithdrawalSharesContractFunction0(
    PypechainContractFunction
):
...
class ERC4626Target4RedeemWithdrawalSharesContractFunction(
    PypechainContractFunction
):
    ...
    @overload
    def __call__(self, _withdrawalShares: int, _minOutputPerShare: int, _options: IHyperdrive.Options) -> ERC4626Target4RedeemWithdrawalSharesContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> ERC4626Target4RedeemWithdrawalSharesContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            ERC4626Target4RedeemWithdrawalSharesContractFunction0._type_signature: ERC4626Target4RedeemWithdrawalSharesContractFunction0.factory(
                "ERC4626Target4RedeemWithdrawalSharesContractFunction0",
                **kwargs,
            ),
        }
        return out
...
class ERC4626Target4RemoveLiquidityContractFunction0(PypechainContractFunction):
...
class ERC4626Target4RemoveLiquidityContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _lpShares: int, _minOutputPerShare: int, _options: IHyperdrive.Options) -> ERC4626Target4RemoveLiquidityContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> ERC4626Target4RemoveLiquidityContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            ERC4626Target4RemoveLiquidityContractFunction0._type_signature: ERC4626Target4RemoveLiquidityContractFunction0.factory(
                "ERC4626Target4RemoveLiquidityContractFunction0", **kwargs
            ),
        }
        return out
