...
class StETHTarget2DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class StETHTarget2ExpInvalidExponentContractError(PypechainBaseError):
...
class StETHTarget2InsufficientLiquidityContractError(PypechainBaseError):
...
class StETHTarget2InvalidTimestampContractError(PypechainBaseError):
...
class StETHTarget2LnInvalidInputContractError(PypechainBaseError):
...
class StETHTarget2MinimumSharePriceContractError(PypechainBaseError):
...
class StETHTarget2MinimumTransactionAmountContractError(PypechainBaseError):
...
class StETHTarget2OutputLimitContractError(PypechainBaseError):
...
class StETHTarget2PoolIsPausedContractError(PypechainBaseError):
...
class StETHTarget2ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class StETHTarget2RestrictedZeroAddressContractError(PypechainBaseError):
...
class StETHTarget2TransferFailedContractError(PypechainBaseError):
...
class StETHTarget2UnsafeCastToInt128ContractError(PypechainBaseError):
...
class StETHTarget2UnsafeCastToInt256ContractError(PypechainBaseError):
...
class StETHTarget2UnsafeCastToUint112ContractError(PypechainBaseError):
...
class StETHTarget2UnsafeCastToUint128ContractError(PypechainBaseError):
...
class StETHTarget2ContractErrors(PypechainBaseContractErrors):
...
class StETHTarget2OpenLongContractFunction0(PypechainContractFunction):
    ...
    _error_class = StETHTarget2ContractErrors
...
class StETHTarget2OpenLongContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _amount: int, _minOutput: int, _minVaultSharePrice: int, _options: IHyperdrive.Options) -> StETHTarget2OpenLongContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> StETHTarget2OpenLongContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            StETHTarget2OpenLongContractFunction0._type_signature: StETHTarget2OpenLongContractFunction0.factory(
                "StETHTarget2OpenLongContractFunction0", **kwargs
            ),
        }
        return out


class StETHTarget2OpenShortContractFunction0(PypechainContractFunction):
...
class StETHTarget2OpenShortContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _bondAmount: int, _maxDeposit: int, _minVaultSharePrice: int, _options: IHyperdrive.Options) -> StETHTarget2OpenShortContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> StETHTarget2OpenShortContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            StETHTarget2OpenShortContractFunction0._type_signature: StETHTarget2OpenShortContractFunction0.factory(
                "StETHTarget2OpenShortContractFunction0", **kwargs
            ),
        }
        return out
