...
class AaveTarget3AddressEmptyCodeContractError(PypechainBaseError):
...
class AaveTarget3AddressInsufficientBalanceContractError(PypechainBaseError):
...
class AaveTarget3BelowMinimumContributionContractError(PypechainBaseError):
...
class AaveTarget3CircuitBreakerTriggeredContractError(PypechainBaseError):
...
class AaveTarget3DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class AaveTarget3ExpInvalidExponentContractError(PypechainBaseError):
...
class AaveTarget3FailedInnerCallContractError(PypechainBaseError):
...
class AaveTarget3InsufficientLiquidityContractError(PypechainBaseError):
...
class AaveTarget3InvalidAprContractError(PypechainBaseError):
...
class AaveTarget3InvalidEffectiveShareReservesContractError(PypechainBaseError):
...
class AaveTarget3InvalidTimestampContractError(PypechainBaseError):
...
class AaveTarget3LnInvalidInputContractError(PypechainBaseError):
...
class AaveTarget3MinimumTransactionAmountContractError(PypechainBaseError):
...
class AaveTarget3NotPayableContractError(PypechainBaseError):
...
class AaveTarget3OutputLimitContractError(PypechainBaseError):
...
class AaveTarget3PoolAlreadyInitializedContractError(PypechainBaseError):
...
class AaveTarget3PoolIsPausedContractError(PypechainBaseError):
...
class AaveTarget3ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class AaveTarget3RestrictedZeroAddressContractError(PypechainBaseError):
...
class AaveTarget3SafeERC20FailedOperationContractError(PypechainBaseError):
...
class AaveTarget3TransferFailedContractError(PypechainBaseError):
...
class AaveTarget3UnsafeCastToInt128ContractError(PypechainBaseError):
...
class AaveTarget3UnsafeCastToInt256ContractError(PypechainBaseError):
...
class AaveTarget3UnsafeCastToUint112ContractError(PypechainBaseError):
...
class AaveTarget3UnsafeCastToUint128ContractError(PypechainBaseError):
...
class AaveTarget3UpdateLiquidityFailedContractError(PypechainBaseError):
...
class AaveTarget3ContractErrors(PypechainBaseContractErrors):
...
class AaveTarget3AddLiquidityContractFunction0(PypechainContractFunction):
    ...
    _error_class = AaveTarget3ContractErrors
...
class AaveTarget3AddLiquidityContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _minLpSharePrice: int, _minApr: int, _maxApr: int, _options: IHyperdrive.Options) -> AaveTarget3AddLiquidityContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> AaveTarget3AddLiquidityContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            AaveTarget3AddLiquidityContractFunction0._type_signature: AaveTarget3AddLiquidityContractFunction0.factory(
                "AaveTarget3AddLiquidityContractFunction0", **kwargs
            ),
        }
        return out


class AaveTarget3InitializeContractFunction0(PypechainContractFunction):
...
class AaveTarget3InitializeContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _apr: int, _options: IHyperdrive.Options) -> AaveTarget3InitializeContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> AaveTarget3InitializeContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            AaveTarget3InitializeContractFunction0._type_signature: AaveTarget3InitializeContractFunction0.factory(
                "AaveTarget3InitializeContractFunction0", **kwargs
            ),
        }
        return out
