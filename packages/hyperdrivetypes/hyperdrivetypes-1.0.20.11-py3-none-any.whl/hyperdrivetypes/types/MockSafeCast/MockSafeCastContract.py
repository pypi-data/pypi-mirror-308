...
class MockSafeCastToInt128ContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            MockSafeCastToInt128ContractFunction0._type_signature: MockSafeCastToInt128ContractFunction0.factory(
                "MockSafeCastToInt128ContractFunction0", **kwargs
            ),
            MockSafeCastToInt128ContractFunction1._type_signature: MockSafeCastToInt128ContractFunction1.factory(
                "MockSafeCastToInt128ContractFunction1", **kwargs
            ),
        }
        return out
...
class MockSafeCastToInt256ContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            MockSafeCastToInt256ContractFunction0._type_signature: MockSafeCastToInt256ContractFunction0.factory(
                "MockSafeCastToInt256ContractFunction0", **kwargs
            ),
        }
        return out
...
class MockSafeCastToUint112ContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            MockSafeCastToUint112ContractFunction0._type_signature: MockSafeCastToUint112ContractFunction0.factory(
                "MockSafeCastToUint112ContractFunction0", **kwargs
            ),
        }
        return out
...
class MockSafeCastToUint128ContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            MockSafeCastToUint128ContractFunction0._type_signature: MockSafeCastToUint128ContractFunction0.factory(
                "MockSafeCastToUint128ContractFunction0", **kwargs
            ),
        }
        return out
...
class MockSafeCastToUint256ContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            MockSafeCastToUint256ContractFunction0._type_signature: MockSafeCastToUint256ContractFunction0.factory(
                "MockSafeCastToUint256ContractFunction0", **kwargs
            ),
        }
        return out
...
class MockSafeCastContract(Contract):
    ...
    _raw_bytecode: HexStr | None = HexStr(
        ""
    )
