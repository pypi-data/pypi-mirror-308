...
class EzETHTarget1DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class EzETHTarget1ExpInvalidExponentContractError(PypechainBaseError):
...
class EzETHTarget1InsufficientBalanceContractError(PypechainBaseError):
...
class EzETHTarget1InsufficientLiquidityContractError(PypechainBaseError):
...
class EzETHTarget1InvalidTimestampContractError(PypechainBaseError):
...
class EzETHTarget1LnInvalidInputContractError(PypechainBaseError):
...
class EzETHTarget1MinimumTransactionAmountContractError(PypechainBaseError):
...
class EzETHTarget1OutputLimitContractError(PypechainBaseError):
...
class EzETHTarget1ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class EzETHTarget1RestrictedZeroAddressContractError(PypechainBaseError):
...
class EzETHTarget1UnsafeCastToInt128ContractError(PypechainBaseError):
...
class EzETHTarget1UnsafeCastToInt256ContractError(PypechainBaseError):
...
class EzETHTarget1UnsafeCastToUint112ContractError(PypechainBaseError):
...
class EzETHTarget1UnsafeCastToUint128ContractError(PypechainBaseError):
...
class EzETHTarget1UnsupportedTokenContractError(PypechainBaseError):
...
class EzETHTarget1ContractErrors(PypechainBaseContractErrors):
...
class EzETHTarget1CloseLongContractFunction0(PypechainContractFunction):
    ...
    _error_class = EzETHTarget1ContractErrors
...
class EzETHTarget1CloseLongContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> EzETHTarget1CloseLongContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EzETHTarget1CloseLongContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            EzETHTarget1CloseLongContractFunction0._type_signature: EzETHTarget1CloseLongContractFunction0.factory(
                "EzETHTarget1CloseLongContractFunction0", **kwargs
            ),
        }
        return out


class EzETHTarget1CloseShortContractFunction0(PypechainContractFunction):
...
class EzETHTarget1CloseShortContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> EzETHTarget1CloseShortContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EzETHTarget1CloseShortContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            EzETHTarget1CloseShortContractFunction0._type_signature: EzETHTarget1CloseShortContractFunction0.factory(
                "EzETHTarget1CloseShortContractFunction0", **kwargs
            ),
        }
        return out
