...
class EtchingVaultAssetContractFunction(PypechainContractFunction):
    """ContractFunction for the asset method."""
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            EtchingVaultAssetContractFunction0._type_signature: EtchingVaultAssetContractFunction0.factory(
                "EtchingVaultAssetContractFunction0", **kwargs
            ),
        }
        return out
...
class EtchingVaultConvertToAssetsContractFunction(PypechainContractFunction):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            EtchingVaultConvertToAssetsContractFunction0._type_signature: EtchingVaultConvertToAssetsContractFunction0.factory(
                "EtchingVaultConvertToAssetsContractFunction0", **kwargs
            ),
        }
        return out
...
class EtchingVaultContract(Contract):
    ...
    _raw_bytecode: HexStr | None = HexStr(
        ""
    )
