...
class MorphoBlueTarget1AddressEmptyCodeContractError(PypechainBaseError):
...
class MorphoBlueTarget1ExpInvalidExponentContractError(PypechainBaseError):
...
class MorphoBlueTarget1FailedInnerCallContractError(PypechainBaseError):
...
class MorphoBlueTarget1InsufficientBalanceContractError(PypechainBaseError):
...
class MorphoBlueTarget1InsufficientLiquidityContractError(PypechainBaseError):
...
class MorphoBlueTarget1InvalidTimestampContractError(PypechainBaseError):
...
class MorphoBlueTarget1LnInvalidInputContractError(PypechainBaseError):
...
class MorphoBlueTarget1OutputLimitContractError(PypechainBaseError):
...
class MorphoBlueTarget1RestrictedZeroAddressContractError(PypechainBaseError):
...
class MorphoBlueTarget1UnsafeCastToInt128ContractError(PypechainBaseError):
...
class MorphoBlueTarget1UnsafeCastToInt256ContractError(PypechainBaseError):
...
class MorphoBlueTarget1UnsafeCastToUint112ContractError(PypechainBaseError):
...
class MorphoBlueTarget1UnsafeCastToUint128ContractError(PypechainBaseError):
...
class MorphoBlueTarget1UnsupportedTokenContractError(PypechainBaseError):
...
class MorphoBlueTarget1ContractErrors(PypechainBaseContractErrors):
...
class MorphoBlueTarget1CloseLongContractFunction0(PypechainContractFunction):
    ...
    _error_class = MorphoBlueTarget1ContractErrors
...
class MorphoBlueTarget1CloseLongContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> MorphoBlueTarget1CloseLongContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> MorphoBlueTarget1CloseLongContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            MorphoBlueTarget1CloseLongContractFunction0._type_signature: MorphoBlueTarget1CloseLongContractFunction0.factory(
                "MorphoBlueTarget1CloseLongContractFunction0", **kwargs
            ),
        }
        return out


class MorphoBlueTarget1CloseShortContractFunction0(PypechainContractFunction):
...
class MorphoBlueTarget1CloseShortContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _maturityTime: int, _bondAmount: int, _minOutput: int, _options: IHyperdrive.Options) -> MorphoBlueTarget1CloseShortContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> MorphoBlueTarget1CloseShortContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            MorphoBlueTarget1CloseShortContractFunction0._type_signature: MorphoBlueTarget1CloseShortContractFunction0.factory(
                "MorphoBlueTarget1CloseShortContractFunction0", **kwargs
            ),
        }
        return out
