...
class EETHTarget3BelowMinimumContributionContractError(PypechainBaseError):
...
class EETHTarget3CircuitBreakerTriggeredContractError(PypechainBaseError):
...
class EETHTarget3DistributeExcessIdleFailedContractError(PypechainBaseError):
...
class EETHTarget3ExpInvalidExponentContractError(PypechainBaseError):
...
class EETHTarget3InsufficientLiquidityContractError(PypechainBaseError):
...
class EETHTarget3InvalidAprContractError(PypechainBaseError):
...
class EETHTarget3InvalidEffectiveShareReservesContractError(PypechainBaseError):
...
class EETHTarget3InvalidTimestampContractError(PypechainBaseError):
...
class EETHTarget3LnInvalidInputContractError(PypechainBaseError):
...
class EETHTarget3MinimumTransactionAmountContractError(PypechainBaseError):
...
class EETHTarget3OutputLimitContractError(PypechainBaseError):
...
class EETHTarget3PoolAlreadyInitializedContractError(PypechainBaseError):
...
class EETHTarget3PoolIsPausedContractError(PypechainBaseError):
...
class EETHTarget3ReentrancyGuardReentrantCallContractError(PypechainBaseError):
...
class EETHTarget3RestrictedZeroAddressContractError(PypechainBaseError):
...
class EETHTarget3TransferFailedContractError(PypechainBaseError):
...
class EETHTarget3UnsafeCastToInt128ContractError(PypechainBaseError):
...
class EETHTarget3UnsafeCastToInt256ContractError(PypechainBaseError):
...
class EETHTarget3UnsafeCastToUint112ContractError(PypechainBaseError):
...
class EETHTarget3UnsafeCastToUint128ContractError(PypechainBaseError):
...
class EETHTarget3UpdateLiquidityFailedContractError(PypechainBaseError):
...
class EETHTarget3ContractErrors(PypechainBaseContractErrors):
...
class EETHTarget3_liquidityPoolContractFunction0(PypechainContractFunction):
    """ContractFunction for the _liquidityPool() method."""

    _function_name = "_liquidityPool"
    _type_signature = expand_struct_type_str(tuple([]), structs)
    _error_class = EETHTarget3ContractErrors
...
class EETHTarget3_liquidityPoolContractFunction(PypechainContractFunction):
    """ContractFunction for the _liquidityPool method."""
    ...
    @overload
    def __call__(self) -> EETHTarget3_liquidityPoolContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EETHTarget3_liquidityPoolContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            EETHTarget3_liquidityPoolContractFunction0._type_signature: EETHTarget3_liquidityPoolContractFunction0.factory(
                "EETHTarget3_liquidityPoolContractFunction0", **kwargs
            ),
        }
        return out


class EETHTarget3AddLiquidityContractFunction0(PypechainContractFunction):
...
class EETHTarget3AddLiquidityContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _minLpSharePrice: int, _minApr: int, _maxApr: int, _options: IHyperdrive.Options) -> EETHTarget3AddLiquidityContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EETHTarget3AddLiquidityContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            EETHTarget3AddLiquidityContractFunction0._type_signature: EETHTarget3AddLiquidityContractFunction0.factory(
                "EETHTarget3AddLiquidityContractFunction0", **kwargs
            ),
        }
        return out


class EETHTarget3InitializeContractFunction0(PypechainContractFunction):
...
class EETHTarget3InitializeContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _apr: int, _options: IHyperdrive.Options) -> EETHTarget3InitializeContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EETHTarget3InitializeContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            EETHTarget3InitializeContractFunction0._type_signature: EETHTarget3InitializeContractFunction0.factory(
                "EETHTarget3InitializeContractFunction0", **kwargs
            ),
        }
        return out
