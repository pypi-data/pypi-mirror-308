"""Dataclasses for all structs in the MultiToken__transferFrom contract.
...
ExpectedFailError = ErrorInfo(
    inputs=[],
    name="ExpectedFail",
    selector="0xe94645fb",
    signature="ExpectedFail()",
)

ExpectedSuccessError = ErrorInfo(
    inputs=[],
    name="ExpectedSuccess",
    selector="0xaf0642f4",
    signature="ExpectedSuccess()",
)
...
UnassignedCatchError = ErrorInfo(
    inputs=[],
    name="UnassignedCatch",
    selector="0xec362f5e",
    signature="UnassignedCatch()",
)

UnassignedFailError = ErrorInfo(
    inputs=[],
    name="UnassignedFail",
    selector="0x12121737",
    signature="UnassignedFail()",
)
