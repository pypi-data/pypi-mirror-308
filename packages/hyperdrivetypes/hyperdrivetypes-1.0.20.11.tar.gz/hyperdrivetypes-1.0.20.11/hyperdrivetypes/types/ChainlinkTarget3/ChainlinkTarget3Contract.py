...
class ChainlinkTarget3AddressEmptyCodeContractError(PypechainBaseError):
...
class ChainlinkTarget3BelowMinimumContributionContractError(PypechainBaseError):
...
class ChainlinkTarget3CircuitBreakerTriggeredContractError(PypechainBaseError):
...
class ChainlinkTarget3ExpInvalidExponentContractError(PypechainBaseError):
...
class ChainlinkTarget3FailedInnerCallContractError(PypechainBaseError):
...
class ChainlinkTarget3InsufficientLiquidityContractError(PypechainBaseError):
...
class ChainlinkTarget3InvalidAprContractError(PypechainBaseError):
...
class ChainlinkTarget3InvalidTimestampContractError(PypechainBaseError):
...
class ChainlinkTarget3LnInvalidInputContractError(PypechainBaseError):
...
class ChainlinkTarget3MinimumTransactionAmountContractError(PypechainBaseError):
...
class ChainlinkTarget3NotPayableContractError(PypechainBaseError):
...
class ChainlinkTarget3OutputLimitContractError(PypechainBaseError):
...
class ChainlinkTarget3PoolAlreadyInitializedContractError(PypechainBaseError):
...
class ChainlinkTarget3PoolIsPausedContractError(PypechainBaseError):
...
class ChainlinkTarget3RestrictedZeroAddressContractError(PypechainBaseError):
...
class ChainlinkTarget3SafeERC20FailedOperationContractError(PypechainBaseError):
...
class ChainlinkTarget3TransferFailedContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsafeCastToInt128ContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsafeCastToInt256ContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsafeCastToUint112ContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsafeCastToUint128ContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsafeCastToUint256ContractError(PypechainBaseError):
...
class ChainlinkTarget3UnsupportedTokenContractError(PypechainBaseError):
...
class ChainlinkTarget3UpdateLiquidityFailedContractError(PypechainBaseError):
...
class ChainlinkTarget3ContractErrors(PypechainBaseContractErrors):
...
class ChainlinkTarget3AddLiquidityContractFunction0(PypechainContractFunction):
    ...
    _error_class = ChainlinkTarget3ContractErrors
...
class ChainlinkTarget3AddLiquidityContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _minLpSharePrice: int, _minApr: int, _maxApr: int, _options: IHyperdrive.Options) -> ChainlinkTarget3AddLiquidityContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> ChainlinkTarget3AddLiquidityContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            ChainlinkTarget3AddLiquidityContractFunction0._type_signature: ChainlinkTarget3AddLiquidityContractFunction0.factory(
                "ChainlinkTarget3AddLiquidityContractFunction0", **kwargs
            ),
        }
        return out


class ChainlinkTarget3InitializeContractFunction0(PypechainContractFunction):
...
class ChainlinkTarget3InitializeContractFunction(PypechainContractFunction):
    ...
    @overload
    def __call__(self, _contribution: int, _apr: int, _options: IHyperdrive.Options) -> ChainlinkTarget3InitializeContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> ChainlinkTarget3InitializeContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            ChainlinkTarget3InitializeContractFunction0._type_signature: ChainlinkTarget3InitializeContractFunction0.factory(
                "ChainlinkTarget3InitializeContractFunction0", **kwargs
            ),
        }
        return out
