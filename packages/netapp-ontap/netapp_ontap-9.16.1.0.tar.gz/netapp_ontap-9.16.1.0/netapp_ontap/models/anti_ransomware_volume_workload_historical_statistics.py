...
__all__ = ["AntiRansomwareVolumeWorkloadHistoricalStatistics", "AntiRansomwareVolumeWorkloadHistoricalStatisticsSchema"]
__pdoc__ = {
    "AntiRansomwareVolumeWorkloadHistoricalStatisticsSchema.resource": False,
    "AntiRansomwareVolumeWorkloadHistoricalStatisticsSchema.opts": False,
    "AntiRansomwareVolumeWorkloadHistoricalStatistics": False,
}


class AntiRansomwareVolumeWorkloadHistoricalStatisticsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
Example: 1200 """
    ...
    @property
    def resource(self):
        return AntiRansomwareVolumeWorkloadHistoricalStatistics
...
class AntiRansomwareVolumeWorkloadHistoricalStatistics(Resource):

    _schema = AntiRansomwareVolumeWorkloadHistoricalStatisticsSchema
