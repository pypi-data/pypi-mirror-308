...
* PT5M """
    ...
    space = marshmallow_fields.Nested("netapp_ontap.models.performance_namespace_metric_space.PerformanceNamespaceMetricSpaceSchema", unknown=EXCLUDE, data_key="space", allow_none=True)
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    """iops.other,iops.read,iops.total,iops.write,latency.other,latency.read,latency.total,latency.write,space,throughput.read,throughput.total,throughput.write,"""
