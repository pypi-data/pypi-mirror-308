...
class TableTripStopFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["essence_type", "essence_key", "driving_time", "waiting_time", "break_time", "rest_time", "working_time", "arriving_time", "departure_time", "total_time", "distance", "time_window", "trip_key", "order_key", "demand_type"]
