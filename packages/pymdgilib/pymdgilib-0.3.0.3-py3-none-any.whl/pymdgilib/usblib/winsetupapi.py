...
class DEVPROPKEY(Structure):#pylint: disable=too-few-public-methods
...
class GUID(Structure):#pylint: disable=too-few-public-methods
...
class SpDeviceInterfaceData(Structure):#pylint: disable=too-few-public-methods
...
class SpDeviceInterfaceDetailData(Structure):#pylint: disable=too-few-public-methods
...
class SpDevinfoData(Structure):#pylint: disable=too-few-public-methods
...
class UsbDescriptorRequest(Structure):#pylint: disable=too-few-public-methods
...
class DIGCF:#pylint: disable=too-few-public-methods
    """
...
class WinApiException(Exception):
    "Generic Windows API exception type"
...
SetupDiOpenDeviceInfoW.argtypes = [
    c_void_p, # [in]            HDEVINFO         DeviceInfoSet,
    LPCWSTR, # [in]            PCWSTR           DeviceInstanceId,
    HANDLE, # [in, optional]  HWND             hwndParent,
    DWORD,  # [in]            DWORD            OpenFlags,
    POINTER(SpDevinfoData) # [out, optional] PSP_DEVINFO_DATA DeviceInfoData
]
