...
def _collection_inputs(
    ...
    if output_collection:
        outputs = [Output(collection=output_collection)]
...
def _asset_band_outputs(asset: str, band: Union[int, str]) -> List[Output]:
    return [Output(asset=asset, bands=[band])]


def _asset_bands_outputs(asset: str, bands: List[Union[int, str]]) -> List[Output]:
    return [Output(asset=asset, bands=bands)]
...
def rename_fields(
    ...
    Examples:
        ...
        >>> transform = Middleware.rename_fields(field_map={"old_field": "new_field"})

        >>> # Rename the field "old_field" to "new_field" and make it uppercase
        >>> transform = Middleware.rename_fields(case="upper", field_map={"old_field": "new_field"})
    """  # noqa: E501
...
def combine_fields(
    ...
    Examples:
        ...
        >>> transform = Middleware.combine_fields(
        ...     new_field="FIPS",
...
def simplify(
    ...
    Examples:
        ...
        ...     middleware=[
        ...         Middleware.simplify(threshold=0.01, stride=3)
        ...     ]
        ... )
    """  # noqa: E501
    if threshold < 0:
...
def buffer(
    ...
    Examples:
        ...
        ...     name="buffered-ds",
        ...     middleware=[
        ...         Middleware.buffer(distance=0.01, segments=32)
        ...     ]
        ... )
    """
...
def default_datetime_range(
    ...
    Example:
        ...
        >>> default_datetime_transform = Middleware.default_datetime_range(before_now=datetime.timedelta(days=1))

        >>> # Set the default datetime range to be from 2021-01-01 to 2021-01-02
        >>> default_datetime_transform = Middleware.default_datetime_range(start="2021-01-01", end="2021-01-02")
    """  # noqa: E501
...
def s2(
    ...
    Examples:
        ...
        >>> transform = Middleware.s2(level=10)
    """
...
def h3(
    ...
    Examples:
        ...
        >>> transform = Middleware.h3(resolution=10)
    """
...
def calculate_field(
    ...
    Examples:
        ...
        >>> transform = Middleware.calculate_field(
        ...     new_field="sum",
...
def compute_id(
    ...
    Examples:
        >>> # Compute an ID for each feature in the search response
        >>> transform = Middleware.compute_id()
    """
    inputs, outputs = _collection_inputs(input_collection, output_collection)
...
def colormap(
    *,
    ...
    Examples:
        ...
        >>> colormap_transform = Middleware.colormap(asset="rasterized", band="rasterized", min=0, max=1000)
    """  # noqa: E501
    properties = {
...
def rescale_shift(
    ...
    Examples:
        ...
        >>> transform = Middleware.rescale_shift(
        ... asset="my_asset",
        ... bands=[0, 1, 2],
        ... scale=[255],
        ... shift=[0],
...
def rasterize(
    ...
    Examples:
        ...
        >>> transform = Middleware.rasterize(
...
def inverse_distance_weighting(
    ...
    Examples:
        ...
        >>> transform = Middleware.inverse_distance_weighting(
...
def band_arithmetic(
    ...
    Examples:
        ...
        >>> transform = Middleware.band_arithmetic(
...
def normalized_difference(
    ...
    Examples:
        ...
        >>> transform = Middleware.normalized_difference(
...
def datetime_difference(
    ...
    Examples:
        ...
        >>> transform = Middleware.datetime_difference(
