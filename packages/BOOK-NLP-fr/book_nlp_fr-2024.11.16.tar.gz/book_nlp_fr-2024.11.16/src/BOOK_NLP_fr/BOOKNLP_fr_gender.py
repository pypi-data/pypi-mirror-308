...
def singular_ambiguous_gender_head(df):
    ...
    singular_ambiguous_head = ['enfant', 'reporter', 'autre', 'docteur', 'détective', 'capitaine', 'médecin', 'commissaire', 'notaire', 'juge', 'artiste', 'domestique', 'malade', 'maire', 'concierge', 'ministre', 'professeur', 'auteur', 'hôte', 'esclave', 'troisième', 'coupable', 'misérable', 'pensionnaire', 'élève', 'somnambule', 'garde-malade', 'garde', 'secrétaire', 'modiste', 'camarade', 'chèvre', 'gosse', 'aveugle', 'aristocrate', 'gendarme', 'poète', 'commissionnaire', 'traître', 'lâche', 'guide', 'flic', 'témoin', 'philosophe', 'imbécile', 'sauvage', 'bandit', 'ivrogne', 'journaliste', 'militaire', 'pauvre', 'novice', 'russe', 'collègue', 'fleuriste', 'aubergiste', 'adversaire', 'propriétaire', 'môme', 'architecte', 'pilote', 'ermite', 'pote', 'interne', 'suisse', 'procureur', 'infirme', 'jeune', 'prophète', 'brave', 'drôle', 'monarque', 'mousquetaire', 'vétérinaire', 'poëte', 'photographe', 'apothicaire', 'matamore', 'apôtre', 'séminariste', 'commis', 'noble', 'drapier', 'fat', 'diable', 'diplomate', 'droguiste', 'paralytique', 'journalier', 'aide-de-camp', 'partenaire', 'dentiste', 'confrère', 'copiste', 'centenaire', 'timide', 'vaguemestre', 'patriote', 'convive', 'ex-jésuite', 'gnangnan', 'anatomiste', 'dr', 'fidèle', 'myope', 'proviseur'
                               ]
