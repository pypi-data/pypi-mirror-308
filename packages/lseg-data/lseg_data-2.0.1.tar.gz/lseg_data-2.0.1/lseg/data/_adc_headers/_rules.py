...
from .._tools import ADC_TR_F_FUNC_PATTERN, ADC_TR_F_FUNC_WITH_DATE_PATTERN, ADC_FUNC_PATTERN
...
class RDPRules(Rules):
    ...
    def is_date(cls, header: dict, header_name: str) -> bool:
        ...
        if header_type:
            ...
            retval = DATE_PATTERN in header_name.lower()
        return retval
...
class UDFRules(Rules):
    ...
    def is_date(cls, header: dict, header_name: str) -> bool:
        ...
        if ADC_TR_F_FUNC_PATTERN.match(header_name):
            ...
            is_date_column = bool(DATE_PATTERN in header_title.lower() and not ADC_FUNC_PATTERN.match(header_title))
