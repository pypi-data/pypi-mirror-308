...
if TYPE_CHECKING:
    from ......_types import OptFloat, OptStr


class TwistShift(ObjectDefinition):
    """
    ...
    pivot_tenor : str, optional
        The code indicating the curve point which is not shifted (e.g., '1m', '6m',
        '4y').
    """
    ...
    @property
    def pivot_tenor(self):
        """
        The code indicating the curve point which is not shifted (e.g., '1m', '6m',
        '4y').
        :return: str
        """
        return self._get_parameter("pivotTenor")

    @pivot_tenor.setter
    def pivot_tenor(self, value):
        self._set_parameter("pivotTenor", value)
