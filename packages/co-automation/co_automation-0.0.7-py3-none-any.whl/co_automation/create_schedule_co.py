    ...
    for day in days_of_week:
        ...
        if sn_access_token is not None:
            ...
            if access_token is not None:
                ...
                # create CO request
                co = create_sn_co.create_change_order(SN_INSTANCE, access_token, configuration_item_id, start_date, end_date, week_year, requested_by, data_center, environment_name)
