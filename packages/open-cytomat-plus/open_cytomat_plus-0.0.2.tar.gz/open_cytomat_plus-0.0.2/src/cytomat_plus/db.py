...
class DB():
    def __init__(self):
        self.conn = sqlite3.connect('C:\ProgramData\Cytomat\slots.db', timeout=10)
    ...
    def get_SlotNumber_data(self)-> list[list]:
    ...
    def get_usable_rows(self, role: int = 0):
        cursor = self.conn.cursor()
    ...
    """
    def get_rows_role_dict(self, role: int = 0):
        cursor = self.conn.cursor()
