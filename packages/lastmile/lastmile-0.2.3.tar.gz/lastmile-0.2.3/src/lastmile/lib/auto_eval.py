...
""",
    ...
    def upload_dataset(
        ...
        try:
            upload_file_response = self.client.datasets.upload_file(dataset_id=DatasetID(dataset_id.value))  # type: ignore
        ...
        try:
            self.client.datasets.finalize_file_upload(
                dataset_id=DatasetID(dataset_id.value),  # type: ignore
        ...
        self._wait_for_dataset_ready(dataset_id=DatasetID(dataset_id.value))  # type: ignore
        self.logger.info("Dataset is ready for use.")

        return dataset_id  # type: ignore
    ...
    def download_dataset(
        ...
        try:
            get_download_url_response = self.client.datasets.get_download_url(dataset_id=DatasetID(dataset_id.value))  # type: ignore
    ...
    def label_dataset(
        ...
        dataset_columns = self._get_dataset_columns(dataset_id=DatasetID(dataset_id.value))  # type: ignore
        ...
        try:
            self.client.label_dataset_jobs.submit(
                job_id=JobID(create_response.job_id.value),  # type: ignore
                pseudo_label_job_config=job_config,
            )
        except Exception as e:
    ...
    def _get_dataset_columns(self, dataset_id: DatasetID) -> List[str]:
        ...
        try:
            dataset_info = self.client.datasets.get(id=DatasetID(dataset_id.value))  # type: ignore
    ...
    def fine_tune_model(
        ...
        fine_tune_job_config = FineTuneJobConfig(
            ...
            train_dataset_id=DatasetID(train_dataset_id.value),  # type: ignore
            test_dataset_id=DatasetID(test_dataset_id.value),  # type: ignore
            ...
            try:
                if job_type == "label_dataset":
                    get_status_response_label: LabelDatasetJobGetStatusResponse = (
                        self.client.label_dataset_jobs.get_status(job_id=job_id)  # type: ignore
                    )
