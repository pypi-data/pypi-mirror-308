...
def veh_reassignement_plot(df:pd.DataFrame, roads_id:list, path:str,
    ...
    if separe_plots:
        ...
        f.savefig(path+f'/Capacitée_et_occupation_rue_principale.png', bbox_inches='tight')
        ...
        f.savefig(path+f'/Capacitée_et_occupation_rue_secondaire_apres_repport.png', bbox_inches='tight')
    else:
        ...
        f.savefig(path+f'/Capacitée_résiduelle_horaire_secteur.png', bbox_inches='tight')
