...
def CICC_1(x,y,trust):
    ...
    print('Выборочный коэффициент корреляции: ', rrstr(answer[0]))
    print('Верхняя граница доверительного интервала: ', rrstr(answer[2]))
    print('Нижняя граница доверительного интервала: ', rrstr(answer[1]))
