...
def little_func_for_cp(input_wav_dict, output_dir):
    for key, wav_path in tqdm.tqdm(input_wav_dict.items(), total=len(input_wav_dict)):
        utils_file.copy_file2(wav_path, output_dir, is_jump=True)
...
for dataset_name in dataset_names:
    ...
    for dict_i in numb_dict_list:
        multi_process_runner.add_thread(little_func_for_cp, [dict_i, output_wav_dir])
