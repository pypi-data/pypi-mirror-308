...
from ML_management.sdk.schema import DatasetLoaderInfo, DatasetLoaderVersionInfo
from ML_management.sdk.sdk import _print_params_by_schema, _to_datetime, send_graphql_request
...
def set_dataset_loader_version_description(name: str, version: int, description: str) -> DatasetLoaderVersionInfo:
    ...
    set_description = op.set_dataset_loader_version_description(dataset_loader_version=choice, description=description)
    set_description.name()
...
def get_latest_dataset_loader_version(name) -> DatasetLoaderVersionInfo:
    """
...
def get_initial_dataset_loader_version(name) -> DatasetLoaderVersionInfo:
    """
