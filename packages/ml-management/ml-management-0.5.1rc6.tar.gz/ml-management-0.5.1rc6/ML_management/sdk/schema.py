...
class ExecutionJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('available_metrics', 'build_job', 'end_timestamp', 'exception', 'executor_version', 'experiment', 'latest_metrics', 'list_dataset_loader_versions', 'list_init_role_model_version', 'list_params', 'list_result_model_version', 'metric_history', 'name', 'params', 'periodic_type', 'registration_timestamp', 'run', 'start_timestamp', 'status')
...
class Experiment(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('description', 'experiment_id', 'list_job', 'list_model', 'list_model_version', 'list_run', 'name', 'pagination_job', 'pagination_model', 'pagination_model_version', 'pagination_run', 'tags')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
...
class ModelVersionInfo(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('available_collectors', 'available_dataset_loader_versions', 'available_dataset_loaders', 'available_executor_versions', 'available_executors', 'build_job', 'creation_timestamp', 'description', 'get_conda_env', 'group_job_run', 'group_job_run_id', 'last_updated_timestamp', 'list_deployed_jobs', 'list_job', 'list_lineage_model_version', 'list_new_model_from_version', 'list_new_version_from_version', 'list_next_graph_nodes', 'list_next_model_version', 'list_requirements', 'model', 'model_method_schemas', 'name', 'pagination_available_collectors', 'pagination_available_dataset_loader_versions', 'pagination_available_dataset_loaders', 'pagination_available_executor_versions', 'pagination_available_executors', 'pagination_deployed_jobs', 'pagination_job', 'pagination_lineage_model_version', 'pagination_new_model_from_version', 'pagination_new_version_from_version', 'pagination_next_model_version', 'root_model_version', 'root_run', 'run', 'source_executor_version', 'source_model_version', 'source_path', 'source_run', 'tags', 'upload_model_type', 'venv_build_job', 'version')
    available_collectors = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(InlineObject))), graphql_name='availableCollectors')
...
class Run(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('artifact_uri', 'end_time', 'experiment', 'experiment_id', 'lifecycle_stage', 'list_artifacts', 'list_mlflow_artifacts', 'params', 'parent_job', 'run_id', 'start_time', 'status', 'tags')
