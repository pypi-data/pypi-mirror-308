...
from ML_management.sdk.schema import ModelInfo, ModelVersionInfo
from ML_management.sdk.sdk import _to_datetime, send_graphql_request
...
def get_latest_model_version(name) -> ModelVersionInfo:
    """
...
def get_initial_model_version(name) -> ModelVersionInfo:
    """
...
def set_model_version_description(name: str, version: int, description: str) -> ModelVersionInfo:
    ...
    set_description = op.set_model_version_description(model_version=choice, description=description)
    set_description.name()
