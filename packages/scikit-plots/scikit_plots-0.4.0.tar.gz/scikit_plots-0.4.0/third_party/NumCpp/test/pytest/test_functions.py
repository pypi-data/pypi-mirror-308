...
def test_abs():
    ...
    assert np.round(NumCpp.absScalar(value), 8) == np.round(np.abs(value), 8)
    ...
    data = np.random.randint(-100, 100, [shape.rows, shape.cols]) + 1j * np.random.randint(
        -100, 100, [shape.rows, shape.cols]
    )
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.absArray(cArray), 8), np.round(np.abs(data), 8))
...
def test_angle():
    ...
    value = complex(components[0], components[1])
    assert np.round(NumCpp.angleScalar(value), 8) == np.round(np.angle(value), 8)  # noqa
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.angleArray(cArray), 8), np.round(np.angle(data), 8))
...
def test_append():
    ...
    assert np.array_equal(
        NumCpp.append(cArray1, cArray2, NumCpp.Axis.NONE).getNumpyArray().flatten(), np.append(data1, data2)
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.append(cArray1, cArray2, NumCpp.Axis.ROW).getNumpyArray(), np.append(data1, data2, axis=0)
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.append(cArray1, cArray2, NumCpp.Axis.COL).getNumpyArray(), np.append(data1, data2, axis=1)
    )
...
def test_arange():
    ...
    assert np.array_equal(np.round(NumCpp.arange(start, stop, step).flatten(), 8), np.round(data, 8))


####################################################################################
def test_arccos():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.arccosScalar(value), 8) == np.round(np.arccos(value), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arccosArray(cArray), 8), np.round(np.arccos(data), 8))
...
def test_arccosh():
    ...
    assert np.round(NumCpp.arccoshScalar(value), 8) == np.round(np.arccosh(value), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arccoshArray(cArray), 8), np.round(np.arccosh(data), 8))
...
def test_arcsin():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.arcsinScalar(value), 8) == np.round(np.arcsin(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arcsinArray(cArray), 8), np.round(np.arcsin(data), 8))
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    np.array_equal(np.round(NumCpp.arcsinArray(cArray), 8), np.round(np.arcsin(data), 8))


####################################################################################
def test_arcsinh():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.arcsinhScalar(value), 8) == np.round(np.arcsinh(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arcsinhArray(cArray), 8), np.round(np.arcsinh(data), 8))
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    np.array_equal(np.round(NumCpp.arcsinhArray(cArray), 8), np.round(np.arcsinh(data), 8))


####################################################################################
def test_arctan():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.arctanScalar(value), 8) == np.round(np.arctan(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arctanArray(cArray), 8), np.round(np.arctan(data), 8))
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    np.array_equal(np.round(NumCpp.arctanArray(cArray), 8), np.round(np.arctan(data), 8))


####################################################################################
def test_arctan2():
    xy = np.random.rand(2) * 2 - 1
    assert np.round(NumCpp.arctan2Scalar(xy[1], xy[0]), 8) == np.round(np.arctan2(xy[1], xy[0]), 8)
    ...
    assert np.array_equal(np.round(NumCpp.arctan2Array(cArrayY, cArrayX), 8), np.round(np.arctan2(yData, xData), 8))


####################################################################################
def test_arctanh():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.arctanhScalar(value), 8) == np.round(np.arctanh(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.arctanhArray(cArray), 8), np.round(np.arctanh(data), 8))
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    np.array_equal(np.round(NumCpp.arctanhArray(cArray), 8), np.round(np.arctanh(data), 8))
...
def test_argsort():
    ...
    assert np.array_equal(
        dataFlat[NumCpp.argsort(cArray, NumCpp.Axis.NONE).flatten().astype(np.uint32)],
...
def test_around():
    ...
    assert NumCpp.aroundScalar(value, numDecimalsRound) == np.round(value, numDecimalsRound)
...
def test_average():
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.round(NumCpp.average(cArray, NumCpp.Axis.NONE).item(), 8) == np.round(np.average(data), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.average(cArray, NumCpp.Axis.ROW).flatten(), 8), np.round(np.average(data, axis=0), 8)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.average(cArray, NumCpp.Axis.COL).flatten(), 8), np.round(np.average(data, axis=1), 8)
    )
...
def test_averageWeighted():
    ...
    cWeights.setArray(weights)
    assert np.array_equal(
        np.round(NumCpp.averageWeighted(cArray, cWeights, NumCpp.Axis.ROW).flatten(), 8),
        np.round(np.average(data, weights=weights.flatten(), axis=0), 8),
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.averageWeighted(cArray, cWeights, NumCpp.Axis.COL).flatten(), 8),
        np.round(np.average(data, weights=weights.flatten(), axis=1), 8),
    )
...
def test_bartlett():
    ...
    assert np.array_equal(np.round(NumCpp.bartlett(m), 8).flatten(), np.round(np.bartlett(m), 8))
...
def test_bincount():
    ...
    assert np.array_equal(
        NumCpp.bincount(cArray, minLength).flatten(), np.bincount(data.flatten(), minlength=minLength)
    )
    ...
    cWeights.setArray(weights)
    assert np.array_equal(
        NumCpp.bincountWeighted(cArray, cWeights, 0).flatten(),
    ...
    minLength = int(np.max(data) + 10)
    assert np.array_equal(
        NumCpp.bincountWeighted(cArray, cWeights, minLength).flatten(),
...
def test_bit_count():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.bit_count(cArray), np.array(list(map(lambda x: bin(x).count("1"), data.flatten()))).reshape(data.shape)
    )
...
def test_blackman():
    m = np.random.randint(2, 100)
    assert np.array_equal(np.round(NumCpp.blackman(m), 8).flatten(), np.round(np.blackman(m), 8))
...
def test_cbrt():
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.cbrtArray(cArray), 8), np.round(np.cbrt(data), 8))
...
def test_ceil():
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.ceilArray(cArray), 8), np.round(np.ceil(data), 8))
...
def test_center_of_mass():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.centerOfMass(cArray, NumCpp.Axis.NONE).flatten(), 8), np.round(ndimage.center_of_mass(data), 8)
    )
    ...
    for col in range(data.shape[1]):
        coms.append(np.round(ndimage.center_of_mass(data[:, col])[0], 8))

    assert np.array_equal(np.round(NumCpp.centerOfMass(cArray, NumCpp.Axis.ROW).flatten(), 8), np.round(coms, 8))
    ...
    for row in range(data.shape[0]):
        coms.append(np.round(ndimage.center_of_mass(data[row, :])[0], 8))

    assert np.array_equal(np.round(NumCpp.centerOfMass(cArray, NumCpp.Axis.COL).flatten(), 8), np.round(coms, 8))
...
def test_clip():
    ...
    assert NumCpp.clipScalar(value, minValue, maxValue) == np.clip(value, minValue, maxValue)
...
def test_complex():
    ...
    value = complex(real)
    assert np.round(NumCpp.complexScalar(real), 8) == np.round(value, 8)

    components = np.random.rand(2).astype(float)
    value = complex(components[0], components[1])
    assert np.round(NumCpp.complexScalar(components[0], components[1]), 8) == np.round(value, 8)
    ...
    assert np.array_equal(np.round(NumCpp.complexArray(realArray), 8), np.round(real + 1j * np.zeros_like(real), 8))
    ...
    assert np.array_equal(np.round(NumCpp.complexArray(realArray, imagArray), 8), np.round(real + 1j * imag, 8))
...
def test_conj():
    components = np.random.rand(2).astype(float)
    value = complex(components[0], components[1])
    assert np.round(NumCpp.conjScalar(value), 8) == np.round(np.conj(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.conjArray(cArray), 8), np.round(np.conj(data), 8))
...
def test_corrcoef():
    ...
    assert np.array_equal(np.round(NumCpp.corrcoef(a), 8), np.round(np.corrcoef(a), 8))


####################################################################################
def test_cos():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.cosScalar(value), 8) == np.round(np.cos(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.cosArray(cArray), 8), np.round(np.cos(data), 8))
...
def test_cosh():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.coshScalar(value), 8) == np.round(np.cosh(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.coshArray(cArray), 8), np.round(np.cosh(data), 8))
...
def test_cross():
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.cross(cArray1, cArray2, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.cross(data1, data2, axis=0)
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.cross(cArray1, cArray2, NumCpp.Axis.COL).getNumpyArray().flatten(), np.cross(data1, data2, axis=1)
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.cross(cArray1, cArray2, NumCpp.Axis.NONE).getNumpyArray().flatten(), np.cross(data1, data2).flatten()
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.cross(cArray1, cArray2, NumCpp.Axis.ROW).getNumpyArray(), np.cross(data1, data2, axis=0)
    )
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        NumCpp.cross(cArray1, cArray2, NumCpp.Axis.COL).getNumpyArray(), np.cross(data1, data2, axis=1)
    )
...
def test_cube():
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.cube(cArray), 8), np.round(data * data * data, 8))
...
def test_deg2rad():
    ...
    assert np.round(NumCpp.deg2radScalar(value), 8) == np.round(np.deg2rad(value), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.deg2radArray(cArray), 8), np.round(np.deg2rad(data), 8))


####################################################################################
def test_degrees():
    value = np.abs(np.random.rand(1).item()) * 2 * np.pi
    assert np.round(NumCpp.degreesScalar(value), 8) == np.round(np.degrees(value), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.degreesArray(cArray), 8), np.round(np.degrees(data), 8))
...
def test_deleteIndices():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.deleteIndicesScalar(cArray, index, NumCpp.Axis.NONE).flatten(), np.delete(data, index, axis=None)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.deleteIndicesScalar(cArray, index, NumCpp.Axis.ROW), np.delete(data, index, axis=0))
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.deleteIndicesScalar(cArray, index, NumCpp.Axis.COL), np.delete(data, index, axis=1))
    ...
    assert np.array_equal(
        NumCpp.deleteIndicesIndices(cArray, cIndices, NumCpp.Axis.NONE).flatten(), np.delete(data, indicesPy, axis=None)
    )
    ...
    cIndices.setArray(indicesPy)
    assert np.array_equal(
        NumCpp.deleteIndicesIndices(cArray, cIndices, NumCpp.Axis.ROW), np.delete(data, indicesPy, axis=0)
    )
    ...
    cIndices.setArray(indicesPy)
    assert np.array_equal(
        NumCpp.deleteIndicesIndices(cArray, cIndices, NumCpp.Axis.COL), np.delete(data, indicesPy, axis=1)
    )
...
def test_diagonal():
    ...
    assert np.array_equal(
        NumCpp.diagonal(cArray, offset, NumCpp.Axis.ROW).flatten(), np.diagonal(data, offset, axis1=0, axis2=1)
    )
    ...
    assert np.array_equal(
        NumCpp.diagonal(cArray, offset, NumCpp.Axis.COL).flatten(), np.diagonal(data, offset, axis1=1, axis2=0)
    )
...
def test_diff():
    ...
    data = np.random.randint(1, 50, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.diff(cArray, NumCpp.Axis.NONE).flatten(), np.diff(data.flatten()))
...
def test_divide():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(np.round(NumCpp.divide(cArray1, cArray2), 8), np.round(data1 / data2, 8))
    ...
    while value == 0:
        value = np.random.randint(-100, 100)
    assert np.array_equal(np.round(NumCpp.divide(cArray, value), 8), np.round(data / value, 8))
...
def test_extract():
    ...
    assert np.array_equal(NumCpp.extract(mask, data).flatten(), np.extract(mask, data))


####################################################################################
def test_exp2():
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.expScalar(value), 8) == np.round(np.exp(value), 8)
    ...
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.exp2Scalar(value), 8) == np.round(np.exp2(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.exp2Array(cArray), 8), np.round(np.exp2(data), 8))
...
def test_exp():
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.expArray(cArray), 8), np.round(np.exp(data), 8))
    ...
    value = np.abs(np.random.rand(1).item())
    assert np.round(NumCpp.expm1Scalar(value), 8) == np.round(np.expm1(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.expm1Array(cArray), 8), np.round(np.expm1(data), 8))
...
def test_eye():
    ...
    assert np.array_equal(
        NumCpp.eye1DComplex(shapeInput, randK), np.eye(shapeInput, k=randK) + 1j * np.zeros([shapeInput, shapeInput])
    )
    ...
    assert np.array_equal(
        NumCpp.eye2D(shapeInput[0].item(), shapeInput[1].item(), randK),
    ...
    assert np.array_equal(
        NumCpp.eye2DComplex(shapeInput[0].item(), shapeInput[1].item(), randK),
        np.eye(shapeInput[0].item(), shapeInput[1].item(), k=randK) + 1j * np.zeros(shapeInput),
    )
    ...
    assert np.array_equal(
        NumCpp.eyeShapeComplex(cShape, randK),
        np.eye(shapeInput[0].item(), shapeInput[1].item(), k=randK) + 1j * np.zeros(shapeInput),
    )
...
def test_flip():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.flip(cArray, NumCpp.Axis.NONE).getNumpyArray(),
...
def test_floor_divide():
    ...
    assert NumCpp.floor_divideScalar(value1, value2) == np.floor_divide(value1, value2)
...
def test_fromfunction():
    ...
    assert np.array_equal(
        np.round(NumCpp.fromfunction(size).flatten(), 8),
        np.round(
            np.fromfunction(
                functionSize,
                [
    ...
    assert np.array_equal(np.round(NumCpp.fromfunction(cShape), 8), np.round(np.fromfunction(functionShape, shape), 8))
...
def test_full():
    ...
    assert (
        cArray.shape[0] == shapeInput
        and cArray.shape[1] == shapeInput
        and cArray.size == shapeInput**2
        and np.all(cArray == value)
    )
    ...
    assert (
        cArray.shape[0] == shapeInput[0]
        and cArray.shape[1] == shapeInput[1]
        and cArray.size == shapeInput.prod()
        and np.all(cArray == value)
    )
    ...
    assert (
        cArray.shape[0] == shape.rows
        and cArray.shape[1] == shape.cols
        and cArray.size == shapeInput.prod()
        and np.all(cArray == value)
    )
...
def test_full_like():
    ...
    assert (
        cArray2.shape().rows == shape.rows
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(cArray2.getNumpyArray() == value)
    )
...
def test_gradient():
    ...
    data = np.random.randint(1, 1000, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.gradient(cArray, NumCpp.Axis.NONE).flatten(), np.gradient(data.flatten(), axis=0))
...
def test_greater():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.greater(cArray1, cArray2).getNumpyArray(), np.greater(data1, data2))
...
def test_greater_equal():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.greater_equal(cArray1, cArray2).getNumpyArray(), np.greater_equal(data1, data2))
...
def test_hamming():
    m = np.random.randint(2, 100)
    assert np.array_equal(np.round(NumCpp.hamming(m), 8).flatten(), np.round(np.hamming(m), 8))


####################################################################################
def test_hanning():
    m = np.random.randint(2, 100)
    assert np.array_equal(np.round(NumCpp.hanning(m), 8).flatten(), np.round(np.hanning(m), 8))
...
def test_histogram():
    ...
    assert np.array_equal(np.round(bins.getNumpyArray().flatten(), 8), np.round(b, 8))
...
def test_hypot():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(np.round(NumCpp.hypotArray(cArray1, cArray2), 8), np.round(np.hypot(data1, data2), 8))
    ...
    cArray3.setArray(data3)
    assert np.array_equal(
        np.round(NumCpp.hypotArray(cArray1, cArray2, cArray3), 8),
...
def test_identity():
    ...
    assert np.array_equal(
        NumCpp.identityComplex(squareSize).getNumpyArray(),
...
def test_imag():
    components = np.random.rand(2).astype(float)
    value = complex(components[0], components[1])
    assert np.round(NumCpp.imagScalar(value), 8) == np.round(np.imag(value), 8)  # noqa
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.imagArray(cArray), 8), np.round(np.imag(data), 8))
...
def test_insert():
    ...
    value = 666
    assert np.array_equal(
        NumCpp.insert(cArray, index, value, NumCpp.Axis.NONE).flatten(), np.insert(data, index, value, axis=None)
    )
    ...
    value = 666
    assert np.array_equal(NumCpp.insert(cArray, index, value, NumCpp.Axis.ROW), np.insert(data, index, value, axis=0))
    ...
    value = 666
    assert np.array_equal(NumCpp.insert(cArray, index, value, NumCpp.Axis.COL), np.insert(data, index, value, axis=1))
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, index, cValues, NumCpp.Axis.NONE).flatten(), np.insert(data, index, values, axis=None)
    )
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, index, cValues, NumCpp.Axis.ROW), np.insert(data, index, values, axis=0)
    )
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, index, cValues, NumCpp.Axis.COL), np.insert(data, index, values, axis=1)
    )
    ...
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, value, NumCpp.Axis.NONE).flatten(), np.insert(data, indices, value, axis=None)
    )
    ...
    value = np.random.randint(100, 200, 1).item()
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, value, NumCpp.Axis.ROW), np.insert(data, indices, value, axis=0)
    )
    ...
    value = np.random.randint(100, 200, 1).item()
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, value, NumCpp.Axis.COL), np.insert(data, indices, value, axis=1)
    )
    ...
    value = np.random.randint(100, 200, 1).item()
    assert np.array_equal(
        NumCpp.insert(cArray, cSlice, value, NumCpp.Axis.NONE).flatten(),
    ...
    value = np.random.randint(100, 200, 1).item()
    assert np.array_equal(
        NumCpp.insert(cArray, NumCpp.Slice(sliceStart, sliceEnd, sliceStep), value, NumCpp.Axis.ROW),
    ...
    value = np.random.randint(100, 200, 1).item()
    assert np.array_equal(
        NumCpp.insert(cArray, NumCpp.Slice(sliceStart, sliceEnd, sliceStep), value, NumCpp.Axis.COL),
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, cValues, NumCpp.Axis.NONE).flatten(),
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, cValues, NumCpp.Axis.ROW), np.insert(data, indices, values, axis=0)
    )
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cIndices, cValues, NumCpp.Axis.COL), np.insert(data, indices, values, axis=1)
    )
    ...
    values = np.random.randint(
        ...
        200,
        [
            cSlice.numElements(cArray.size()),
        ],
    )
    cValues = NumCpp.NdArray(1, values.size)
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cSlice, cValues, NumCpp.Axis.NONE).flatten(),
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cSlice, cValues, NumCpp.Axis.ROW),
    ...
    cValues.setArray(values)
    assert np.array_equal(
        NumCpp.insert(cArray, cSlice, cValues, NumCpp.Axis.COL),
...
def test_interp():
    ...
    cX.setArray(xData)
    assert np.array_equal(
        np.round(NumCpp.interp(cX, cXp, cFp).flatten(), 8), np.round(np.interp(xData, xpData, fpData), 8)
    )
...
def test_isclose():
    ...
    atol = 1e-8
    assert np.array_equal(
        NumCpp.isclose(cArray1, cArray2, rtol, atol).getNumpyArray(), np.isclose(data1, data2, rtol=rtol, atol=atol)
    )
...
def test_kaiser():
    if NumCpp.STL_SPECIAL_FUNCTIONS or not NumCpp.NUMCPP_NO_USE_BOOST:
        ...
        assert np.array_equal(np.round(NumCpp.kaiser(m, beta), 8).flatten(), np.round(np.kaiser(m, beta), 8))
...
def test_ldexp():
    ...
    assert np.round(NumCpp.ldexpScalar(value1, value2), 8) == np.round(np.ldexp(value1, value2), 8)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(np.round(NumCpp.ldexpArray(cArray1, cArray2), 8), np.round(np.ldexp(data1, data2), 8))
...
def test_left_shift():
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.left_shift(cArray, bitsToshift).getNumpyArray(), np.left_shift(data, bitsToshift))
...
def test_less():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.less(cArray1, cArray2).getNumpyArray(), np.less(data1, data2))
...
def test_less_equal():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.less_equal(cArray1, cArray2).getNumpyArray(), np.less_equal(data1, data2))
...
def test_log():
    value = np.random.randn(1).item() * 100 + 1000
    assert np.round(NumCpp.logScalar(value), 8) == np.round(np.log(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols) * 100 + 1000
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.logArray(cArray), 8), np.round(np.log(data), 8))
...
def test_logb():
    ...
    assert np.round(NumCpp.logbScalar(value, base), 8) == np.round(np.log(value) / np.log(base), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols) * 100 + 1000
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.logbArray(cArray, base), 8), np.round(np.log(data) / np.log(base), 8))
...
def test_log10():
    value = np.random.randn(1).item() * 100 + 1000
    assert np.round(NumCpp.log10Scalar(value), 8) == np.round(np.log10(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols) * 100 + 1000
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.log10Array(cArray), 8), np.round(np.log10(data), 8))
...
def test_log1p():
    value = np.random.randn(1).item() * 100 + 1000
    assert np.round(NumCpp.log1pScalar(value), 8) == np.round(np.log1p(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols) * 100 + 1000
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.log1pArray(cArray), 8), np.round(np.log1p(data), 8))


####################################################################################
def test_log2():
    value = np.random.randn(1).item() * 100 + 1000
    assert np.round(NumCpp.log2Scalar(value), 8) == np.round(np.log2(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols) * 100 + 1000
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.log2Array(cArray), 8), np.round(np.log2(data), 8))


####################################################################################
def test_logaddexp():
    values = np.random.rand(2) * 10
    assert np.round(NumCpp.logaddexpScalar(*values), 8) == np.round(np.logaddexp(*values), 8)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(np.round(NumCpp.logaddexpArray(cArray1, cArray2), 8), np.round(np.logaddexp(data1, data2), 8))


####################################################################################
def test_logaddexp2():
    values = np.random.rand(2) * 10
    assert np.round(NumCpp.logaddexp2Scalar(*values), 8) == np.round(np.logaddexp2(*values), 8)
    ...
    cArray2.setArray(data2)
    assert np.array_equal(
        np.round(NumCpp.logaddexp2Array(cArray1, cArray2), 8), np.round(np.logaddexp2(data1, data2), 8)
    )
...
def test_max():
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.max(cArray, NumCpp.Axis.ROW).flatten(), np.max(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.max(cArray, NumCpp.Axis.COL).flatten(), np.max(data, axis=1))
...
def test_maximum():
    ...
    cArray1.setArray(data1)
    assert np.array_equal(NumCpp.maximum(cArray1, data2), np.maximum(data1, data2))
    ...
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.maximum(data1, cArray2), np.maximum(data1, data2))
...
def test_mean():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.mean(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8), np.round(np.mean(data, axis=0), 8)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.mean(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8), np.round(np.mean(data, axis=1), 8)
    )
...
def test_min():
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.min(cArray, NumCpp.Axis.ROW).flatten(), np.min(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.min(cArray, NumCpp.Axis.COL).flatten(), np.min(data, axis=1))
...
def test_minimum():
    ...
    data2 = np.random.randint(0, 100)
    cArray1.setArray(data1)
    assert np.array_equal(NumCpp.minimum(cArray1, data2), np.minimum(data1, data2))
    ...
    data1 = np.random.randint(0, 100)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.minimum(data1, cArray2), np.minimum(data1, data2))
...
def test_nan_to_num():
    ...
    assert np.array_equal(
        NumCpp.nan_to_num(cArray, nan_replace, pos_inf_replace, neg_inf_replace),
...
def test_nanargmax():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nanargmax(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.nanargmax(data, axis=0)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nanargmax(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.nanargmax(data, axis=1)
    )
...
def test_nanargmin():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nanargmin(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.nanargmin(data, axis=0)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nanargmin(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.nanargmin(data, axis=1)
    )
...
def test_nancumprod():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nancumprod(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten(), np.nancumprod(data, axis=None)
    )
...
def test_nancumsum():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.nancumsum(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten(), np.nancumsum(data, axis=None)
    )
...
def test_nanmax():
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmax(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.nanmax(data, axis=0))
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmax(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.nanmax(data, axis=1))
...
def test_nanmean():
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmean(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.nanmean(data, axis=0))
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmean(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.nanmean(data, axis=1))
...
def test_nanmedian():
    ...
    cArray.setArray(data)
    assert (
        NumCpp.nanmedian(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten().item()
...
def test_nanmin():
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmin(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.nanmin(data, axis=0))
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.nanmin(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.nanmin(data, axis=1))
...
def test_nanpercentile():
    ...
    assert NumCpp.nanpercentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.LOWER
    ).item() == np.nanpercentile(data, percentile, axis=None, method="lower")
    ...
    percentile = np.random.rand(1).item() * 100
    assert NumCpp.nanpercentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.HIGHER
    ).item() == np.nanpercentile(data, percentile, axis=None, method="higher")
    ...
    percentile = np.random.rand(1).item() * 100
    assert NumCpp.nanpercentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.NEAREST
    ).item() == np.nanpercentile(data, percentile, axis=None, method="nearest")
    ...
    percentile = np.random.rand(1).item() * 100
    assert NumCpp.nanpercentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.MIDPOINT
    ).item() == np.nanpercentile(data, percentile, axis=None, method="midpoint")
    ...
    percentile = np.random.rand(1).item() * 100
    assert NumCpp.nanpercentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.LINEAR
    ).item() == np.nanpercentile(data, percentile, axis=None, method="linear")
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.LOWER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.HIGHER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.NEAREST)
        .getNumpyArray()
        .flatten(),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.MIDPOINT)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.LINEAR)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.LOWER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.HIGHER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.NEAREST)
        .getNumpyArray()
        .flatten(),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.MIDPOINT)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.nanpercentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.LINEAR)
            .getNumpyArray()
            .flatten(),
            8,
        ),
...
def test_nans_like():
    ...
    assert (
        ...
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(np.isnan(cArray2.getNumpyArray()))
    )
...
def test_nanstd():
    ...
    data = data.reshape(shapeInput)
    cArray.setArray(data)
    assert np.round(NumCpp.nanstdev(cArray, NumCpp.Axis.NONE).item(), 8) == np.round(np.nanstd(data), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.nanstdev(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8),
        np.round(np.nanstd(data, axis=0), 8),
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.nanstdev(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8),
        np.round(np.nanstd(data, axis=1), 8),
    )
...
def test_nanvar():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.nanvar(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8),
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.nanvar(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8),
...
def test_negative():
    ...
    data = np.random.randint(-100, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.negative(cArray).getNumpyArray(), 8), np.round(np.negative(data), 8))
...
def test_nth_root():
    ...
    assert np.array_equal(np.round(NumCpp.nth_rootArray(cArray, root), 8), np.round(np.power(data, 1 / root), 8))
...
def test_none():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.none(cArray, NumCpp.Axis.ROW).flatten().astype(bool), np.logical_not(np.any(data, axis=0))
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.none(cArray, NumCpp.Axis.COL).flatten().astype(bool), np.logical_not(np.any(data, axis=1))
    )
...
def test_nonzero():
    ...
    assert np.array_equal(rowC.getNumpyArray().flatten(), row) and np.array_equal(colC.getNumpyArray().flatten(), col)
...
def test_ones_like():
    ...
    assert (
        ...
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(cArray2.getNumpyArray() == 1)
    )
    ...
    assert (
        ...
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(cArray2.getNumpyArray() == complex(1, 0))
    )
...
def test_packbits():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.packbitsLittleEndian(cArray, NumCpp.Axis.NONE).flatten(), np.packbits(data, axis=None, bitorder="little")
    )
    assert np.array_equal(
        NumCpp.packbitsLittleEndian(cArray, NumCpp.Axis.ROW), np.packbits(data, axis=0, bitorder="little")
    )
    assert np.array_equal(
        NumCpp.packbitsLittleEndian(cArray, NumCpp.Axis.COL), np.packbits(data, axis=1, bitorder="little")
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.packbitsBigEndian(cArray, NumCpp.Axis.NONE).flatten(), np.packbits(data, axis=None, bitorder="big")
    )
    assert np.array_equal(NumCpp.packbitsBigEndian(cArray, NumCpp.Axis.ROW), np.packbits(data, axis=0, bitorder="big"))
    assert np.array_equal(NumCpp.packbitsBigEndian(cArray, NumCpp.Axis.COL), np.packbits(data, axis=1, bitorder="big"))
    ...
    assert np.array_equiv(NumCpp.packbitsBigEndian(cArray, NumCpp.Axis.ROW), np.packbits(data, axis=0, bitorder="big"))
    assert np.array_equiv(NumCpp.packbitsBigEndian(cArray, NumCpp.Axis.COL), np.packbits(data, axis=1, bitorder="big"))
...
def test_pad():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.pad(cArray, padWidth, padValue).getNumpyArray(),
...
def test_percentile():
    ...
    cArray.setArray(data)
    percentile = np.random.rand(1).item() * 100
    assert NumCpp.percentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.LOWER
    ).item() == np.percentile(data, percentile, axis=None, method="lower")
    ...
    assert NumCpp.percentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.HIGHER
    ).item() == np.percentile(data, percentile, axis=None, method="higher")
    ...
    assert NumCpp.percentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.NEAREST
    ).item() == np.percentile(data, percentile, axis=None, method="nearest")
    ...
    assert NumCpp.percentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.MIDPOINT
    ).item() == np.percentile(data, percentile, axis=None, method="midpoint")
    ...
    assert NumCpp.percentile(
        cArray, percentile, NumCpp.Axis.NONE, NumCpp.InterpolationMethod.LINEAR
    ).item() == np.percentile(data, percentile, axis=None, method="linear")
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.LOWER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.HIGHER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.NEAREST)
        .getNumpyArray()
        .flatten(),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.percentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.MIDPOINT)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.percentile(cArray, percentile, NumCpp.Axis.ROW, NumCpp.InterpolationMethod.LINEAR)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.LOWER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.HIGHER)
        .getNumpyArray()
        .flatten(),
    ...
    percentile = np.random.rand(1).item() * 100
    assert np.array_equal(
        NumCpp.percentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.NEAREST)
        .getNumpyArray()
        .flatten(),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.percentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.MIDPOINT)
            .getNumpyArray()
            .flatten(),
            8,
        ),
    ...
    assert np.array_equal(
        np.round(
            NumCpp.percentile(cArray, percentile, NumCpp.Axis.COL, NumCpp.InterpolationMethod.LINEAR)
            .getNumpyArray()
            .flatten(),
            8,
        ),
...
def test_place():
    ...
    cArray.setArray(data)
    cMask.setArray(mask)
    replaceValues = np.random.randint(
        0,
        100,
        [
            shape.size() // 2,
...
def test_power():
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.powerArrayScalar(cArray, exponent), 8), np.round(np.power(data, exponent), 8))
    ...
    assert np.array_equal(
        np.round(NumCpp.powerArrayArray(cArray, cExponents), 8), np.round(np.power(data, exponents), 8)
    )
...
def test_powerf():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.powerfArrayScalar(cArray, exponent), 8), np.round(np.power(data, exponent), 8)
    )
    ...
    cExponents.setArray(exponents)
    assert np.array_equal(
        np.round(NumCpp.powerfArrayArray(cArray, cExponents), 8), np.round(np.power(data, exponents), 8)
    )
...
def test_rad2deg():
    value = np.abs(np.random.rand(1).item()) * 2 * np.pi
    assert np.round(NumCpp.rad2degScalar(value), 8) == np.round(np.rad2deg(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols) * 2 * np.pi
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.rad2degArray(cArray), 8), np.round(np.rad2deg(data), 8))


####################################################################################
def test_radians():
    value = np.abs(np.random.rand(1).item()) * 360
    assert np.round(NumCpp.radiansScalar(value), 8) == np.round(np.radians(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols) * 360
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.radiansArray(cArray), 8), np.round(np.radians(data), 8))
...
def test_real():
    components = np.random.rand(2).astype(float)
    value = complex(components[0], components[1])
    assert np.round(NumCpp.realScalar(value), 8) == np.round(np.real(value), 8)  # noqa
    ...
    data = np.random.rand(shape.rows, shape.cols) + 1j * np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.realArray(cArray), 8), np.round(np.real(data), 8))
...
def test_reciprocal():
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.reciprocal(cArray), 8), np.round(np.reciprocal(data), 8))
...
def test_remainder():
    ...
    if res < 0:
        res += values[0].item()
    assert np.round(res, 8) == np.round(np.remainder(values[1], values[0]), 8)
    ...
    assert np.array_equal(np.round(res, 8), np.round(np.remainder(data1, data2), 8))
...
def test_right_shift():
    ...
    data = np.random.randint(1, np.iinfo(np.uint32).max, [shape.rows, shape.cols], dtype=np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.right_shift(cArray, bitsToshift).getNumpyArray(), np.right_shift(data, bitsToshift))
...
def test_rms():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.rms(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8),
        np.round(np.sqrt(np.mean(np.square(data), axis=0)), 8),
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.rms(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8),
        np.round(np.sqrt(np.mean(np.square(data), axis=1)), 8),
    )
...
def test_roll():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.roll(cArray, amount, NumCpp.Axis.NONE).getNumpyArray(), np.roll(data, amount, axis=None)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.roll(cArray, amount, NumCpp.Axis.ROW).getNumpyArray(), np.roll(data, amount, axis=0))
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.roll(cArray, amount, NumCpp.Axis.COL).getNumpyArray(), np.roll(data, amount, axis=1))
...
def test_round():
    ...
    data = np.random.rand(shape.rows, shape.cols) * 2 * np.pi
    cArray.setArray(data)
    assert np.array_equal(NumCpp.roundArray(cArray, 8), np.round(data, 8))
...
def test_select():
    ...
    assert np.array_equal(NumCpp.select(condlist, choicelist, default), np.select(condlist, choicelist, default))
    ...
    assert np.array_equal(NumCpp.selectVector(condlist, choicelist, default), np.select(condlist, choicelist, default))
...
def test_setdiff1d():
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.setdiff1d(cArray1, cArray2).getNumpyArray().flatten(), np.setdiff1d(data1, data2))
...
def test_sin():
    ...
    assert np.round(NumCpp.sinScalar(value), 8) == np.round(np.sin(value), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.sinArray(cArray), 8), np.round(np.sin(data), 8))
...
def test_sinc():
    ...
    assert np.round(NumCpp.sincScalar(value.item()), 8) == np.round(np.sinc(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.sincArray(cArray), 8), np.round(np.sinc(data), 8))


####################################################################################
def test_sinh():
    value = np.random.randn(1).item()
    assert np.round(NumCpp.sinhScalar(value), 8) == np.round(np.sinh(value), 8)
    ...
    data = np.random.randn(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.sinhArray(cArray), 8), np.round(np.sinh(data), 8))
...
def test_sqrt():
    ...
    assert np.round(NumCpp.sqrtScalar(value), 8) == np.round(np.sqrt(value), 8)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.sqrtArray(cArray), 8), np.round(np.sqrt(data), 8))
...
def test_square():
    ...
    assert np.round(NumCpp.squareScalar(value), 8) == np.round(np.square(value), 8)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.squareArray(cArray), 8), np.round(np.square(data), 8))
...
def test_stdev():
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.round(NumCpp.stdev(cArray, NumCpp.Axis.NONE).item(), 8) == np.round(np.std(data), 8)
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.stdev(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8), np.round(np.std(data, axis=0), 8)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.stdev(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8), np.round(np.std(data, axis=1), 8)
    )
...
def test_swap():
    ...
    assert np.array_equal(cArray1.getNumpyArray(), data2) and np.array_equal(cArray2.getNumpyArray(), data1)
...
def test_tan():
    ...
    assert np.round(NumCpp.tanScalar(value), 8) == np.round(np.tan(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.tanArray(cArray), 8), np.round(np.tan(data), 8))
...
def test_take():
    ...
    cIndices.setArray(indices)
    assert np.array_equal(NumCpp.take(cArray, cIndices, NumCpp.Axis.NONE).flatten(), np.take(data, indices).flatten())
    ...
    assert np.array_equal(NumCpp.take(cArray, cRowIndices, NumCpp.Axis.ROW), np.take(data, rowIndices, axis=0))
    ...
    assert np.array_equal(NumCpp.take(cArray, cColIndices, NumCpp.Axis.COL), np.take(data, colIndices, axis=1))


####################################################################################
def test_tanh():
    value = np.random.rand(1).item() * np.pi
    assert np.round(NumCpp.tanhScalar(value), 8) == np.round(np.tanh(value), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.tanhArray(cArray), 8), np.round(np.tanh(data), 8))
...
def test_tril():
    ...
    assert np.array_equal(NumCpp.trilSquare(squareSize, offset), np.tri(squareSize, k=offset))
    ...
    assert np.array_equal(
        NumCpp.trilSquareComplex(squareSize, offset),
    ...
    assert np.array_equal(
        NumCpp.trilRect(shapeInput[0].item(), shapeInput[1].item(), offset),
    ...
    assert np.array_equal(
        NumCpp.trilRectComplex(shapeInput[0].item(), shapeInput[1].item(), offset),
    ...
    assert np.array_equal(NumCpp.trilArray(cArray, offset), np.tril(data, k=offset))
...
def test_triu():
    ...
    assert np.array_equal(NumCpp.triuSquare(squareSize, offset), np.tri(squareSize, k=-offset).T)
    ...
    assert np.array_equal(
        NumCpp.triuSquareComplex(squareSize, offset),
...
def test_trim_zeros():
    ...
    data[0, -offsetEnd:] = 0
    cArray.setArray(data)
    assert np.array_equal(NumCpp.trim_zeros(cArray, "f").getNumpyArray().flatten(), np.trim_zeros(data.flatten(), "f"))
    ...
    data[0, -offsetEnd:] = 0
    cArray.setArray(data)
    assert np.array_equal(NumCpp.trim_zeros(cArray, "b").getNumpyArray().flatten(), np.trim_zeros(data.flatten(), "b"))
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.trim_zeros(cArray, "fb").getNumpyArray().flatten(), np.trim_zeros(data.flatten(), "fb")
    )
...
def test_unpackbits():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.unpackbitsLittleEndian(cArray, NumCpp.Axis.NONE).flatten(),
        np.unpackbits(data, axis=None, bitorder="little"),
    )
    assert np.array_equal(
        NumCpp.unpackbitsLittleEndian(cArray, NumCpp.Axis.ROW), np.unpackbits(data, axis=0, bitorder="little")
    )
    assert np.array_equal(
        NumCpp.unpackbitsLittleEndian(cArray, NumCpp.Axis.COL), np.unpackbits(data, axis=1, bitorder="little")
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        NumCpp.unpackbitsBigEndian(cArray, NumCpp.Axis.NONE).flatten(), np.unpackbits(data, axis=None, bitorder="big")
    )
    assert np.array_equal(
        NumCpp.unpackbitsBigEndian(cArray, NumCpp.Axis.ROW), np.unpackbits(data, axis=0, bitorder="big")
    )
    assert np.array_equal(
        NumCpp.unpackbitsBigEndian(cArray, NumCpp.Axis.COL), np.unpackbits(data, axis=1, bitorder="big")
    )
...
def test_unwrap():
    ...
    assert np.round(NumCpp.unwrapScalar(value), 8) == np.round(np.arctan2(np.sin(value), np.cos(value)), 8)
    ...
    data = np.random.rand(shape.rows, shape.cols)
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.unwrapArray(cArray), 8), np.round(np.arctan2(np.sin(data), np.cos(data)), 8))
...
def test_var():
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.var(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), 8), np.round(np.var(data, axis=0), 8)
    )
    ...
    cArray.setArray(data)
    assert np.array_equal(
        np.round(NumCpp.var(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), 8), np.round(np.var(data, axis=1), 8)
    )
...
def test_zeros():
    ...
    assert (
        ...
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(cArray2.getNumpyArray() == 0)
    )
    ...
    assert (
        ...
        and cArray2.shape().cols == shape.cols
        and cArray2.size() == shapeInput.prod()
        and np.all(cArray2.getNumpyArray() == complex(0, 0))
    )
