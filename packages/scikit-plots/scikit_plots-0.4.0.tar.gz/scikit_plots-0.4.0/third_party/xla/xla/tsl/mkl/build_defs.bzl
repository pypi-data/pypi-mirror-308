...
def if_mkl_ml(if_true, if_false = []):
    ...
    """
    return select({
        "@xla//xla/tsl/mkl:build_with_mkl_opensource": if_false,
        "@xla//xla/tsl/mkl:build_with_mkl": if_true,
        "//conditions:default": if_false,
    })
...
def if_mkl_lnx_x64(if_true, if_false = []):
    ...
    """
    return select({
        "@xla//xla/tsl/mkl:build_with_mkl_lnx_x64": if_true,
        "//conditions:default": if_false,
    })
...
def if_enable_mkl(if_true, if_false = []):
    ...
    """
    return select({
        "@xla//xla/tsl/mkl:enable_mkl": if_true,
        "//conditions:default": if_false,
    })
...
def onednn_v3_define():
    ...
    """
    return select({
        "@xla//xla/tsl/mkl:build_with_mkl_aarch64": ["-DENABLE_ONEDNN_V3"],
        "@xla//xla/tsl:linux_x86_64": ["-DENABLE_ONEDNN_V3"],
        "@xla//xla/tsl:windows": ["-DENABLE_ONEDNN_V3"],
        "//conditions:default": [],
    })
...
def if_mkldnn_openmp(if_true, if_false = []):
    ...
    """
    return select({
        "@xla//xla/tsl/mkl:build_with_mkldnn_openmp": if_true,
        "//conditions:default": if_false,
    })
...
def if_mkldnn_aarch64_acl_openmp(if_true, if_false = []):
    return select({
        "@xla//xla/tsl/mkl:build_with_mkl_aarch64_openmp": if_true,
        "//conditions:default": if_false,
    })
