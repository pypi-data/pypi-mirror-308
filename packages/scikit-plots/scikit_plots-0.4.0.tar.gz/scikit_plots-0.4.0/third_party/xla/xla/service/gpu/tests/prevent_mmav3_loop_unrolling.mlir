...
#mma = #triton_gpu.nvidia_mma<{versionMajor = 3, versionMinor = 0, warpsPerCTA = [4, 1], instrShape = [16, 32, 16]}>
#shared = #triton_gpu.shared<{vec = 8, perPhase = 2, maxPhase = 4, order = [1, 0], hasLeadingOffset = true}>
// CHECK-LABEL: @add_pragma_nounroll
tt.func @add_pragma_nounroll(%arg0: !tt.memdesc<64x32xf16, #shared>, %arg1: !tt.memdesc<32x32xf16, #shared>) {
  ...
  %38:1 = scf.for %arg2 = %c0_i32 to %c128_i32 step %c32_i32 iter_args(%arg3 = %cst_2) -> (tensor<64x32xf32, #mma>)  : i32 {
    ...
    %dot = triton_nvidia_gpu.warp_group_dot %arg0, %arg1, %arg3 : !tt.memdesc<64x32xf16, #shared> * !tt.memdesc<32x32xf16, #shared> -> tensor<64x32xf32, #mma>
...
tt.func @add_pragma_unroll_exactly_once(%arg0: !tt.memdesc<64x32xf16, #shared>, %arg1: !tt.memdesc<32x32xf16, #shared>) {
  %c0_i32 = arith.constant 0 : i32
  %c32_i32 = arith.constant 32 : i32
  %c128_i32 = arith.constant 128 : i32
  %cst_2 = arith.constant dense<0.000000e+00> : tensor<64x32xf32, #mma>
  %38:1 = scf.for %arg2 = %c0_i32 to %c128_i32 step %c32_i32 iter_args(%arg3 = %cst_2) -> (tensor<64x32xf32, #mma>)  : i32 {
    ...
    // CHECK-NOT: tt.elementwise_inline_asm ".pragma \22nounroll\22;"
    %dot = triton_nvidia_gpu.warp_group_dot %arg0, %arg1, %arg3 : !tt.memdesc<64x32xf16, #shared> * !tt.memdesc<32x32xf16, #shared> -> tensor<64x32xf32, #mma>
    %dot2 = triton_nvidia_gpu.warp_group_dot %arg0, %arg1, %arg3 : !tt.memdesc<64x32xf16, #shared> * !tt.memdesc<32x32xf16, #shared> -> tensor<64x32xf32, #mma>
    scf.yield %dot : tensor<64x32xf32, #mma>
  }
  tt.return
}
