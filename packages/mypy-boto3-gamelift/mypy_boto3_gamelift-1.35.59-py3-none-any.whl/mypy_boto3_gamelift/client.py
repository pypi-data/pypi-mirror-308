...
class GameLiftClient(BaseClient):
    ...
    def create_build(
        ...
        stores the software for deployment to hosting
        resources.
    ...
    def create_container_fleet(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.create_container_fleet)
    ...
    def create_container_group_definition(
        ...
        hosting your game server with Amazon GameLift managed containers
        hosting.
    ...
    def create_fleet_locations(
        ...
        begins populating the new locations with
        instances.
    ...
    def delete_container_fleet(
        ...
        down currently running fleet instances, including those in remote
        locations.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.delete_container_fleet)
    ...
    def describe_container_fleet(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.describe_container_fleet)
    ...
    def describe_fleet_deployment(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.describe_fleet_deployment)
    ...
    def list_container_fleets(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.list_container_fleets)
    ...
    def list_container_group_definition_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.list_container_group_definition_versions)
    ...
    def list_fleet_deployments(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.list_fleet_deployments)
    ...
    def update_container_fleet(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.update_container_fleet)
    ...
    def update_container_group_definition(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift.html#GameLift.Client.update_container_group_definition)
