...
class InteractionCacheManager:
    ...
    def save_interaction(
        ...
        """Save interaction with persistence"""
        ...
        cls._interaction_cache[prompt_id][session_id][version] = interaction_data

        # Save to persistent storage
        cls._persistent.save(cache_key, interaction_data)
        logger.info(f"Saved interaction to persistent storage with key: {cache_key}")
