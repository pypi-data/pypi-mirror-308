...
class InteractionCacheManager:
    ...
    def print_cache_contents(cls) -> None:
        ...
        print("\n=== Version Messages Cache Contents ===")
        if not cls._prompt_version_messages:
            print("Version messages cache is empty")
        for key, value in cls._prompt_version_messages.items():
            print(f"\nVersion Key: {key}")
            print(f"Messages: {value}")
