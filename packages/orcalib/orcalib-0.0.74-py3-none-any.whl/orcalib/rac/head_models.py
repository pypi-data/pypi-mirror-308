...
class RACHeadProtocol(Protocol):
    ...
    def forward(
        ...
        Args:
            ...
            original_input (list[InputType]): The original (non-embedded) input examples.
            original_memories (list[list[InputType]]): The original (non-embedded) memories.
        Returns:
...
class MCERHead(nn.Module):
    ...
    def compute_score(self, original_input: list[InputType], original_memory: list[InputType]) -> Tensor:
