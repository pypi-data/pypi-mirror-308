...
class MainWindowInit:
    ...
    Attributes:
        ...
        minimum_size (ObjectSize | None): The minimum size of the main window. Defaults to None.
        maximum_size (ObjectSize | None): The maximum size of the main window. Defaults to None.
        fixed_size (ObjectSize | None): The fixed size of the main window. Defaults to None.
        size_policy (QSizePolicy | None): The size policy of the main window. Defaults to None.
        graphic_effect (QGraphicsEffect | None): The graphic effect to apply to the main window. Defaults to None.
