...
class AddBlockDialog(myDialog): 
    def _make_main_sizers_and_panel(self):
        ...
        self.wrapper = wx.FlexGridSizer(5,1,5,5)
 

    def make_widgets(self):
        print("top of make widgets")
        ...
        self.wrapper.AddGrowableRow(1, 1)
        self.wrapper.AddGrowableCol(0, 1)
