...
class ModalClientStub:
    ...
    AppDeploySingleObject: grpc.UnaryUnaryMultiCallable[
    ...
    ProxyIpDelete: grpc.UnaryUnaryMultiCallable[
...
class ModalClientServicer(metaclass=abc.ABCMeta):
    ...
    def AppDeploySingleObject(
        self,
        request: modal_proto.api_pb2.AppDeploySingleObjectRequest,
        context: grpc.ServicerContext,
    ) -> modal_proto.api_pb2.AppDeploySingleObjectResponse: ...
    @abc.abstractmethod
    ...
    def ProxyIpDelete(
        self,
        request: modal_proto.api_pb2.ProxyIpDeleteRequest,
        context: grpc.ServicerContext,
    ) -> google.protobuf.empty_pb2.Empty:
        """Proxy IPs
        TODO: remove all methods when migration from ProxyIp -> Proxy is complete.
        """
    @abc.abstractmethod
    def ProxyIpGetOrCreate(
        self,
        request: modal_proto.api_pb2.ProxyIpGetOrCreateRequest,
        context: grpc.ServicerContext,
    ) -> modal_proto.api_pb2.ProxyIpGetOrCreateResponse: ...
    @abc.abstractmethod
    def ProxyIpList(
