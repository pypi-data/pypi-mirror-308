...
class _ContainerIOManager:
    ...
    async def _push_terminated_outputs(self, input_ids: typing.List[str]) -> None: ...
...
class ContainerIOManager:
    ...
    class ___push_terminated_outputs_spec(typing_extensions.Protocol):
        def __call__(self, input_ids: typing.List[str]) -> None: ...
        async def aio(self, input_ids: typing.List[str]) -> None: ...

    _push_terminated_outputs: ___push_terminated_outputs_spec
