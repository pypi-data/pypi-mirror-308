...
class _ContainerIOManager:
    ...
    async def exit_context(self, started_at, input_ids: typing.List[str]): ...
...
class ContainerIOManager:
    ...
    class __exit_context_spec(typing_extensions.Protocol):
        def __call__(self, started_at, input_ids: typing.List[str]): ...
        async def aio(self, started_at, input_ids: typing.List[str]): ...
